...
\begin{document}
  ...
  \songchapter{Asia}
    \section{Indian Bhajans \& Mantras} 
      \begin{songs}{titleidx,authidx}
        ...
        \input{songdata/songs_mantra_hindu.tex}
      \end{songs}
     \scleardpage
    \section{Tibetan Buddhist Mantras}
      \begin{songs}{titleidx,authidx}
        \setcounter{songnum}{170}
        \input{songdata/songs_mantra_buddhist.tex}
      \end{songs}  
  ...
  \songchapter{Suomi}
    \section{Lauluja}
      \begin{songs}{titleidx,authidx}
        \input{songdata/songs_suomi.tex}
      \end{songs}

    \section{Muinaissuomalaista mytologiaa}
      \input{songdata/suomi_mytologiaa.tex}
    \section{Runoutta, loitsuja}
      \begin{songs}{titleidx,authidx}
        ...
        \input{songdata/songs_suomi_runoja_loitsuja.tex}
        \renewcommand{\lyricfont}{\sffamily\Large} % songs: modify lyrics font style
        \chordson
      \end{songs}
