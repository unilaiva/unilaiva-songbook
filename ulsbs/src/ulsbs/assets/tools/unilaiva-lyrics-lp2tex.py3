...
"""
Extract lyrics from LilyPond into Unilaiva LaTeX verse/chorus blocks.
...
def _skip_line_comment(text: str, i: int) -> int:
    """Skip from '%' to end of line and return index at newline."""
...
def extract_lyrics_blocks(content: str) -> List[Tuple[str, str]]:
    ...
    warn(f"Found {len(blocks)} theLyrics blocks.")
    return blocks
...
def apply_replacements(text: str) -> str:
    """Apply cleanup rules to lyrics and return trimmed text."""
...
def number_from_name(name: str) -> Optional[int]:
    """Return verse number parsed from a name like 'theLyricsOne'."""
...
def render_section(clean_text: str, is_chorus: bool) -> str:
    """Render a cleaned section inside verse/chorus environment."""
...
def main():
    """CLI entry: read .ly, extract lyrics, write LaTeX snippet."""
