...
COVERIMAGE_MODIFIED_FNAME_POSTFIX = "_MODIFIED"

JSON_INCLUDE_PLAIN_LOWERCASE_LYRICS: bool = False

ASSUMED_OS_MEM_GB: float = 2
ASSUMED_JOB_MEM_GB: float = 1.2
