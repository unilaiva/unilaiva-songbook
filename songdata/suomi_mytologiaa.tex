...
\begin{figure}[!h]
  ...
  \centering
  \includegraphics[width=0.8\textwidth]{Ekman_-_Vainamoinen-2.jpg}
\end{figure}  
...
\subsection{Päivä, Aurinko, Kuu} 
  ...
  \paragraph{Ilmarisen} mainitaan olleen mukana kosmisessa luomisessa, takomalla taivaankantta ja asettamalla taivaankappaleita.
...
\subsection{Tieto}
  ...
  \begin{figure}[!h]
    ...
    \centering
    \includegraphics[width=0.5\textwidth]{Ekman_-_Vainamoisen_soitto.jpg}
  \end{figure}  
