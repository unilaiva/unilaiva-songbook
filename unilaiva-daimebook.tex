...
\begin{document}
  ...
  \mainchapter[]{Hinos Diversos da Concentração \chapsymbol{lime}}
    \begin{songs}{}
      \input{content/songs_daimebook_concentracao_diversos.tex}
    \end{songs}

  \mainchapter[]{Hinos do Daime \chapsymbol{teal}}
    \begin{songs}{}
      \input{content/songs_daimebook_daime.tex}
    \end{songs}
  ...
  \mainchapter[]{Hinos Diversos de Cura \chapsymbol{olive}}
    \begin{songs}{}
      \input{content/songs_daimebook_cura_diversos.tex}
    \end{songs}

  \mainchapter[]{Padr. Alfredo: Nova Dimensão}
    \begin{songs}{}
      \input{content/songs_daimebook_novadimensao.tex}
    \end{songs}
  ...
  \mainchapter[]{Mestre Irineu Serra: O Cruzeirinho \chapsymbol{yellow}}
    \begin{songs}{}
      \input{content/songs_daimebook_cruzeirinho.tex}
    \end{songs}

  \mainchapter[]{Hinos do Encerramento \chapsymbol{cyan}}
    \begin{songs}{}
      \input{content/songs_daimebook_encerramento.tex}
    \end{songs}

  \mainchapter[]{Pontos de Defumação}
    \begin{songs}{}
      \input{content/songs_daimebook_defumacao.tex}
    \end{songs}
