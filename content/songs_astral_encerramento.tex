...
\beginsong{Meu Deus, Meu São João}[by={Padr. Alfredo},key={C},sks={C, B\flt{}--D},tags={valsa}]
...
\beginsong{Meu Rei Salomão}[by={Madr. Cristina},key={G},sks={G, (F\shrp{})--(G)},tags={2x}]
...
\beginsong{Sou Brilho do Sol}[by={Padr. Sebastião}, key={C}, sks={D, C--F\shrp{}m}]
