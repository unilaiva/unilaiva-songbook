...
\beginsong{Meu Deus, Meu São João}[id={meu-deus-meu-sao-joao-sp33ty},by={Alfredo},key={C},gk={C, B&--D},tags={valsa}]
...
\beginsong{Meu Rei Salomão}[id={meu-rei-salomao-r2v3xw},by={Cristina},key={G},gk={G, (F#)--(G)},tags={2x}]
...
\beginsong{Sou Brilho do Sol}[id={sou-brilho-do-sol-ufywff},by={Sebastião},key={C},gk={D, C--F#m}]
  ...
  \beginverse
    \beginrep
      \beginrep
        Olen |^paiste aurin^gon, |sekä loiste ^kuun \altchords{\id[1]{(D)}|D | - Bm/F#}
      \endrep
      \beginrep
