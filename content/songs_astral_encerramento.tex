...
\beginsong{Meu Deus, Meu São João}[by={Alfredo},key={C},gk={C, B\flt{}--D},tags={valsa}]
...
\beginsong{Meu Rei Salomão}[by={Cristina},key={G},gk={G, (F\shrp{})--(G)},tags={2x}]
...
\beginsong{Sou Brilho do Sol}[by={Sebastião}, key={C}, gk={D, C--F\shrp{}m}]
