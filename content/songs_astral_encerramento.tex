...
\beginsong{Sou Brilho do Sol}[id={sou-brilho-do-sol-ufywff},by={Sebastião},key={C},gk={D, C--F\shrp{}m}]
  ...
  \mnbeginverse
    \beginrep\memorize
      \beginrep
        \[^\mn{A}]Eu |\[\mnc{D}D]sou \[^\mn{F#}]bri\[^\mn{E}]lho \[^\mn{D}]do \[\bm]sol, |sou \[^\mn{F#}]bri\[^\mn{E}]lho \[^\mn{D}]da \[\mnc{F#}Bm/F#]lua
      \endrep
      \beginrep
        \[^\mn{F#}]Dou |\[\mnc{G}G]bri\[^\mn{F#}]lho \[^\mn{E}]as \[^\mn{D}]es\[\mnc{F#}D]trelas, \[^\mn{D}]por\[^\mn{F#}]que |\[\mnc{E}A7]todas \[^\mn{B}]me\jw a\[^\mn{C#}]com\[\mnc{D}D]panham
      \endrep
    \endrep
  \mnendverse
  \notesoff
