...
\beginsong{Brilhantes Pedras Finas}[id={brilhantes-pedras-finas-dpjbaj},by={Alfredo},key={A},gk={A, (A)--(B&)},tags={marcha e valsa},off={Angelina}]
...
\beginsong{Ciranda do Amor \\ Ciranda do Santo Daime}[id={ciranda-do-amor-3qdx23},by={Alfredo},key={Am},gk={Bm, (Am)--(Cm)},tags={marcha e meia valsa},off={April, Lemoni e Grace}]
  ...
  \mnbeginverse[1]\memorize[chords_cirandadoamor_a]
    \beginrep
      ...
      |\[Em]Ma\[^<F#>]mãe \[<* G>]con\[^<A>]sa|\[<E>E]grou \[E7]{} \altchords{|F#m |F# F#7}
    \endrep
  \mnendverse
  \mnbeginverse\memorize[chords_cirandadoamor_b]
    \beginrep
      \[^<A>]Gira, |\[Am]gira, \[^<E>]crian\[<* C>]ci\[^<A>]nha, |\[^<C>]gi\[^<A>]ra \altchords{|Bm | \e}
      \[<*>]Na ci|\[<E>E]randa \[<* A>]do a|\[<C>C]mor \[<*>]{} \altchords{|F# |D}
      \[^<A>]Gira, |\[Am]gira, \[^<E>]crian\[<* C>]ci\[^<A>]nha, |\[^<C>]gi\[^<A>]ra \altchords{|Bm | \e}
      \[<*>]Que a |\[<E>E]Virgem \[<* C>]Mãe \[^<B>]man|\[<A>Am]dou \[<*>]{} \altchords{|F# |Bm}
    \endrep
  \mnendverse
  \notesoff
  ...
  \beginverse[1]\replay[chords_cirandadoamor_a]
    \beginrep
      ...
      No|^vo tem^po che|^gou ^ \altchords{| - |F#7}
    \endrep
  \endverse
  \beginverse\replay[chords_cirandadoamor_b]
    \beginrep
      Novo |^mundo, novo ^povo, nova |era, \altchords{|Bm D | - Bm}
      ^E um |^novo ^profes|^sor ^ \altchords{|F#7 Bm |D}
      Novo |^mundo, novo ^povo, nova |era \altchords{|Bm D | - Bm}
      ^E um |^novo ^profes|^sor ^ \altchords{|F#7 D |Bm}
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
...
\beginsong{Rei da Ciência}[id={rei-da-ciencia-4lc6jm},by={Alfredo},key={Am},gk={Am, Gm--G#m--(Am)},off={Lúcio \& Cristiane},tags={mazurca}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_reidaciencia_a]
      ...
      Não \[^<B>]se |\[^<C>]tem \[^<A>]na\[^<E>]da \[^<D>]mai\[<C>C]or \altchords{| - B&}
    \endrep
    \mnendverse\glueverses\mnbeginverse
...
\beginsong{In, in \\ In Agradecimento}[id={in-in-htlias},by={Alfredo},key={C},gk={C, B&--E},off={José Bento}]
...
\beginsong{Eu Sou Flor das Águas}[id={eu-sou-flor-das-aguas-fzg1nb},by={Alfredo},key={Am},gk={Bm, G#m--Bm},off={Mariana, Mikael},tags={valsa, 2x}]
  ...
  \mnbeginverse\memorize[chords_eusouflordasaguas_a]
    \beginrep
      ...
      E |\[^<C>]te\[^<A>]nho \[^<C>]po|\[<B>E]der \altchords{| - |F#}
      \[^<D>]Eu |\[E7/D]sa\[^<E>]cio \[^<D>]a |\[<B>E]se\[^<G#>]de \altchords{|F#7/E |F#}
      \[^<B>]De |\[<D>Dm]quem \[^<E>]me\[^<F>]re|\[<E>E]cer \altchords{|Em |F#}
    \endrep
  \mnendverse
  \mnbeginverse[1]\memorize[chords_eusouflordasaguas_b]
    \beginrep
      |\[^<E>]Da \[^<F>]on\[^<E>]de |\[<D>Dm]vens \altchords{| - |Em}
      Pa|\[^<F>]ra on\[^<A>]de |\[<E>E]vais \altchords{| - |F#}
      Eu |sou \[^<F>]flor \[^<E>]das |\[<D>Dm]á\[^<B>]guas \altchords{| - |Em}
      \[^<C>]Somos |\[<D>E7]e \[^<G#>]de\[^<B>]ve |\[<A>Am]ser \altchords{|F#7 |Bm}
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Excelência}[id={excelencia-n0jj4s},by={Alfredo},key={Am},gk={Am, Gm--Bm},off={Kelly Cristina},tags={3x}]
  ...
  \beginverse
    \beginrep
      ...
      Para |^sempre só nos ^resta\jw agrade|^cer ^ \altchords{|F# |Bm}
      Para |^sempre com a^mor hei de ven|^cer ^ \altchords{|F# |Bm}
    \endrep
  \endverse
  \begin{translation}[EN]
...
\beginsong{Louvar o Criador}[id={louvar-o-criador-m93z9k},by={Alfredo},key={C},gk={C, B&--B--(C)},off={Kayke}]
  ...
  \mnbeginverse[1]\memorize[chords_louvarocriador_b]
    \beginrep
      \[^<C>]Por tu\[^<B>]{do\jw o} |\[<A>F]que já \[<* C>]es\[^<E>]tá |\[<G>C]fei\[<E>(Am)]to \altchords{|D |A (F#m)}
      \[^<A>]E tudo\jw o |\[<E>C]que \[^<C>]nos \[<A>F]en\[^<C>]si|\[C]nou \[<*>]{} \altchords{|A D |A}
    \endrep
  \mnendverse
  \mnbeginverse[2]\memorize[chords_louvarocriador_c]
    \beginrep
      \[^<A>]Lou|\[<D>G]var, \[^<A>]lou\[<C>F]var lou|\[C]van\[<A>(Am)]do \altchords{|E D |A (F#m)}
...
\beginsong{Bastão}[id={bastao-31jzze},by={Alfredo},key={C},gk={C, B&--D},off={Vicente e o povo do Japão}]
...
\beginsong{Vida}[id={vida-bbob1m},by={Alfredo},key={Am},gk={Am, Gm--Am},off={Ramaiam, Ana Rita, Igor}]
  ...
  \beginverse
    \beginrep
      ...
      \beginrep
        Oh Patri|^arca, nos as^cenda Lu|^z \altchords{|Am7&5 (Cm/E&) |Gm}
        Vida ^meu Jesu|^s, Espe\[<*>]rança\jw e |^Fé \[<*>]{} \altchords{(B&) |D7 |Gm}
      \endrep
    \endrep
  \endverse
  \ifbassclefbook\hardbrk\fi
...
\beginsong{O Rigor das Profecias}[id={o-rigor-das-profecias-1uuhox},by={Alfredo},key={C},gk={C, B&--B--(C)},off={Vinícius Antonelli e Família}]
  ...
  \beginverse
    \beginrep
      ...
      Anunci|^ado por Je^sus \altchords{|F# B}
      Que mos|^trou na Santa ^Cruz \altchords{|G#m B}
      O Misté|^rio da Salva^ção \altchords{|F# B}
      \beginrep
        | Agrade^cer esta \altchords{| - G#m}
        |^Escola di^vina\jw \altchords{|C#m B}
        E aos Mes|^tres que nos en^sinam \altchords{|G#m}
        Jesus |^Cristo\jw e São Jo^ão \altchords{|F#7 B}
      \endrep
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[]
...
\beginsong{Renascer}[id={renascer-t4abn9},by={Alfredo},key={C},gk={C, G#--B--(C)}]
  ...
  \beginverse
    \beginrep
      ...
      \beginrep
        Lem|^brar Ju^rami|^dam, ^vê o |^{dia\jw A}^manhe|^cer ^ \altchords{|A |D |F#m |A}
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep
        ...
        \[^<D>]Ilumi|\[<A>Am]nando com a \[<B>Bm]cura do per|\[<G>G]dão \[<*>] \altchords{|Bm |C#m |A}
      \endrep
    \endrep
  \mnendverse
  \notesoff
