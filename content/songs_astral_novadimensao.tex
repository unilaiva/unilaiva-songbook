...
\beginsong{Brilhantes Pedras Finas}[by={Padr. Alfredo}, key={A}, gk={A, (A)--(B\flt{})}, tags={marcha e valsa}, off={Angelina}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_brilhantes_pedras_a]
  ...
  \mnendverse
  \mnbeginverse
    \beginrep\memorize[chords_brilhantes_pedras_b]
    \ind \[^\mn{A}]Se\meter{3}{4}|\[A7]guin\[^\mn{B}]{do\jw es}\[^\mn{C#}]ta |\[\mnc{D}D]rosa \[^\mn{F#}]de |\[^\mn{B}]luz \[^\mn{A}]e \[^\mn{C#}]ca|\[\mnc{E}E]lor
    \ind \[^\mn{F#}]Que |\[^\mn{E}]no \[^\mn{C#}]meu \[^\mn{A}]jar|\[^\mn{B}]dim fez nas|cer \[^\mn{A}]es\[^\mn{C#}]ta |\[A]flor
    \ind Es|\[\mnc{A}A7]ta \[^\mn{B}]flor \[^\mn{C#}]me|\[\mnc{D}D]nina, \[^\mn{F#}]di|\[^\mn{B}]vi\[^\mn{A}]{na\jw es}\[^\mn{C#}]ta |\[\mnc{E}E]flor
  ...
  \beginverse\replay[chords_brilhantes_pedras_a]
    ...
    O nosso |^mestre tem po^der de nos sal\up{1}(|^var^ ) \up{2}(\meter{3}{4}|^var)
      \endrep
  \endverse
  \beginverse\replay[chords_brilhantes_pedras_b]
    \beginrep
    \ind No \meter{3}{4}|^jardim lou|^vando a |nossa mãe|^zinha
    \ind Que |foi quem nos |deu es|ta pedra |^fina
    \ind Es|^te dia|^mante de\jw i|lumina|^ção
    \ind E|leva\jw o es|tudo No|va Dimen\up{1}(|^são) \up{2}(\meter{4}{4}|^são^ )
    \endrep
  \endverse
...
\beginsong{Ciranda do Amor \\ Ciranda do Santo Daime}[by={Padr. Alfredo}, key={Am}, gk={Bm, (Am)--(Cm)}, tags={marcha e meia valsa}, off={April, Lemoni e Grace}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_cirandadoamor_a]
  ...
  \mnendverse
  \mnbeginverse
    \beginrep\memorize[chords_cirandadoamor_b]
  ...
  \mnendverse
  \notesoff
  \beginverse\replay[chords_cirandadoamor_a]
    \beginrep
...
\beginsong{Porto Seguro}[by={Padr. Alfredo}, key={A}, gk={A, G--B}, off={Isabella, Sophia Sterling e família}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_portoseguro_a]
  ...
  \mnendverse
  \mnbeginverse
    \beginrep\memorize[chords_portoseguro_b]
    ...
    \ind E só \[\bm]com \[^\mn{A}]Vós, \[^\mn{C#}]eu |\[\mnc{A}A]sou\[\bm]{} |\[\ac(1){A7}]{} \[\bm]{} \altchords{|G |\ac(1){G7}}
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_portoseguro_a]
    ...
    \endrep
  \endverse
  \beginverse\replay[chords_portoseguro_b]
    \beginrep
    \ind Can|^tar^ | \e
...
\beginsong{Eu Sou Flor das Águas}[by={Padr. Alfredo}, key={Am}, gk={Bm, G\shrp{}m--Bm}, off={Mariana, Mikael}, tags={valsa, 2x}]
  ...
  \meter{3}{4}
  \mnbeginverse
    \beginrep\memorize[chords_eusouflordasaguas_a]
  ...
  \mnendverse
  \mnbeginverse
    \beginrep\memorize[chords_eusouflordasaguas_b]
  ...
  \beginverse\replay[chords_eusouflordasaguas_a]
    ...
    \endrep
  \endverse
  \beginverse\replay[chords_eusouflordasaguas_b]
    \beginrep
...
\beginsong{Louvar o Criador}[by={Padr. Alfredo}, key={C}, gk={C, B\flt{}--B--(C)}, off={Kayke}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_louvarocriador_a]
  ...
  \mnendverse
  \mnbeginverse
    \beginrep\memorize[chords_louvarocriador_b]
    \ind \[^\mn{C}]Por tu\[^\mn{B}]{do\jw o} |\[\mnc{A}F]que já \[\bmc\mn{C}]es\[^\mn{E}]tá |\[\mnc{G}C]fei\[\mnc{E}(Am)]to \altchords{|D |A (F\shrp{}m)}
    \ind \[^\mnc{A}]E tudo\jw o |\[\mnc{E}C]que \[^\mn{C}]nos \[\mnc{A}F]en\[^\mn{C}]si|\[C]nou \[\bm]{} \altchords{|A D |A}
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep\memorize[chords_louvarocriador_c]
  ...
  \beginverse\replay[chords_louvarocriador_a]
    ...
    \endrep
  \endverse
  \beginverse\replay[chords_louvarocriador_b]
    \beginrep
    \ind A Ra|^inha ^da flo|^res^ta
    \ind Mãe do |^mestre\jw en^sina|^dor ^
    \endrep
  \endverse
  \beginverse\replay[chords_louvarocriador_c]
    \beginrep
    \ind[2] Pa|^pai, Ma^mãe tam|^bém
    \ind[2] ^Filho\jw Es|^pírito ^Santo\jw a|^mém ^
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[]
    % transcribed by larva, latest update on 2023-05
...
\beginsong{Só por Amor}[by={Padr. Alfredo},key={C},gk={C, (B)--(C)},off={Cecila Pineiros}]
  ...
  \meter{2}{4}
    \mnbeginverse
    \beginrep\memorize[chords_soporamor_a]
  ...
  \mnendverse
    \mnbeginverse
    \beginrep\memorize[chords_soporamor_b]
      \ind \[^\mn{C}]Essa |\[\mnc{F}F]trilha que |estou \[^\mn{G}]an|\[^\mn{A}]dan|do
      \ind É \[^\mn{G}]a |\[\mnc{E}C]mesma que |an\[^\mn{G}]dou Je|\[G]sus | \e
      \beginrep
      \ind \[^\mn{B}]Es\[^\mn{C}]te |\[\mnc{D}Dm]mes\[^\mn{C}]tre \[^\mn{B}]a|\[^\mn{D}]qui \[^\mn{C}]en\[^\mn{B}]si|\[\mnc{A}G]nan\[^\mn{G}]do | \e
      \ind \[^\mn{C}]Com \[^\mn{D}]o |\[\mnc{E}Am]simbo\[^\mn{G}]lo |\[\mnc{D}G]da San\[^\mn{E}]ta |\[\mnc{C}C]Cruz | \e
    \endrep
      \endrep
  \mnendverse
    \notesoff
    ...
    \beginrep
      ...
      \endrep
  \endverse
    \beginverse\replay[chords_soporamor_b]
    \beginrep
      \ind O a|^mor de |Deus coman|dan|do
      \ind O as|^tral com |toda\jw ale|^gri|a
      \beginrep
      \ind Viva |^nós e o |nosso pla|^neta | \e
      \ind Dando |^viva a |^Virgem Ma|^ri|a
    \endrep
      \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[]
