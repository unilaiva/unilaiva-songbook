...
\beginsong{Tucum}[by={Padr. Alfredo}, key={C}, gk={C, (B)--(C)}, off={Samara Melo}]
  ...
  \mnbeginchorus\memorize
    ...
    \lrep \[^\mn{C}]E |\[C]quando\jw eu or\[\mnc{A}(Am7)]de\[^\mn{G}]{no\jw esse} |\[\mnc{C}C]mal vai em\[\bmc\mn{E}]bora
    É\jw em |\[^\mn{C}]nome \[^\mn{E}]de \[\mnc{G}G]Deus \[^\mnc{D}]e de |\[G7]Nos\[^\mn{C}]sa Se\[C]nhora
    É\jw em |nome \[^\mn{E}]de \[\mnc{G}G]Deus \[^\mnc{D}]e de |\[G7]Nos\[^\mn{C}]sa Se\[C]nhora \rrep
  \mnendchorus
  \notesoff
  \beginchorus
...
\beginsong{Vida}[by={Padr. Alfredo},key={Am},gk={Am, Gm--Am},off={Ramaiam, Ana Rita, Igor}]
  ...
  \mnbeginchorus\memorize
    ...
    \lrep \ilsl{\[^\mn{A}]É} tão bo|\[\mnc{B}Bm7&5]ni\[^\mn{A}]to,\jw o poder \[\mnc{F}(Dm/F)]da \[^\mn{D}]fo\[^\mn{F}]gue|\[Am]i\[^\mn{E}]ra
    Queima a \[\mnc{C}(C)]noi\[^\mn{A}]{te\jw in}\[^\mn{E}]te|\[E7]i\[^\mn{D}]ra, mis\[^\mn{C}]té\[^\bm\mn{B}]rio \[^\mn{C}]da |\[\mnc{A}Am]Cruz \[^\bm]{} \rrep
  \mnendchorus
  \notesoff
  \beginchorus
  ...
  \beginchorus
    ...
    \lrep Oh Patri|^arca, nos as^cenda Lu|^z \altchords{|Am7\flt{}5 (Cm/E\flt{}) |Gm}
    Vida ^meu Jesu|^s, Espe\[\bm]rança\jw e |^Fé \[\bm]{} \rrep \altchords{(B\flt{}) |D7 |Gm}
  \endchorus
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    % transcribed by larva, latest update on 2025-12
    theMelody = \relative a' {
...
\beginsong{O Rigor das Profecias}[by={Padr. Alfredo},key={C},gk={C, B\flt{}--B--(C)},off={Vinícius Antonelli e Família}]
  ...
  \mnbeginchorus\memorize
    ...
    \[^\mn{G}]Jesus |\[\mnc{D}G7]Cristo\jw e \[^\mn{E}]São \[^\mn{C}]Jo\[C]ão \rrep
  \mnendchorus
  \notesoff
  \beginchorus
    ...
    \lrep | Agrade^cer esta \altchords{| - G\shrp{}m}
    |^Escola di^vina\jw \altchords{|C\shrp{}m B}
    E aos Mes|^tres que nos en^sinam \altchords{|G\shrp{}m}
    Jesus |^Cristo\jw e São Jo^ão \rrep \altchords{|F\shrp{}7 B}
  \endchorus
  \begin{lilywrap}\begin{lilypond}[]
    % transcribed by larva, latest update on 2025-12
    \include "tex/lp-include-head.ly"
...
\beginsong{Renascer}[by={Padr. Alfredo},key={C},gk={C, G\shrp{}--B--(C)}]
  ...
  \mnbeginchorus\memorize
    ...
    \lrep \[^\bmc\madii{C}{E}]Aqui |\[\mnc{C}C]na nos\[\bm]sa mis|\[\mnc{F}F]são o \[\bm]nosso |\[\mnc{A}Am]Mestre \[\bm]Re\[^\mn{G}]plan|\[\mnc{C}C]tou
