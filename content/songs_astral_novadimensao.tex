...
\beginsong{Excelência}[by={Padr. Alfredo}, key={Am}, sks={Am, Gm--Bm}, off={Kelly Cristina}, tags={3x}]
  \mnbeginchorus\memorize
...
\beginsong{Louvar o Criador}[by={Padr. Alfredo}, key={C}, sks={C, B\flt{}--B--(C)}, off={Kayke}]
...
\beginsong{Tucum}[by={Padr. Alfredo}, key={C}, sks={C, (B)--(C)}, off={Samara Melo}]
  \audio{https://nossairmandade.com/hymn/4369/Tucum}
...
\beginsong{Vida}[by={Padr. Alfredo},key={Am},sks={Am},off={Ramaiam, Ana Rita, Igor}]
...
\beginsong{O Rigor das Profecias}[by={Padr. Alfredo},key={C},sks={C, B\flt{}--B--(C)},off={Vinícius Antonelli e Família}]
