...
\beginsong{Brilhantes Pedras Finas}[by={Alfredo}, key={A}, gk={A, (A)--(B\flt{})}, tags={marcha e valsa}, off={Angelina}]
...
\beginsong{Ciranda do Amor \\ Ciranda do Santo Daime}[by={Alfredo}, key={Am}, gk={Bm, (Am)--(Cm)}, tags={marcha e meia valsa}, off={April, Lemoni e Grace}]
...
\beginsong{Luzeiro do Meu Hinário}[by={Alfredo}, key={Dm}, gk={Dm, Cm--Em}, off={Rosália}]
...
\beginsong{Salmo}[by={Alfredo}, key={Dm}, gk={Dm}, off={Alexandre}, tags={valsa}]
...
\beginsong{Rei da Ciência}[by={Alfredo}, key={Am}, gk={Am, Gm--G\shrp{}m--(Am)}, off={Lúcio \& Cristiane}, tags={mazurca}]
...
\beginsong{In, in \\ In Agradecimento}[by={Alfredo}, key={C}, gk={C, B\flt{}--E}, off={José Bento}]
...
\beginsong{Porto Seguro}[by={Alfredo}, key={A}, gk={A, G--B}, off={Isabella, Sophia Sterling e família}]
...
\beginsong{Mamãe Maria}[by={Alfredo}, key={C}, gk={C, (B)--(C)}, off={Gabriela Shore}]
  \mnbeginverse
    \beginrep\memorize
...
\beginsong{Eu Sou Flor das Águas}[by={Alfredo}, key={Am}, gk={Bm, G\shrp{}m--Bm}, off={Mariana, Mikael}, tags={valsa, 2x}]
...
\beginsong{Excelência}[by={Alfredo}, key={Am}, gk={Am, Gm--Bm}, off={Kelly Cristina}, tags={3x}]
  \mnbeginverse
    \beginrep\memorize
...
\beginsong{Louvar o Criador}[by={Alfredo}, key={C}, gk={C, B\flt{}--B--(C)}, off={Kayke}]
...
\beginsong{Tucum}[by={Alfredo}, key={C}, gk={C, (B)--(C)}, off={Samara Melo}]
  \audio{https://nossairmandade.com/hymn/4369/Tucum}
  ...
  \mnbeginverse
    ...
    \beginrep \[^\mn{C}]E |\[C]quando\jw eu or\[\mnc{A}(Am7)]de\[^\mn{G}]{no\jw esse} |\[\mnc{C}C]mal vai em\[\bmc\mn{E}]bora
    É\jw em |\[^\mn{C}]nome \[^\mn{E}]de \[\mnc{G}G]Deus \[^\mnc{D}]e de |\[G7]Nos\[^\mn{C}]sa Se\[C]nhora
    É\jw em |nome \[^\mn{E}]de \[\mnc{G}G]Deus \[^\mnc{D}]e de |\[G7]Nos\[^\mn{C}]sa Se\[C]nhora \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    ...
    \beginrep Enxo|^tando os ^maus que não |^querem ou^vir
    A Jus|tiça do ^Mestre pa|^ra ser fe^liz
    A Jus|tiça do ^Mestre pa|^ra ser fe^liz \endrep
    \endrep
  \endverse
  \begin{translation}[EN]
...
\beginsong{Só por Amor}[by={Alfredo},key={C},gk={C, (B)--(C)},off={Cecila Pineiros}]
...
\beginsong{Bastão}[by={Alfredo},key={C},gk={C, B\flt{}--D},off={Vicente e o povo do Japão}]
...
\beginsong{Vida}[by={Alfredo},key={Am},gk={Am, Gm--Am},off={Ramaiam, Ana Rita, Igor}]
  ...
  \mnbeginverse
    ...
    \beginrep \ilsl{\[^\mn{A}]É} tão bo|\[\mnc{B}Bm7&5]ni\[^\mn{A}]to,\jw o poder \[\mnc{F}(Dm/F)]da \[^\mn{D}]fo\[^\mn{F}]gue|\[Am]i\[^\mn{E}]ra
    Queima a \[\mnc{C}(C)]noi\[^\mn{A}]{te\jw in}\[^\mn{E}]te|\[E7]i\[^\mn{D}]ra, mis\[^\mn{C}]té\[^\bm\mn{B}]rio \[^\mn{C}]da |\[\mnc{A}Am]Cruz \[^\bm]{} \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    ...
    \beginrep Lembrando |^sempre a Luz ^deste di|^{-a}
    Oh Vir^gem Mari|^{'a}, vós lem\[\bm]brai de |^mim \[\bm]{} \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    ...
    \beginrep Oh Patri|^arca, nos as^cenda Lu|^z \altchords{|Am7\flt{}5 (Cm/E\flt{}) |Gm}
    Vida ^meu Jesu|^s, Espe\[\bm]rança\jw e |^Fé \[\bm]{} \altchords{(B\flt{}) |D7 |Gm} \endrep
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
    % transcribed by larva, latest update on 2025-12
...
\beginsong{O Rigor das Profecias}[by={Alfredo},key={C},gk={C, B\flt{}--B--(C)},off={Vinícius Antonelli e Família}]
  ...
  \mnbeginverse
    ...
    \beginrep | \[^\mn{C}]Nos \[^\mn{D}]dê \[^\mn{C}]a \[\mnc{A}Am]cura
    ...
    \[^\mn{G}]Jesus |\[\mnc{D}G7]Cristo\jw e \[^\mn{E}]São \[^\mn{C}]Jo\[C]ão \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    ...
    \beginrep | Agrade^cer esta \altchords{| - G\shrp{}m}
    |^Escola di^vina\jw \altchords{|C\shrp{}m B}
    E aos Mes|^tres que nos en^sinam \altchords{|G\shrp{}m}
    Jesus |^Cristo\jw e São Jo^ão \altchords{|F\shrp{}7 B} \endrep
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[]
    % transcribed by larva, latest update on 2025-12
...
\beginsong{Santa Cura}[by={Alfredo},key={C},gk={C, C--D}]
...
\beginsong{Renascer}[by={Alfredo},key={C},gk={C, G\shrp{}--B--(C)}]
  ...
  \mnbeginverse
    ...
    \beginrep \[^\bmc\madii{C}{E}]Aqui |\[\mnc{C}C]na nos\[\bm]sa mis|\[\mnc{F}F]são o \[\bm]nosso |\[\mnc{A}Am]Mestre \[\bm]Re\[^\mn{G}]plan|\[\mnc{C}C]tou
    \[\bmc\mn{G}]Doutri|\[\mnc{A}G]na \[^\mn{G}]de \[\bm]Jesus |\[\mnc{D}Dm]Cristo \[\bm]do nos|\[\mnc{G}G]so Pai \[\bmc\mn{D}]Cri\[^\mn{E}]a|\[\mnc{C}C]dor. \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    ...
    \beginrep Pe|^dir a ^nossa |^Mãe, a ^vossa |^Chama ^do a|^mor
    I^lumi|^nar\jw o nos^so per|^dão e ^se fir|^mar no ^Cria|^dor. \[\bm] \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    ...
    \beginrep Lem|^brar Ju^rami|^dam, ^vê o |^{dia\jw A}^manhe|^cer ^ \altchords{|A |D |F\shrp{}m |A}
    Na |^luz do ^Santo |^Daime, ^vamos |^todos ^Renas|^cer. \[\bm] \altchords{|E |Bm |E |A} \endrep
    \endrep
  \endverse
  \begin{translation}[EN]
...
\beginsong{Infinitum}[by={Alfredo},key={C},gk={C, (B)--(C)}]
  ...
  \mnbeginverse
    ...
    \beginrep \[^\mn{C}]Toda\jw a flo|\[\mnc{A}Am]res\[^\mn{G}]ta,\[\bm] \[^\mn{C}]está em |\[\mnc{E}C]festa \[G7]
    \[^\mn{D}]Infini|\[\mnc{C}C]tum \[\bm] \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay
    ...
    \beginrep O nosso |^Mestre^ é Jesus |^Cristo^
    Nosso Se|^nhor ^ \endrep
    \endrep
  \endverse
  \beginverse\replay
    \beginrep
    ...
    \beginrep Para lou|^var,^ o Pai E|^terno^
    Rei Cria|^dor ^ \endrep
    \endrep
  \endverse
  \beginverse\replay
    ...
    \beginrep A Divin|^dade,^ desta flo|^resta^
    Deste Lu|^gar ^ \endrep
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[]
...
\beginsong{Centenário Integração}[by={Alfredo},key={G},gk={G, G--A}]
  ...
  \mnbeginverse
    ...
    \beginrep \[^\mn{D}]Bati|\[\mnc{C}C]zando lá no \[\mnc{D}D]Rio de Jor|\[\mnc{B}Bm]dão \[\bm] \altchords{|D E |Am}
    \[^\mn{D}]Ilumi|\[\mnc{A}Am]nando com a \[\mnc{B}Bm]cura do per|\[\mnc{G}G]dão \[\bm] \altchords{|Bm |C\shrp{}m |A} \endrep
    \endrep
  \mnendverse
  \notesoff
  % verse 2
  \beginverse
    ...
    \beginrep O cente|^nário da nos^sa Senhora |^Mãe ^
    Eterna |^força, dessa ^grande\jw integra|^ção ^ \endrep
    \endrep
  \endverse
  % verse 3
  \beginverse
    ...
    \beginrep Ter nossa |^Mãe, fé e ^considera|^ção ^
    O Pai e|^terno é Rei ^da integra|^ção ^ \endrep
    \endrep
  \endverse
  % verse 4
  \beginverse
    ...
    \beginrep O nosso |^Mestre ensi^nando\jw os seus ir|^mãos ^
    Cantando\jw hi|^nário, afir^mando\jw a uni|^ão ^ \endrep
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[]
    %% transcribed by larva, latest update on 2025-12
