...
\beginsong{Brilhantes Pedras Finas}[by={Padr. Alfredo}, key={A}, gk={A, (A)--(B\flt{})}, tags={marcha e valsa}, off={Angelina}]
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    ...
    \setStaffSize #10.3 % for better fit
...
\beginsong{Mamãe Maria}[by={Padr. Alfredo}, key={C}, gk={C, (B)--(C)}, off={Gabriela Shore}]
  \mnbeginverse
    \beginrep\memorize
...
\beginsong{Vida}[by={Padr. Alfredo},key={Am},gk={Am, Gm--Am},off={Ramaiam, Ana Rita, Igor}]
