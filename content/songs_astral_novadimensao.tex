...
\beginsong{Brilhantes Pedras Finas}[id={brilhantes-pedras-finas-dpjbaj},by={Alfredo},key={A},gk={A, (A)--(B\flt{})},tags={marcha e valsa},off={Angelina}]
  ...
  \mnbeginverse\memorize[chords_brilhantes_pedras_a]
    \beginrep
      ...
      \[^\mn{B}]Je\[^\mn{C#}]sus |\[^\mn{D}]Cristo nos\[^\mn{F#}]so \[\bmc\mn{B}]gui\[^\mn{A}]{a\jw e}terna|\[\mnc{E}A]men\[^\mn{C#}]te\[\bm]
      \[^\mnc{E}]E me dá |\[E]forças \[^\mn{B}]pa\[^\mn{C#}]ra \[\bmc\mn{D}]eu e\[^\mn{A}]xe\[^\mn{B}]cu|\[\mnc{C#}A]tar\[A7]
  ...
  \mnbeginverse[1]\memorize[chords_brilhantes_pedras_b]
    \beginrep
      \[^\mn{A}]Se\meter{3}{4}|\[A7]guin\[^\mn{B}]{do\jw es}\[^\mn{C#}]ta |\[\mnc{D}D]rosa \[^\mn{F#}]de |\[^\mn{B}]luz \[^\mn{A}]e \[^\mn{C#}]ca|\[\mnc{E}E]lor
      \[^\mn{F#}]Que |\[^\mn{E}]no \[^\mn{C#}]meu \[^\mn{A}]jar|\[^\mn{B}]dim fez nas|cer \[^\mn{A}]es\[^\mn{C#}]ta |\[A]flor
      Es|\[\mnc{A}A7]ta \[^\mn{B}]flor \[^\mn{C#}]me|\[\mnc{D}D]nina, \[^\mn{F#}]di|\[^\mn{B}]vi\[^\mn{A}]{na\jw es}\[^\mn{C#}]ta |\[\mnc{E}E]flor
      \[^\mn{F#}]Jar|\[^\mn{E}]dim \[^\mn{C#}]da \[^\mn{A}]in|\[^\mn{B}]fância \[^\mn{A}]Jar|\[^\mn{C#}]dim \[^\mn{A}]do \[^\mn{F#}]a\up{1}(|\[\mnc{A}A]mor) \up{2}(\meter{4}{4}|\[\mnc{A}A]mor\[\bm]{} )
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Ciranda do Amor \\ Ciranda do Santo Daime}[id={ciranda-do-amor-3qdx23},by={Alfredo},key={Am},gk={Bm, (Am)--(Cm)},tags={marcha e meia valsa},off={April, Lemoni e Grace}]
  ...
  \mnbeginverse[1]\memorize[chords_cirandadoamor_a]
    \beginrep
      \[^\mn{E}]O |\[\mnc{A}Am]que Pa\[\bm]pai \[^\mn{B}]me |\[^\mn{A}]de\[\mnc{G}Am7]{-u} \altchords{\id[1]{(Bm)}|Bm | - Bm7}
      |\[Em]Ma\[^\mn{F#}]mãe \[\bmc\mn{G}]con\[^\mn{A}]sa|\[\mnc{E}E]grou \[E7]{} \altchords{|F\shrp{}m |F\shrp{} F\shrp{}7}
    \endrep
  \mnendverse
...
\beginsong{Luzeiro do Meu Hinário}[id={luzeiro-do-meu-hinario-0jg509},by={Alfredo},key={Dm},gk={Dm, Cm--Em},off={Rosália}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_luzeirodomeuhinario_a]
      ...
      Cla\[^\mn{C#}]re|\[^\mn{A}]ando\jw o \[\bm]nos\[^\mn{E}]so |\[\mnc{D}Dm]chão \[\bm]{} \altchords{| - | Am}
    \endrep
...
\beginsong{Salmo}[id={salmo-eag6vm},by={Alfredo},key={Dm},gk={Dm},off={Alexandre},tags={valsa}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_salmo_a]
      ...
      \[^\mn{A}]ma|\[\mnc{C#}A7]mãe \[^\mn{E}]do |\[\mnc{D}Dm]Céu, ma|\[\mnc{C#}A7]mãe \[^\mn{E}]do |\[\mnc{D}Dm]Céu |\[\ac<2>{D7}]\e
    \endrep
    \mnendverse\glueverses\mnbeginverse\memorize[chords_salmo_b]
    \[^\mn{D}]Eu |\[\mnc{G}Gm]vou can|\[\mnc{B&}(B&)]tan\[^\mn{A}]{do,\jw e} este |\[\mnc{F}Dm]sal\[^\mn{D}]mo bai|\[\mnc{F}(F)]lan\[^\mn{E}]do
    \[^\mn{A}]es|\[\mnc{B&}B&]te \[^\mn{G}]do\[^\mn{B&}]ce |\[\mnc{A}A]mel |\[A7]{} \e
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_salmo_c]
      \[^\mn{D}]Vou |\[\mnc{G}Gm]implo|\[\mnc{B&}(B&)]ran\[^\mn{A}]do, pe|\[\mnc{F}Dm]din\[^\mn{D}]{do\jw e} ro|\[\mnc{F}(F)]gan\[^\mn{E}]do
      \[^\mn{D}]Ao |\[\mnc{C#}A7]meu São \[^\mn{E}]Mi|\[\mnc{D}Dm]guel, |\[\mnc{C#}A7]meu São \[^\mn{E}]Mi|\[\mnc{D}Dm]guel |\[\ac<1>{D7}]{} \e
    \endrep
  \mnendverse
  \notesoff
  \vspace{2ex}
...
\beginsong{In, in \\ In Agradecimento}[id={in-in-htlias},by={Alfredo},key={C},gk={C, B\flt{}--E},off={José Bento}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_inin_a]
      \[^\mn{E}]Meu |\[\mnc{D}Dm]Pai, \[^\mn{A}]Vos \[\mnc{C}Fmaj7]a\[^\mn{E}]gra|\[\mnc{C}C]de\[\bmc\mn{A}]ço\jw \altchords{\id[1]{(D)}|Em Gmaj7 |D}
      O \[^\mn{E}]que\jw o Se|\[\mnc{D}Dm]nhor \[^\mn{A}]con\[\mnc{C}Fmaj7]ce\[^\mn{E}]{de\jw a} |\[\mnc{C}C]mim \[\bm]{} \altchords{|Em Gmaj7 |D}
    \endrep
    \mnendverse\glueverses\mnbeginverse
...
\beginsong{Porto Seguro}[id={porto-seguro-i4ums5},by={Alfredo},key={A},gk={A, G--B},off={Isabella, Sophia Sterling e família}]
  ...
  \mnbeginverse\memorize[chords_portoseguro_a]
    \beginrep
      ...
      Minha\jw o\[\bm]ra\[^\mn{A}]ção \[^\mn{C#}]{de\jw a}|\[A]mor\[\bm]{} |\[\ac<2>{A7}] \[\bm]{} \altchords{|G |\ac<2>{G7}}
    \endrep
  \mnendverse
  \mnbeginverse[1]\memorize[chords_portoseguro_b]
    \beginrep
      \[^\mn{A}]Por|\[\mnc{D}D]que\[\bm]{} | \e \altchords{|C | \e}
      Sois \[^\mn{F#}]meu \[\bmc\mn{A}]porto se|\[A]gu\[^\mn{E}]ro\[\bm]{} | \e \altchords{|G | \e}
      \[^\mn{C#}]Só com \[\bmc\mn{E}]Vós eu me |\[E]cu\[^\mn{B}]ro\[\bm]{} | \e \altchords{|D | \e}
      E só \[\bm]com \[^\mn{A}]Vós, \[^\mn{C#}]eu |\[\mnc{A}A]sou\[\bm]{} |\[\ac<1>{A7}]{} \[\bm]{} \altchords{|G |\ac<1>{G7}}
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Mamãe Maria}[id={mamae-maria-0vt5nn},by={Alfredo},key={C},gk={C, (B)--(C)},off={Gabriela Shore}]
  \mnbeginverse
    \beginrep\memorize
      \[^\mn{G}]Firmo |\[\mnc{C}C]lá na al\[\bm]tu\[^\mn{G}]ra\jw
      E no |\[^\mn{E}]fundo \[^\mn{D}]do \[\bmc\mn{C}]mar
      Vem |\[\mnc{D}Dm]Mamãe Ma\[\bm]ria \[^\mnc{A}]e Ma|\[\mnc{C}C]mãe Ieman\[\bm]já
      \[^\mn{A}]Vem |\[Am]Mamãe Ma\[\bm]ria \[^\mnc{G}]e Ma|\[\mnc{C}C]mãe Ieman\[\bm]já
      \[^\mn{A}]Vem |\[Am]Mamãe Ma\[\bm]ria \[^\mnc{G}]e Ma|\[\mnc{C}C]mãe Ieman\[\bm]já
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Eu Sou Flor das Águas}[id={eu-sou-flor-das-aguas-fzg1nb},by={Alfredo},key={Am},gk={Bm, G\shrp{}m--Bm},off={Mariana, Mikael},tags={valsa, 2x}]
  ...
  \mnbeginverse[1]\memorize[chords_eusouflordasaguas_b]
    \beginrep
      |\[^\mn{E}]Da \[^\mn{F}]on\[^\mn{E}]de |\[\mnc{D}Dm]vens \altchords{| - |Em}
      Pa|\[^\mn{F}]ra on\[^\mn{A}]de |\[\mnc{E}E]vais \altchords{| - |F\shrp{}}
      Eu |sou \[^\mn{F}]flor \[^\mn{E}]das |\[\mnc{D}Dm]á\[^\mn{B}]guas \altchords{| - |Em}
      \[^\mn{C}]Somos |\[\mnc{D}E7]e \[^\mn{G#}]de\[^\mn{B}]ve |\[\mnc{A}Am]ser \altchords{|F\shrp{}7 |Bm}
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Excelência}[id={excelencia-n0jj4s},by={Alfredo},key={Am},gk={Am, Gm--Bm},off={Kelly Cristina},tags={3x}]
  \mnbeginverse
    \beginrep\memorize
      ...
      Vos\[^\mn{C}]{sa\jw ex}\[^\mn{E}]ce|\[^\mn{A}]lência\jw e Jesus \[\bm]Cristo Reden|\[\mnc{D}Dm]tor \[\bm]
      São quem \[^\mn{C}]{me\jw en}|\[\mnc{B}E]sinam nesta\jw es\[\bm]cola \[^\mn{C}]do \[^\mn{D}]a|\[\mnc{E}Am]mor \[\bm]
      \[^\mnc{A}]A Vir\[^\mn{C}]gem |\[\mnc{E}E]{Mãe\jw e} o \[^\mn{D}]nosso \[\bmc\mn{C}]Mestre\jw En\[^\mn{B}]sina|\[\mnc{A}Am]dor \[\bm]
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Louvar o Criador}[id={louvar-o-criador-m93z9k},by={Alfredo},key={C},gk={C, B\flt{}--B--(C)},off={Kayke}]
  ...
  \mnbeginverse[1]\memorize[chords_louvarocriador_b]
    \beginrep
      \[^\mn{C}]Por tu\[^\mn{B}]{do\jw o} |\[\mnc{A}F]que já \[\bmc\mn{C}]es\[^\mn{E}]tá |\[\mnc{G}C]fei\[\mnc{E}(Am)]to \altchords{|D |A (F\shrp{}m)}
      \[^\mnc{A}]E tudo\jw o |\[\mnc{E}C]que \[^\mn{C}]nos \[\mnc{A}F]en\[^\mn{C}]si|\[C]nou \[\bm]{} \altchords{|A D |A}
    \endrep
  \mnendverse
  \mnbeginverse[2]\memorize[chords_louvarocriador_c]
    \beginrep
      \[^\mn{A}]Lou|\[\mnc{D}G]var, \[^\mn{A}]lou\[\mnc{C}F]var lou|\[C]van\[\mnc{A}(Am)]do \altchords{|E D |A (F\shrp{}m)}
      Lou|\[\mnc{D}G]var \[^\mn{A}]o \[\mnc{C}F]Cria|\[C]dor \[\bm]{} \altchords{|E D |A}
    \endrep
  \mnendverse
  \notesoff
  % verse two
...
\beginsong{Tucum}[id={tucum-285ufn},by={Alfredo},key={C},gk={C, (B)--(C)},off={Samara Melo}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep
        \[^\mn{C}]E |\[C]quando\jw eu or\[\mnc{A}(Am7)]de\[^\mn{G}]{no\jw esse} |\[\mnc{C}C]mal vai em\[\bmc\mn{E}]bora
        É\jw em |\[^\mn{C}]nome \[^\mn{E}]de \[\mnc{G}G]Deus \[^\mnc{D}]e de |\[G7]Nos\[^\mn{C}]sa Se\[C]nhora
        É\jw em |nome \[^\mn{E}]de \[\mnc{G}G]Deus \[^\mnc{D}]e de |\[G7]Nos\[^\mn{C}]sa Se\[C]nhora
      \endrep
    \endrep
  \mnendverse
  \notesoff
  ...
  \meter{2}{4}
    \mnbeginverse\memorize[chords_soporamor_a]
      \beginrep
        ...
        \[^\mn{A}]Mui\[^\mn{G}]{to\jw a}|\[^\mn{C}]mor | \e
        É |\[\mnc{D}Dm]que es|\[\mnc{E}Am/E]{pando\jw esta} |\[\mnc{C}C]luz | \e
      \endrep
    \mnendverse
    \mnbeginverse[1]\memorize[chords_soporamor_b]
      \beginrep
        \[^\mn{C}]Essa |\[\mnc{F}F]trilha que |estou \[^\mn{G}]an|\[^\mn{A}]dan|do
        É \[^\mn{G}]a |\[\mnc{E}C]mesma que |an\[^\mn{G}]dou Je|\[G]sus | \e
        \beginrep
          \[^\mn{B}]Es\[^\mn{C}]te |\[\mnc{D}Dm]mes\[^\mn{C}]tre \[^\mn{B}]a|\[^\mn{D}]qui \[^\mn{C}]en\[^\mn{B}]si|\[\mnc{A}G]nan\[^\mn{G}]do | \e
          \[^\mn{C}]Com \[^\mn{D}]o |\[\mnc{E}Am]simbo\[^\mn{G}]lo |\[\mnc{D}G]da San\[^\mn{E}]ta |\[\mnc{C}C]Cruz | \e
        \endrep
      \endrep
    \mnendverse
    \notesoff
...
\beginsong{Bastão}[id={bastao-31jzze},by={Alfredo},key={C},gk={C, B\flt{}--D},off={Vicente e o povo do Japão}]
  ...
  \mnbeginverse
    \beginrep\memorize
      \ilsl{\[^\mn{C}]É} se|\[\mnc{D}Dm]guir o \[^\mn{A}]nos\[^\mn{B}]so \[\mnc{C}C]mestre \altchords{\id[1]{(D)}|Em D}
      Den\[^\mn{E}]tro |\[^\mn{G}]da vossa\jw ins\[^\mn{E}]tru\[\bmc\mn{G}]ção \altchords{| \e}
...
\beginsong{Vida}[id={vida-bbob1m},by={Alfredo},key={Am},gk={Am, Gm--Am},off={Ramaiam, Ana Rita, Igor}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep
        \ilsl{\[^\mn{A}]É} tão bo|\[\mnc{B}Bm7&5]ni\[^\mn{A}]to,\jw o poder \[\mnc{F}(Dm/F)]da \[^\mn{D}]fo\[^\mn{F}]gue|\[Am]i\[^\mn{E}]ra
        Queima a \[\mnc{C}(C)]noi\[^\mn{A}]{te\jw in}\[^\mn{E}]te|\[E7]i\[^\mn{D}]ra, mis\[^\mn{C}]té\[^\bm\mn{B}]rio \[^\mn{C}]da |\[\mnc{A}Am]Cruz \[^\bm]{}
      \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    \beginrep
      Esta lem|^brança\jw é da e^terni|^da\[\bm]de
      Esta ver|dade nos e^leva\jw as|^sim \[\bm]
      \beginrep
        Lembrando |^sempre a Luz ^deste di|^{-a}
        Oh Vir^gem Mari|^{'a}, vós lem\[\bm]brai de |^mim \[\bm]{}
      \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
      ...
      Domina|dor da vida\jw é ^São Jo|^sé \[\bm] \altchords{| - G7 |Cm}
      \beginrep
        Oh Patri|^arca, nos as^cenda Lu|^z \altchords{|Am7\flt{}5 (Cm/E\flt{}) |Gm}
        Vida ^meu Jesu|^s, Espe\[\bm]rança\jw e |^Fé \[\bm]{} \altchords{(B\flt{}) |D7 |Gm}
      \endrep
    \endrep
  \endverse
  \ifbassclefbook\hardbrk\fi
...
\beginsong{O Rigor das Profecias}[id={o-rigor-das-profecias-1uuhox},by={Alfredo},key={C},gk={C, B\flt{}--B--(C)},off={Vinícius Antonelli e Família}]
  ...
  \mnbeginverse
    \beginrep\memorize
      \[^\mn{G}]Todo |\[\mnc{C}C]di\[^\mn{G}]{a\jw eu} o\[^\mn{F}]b\[\bmc\mn{E}]ser\[^\mn{C}]vo
      ...
      Nos es|\[\mnc{D}G]tendam\jw as vos\[^\mn{C}]sas \[\mnc{E}C]mãos
      \beginrep
        | \[^\mn{C}]Nos \[^\mn{D}]dê \[^\mn{C}]a \[\mnc{A}Am]cura
        ...
        \[^\mn{G}]Jesus |\[\mnc{D}G7]Cristo\jw e \[^\mn{E}]São \[^\mn{C}]Jo\[C]ão
      \endrep
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Santa Cura}[id={santa-cura-tydmze},by={Alfredo},key={C},gk={C, C--D}]
  ...
  \mnbeginverse
    ...
    \beginrep\memorize[chords_santacura_b]
      \[^\mn{A}]Para |\[F]nun\[^\mn{G}]ca \[Am7]{se\jw es}que|\[\mnc{D}Dm]cer \altchords{|G Bm7 |Em}
...
\beginsong{Renascer}[id={renascer-t4abn9},by={Alfredo},key={C},gk={C, G\shrp{}--B--(C)}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep
        \[^\bmc\madii{C}{E}]Aqui |\[\mnc{C}C]na nos\[\bm]sa mis|\[\mnc{F}F]são o \[\bm]nosso |\[\mnc{A}Am]Mestre \[\bm]Re\[^\mn{G}]plan|\[\mnc{C}C]tou
        \[\bmc\mn{G}]Doutri|\[\mnc{A}G]na \[^\mn{G}]de \[\bm]Jesus |\[\mnc{D}Dm]Cristo \[\bm]do nos|\[\mnc{G}G]so Pai \[\bmc\mn{D}]Cri\[^\mn{E}]a|\[\mnc{C}C]dor.
      \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    \beginrep
      ...
      \beginrep
        ...
        I^lumi|^nar\jw o nos^so per|^dão e ^se fir|^mar no ^Cria|^dor. \[\bm]
      \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
      ...
      \beginrep
        ...
        Na |^luz do ^Santo |^Daime, ^vamos |^todos ^Renas|^cer. \[\bm] \altchords{|E |Bm |E |A}
      \endrep
    \endrep
  \endverse
  \begin{translation}[EN]
...
\beginsong{Infinitum}[id={infinitum-7vdbkc},by={Alfredo},key={C},gk={C, (B)--(C)}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep
        \[^\mn{C}]Toda\jw a flo|\[\mnc{A}Am]res\[^\mn{G}]ta,\[\bm] \[^\mn{C}]está em |\[\mnc{E}C]festa \[G7]
        \[^\mn{D}]Infini|\[\mnc{C}C]tum \[\bm]
      \endrep
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Centenário Integração}[id={centenario-integracao-woxyjc},by={Alfredo},key={G},gk={G, G--A}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep
        \[^\mn{D}]Bati|\[\mnc{C}C]zando lá no \[\mnc{D}D]Rio de Jor|\[\mnc{B}Bm]dão \[\bm] \altchords{|D E |Am}
        \[^\mn{D}]Ilumi|\[\mnc{A}Am]nando com a \[\mnc{B}Bm]cura do per|\[\mnc{G}G]dão \[\bm] \altchords{|Bm |C\shrp{}m |A}
      \endrep
    \endrep
  \mnendverse
  \notesoff
