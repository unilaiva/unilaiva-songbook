...
\beginsong{Examine a Consciência}[by={Sebastião}, key={C}, gk={D, C--E}]
...
\beginsong{A meu Pai Peço Firmeza}[by={Sebastião}, tags={á capela, perfilado}, key={C}, gk={D, C--E}]
...
\beginsong{Eu Vivo com meu Mestre}[by={Sebastião}, key={C}, gk={D, C--F\shrp{}}]
...
\beginsong{É Pedindo e é Rogando}[by={Sebastião}, key={C}, gk={D, C--E}]
...
\beginsong{Dem Dum}[by={Sebastião}, key={C}, gk={D, C--E}]
...
\beginsong{Aqui Eu Vou Expor}[by={Sebastião}, key={D}, gk={D, D--E}]
...
\beginsong{Eu Vou Rezar}[by={Sebastião}, key={D}, gk={D, D\shrp{}--G\shrp{}}]
...
\beginsong{Para Estar Junto a Este Cruzeiro}[by={Sebastião}, key={C}, gk={D, C--E}]
...
\beginsong{Não Creia nos Mestres que te Aparecem}[by={Sebastião}, key={C}, gk={D, C--D}]
...
\beginsong{Peço que Vós me Ouça}[by={Sebastião}, tags={valsa}, key={C}, gk={C, C--D}]
...
\beginsong{O Amor}[by={Sebastião}, key={D}, gk={D, D--D\shrp{}}]
...
\beginsong{Eu Não Sou Deus}[by={Sebastião},tags={perfilado, 2x}, key={D}, gk={D, D\shrp{}--F\shrp{}}]
...
\beginsong{Eu Pedi e Tive o Toque}[by={Alfredo}, off={Maria Sebastiana}, key={A}, gk={A, A--B}]
...
\beginsong{A Magia da Oração}[by={Nonata}, off={Júlia}, key={C}, gk={D, C--E}]
