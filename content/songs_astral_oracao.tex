...
\beginsong{A meu Pai Peço Firmeza}[id={a-meu-pai-peco-firmeza-ibk9xm},by={Sebastião},tags={á capela, perfilado},key={C},gk={D, C--E}]
  ...
  \beginverse
    \beginrep
      \[\mnd{G}]A meu |\[\mnd{C}]Pai pe\[\bm]ço \[\mnd{E}]fir|\[\mnd{G}]m\[\bm]e\[\mnd{C}]za
      E não |\[\mnd{E}]saia \[\mnd{C}]da \[\bmc\mnd{A}\mnd{G}]min\[\mnd{C}]ha |men\[\bm]te
    \endrep
    \endverse\glueverses\beginverse
    \beginrep
      \[\mnd{C}]Dou en|\[\mnd{E}]sino \[\mnd{C}]a \[\bmc\mnd{A}]quem \[\mnd{G}]não |s\[\bm]abe
      \[\mnd{C}]E a\[\mnd{D}]con|se\[\mnd{C}]{lho os} \[\bmc\mnd{A}]i\[\mnd{C}]no|cen\[\bm]tes
    \endrep
  \endverse
...
\beginsong{É Pedindo e é Rogando}[id={e-pedindo-e-e-rogando-ucjq4v},by={Sebastião},key={C},gk={D, C--E}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_epedindo_a]
      \ilsl{\[^\mn{G}]É} pe|\[\mnc{C}C]dindo \[Am]{e é} \[^\mn{E}]ro|\[\mnc{G}G]ga\[\bm]n\[^\mn{F}]do \altchords{\id[1]{(D)}|D Bm |A}
...
\beginsong{Dem Dum}[id={dem-dum-inarwi},by={Sebastião},key={C},gk={D, C--E}]
  ...
  \mnbeginverse[1]
    \beginrep\prep{3}
      \[\mn{G}]Dem |\[\mnc{C}C]dum\[\bm], \[\mn{G}]dem |\[\mn{C}]dum\[\bm]{} \altchords{\id[1]{(D)}|D | \e}
      \[\mn{G}]Dem |\[\mnc{E}Am]dum\[\bm], \[\mn{G}]dem |\[\mnc{C}C]dum\[\bm]{} \altchords{|Bm |D}
    \endrep
  \mnendverse
...
\beginsong{Eu Vou Rezar}[id={eu-vou-rezar-ylisa5},by={Sebastião},key={D},gk={D, D\shrp{}--G\shrp{}}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_euvourezar_a]
      ...
      Pai \[^\mn{B}]nos\[\bmc\mn{D}]so que estais \[^\mn{B}]no |\[^\mn{G}]céu vós \[^\mn{B}]quei\[\bmc\mn{D}]ra \[^\mn{C}]me \[^\mn{A}]de\[^\mn{B}]fen|\[\mnc{C}C]der \[\ac<2>{C7}]
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_euvourezar_b]
      \[^\mn{C}]Pão |\[\mncii{F}{E}F]nos\[\mnc{D}G]so \[^\mn{E}]de \[^\mn{F}]ca\[^\mn{D}]da |\[\mnc{C}C]dia
      Je\[^\mn{A}]sus \[\mnc{C}Am]no alto \[^\mn{A}]da |\[\mnc{G}G]cruz \[^\mn{B}]so\[\bmc\mn{D}]freu \[^\mn{C}]to\[^\mn{A}]da a\[^\mn{B}]go|\[\mnc{C}C]ni\[\ac<1>{C7}]a
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Eu Não Sou Deus}[id={eu-nao-sou-deus-zboxp4},by={Sebastião},tags={perfilado, 2x},key={D},gk={D, D\shrp{}--F\shrp{}}]
  ...
  \mnbeginverse\memorize[chords_eunaosoudeus_a]
    ...
    \beginrep
      \[^\mn{A}]Deus \[^\mn{C}]é |\[\mnc{E}C]fo\[^\mn{C}]go, \altchords{|C}
      Deus é \[\bmc\mn{A}]á\[^\mn{G}]gua, \[^\mn{E}]Deus \[^\mn{G}]é |\[G]tudo \altchords{|G}
      Eu con\[\bm]vido os \[^\mn{B}]meus \[^\mn{D}]ir|\[\mnc{F}F]mãos \altchords{|F}
      Para co\[^\mn{E}]me\[\bm\mn{A}]çar \[^\mn{C}]nossos es|\[C]tudos\[\bm]{} \altchords{|C}
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Recebendo}[id={recebendo-94108g},by={Odemir Raulino da Silva},off={Francinete Oliveira},tags={valsa},key={C},gk={D, C--E}]
  ...
  \mnbeginverse
    \beginrep\memorize
      \beginrep \[^\mn{G}]Rece|\[C]ben\[^\mn{E}]do \[^\mn{D}]no |\[^\mn{C}]meu \[^\mn{B}]co\[^\mn{C}]ra|\[\mncii{D}{A}Dm]ção | \e \altchords{\id[1]{(D)}|D | - |Em | \e}
      \[^\mn{F}]U\[^\mn{D}]ma |\[\mncii{B}{G}G]flor |\[\mnc{F}G7]que \[^\mn{E}]me \[^\mn{D}]con|\[\mnc{C}C]for|te \altchords{|A |A7 |D | \e} \endrep
      \beginrep Agra|\[\mnc{A}F]deço por |tudo \[^\mn{B}]de |\[\mncii{C}{G}C]bom |\[A7]{} \e \altchords{|G | - |D |B7}
      \[^\mn{E}]Deus \[^\mn{D}]nos |\[\mnc{G}Dm]liv\[^\mn{F}]re \[^\mn{D}]do |\[\mnc{G}G7]que \[^\mn{B}]é \[^\mn{D}]a |\[\mnc{C}C]mor|te \altchords{|Em |A7 |D | \e } \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
