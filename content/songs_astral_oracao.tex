...
\beginsong{Examine a Consciência}[id={examine-a-consciencia-3e8lv6},by={Sebastião},key={C},gk={D, C--E}]
  ...
  \mnbeginverse
    \beginrep\memorize
      \[^<G>]E\[^<C>]xa|\[<E>C]mine a \[<* D>]con\[^<C>]sci|\[<G>G]ência \altchords{\id[1]{(D)}|D |A}
      \[<*>]E\[^<C>]xa|\[<E>Am]mine \[<* D>]di\[^<C>]rei|\[<G>G]ti\[<*>]nho \altchords{|Bm |A}
      \[^<C>]Sou |\[<E>C]Pai e \[<* D>]não \[^<C>]sou |\[<G>G]filho \altchords{|D |A}
      \[<*>]Mas \[^<C>]eu |\[<E>Am]não fa\[<D>G]ço \[^<E>]as|\[<C>C]sim\[<*>]{} \altchords{|Bm A |D}
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{A meu Pai Peço Firmeza}[id={a-meu-pai-peco-firmeza-ibk9xm},by={Sebastião},tags={á capela, perfilado},key={C},gk={D, C--E}]
  ...
  \beginverse
    \beginrep
      \[<G>]A meu |\[<C>]Pai pe\[<*>]ço \[<E>]fir|\[<G>]m\[<*>]e\[<C>]za
      E não |\[<E>]saia \[<C>]da \[<* A G>]min\[<C>]ha |men\[<*>]te
    \endrep
    \endverse\glueverses\beginverse
    \beginrep
      \[<C>]Dou en|\[<E>]sino \[<C>]a \[<* A>]quem \[<G>]não |s\[<*>]abe
      \[<C>]E a\[<D>]con|se\[<C>]{lho os} \[<* A>]i\[<C>]no|cen\[<*>]tes
    \endrep
  \endverse
  \notesoff\chordsoff\measureson
  \beginverse
    \beginrep
      Meu |Pai a \[<*>]ti eu |p\[<*>]eço
  ...
  \beginverse
    ...
    \beginrep
      Ro|gando \[<*>]pelo |p\[<*>]ovo
      Para |ser me\[<*>]rece|dor\[<*>]
    \endrep
  \endverse
  \beginverse
    \beginrep
      Oh! |Minha \[<*>]Virgem |Mãe\[<*>]
      Oh! |Virgem \[<*>]prote|to\[<*>]ra
    \endrep
    \endverse\glueverses\beginverse
    \beginrep
      És |Rai\[<*>]nha do |mar\[<*>]
      És |minha \[<*>]profes|so\[<*>]ra
    \endrep
  \endverse
  \beginverse
    \beginrep
...
\beginsong{Eu Vivo com meu Mestre}[id={eu-vivo-com-meu-mestre-bw2ajv},by={Sebastião},key={C},gk={D, C--F\shrp{}}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_euvivocom_a]
      \[^<G>]Eu |\[<C>C]vivo \[<A>Am]com \[^<C>]meu |\[<G>G]Mes\[<*>]tre \altchords{\id[1]{(D)} |D Bm |A}
      \[^<C>]Eu |\[<E>Am]vi\[^<C>]vo com \[<A>F]meus \[^<C>]ir|\[C]mãos\[<*>]{} \altchords{|Bm G |D}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_euvivocom_b]
      \[^<C>]Eu |\[<F>F]vivo \[^<E>]na \[<D>G]san\[^<E>]ta |\[<C>C]luz \altchords{|G A |D}
      Estou \[^<B>]no \[<A>(F)]pé \[^<B>]da |\[<G>G]cruz com Ju\[<C>(Am)]ra\[^<E>]mi|\[<C>C]dam\[<*>]{} \altchords{ (G) |A (Bm) |D}
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_euvivocom_a]
    \beginrep
      |^Eu pe^{ço a} meu |^Pai
      ^O que eu pe|^dir E^le me |^dá^
    \endrep
    \endverse\glueverses\beginverse\replay[chords_euvivocom_b]
    \beginrep
...
\beginsong{É Pedindo e é Rogando}[id={e-pedindo-e-e-rogando-ucjq4v},by={Sebastião},key={C},gk={D, C--E}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_epedindo_a]
      \ilsl{\[^<G>]É} pe|\[<C>C]dindo \[Am]{e é} \[^<E>]ro|\[<G>G]ga\[<*>]n\[^<F>]do \altchords{\id[1]{(D)}|D Bm |A}
      \[^<E>]Que \[^<D>]po|\[<C>Am]demos \[<G>G]al\[^<D>]can|\[<C>C]çar \[<*>]{} \altchords{|Bm A |D}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_epedindo_b]
      \[^<C>]Não é |\[<G>C]fa\[^<C>]lar \[<*>]um do |\[<E>Am]ou\[<* @-.85ex>]\[^<C>]tro \altchords{|D |Bm}
      Queren|\[<G>G]do ca\[<C>Am]lu\[^<E>]ni|\[<C>C]ar \[<*>]{} \altchords{|A Bm |D}
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_epedindo_a]
    \beginrep
      Me apre|^sento ^{a meu} |^Pa^i
      E minha his|^tória eu ^sei con|^tar ^
    \endrep
    \endverse\glueverses\beginverse\replay[chords_epedindo_b]
    \beginrep
...
\beginsong{Dem Dum}[id={dem-dum-inarwi},by={Sebastião},key={C},gk={D, C--E}]
  ...
  \mnbeginverse[1]
    \beginrep\prep{3}
      \[<G>]Dem |\[<C>C]dum\[<*>], \[<G>]dem |\[<C>]dum\[<*>]{} \altchords{\id[1]{(D)}|D | \e}
      \[<G>]Dem |\[<E>Am]dum\[<*>], \[<G>]dem |\[<C>C]dum\[<*>]{} \altchords{|Bm |D}
    \endrep
  \mnendverse
  \mnbeginverse\memorize[chords_demdum_a]
    \beginrep
      \[^<G>]Deus sa|\[<C>C]be o que es\[<*>]tá \[^<D>]fa|\[<C>Am]zen\[<* @-.85ex>]do \altchords{|D |Bm}
      Sen\[^<D>]ta|\[<E>C]do \[^<G>]no \[<D>G]seu \[^<E>]lu|\[<C>C]gar\[<*>]{} \altchords{|D A |D}
    \endrep
    \mnendverse\glueverses\mnbeginverse\memorize[chords_demdum_b]
    \beginrep
      \[^<C>]As |\[<D>Dm]doze \[^<C>]ho\[<A>F]ras \[^<C>]do |\[<G>G]di\[<*>]a \altchords{|Em G |A}
      \[^<C>]Nós \[^<D>]pre|\[<E>Am]ci\[^<G>]sa\[<D>G]mos \[^<E>]re|\[<C>C]zar\[<*>]{} \altchords{|Bm A |D}
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_demdum_a]
    \beginrep
      Pai |^nosso que es^tais no |^céu ^
      Rece|^bemos com ^ale|^gri^a
    \endrep
    \endverse\glueverses\beginverse\replay[chords_demdum_b]
    \beginrep
...
\beginsong{Aqui Eu Vou Expor}[id={aqui-eu-vou-expor-6xlhhn},by={Sebastião},key={D},gk={D, D--E}]
  ...
  \mnbeginverse
    \beginrep\memorize
      \[^<G>]A|\[<C>C]qui eu \[<*>]vou \[^<E>]ex|\[<G>(G)]po\[<* E>]r \altchords{\id[1]{(C)}|C |(G)}
      \[^<G>]Eu |\[<F>C7]vim \[^<E>]pa\[<* D>]ra \[^<C>]lem|\[<F>F]brar\[<*>]{} \altchords{|C7 |F}
      \[^<A>]O mis|tério da \[<* F>]o\[^<A>]ra|\[<G>C]ção \altchords{| - |C}
      \[<* C>]Não \[^<D>]é |\[<E>G7]so\[^<D>]men\[<* A>]te \[^<B>]re|\[<C>C]zar\[<*>]{} \altchords{|G7 |C}
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Eu Vou Rezar}[id={eu-vou-rezar-ylisa5},by={Sebastião},key={D},gk={D, D\shrp{}--G\shrp{}}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_euvourezar_a]
      \[^<G>]Eu \[^<E>]vou \[^<G>]re|\[<C>C]zar que é pa\[^<B>]ra \[<A>(Am)]to\[^<B>]do \[^<C>]mun\[^<A>]do |\[<G>G]ver
      Pai \[^<B>]nos\[<* D>]so que estais \[^<B>]no |\[^<G>]céu vós \[^<B>]quei\[<* D>]ra \[^<C>]me \[^<A>]de\[^<B>]fen|\[<C>C]der \[\ac{2}{C7}]
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_euvourezar_b]
      \[^<C>]Pão |\[<F E>F]nos\[<D>G]so \[^<E>]de \[^<F>]ca\[^<D>]da |\[<C>C]dia
      Je\[^<A>]sus \[<C>Am]no alto \[^<A>]da |\[<G>G]cruz \[^<B>]so\[<* D>]freu \[^<C>]to\[^<A>]da a\[^<B>]go|\[<C>C]ni\[\ac{1}{C7}]a
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_euvourezar_a]
    \beginrep
      \noteson\[<* E>]Eu \[<G>]pe\notesoff|^di ^{e meu} Pai me |^deu \altchords{\id[1]{(C)}|C (Am) |G}
      Para eu ^nunca me esque|cer ^de São Iri|^neu ^ \altchords{| - |C \ac{2}{C7}}
    \endrep
    \endverse\glueverses\beginverse\replay[chords_euvourezar_b]
    \beginrep
      A |^cruz ele ^sempre consa|^grou \altchords{|F G |C}
      ^No céu e na |^terra aqui es^tá o meu a|^mor ^ \altchords{Am |G |C \ac{1}{C7}}
    \endrep
  \endverse
  \beginverse\replay[chords_euvourezar_a]
    \beginrep
  ...
  \beginverse\replay[chords_euvourezar_a]
    \beginrep
      ...
      E^le bem ensi|nou e você ^não quis apren|^der ^ \altchords{|A7 |D \ac{2}{D7}}
    \endrep
    \endverse\glueverses\beginverse\replay[chords_euvourezar_b]
    \beginrep
      A|^gora ^é que eu quero |^ver \altchords{|G A |Bm}
      É ^andar direi|^tinho sob ^pena de sof|^rer ^ \altchords{G |A7 |D \ac{1}{D7}}
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
    % transcribed by larva on 2022-08
...
\beginsong{Para Estar Junto a Este Cruzeiro}[id={para-estar-junto-a-este-cruzeiro-75ot0q},by={Sebastião},key={C},gk={D, C--E}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_paraestarjunto_a]
      \[^<G>]Para es|\[<C>C]tar junto a \[<*>]este \[^<E>]cru|\[^<G>]zei\[<* E>]ro \altchords{\id[1]{(D)}|D | \e }
      É \[^<G>]mu|\[<E>Am]dar \[^<C>]de \[^<A>]o\[<D>G]pi\[^<E>]ni|\[<C>C]ão \[<*>]{} \altchords{|Bm A |D}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_paraestarjunto_b]
      \[^<A>]Quem |\[<C>C]a\[^<A>]ma a \[<D>Dm]Je\[^<C>]sus |\[<G>G]Cris\[<*>]to \altchords{|D Em |A}
      \[^<C>]Não |\[<E>Am]fa\[^<C>]la \[^<A>]do \[<D>G]seu \[^<E>]ir|\[<C>C]mão \[<*>]{} \altchords{|Bm A |D}
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_paraestarjunto_a]
    \beginrep
      O |^Mestre es^tá a|qui ^
      E|^le fala ^bem bai|^xi^nho
    \endrep
    \endverse\glueverses\beginverse\replay[chords_paraestarjunto_b]
    \beginrep
...
\beginsong{Não Creia nos Mestres que te Aparecem}[id={nao-creia-nos-mestres-que-te-aparecem-wsa6rt},by={Sebastião},key={C},gk={D, C--D}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_naocreianosmestres_a]
      \[^<G>]Não |\[<C>C]creia nos \[^<D>]mes\[<*>]tres \[^<C>]que \[^<A>]te a\[^<C>]pa|re\[<*>]cem \altchords{\id[1]{(D)}|D | \e}
      E nem \[^<E>]com |\[<G>G]eles no ca\[F]min\[^<E>]ho \[^<C>]quei\[^<F>]ra an|\[<E>E]dar\[<*>]{} \altchords{|A G |F\shrp{}}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_naocreianosmestres_b]
      |\[<G>G]Creia \[^<E>]so\[<A>Am]men\[^<G>]te em \[^<F>]seu \[^<E>]Je|\[<C>C]su\[<A>(Am)]s \altchords{|A Bm |D (Bm)}
      \[^<E>]Que |\[<C>F]E\[^<A>]le é \[^<D>]quem \[G7]tem \[^<C>]pa\[^<A>]ra \[^<C>]te |\[C]dar\[<*>]{} \altchords{|G A7 |D}
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_naocreianosmestres_a]
    \beginrep
      Meu |^Mestre a^qui a vós eu |pe^ço
      |^Para ^Vós me gui|^ar ^
    \endrep
    \endverse\glueverses\beginverse\replay[chords_naocreianosmestres_b]
    \beginrep
  ...
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
    % transcribed by larva on 2025-08
    theMelody = \relative g' {
      \set melismaBusyProperties = #'() \slurDashed
      \key c \major \time 4/4 \partial 4
      \repeat volta 2 {
...
\beginsong{Peço que Vós me Ouça}[id={peco-que-vos-me-ouca-n00urd},by={Sebastião},tags={valsa},key={C},gk={C, C--D}]
  ...
  \meter{3}{4}
  \mnbeginverse
    \beginrep\memorize[chords_pecoquevosmeouca_a]
    ...
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_pecoquevosmeouca_b]
  ...
  \mnendverse
  \notesoff
  \beginverse\replay[chords_pecoquevosmeouca_a]
    \beginrep
      Meu |^Pai quando |^for perdo|^ar |^ \e
      Per|^{doa co}|^mo lhe con|^vém | \e
    \endrep
    \endverse\glueverses\beginverse\replay[chords_pecoquevosmeouca_b]
    \beginrep
...
\beginsong{O Amor}[id={o-amor-x6u4w6},by={Sebastião},key={D},gk={D, D--D\shrp{}}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_oamor_a]
      \[^<C>]O \[^<E>]a|\[<G>C]mor é para \[<* A>]ser \[^<G>]distri\[^<E>]bu|\[^<G>]ído \altchords{\id[1]{(C)}|C | \e}
      \[^<C>]E \[<* E>]não \[^<C>]amor \[^<A>]fin|\[<G>G]gido por\[^<B>]que \[<D C>F]ele \[^<A>]cau\[^<C>]sa |\[C]dor\[<*>]{} \altchords{|G F |C}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_oamor_b]
      \[^<E>]O \[^<G>]a|\[G]mor é o \[^<B>]cam\[<* D>]po \[^<C>]da \[^<A>]for\[^<C>]mo|\[<E>C]su\[^<C>]ra \altchords{|G |C}
      Onde es\[<* A>]tá \[^<G>]minha i\[^<E>]ma\[^<G>]gem |\[G]pu\[^<C>]ra, \[<D>F]Deus \[^<C>]foi \[^<A>]quem \[^<C>]cri|\[C]ou\[<*>]{} \altchords{|G F |C}
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_oamor_a]
    \beginrep
      O a|^mor é o ^trono da ver|dade \altchords{\id[4]{simples (D)}{|D | \e}}
      Onde es^tá a majes|^tade Cris^to Nosso Se|^nhor^ \altchords{|A |D}
    \endrep
    \endverse\glueverses\beginverse\replay[chords_oamor_b]
    \beginrep
...
\beginsong{Eu Não Sou Deus}[id={eu-nao-sou-deus-zboxp4},by={Sebastião},tags={perfilado, 2x},key={D},gk={D, D\shrp{}--F\shrp{}}]
  ...
  \mnbeginverse\memorize[chords_eunaosoudeus_a]
    \beginrep
      \[^<C>]Eu \[^<A>]não \[^<C>]sou |\[<E>C]Deus \altchords{\id[1]{(C)}|C}
      \[^<C>]Mas \[<A>Am]tenho uma \[^<E>]es\[^<G>]pe|\[G]rança\[<*>]{} \altchords{Am |G}
      Eu \[^<B>]não \[^<D>]sou |\[<F>F]Deus \altchords{|F}
      \[^<E>]Mas \[<* A>]sou \[^<C>]sua semel|\[C]hança\[<*>]{} \altchords{G |C}
    \endrep
    \mnendverse\glueverses\mnbeginverse[1]\memorize[chords_eunaosoudeus_b]
    \beginrep
      \[^<A>]Deus \[^<C>]é |\[<E>C]fo\[^<C>]go, \altchords{|C}
      Deus é \[<* A>]á\[^<G>]gua, \[^<E>]Deus \[^<G>]é |\[G]tudo \altchords{|G}
      Eu con\[<*>]vido os \[^<B>]meus \[^<D>]ir|\[<F>F]mãos \altchords{|F}
      Para co\[^<E>]me\[<* A>]çar \[^<C>]nossos es|\[C]tudos\[<*>]{} \altchords{|C}
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_eunaosoudeus_a]
    \beginrep
    ...
    \endrep
    \endverse\glueverses\beginverse[1]\replay[chords_eunaosoudeus_b]
    \beginrep
      Deus no |^céu, \altchords{|Bm}
      Deus na ^terra, Deus no |^mar \altchords{|A}
      Eu con^vido os meus ir|^mãos \altchords{|G}
      Para fi^car em seu lu|^gar ^ \altchords{|D}
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
    % transcribed by larva on 2022-08
...
\beginsong{Eu Pedi e Tive o Toque}[id={eu-pedi-e-tive-o-toque-gc378m},by={Alfredo},off={Maria Sebastiana},key={A},gk={A, A--B}]
  ...
  \transpose{-3}
  \mnbeginverse
    \beginrep\memorize[chords_eupedietive_a]
      \[^<E>]Eu \[^<F>]pe|\[<G>C]di e \[<* C>]ti\[^<A>]ve o |\[Fmaj7]to\[<*>]que \altchords{\id[1]{(G)}|G |Cmaj7}
      \[^<D>]Da \[^<E>]Flo|\[<F>Dm]res\[^<D>]ta e \[<G>C]do Ast|\[G]ral\[<*>] \altchords{|Am G |D}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_eupedietive_b]
      \[^<C>]A\[^<D>]qui |\[<E>C]estou \[<D>Dm7]a\[^<C>]vi|\[<G>G]sando \altchords{|G Am7 |D}
      \[<* D>]Que \[^<B>]de|\[^<G>]vemos \[<D>G7]ser \[^<E>]i|\[<C>C]gual\[<*>] \altchords{| - D7 |G}
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_eupedietive_a]
    \beginrep
      Exami|^nando o ^firma|^men^to
      O te|^souro u^niver|^sal ^
    \endrep
    \endverse\glueverses\beginverse\replay[chords_eupedietive_b]
    \beginrep
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
    ...
    %\setStaffSize #14 % for all verses: 14
    \include "ulsbs-include-tail-lyricsbetween.ly" % for all verses: -lyricsbelow.ly
  \end{lilypond}\end{lilywrap}
  \ifshowlilypond\translationoff\fi % to fit whole song on one spread
  \begin{translation}[EN]
...
\beginsong{A Magia da Oração}[id={a-magia-da-oracao-ksckcu},by={Nonata},off={Júlia},key={C},gk={D, C--E}]
  ...
  \mnbeginverse
    \beginrep\memorize[songs_amagiadaoracao_a]
      \[^<C>]Meu São \[^<E>]Jo|\[<G>C]ão\[<*>], \[^<E>]Meu \[^<C>]São \[^<E>]Jo|\[^<G>]ão \[<*>]{} \altchords{\id[1]{(D)}|D | \e }
      \[^<C>]Foi quem can|\[<E>Am]tou \[^<C>]es\[<G>G]ta \[^<D>]can|\[<C>C]ção \[<*>]{} \altchords{|Bm A |D}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[songs_amagiadaoracao_b]
      \[^<C>]Para |\[<G>G]mim\[<*>]{} \[^<C>]{e para} |\[<E>Em]ti \[<*>]{} \altchords{|A |F\shrp{}m}
      \[^<G>]Na \[^<C>]ma|\[<E>Am]gi\[^<C>]{a da} \[<G>G7]O\[^<D>]ra|\[<C>C]ção \[<*>]{} \altchords{|Bm A7 |D}
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[songs_amagiadaoracao_a]
    \beginrep
      Exa|^mi^{--ne} a consci|ên^cia
      E a|^calme seu ^cora|^ção ^
    \endrep
    \endverse\glueverses\beginverse\replay[songs_amagiadaoracao_b]
    \beginrep
...
\beginsong{Recebendo}[id={recebendo-94108g},by={Odemir Raulino da Silva},off={Francinete Oliveira},tags={valsa},key={C},gk={D, C--E}]
  ...
  \mnbeginverse
    \beginrep\memorize
      \beginrep \[^<G>]Rece|\[C]ben\[^<E>]do \[^<D>]no |\[^<C>]meu \[^<B>]co\[^<C>]ra|\[<D A>Dm]ção | \e \altchords{\id[1]{(D)}|D | - |Em | \e}
      \[^<F>]U\[^<D>]ma |\[<B G>G]flor |\[<F>G7]que \[^<E>]me \[^<D>]con|\[<C>C]for|te \altchords{|A |A7 |D | \e} \endrep
      \beginrep Agra|\[<A>F]deço por |tudo \[^<B>]de |\[<C G>C]bom |\[A7]{} \e \altchords{|G | - |D |B7}
      \[^<E>]Deus \[^<D>]nos |\[<G>Dm]liv\[^<F>]re \[^<D>]do |\[<G>G7]que \[^<B>]é \[^<D>]a |\[<C>C]mor|te \altchords{|Em |A7 |D | \e } \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    \beginrep
      \beginrep Esta |^é uma |mensagem |^boa | \e
      Para |^nós vi|^ver consci|^en|te \endrep
      \beginrep Aumen|^tai a nos|sa ale|^gria |^ \e
      E na tris|^teza um fi|^nal para |^sem|pre \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
      \beginrep É mais |^isto que eu |tenho a di|^zer | \e
      No meu |^ponto e|^spiritu|^al | \e \endrep
      \beginrep Deus nos |^cubra com |a vossa |^glória |^ \e
      E nas mal|^dades um |^ponto fi|^nal | \e \endrep
    \endrep
  \endverse
  \begin{translation}[EN]
...
\begin{intersong}
  \begin{explanation}[PT]
    Nos trabalhos sentados, após a Oração, é costume rezar a
    \textbf{Consagração do Aposento}.
  \end{explanation}
  \begin{explanation}[EN]
    In sitting works, after Oração, it is customary to recite the
    \textbf{Consecration of the Space}.
  \end{explanation}
\end{intersong}
