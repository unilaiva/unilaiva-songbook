...
\beginsong{Eu Vivo com meu Mestre}[id={eu-vivo-com-meu-mestre-bw2ajv},by={Sebastião},key={C},gk={D, C--F#}]
...
\beginsong{Eu Vou Rezar}[id={eu-vou-rezar-ylisa5},by={Sebastião},key={D},gk={D, D#--G#}]
...
\beginsong{Não Creia nos Mestres que te Aparecem}[id={nao-creia-nos-mestres-que-te-aparecem-wsa6rt},by={Sebastião},key={C},gk={D, C--D}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_naocreianosmestres_a]
      ...
      E nem \[^<E>]com |\[<G>G]eles no ca\[F]min\[^<E>]ho \[^<C>]quei\[^<F>]ra an|\[<E>E]dar\[<*>]{} \altchords{|A G |F#}
    \endrep
    \mnendverse\glueverses\mnbeginverse
...
\beginsong{O Amor}[id={o-amor-x6u4w6},by={Sebastião},key={D},gk={D, D--D#}]
...
\beginsong{Eu Não Sou Deus}[id={eu-nao-sou-deus-zboxp4},by={Sebastião},tags={perfilado, 2x},key={D},gk={D, D#--F#}]
...
\beginsong{A Magia da Oração}[id={a-magia-da-oracao-ksckcu},by={Nonata},off={Júlia},key={C},gk={D, C--E}]
  ...
  \mnbeginverse
    ...
    \beginrep\memorize[songs_amagiadaoracao_b]
      \[^<C>]Para |\[<G>G]mim\[<*>]{} \[^<C>]{e para} |\[<E>Em]ti \[<*>]{} \altchords{|A |F#m}
