...
\beginsong{A Chave da Justiça}[id={a-chave-da-justica-r8hv5d},by={Alex Polari},key={C},gk={C, G--B},tags={2x}]
  ...
  \beginverse\replay
    \beginrep
      ...
      A chave ^da jus|^tiça no Santo ^Daime es|\noteson\usealtmnstyletrue\[\mnc{C}C]tá. \[\bm]
    \endrep
  \endverse
...
\beginsong{As Seguranças do Céu \\ Papapapaparuê}[id={as-segurancas-do-ceu-7op69r},by={Valdete},key={G},gk={G, D\shrp{}--B},tags={perfilado, à capela}]
  ...
  \mnbeginverse[2]
    \beginrep
      \[\bmc\mnd{B}]Pa\[\mnd{D}]pa|\[\mnd{G}]papa\[\bmc\mnd{D}]paru\[\mnd{G}]ê |-\[\bm]{} | \e
      \[\bmc\mnd{B}]Pa\[\mnd{D}]pa|\[\mnd{G}]papa\[\bmc\mnd{D}]paru\[\mnd{G}]á |-\[\bm]{} | \e
    \endrep
  \mnendverse
  \mnbeginverse[1]
    \beginrep
      \[\bmc\mnd{B}]Vou \[\mnd{D}]cha|\[\mnd{G}]mar nes\[\bmc\mnd{D}]te ter\[\mnd{G}]r|ei\[\bm]ro
      O|\[\mnd{B}]gum \[\mnd{D}]da \[\bmc\mnd{G}]Mata O|\[\mnd{D}]gum do \[\mnd{G}\bm]Mar | \e
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep
      \[\bmc\mnd{B}]Tam\[\mnd{D}]bém |\[\mnd{F#}]vou cha\[\bmc\mnd{D}]mar a\[\mnd{F#}]q|ui \[\bm]
      |\[\mnd{D}]As se\[\bmc\mnd{F#}]guran|\[\mnd{D}]ças do \[\mnd{G}\bm]Céu | \e
    \endrep
  \mnendverse
  \beginverse
    \beginrep
  ...
  \mnbeginverse[1]
    \beginrep
      \[\bmc\mnd{B}]Pa\[\mnd{D}]ra |\[\mnd{G}]isto \[\bmc\mnd{D}]é pre\[\mnd{G}]c|i\[\bm]so
      |\[\mnd{B}]Ser\[\mnd{D}]mos \[\bmc\mnd{G}]solda|\[\mnd{D}]dos fi\[\mnd{G}\bm]éis | \e
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep
      \[\bmc\mnd{B}]Pa\[\mnd{D}]ra |\[\mnd{F#}]poder \[\bmc\mnd{D}]mere\[\mnd{F#}]c|er \[\bm]
      |\[\mnd{D}]A se\[\bmc\mnd{F#}]guran|\[\mnd{D}]ças do \[\mnd{G}\bm]Céu | \e
    \endrep
  \mnendverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
    % transcribed by larva, updated on 2022-12
...
\beginsong{Viva o Senhor São Miguel \\ Falanges do Céu}[id={viva-o-senhor-sao-miguel-fqv99m},by={Valdete},key={C},gk={D, C--E},tags={valsa, 2x}]
  ...
  \mnbeginverse
    \beginrep\memorize
      \[^\mn{G}]Viva\jw o \[^\mn{E}]Se|\[\mnc{G}C]nhor \[^\mn{E}]São \[^\mn{C}]Mi|\[^\mn{G}]guel \altchords{\id[1]{(D)}|D | \e}
      \[^\mn{G}]Viva\jw as \[^\mnc{E}]fa|\[^\mn{G}]lan\[^\mn{E}]ges \[^\mn{C}]do |\[^\mn{G}]Céu \altchords{| - | \e}
      \[^\mn{G}]{E\jw os} arcan|jos Que\[^\mn{E}]ru|\[\mnc{G}G]bins | | \e \altchords{| - |A | - | \e}
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Sete Cruzes de São Miguel}[id={sete-cruzes-de-sao-miguel-3o86ym},by={Isabel Barsé},key={Dm},gk={Cm--Em},tags={mazurca}]
  ...
  \mnbeginverse
    \beginrep\memorize
      \beginrep
        \[^\mn{A}]As sete |\[\mnc{D}Dm]cruzes de São \[^\mn{F}]Mi\[\bmc\mn{A}]guel \altchords{\id[1]{(Em)}|Em}
        \[^\mn{G}]Estão a|\[\mnc{F}A7]qui \[^\mn{E}]pra \[^\mn{C#}]te \[^\mn{E}]liber\[\mnc{D}Dm]tar \altchords{|B7 Em}
      \endrep
      \beginrep \[^\mn{D}]São sete |\[Dm]cruzes, são sete \[\bm]cru\[^\mn{A}]zes \altchords{|Em}
        São sete |\[\mnc{F}A7]cruzes \[^\mn{E}]pra \[^\mn{C#}]te \[^\mn{E}]liber\[\mnc{D}Dm]tar \altchords{|B7 Em}
      \endrep
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Clareia}[id={clareia-bnsmso},by={Paulo Roberto de Souza},tags={perfilado, à capela},key={D},gk={D, C-E}]
  ...
  \mnbeginverse
    \beginrep
      \[\mnd{A}]Cla\[\mnd{F#}]reia, \[\mnd{A}]cla\[\mnd{D}]reia, \[\mnd{F#}]cla\[\mnd{A}]reia
      Estou ven\[\mnd{C#}]do \[\mnd{E}]tudo cla\[\mnd{G}]re\[\mnd{F#}\mnd{D}]ar
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep
      \[\mnd{D}]Lua \[\mnd{G}]cheia, \[\mnd{D}]lu\[\mnd{E}]a \[\mnd{F#}]cheia
      Ilu\[\mnd{A}]mina, nas \[\mnd{C#}]al\[\mnd{E}]turas on\[\mnd{G}]de es\[\mnd{F#}\mnd{D}]tás
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep
      \[\mnd{a}]Per\[\mnd{F#}]fila, \[\mnd{A}]te a\[\mnd{D}]pruma, \[\mnd{F#}]te \[\mnd{A}]firma
      Em honra ao Glo\[\mnd{C#}]rio\[\mnd{E}]síssimo São \[\mnd{G}]Mi\[\mnd{F#}\mnd{D}]guel
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep
      \[\mnd{D}]Para ser\[\mnd{G}]vir ao valoro\[\mnd{D}]so \[\mnd{B}]Guar\[\mnd{D}]di\[\mnd{F#}]ão
      Prín\[\mnd{A}]cipe dos \[\mnd{C#}]e\[\mnd{E}]xércitos \[\mnd{G}]dos \[\mnd{F#}\mnd{D}]céus
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep
      \[\mnd{A}]Com a sua es\[\mnd{F#}]pada \[\mnd{A}]de \[\mnd{D}]fogo
      \[\mnd{A}]Com \[\mnd{C#}]seu \[\mnd{E}]escudo \[\mnd{G}]de \[\mnd{F#}\mnd{D}]luz
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep
      \[\mnd{D}]Onde está es\[\mnd{G}]crito ''Quem como D\[\mnd{D}]eus, \[\mnd{E}]nin\[\mnd{F#}]guém``
      Seja na \[\mnd{A}]Terra, lá \[\mnd{C#}]no \[\mnd{E}]Céu ou no \[\mnd{G}]a\[\mnd{F#}\mnd{D}]lém
    \endrep
  \mnendverse
  \begin{translation}[EN]
...
\beginsong{A São Miguel que Domine}[id={a-sao-miguel-que-domine-otvadx},by={Francisco Cavalcante de Lima},tags={valsa, Mesa Branca},key={Gm},gk={Gm, (F\shrp{}m)--(Gm)}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_asaomiguelquedomine_a]
      ...
      Que \[^\mn{B&}]do|\[^\mn{A}]mine \[^\mn{G}]o |\[\mnc{F#}D]mal \[^\mn{D}]que a|\[\mnc{E&}Cm]qui \[^\mn{D}]e\[^\mn{C}]xis|\[\mnc{D}D]tir |\[\ac<1>{D7}]{} \e \altchords{| - |B |Am |B |\ac<1>{B7}}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_asaomiguelquedomine_b]
      ...
      |\[^\mn{G}]Fa\[^\mn{D}]zer \[^\mn{E&}]o |\[^\mn{D}]bem \[^\mn{C}]e \[^\mn{B&}]sem |\[\mnc{A}D7]o\[^\mn{B&}]lhar \[^\mn{A}]a |\[\mnc{G}Gm]quem |\[\ac<1>{G7}]{} \e \altchords{| - | - |B7 |Em |\ac<1>{E7}}
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{A Estrela Azul}[id={a-estrela-azul-46wrae},by={Baixinha},key={A},gk={A, G--B},tags={2x}]
  ...
  \mnbeginverse[1]
    \beginrep\noteson
      \[\mn{G}]Ela \meter{2}{4}|\[\mnc{B}G]vem \[\mn{D}]cu\meter{4}{4}|\[\mnc{A}Am]rar \[\bm]{} \[\mn{C}]quem a\meter{2}{4}|\[\mn{B}]cre\[\mn{A}]di\meter{4}{4}|\[\mnc{G}G]tar\[\bm]{} \altchords{\meter{2}{4}|G \meter{4}{4}|Am \meter{2}{4}| - \meter{4}{4}|G}
      A Es\meter{2}{4}|\[\mn{B}]tre\[\mn{D}]la A\meter{4}{4}|\[\mnc{A}Am]zul \[\bm]{} \[\mn{C}]em seu \meter{2}{4}|\[\mnc{B}D]trono \[\mn{A}]divi\meter{4}{4}|\[\mnc{G}G]nal \[\bm]{} \up{2}(| \e) \altchords{\meter{2}{4}| - \meter{4}{4}|Am \meter{2}{4}|D \meter{4}{4}|G \ac<2>{| \e}}
    \endrep
  \mnendverse
  \begin{translation}[EN]
...
\beginsong{O Anjo de Deus}[id={o-anjo-de-deus-m85jwl},by={Alfredo},tags={valsa},key={Am},gk={Am, (G\shrp{m})--(Cm)}]
  ...
  \mnbeginverse\memorize[chords_oanjodedeus_a]
    ...
    \beginrep
      \[^\mn{A}]De |\[\mnc{D}Dm]leste a o|este, |\[^\mn{F}]de \[^\mn{D}]nor\[^\mn{F}]te a |\[\mnc{E}Am]sul
      |\[E7]Vi\[^\mn{F}]va a \[^\mn{E}]Es|\[^\mn{D}]tre\[^\mn{C}]la \[^\mn{B}]do a|\[\mnc{A}Am]zul
    \endrep
    \mnendverse\glueverses\mnbeginverse[1]\memorize[chords_oanjodedeus_c]
    \beginrep
      |\[\mnc{D}Dm]Que faz bri|lhar as Es|\[^\mn{F}]tre\[^\mn{D}]las \[^\mn{F}]do |\[\mnc{E}Am]Céu
      |\[E7]Do \[^\mn{F}]ar\[^\mn{E}]can|\[^\mn{D}]jo \[^\mn{C}]Ra\[^\mn{B}]fa|\[\mnc{A}Am]el \up{2}(| \e)
    \endrep
  \mnendverse
  \notesoff
