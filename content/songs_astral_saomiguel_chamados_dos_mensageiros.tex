...
\beginsong{Sou Comando de Maria}[by={Padr. Corrente}, off={Maria Cristina Mota}, key={D}, gk={D, D--E}]
...
\beginsong{Eu Peço a Meu São Miguel}[by={Padr. Valdete}, key={C}, gk={D, C--E}]
...
\beginsong{As Seguranças do Céu \\ Papapapaparuê}[by={Padr. Valdete}, key={G}, gk={G, D\shrp{}--B}, tags={perfilado, à capela}]
...
\beginsong{Viva o Senhor São Miguel \\ Falanges do Céu}[by={Padr. Valdete}, key={C}, gk={D, C--E}, tags={valsa, 2x}]
  \meter{3}{4}
  \mnbeginverse
    \beginrep\memorize
