...
\beginsong{A Chave da Justiça}[id={a-chave-da-justica-r8hv5d},by={Alex Polari},key={C},gk={C, G--B},tags={2x}]
  ...
  \mnbeginverse
    \beginrep\memorize
      |\[<C>C]Ei\[^<G>]a, vem a\[<*>]qui \[^<F>]no |\[<A>F]mei\[^<F>]o, vem a\[<*>]qui \[^<E>]com o |\[<G>G]re\[^<D>]lho \altchords{\id{(B)}|B |E |F\shrp{}}
      Eia eu \[<* F>]vou \[^<E>]che|\[<C>C]gar,\[<*>]{} |viva São Mi\[<* F>]guel \[^<E>]que |\[^<C>]veio \altchords{|B | - | \e}
      Veio a\[<* F>]brir \[^<E>]a |\[<G>G7]ban\[^<D>]ca lá dos \[<*>]O\[^<C>]ri|\[<E>C]xás\[<*>]{} \altchords{|F\shrp{}7 |B}
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay
...
\beginsong{Meu Beija-flor o Sol Raiou}[id={meu-beija-flor-o-sol-raiou-uefku8},by={Alessandra},key={Dm},gk={Dm, Cm--Em}]
  ...
  \mnbeginverse
    ...
    \beginrep\memorize[chords_meu_bf_sol_raiou_b]
      ...
      \[<* D>]Que \[^<E>]à |\[<F>(B&)]Ter\[^<D>]ra i\[<F>A7]rá \[^<E>]vol|\[<D>Dm]tar \[\ac{1}{D7}]{} \altchords{|(A\flt) G7 |Cm \ac{1}{C7}}
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Santo Daime Beija-mim}[id={santo-daime-beija-mim-l2uxyd},by={Marina Ruberti},tags={mazurka, Mesa Branca},key={Dm},gk={Dm, Cm--Em}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_santodaimebm_a]
      \[^<A>]Com a|\[<D>Dm]mor eu re\[^<E>]ce\[<F>(F)]bi \altchords{\id[1]{(Cm)}|Cm (E\flt)}
...
\beginsong{As Seguranças do Céu \\ Papapapaparuê}[id={as-segurancas-do-ceu-7op69r},by={Valdete},key={G},gk={G, D\shrp{}--B},tags={perfilado, à capela}]
...
\sclearpage\chapcornermarkdashedtrue
\beginsong{A São Miguel que Domine}[id={a-sao-miguel-que-domine-otvadx},by={Francisco Cavalcante de Lima},tags={valsa, Mesa Branca},key={Gm},gk={Gm, (F\shrp{}m)--(Gm)}]
...
\beginsong{O Anjo de Deus}[id={o-anjo-de-deus-m85jwl},by={Alfredo},tags={valsa},key={Am},gk={Am, (G\shrp{m})--(Cm)}]
