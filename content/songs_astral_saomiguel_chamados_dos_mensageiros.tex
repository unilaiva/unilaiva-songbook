...
\beginsong{As Seguranças do Céu \\ Papapapaparuê}[by={Padr. Valdete}, key={G}, gk={G, D\shrp{}--B}, tags={perfilado, à capela}]
  ...
  \mnbeginverse
    \beginrep
    \ind[2]\[\bmc\mnd{B}]Pa\[\mnd{D}]pa|\[\mnd{G}]papa\[\bmc\mnd{D}]paru\[\mnd{G}]ê |-\[\bm]{} | \e
    \ind[2]\[\bmc\mnd{B}]Pa\[\mnd{D}]pa|\[\mnd{G}]papa\[\bmc\mnd{D}]paru\[\mnd{G}]á |-\[\bm]{} | \e
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep
    \ind[1]\[\bmc\mnd{B}]Vou \[\mnd{D}]cha|\[\mnd{G}]mar nes\[\bmc\mnd{D}]te ter\[\mnd{G}]r|ei\[\bm]ro
    \ind[1]O|\[\mnd{B}]gum \[\mnd{D}]da \[\bmc\mnd{G}]Mata O|\[\mnd{D}]gum do \[\mnd{G}\bm]Mar | \e
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep
  ...
  \mnbeginverse
    \beginrep
    \ind[1]\[\bmc\mnd{B}]Pa\[\mnd{D}]ra |\[\mnd{G}]isto \[\bmc\mnd{D}]é pre\[\mnd{G}]c|i\[\bm]so
    \ind[1]|\[\mnd{B}]Ser\[\mnd{D}]mos \[\bmc\mnd{G}]solda|\[\mnd{D}]dos fi\[\mnd{G}\bm]éis | \e
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep
...
\beginsong{O Anjo de Deus}[by={Padr. Alfredo}, tags={valsa}, key={Am}, gk={Am, (G\shrp{m})--(Cm)}]
  ...
  \meter{3}{4}
  \mnbeginverse
    \beginrep\memorize[chords_oanjodedeus_a]
    ...
    Com |\[\mnc{D}Bm7&5]{seu san}\[^\mn{B}]to |\[\mnc{G#}E]manto \[^\mn{E}]a|\[\mnc{A}Am]zul \up{1}(| \e)
      \endrep
  \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_oanjodedeus_b]
    ...
    \ind |\[E7]Vi\[^\mn{F}]va a \[^\mn{E}]Es|\[^\mn{D}]tre\[^\mn{C}]la \[^\mn{B}]do a|\[\mnc{A}Am]zul
      \endrep
  \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_oanjodedeus_c]
  ...
  \beginverse\replay[chords_oanjodedeus_a]
    ...
    Com di|^versas amos|^tragens de |^cor \up{1}(| \e)
      \endrep
  \endverse\glueverses\beginverse\replay[chords_oanjodedeus_b]
    \beginrep
    \ind |^{É Deus} em |tudo, é o |fruto, é a |^flor
    \ind |^Vida do |meu Cria|^dor
      \endrep
  \endverse\glueverses\beginverse\replay[chords_oanjodedeus_c]
    \beginrep
