...
\beginsong{A Chave da Justiça}[by={Alex Polari}, key={C}, gk={C, G--B}, tags={2x}]
...
\beginsong{Mensageiro do Anjo Azul}[by={Maria Alice}, key={C}, gk={D, C--D}, tags={mazurka}]
  \meter{6}{4}
  \mnbeginverse
    \beginrep
...
\beginsong{São Miguel}[by={Lúcio Mortimer}, key={C}, gk={D, C--E}]
...
\beginsong{Força do Céu}[by={Dalvina Corrente}, key={C}, gk={D, C--D}]
...
\beginsong{Sou Comando de Maria}[by={Corrente}, off={Maria Cristina Mota}, key={D}, gk={D, D--E}]
...
\beginsong{Mensageiro da Luz}[by={Albertina Corrente}, key={C}, gk={C, C--D}, tags={valsa, Mesa Branca}]
...
\beginsong{Eu Peço a Meu São Miguel}[by={Valdete}, key={C}, gk={D, C--E}]
...
\beginsong{As Seguranças do Céu \\ Papapapaparuê}[by={Valdete}, key={G}, gk={G, D\shrp{}--B}, tags={perfilado, à capela}]
...
\beginsong{Viva o Senhor São Miguel \\ Falanges do Céu}[by={Valdete}, key={C}, gk={D, C--E}, tags={valsa, 2x}]
  \meter{3}{4}
  \mnbeginverse
    \beginrep\memorize
...
\beginsong{Sete Cruzes de São Miguel}[by={Isabel Barsé}, key={Dm}, gk={Cm--Em}, tags={mazurca}]
  ...
  \mnbeginverse
    \beginrep\memorize
    \beginrep \[^\mn{A}]As sete |\[\mnc{D}Dm]cruzes de São \[^\mn{F}]Mi\[\bmc\mn{A}]guel \altchords{\id[1]{(Em)}|Em}
    \[^\mn{G}]Estão a|\[\mnc{F}A7]qui \[^\mn{E}]pra \[^\mn{C#}]te \[^\mn{E}]liber\[\mnc{D}Dm]tar \altchords{|B7 Em} \endrep
    \beginrep \[^\mn{D}]São sete |\[Dm]cruzes, são sete \[\bm]cru\[^\mn{A}]zes \altchords{|Em}
    São sete |\[\mnc{F}A7]cruzes \[^\mn{E}]pra \[^\mn{C#}]te \[^\mn{E}]liber\[\mnc{D}Dm]tar \altchords{|B7 Em} \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    \beginrep
    \beginrep Todos os |^seres que me acom^panham
    Vós |^queiram me respei^tar \endrep
    \beginrep Eu sou o |^chefe desta ^casa
    Estou a|^qui para coman^dar \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    \beginrep Esta |^é a casa de ^Deus
    Esta |^é a casa de ^Deus \endrep
    \beginrep Sou |^Luz, sou ^Luz
    Estou a|^qui pra te liber^tar \endrep
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
    % transcribed by larva, updated on 2022-12
...
\beginsong{Clareia}[by={Paulo Roberto de Souza}, tags={perfilado, à capela}, key={D}, gk={D, C-E}]
...
\sclearpage\chapcornermarkdashedtrue
\beginsong{A São Miguel que Domine}[by={Francisco Cavalcante de Lima}, tags={valsa, Mesa Branca}, key={Gm}, gk={Gm, (F\shrp{}m)--(Gm)}]
...
\beginsong{O Anjo de Deus}[by={Alfredo}, tags={valsa}, key={Am}, gk={Am, (G\shrp{m})--(Cm)}]
