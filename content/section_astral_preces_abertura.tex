...
\beginsong{Sinal da Cruz}[id={sinal-da-cruz-pqo6eo},tags={bailado, São Miguel, Mesa Branca}]
...
\scleardpage
\beginsong{Credo}[id={credo-tc187l},tags={bailado}]
  \begin{passage}[PT]{}
...
\scleardpage
\beginsong{Pai nosso \& Ave Maria}[id={pai-nosso-ave-maria-ix7d1a},tags={3x}]
  \vspace*{6ex}
...
\beginsong{O Terço I (trabalho officiais)}[id={o-terco-i-trabalho-officiais-mnc33z},tags={bailado}]
  \begin{passage}[PT]{}
...
\beginsong{O Terço II (Santa Missa)}[id={o-terco-ii-santa-missa-cmqx22},tags={Santa Missa}]
  \begin{passage}[PT]{}
    \passagenote*{Ao rezar o terço, só diz a cada dezena:}
    Gloria ao Pai, ao Filho, ao Espírito Santo.
    Assim como era no princípio, agora e sempre,
...
\sclearpage
\beginsong{Chave de Harmonia}[id={chave-de-harmonia-jtktcw},by={O Circulo Esoterico da comunhão do Pensamento (São Paulo, Brasil)},tags={trabalhos de mesa}]
  \begin{passage}[PT]{}
...
\scleardpage
\beginsong{Consagração do Aposento}[id={consagracao-do-aposento-6vzmc1},by={O Circulo Esoterico da comunhão do Pensamento (São Paulo, Brasil)}]
  \begin{passage}[PT]{}
