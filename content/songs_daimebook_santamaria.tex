...
\beginsong{Quem Procurar Esta Casa}[by={Mestre Irineu Serra},ph={I},key={Am},sks={Am, Gm}]
  ...
  \mnbeginchorus\memorize
    |\[\mnc{A}Am]Quem pro\[^\mn{B}]cu\[^\mn{C}]rar \[^\mn{B}]es\[^\mn{A}]ta |\[\mnc{F}Dm]ca\[^\mn{D}]sa \altchords{\id{\capo{3}}|Em |Am}
  ...
  \notesoff
  \beginchorus
    Mi|^nha Sempre Virgem Ma|^ria \altchords{\id[2]{AP}|Am C |F Dm}
  ...
  \endchorus
  \beginchorus
    |^Eu peço a vós, bem con|^trito \altchords{\id[3]{O}|Am |Dm}
...
\beginsong{Amor, Verdade e Justiça \\ Vou Receber Minha Mãe}[by={Padr. Alfredo}]
