...
\beginsong{Luz de Jesus \\ O Virgem Mãe}[by={Isabela Coutinho},key={Dm},sks={Dm, Cm, Bm}]
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    ...
    theLyricsOne = \lyricmode {
      \set stanza = "1. "
      Oh! Vir -- gem Mãe
      Eu pe -- ço~à Vós um di -- a;
      A San -- ta Ma -- ri -- a eu sa -- ber a -- mar; __
      E fir -- mar sem -- pre o meu pen -- sa -- men -- to;
      Nes -- te~en -- ten -- di -- men -- to
      pa -- ra~eu  -- po -- der me sal -- var. __
    }
    theChords = \chordmode {
      s4. | d1:m | d2:m e:m7.5-
      | e:m7.5- a | a1
...
\beginsong{São Damião}[by={Madr. Cristina Raulino},key={Dm},sks={Dm, Am}]
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    ...
    theMelody = \relative d'' {
      ...
      \repeat volta 2 {
        r4\pomark a'4 | a f e d | cis2 cis4 d | e d e f | d2
      } \break
      \repeat volta 2 {
        d4 e | f g a bes | g2 g4 f | e f g a | d,2
      }
...
\beginsong{Estrelas Divinas}[by={Madrinho Tetê},key={C},sks={C}]
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    ...
    theMelody = \relative c'' {
      ...
      \repeat volta 2 {
        c8\pomark c e | g g e c a'4 g | e8 c c c a'4 g | e8 c c c d4 e | c2~ c8
      }
      \repeat volta 2 {
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    ...
    theLyricsOne = \lyricmode {
      \repeat volta 4 {
        ...
        Tra -- zen -- do~as | for -- cas da Ra -- | in -- ha da flo -- | res -- ta; __
