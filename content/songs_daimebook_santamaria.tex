...
\beginsong{Quem Procurar Esta Casa}[by={Mestre Irineu Serra},ph={I},key={Am},sks={Am, Gm}]
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    theMelody = \relative a'' {
      ...
      \parenthesize e4 | a4 a8 b8 c4 b8 a8 | f2 d4( d4)
      | a'4 a8 b8 c4 b8 a8 | e2.
      \repeat volta 2 {
        \parenthesize e4\genmark "B" | a,4 a8 b8 c4 b8 a8 | \slurSolid d4.( f8) a2
        \slurDashed
...
\beginsong{Santa Maria \\ Conhece Santa Maria}[by={Padr. Alfredo},key={C},sks={D, C}]
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    theMelody = \transpose d c \relative d'' {
      ...
      \set melismaBusyProperties = #'() \slurDashed
      \repeat volta 2 {
        \parenthesize a8 a8( a8) | d4. d8 d4 d8 fis8 | a2 a4 fis8 fis8
        | g4. g8 d8 d8 d8 d8
      } \alternative {
        { | fis2( fis8) }
        { | fis2( fis4) }
      ...
      \repeat volta 2 {
        \parenthesize d8(\genmark "B" \parenthesize d8) | e4. e8 b4 d8 d8 | fis2 fis4 d8 d8
...
\beginsong{Amor, Verdade e Justiça \\ Vou Receber Minha Mãe}[by={Padr. Alfredo},key={C},sks={C}]
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    theMelody = \relative c''' {
      ...
      \repeat volta 2 {
        g8\genmark "B" e | c c b a d4 g8 e | c a c c c4
      }
    }
    theLyricsOne = \lyricmode {
      \set stanza = "1."
...
\beginsong{Santa Maria \\ Louvada Seja}[by={Paulo Roberto},key={Am},sks={Am, Gm}]
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    theMelody = \relative e'' {
      \key a \minor \time 4/4 \partial 4.
      \repeat volta 2 {
        \parenthesize e8 e8 e8 | a8 a8 a8 e8 c'8 c8 c8 b8 | a8 a8 a8 e8 g8 g8 g8 f8
        | e8 e8 e8 c8 d8 d8 d8 c8 | e2~ e8
      }
      \repeat volta 2 {
        \parenthesize d8\genmark "B" d8 d8 | d4 d8 d8 d8 d8 d8 e8 | c8. c16 c8 c8 c8 c8 c8 e8
      } \alternative {
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    theMelody = \transpose g a \relative g' {
      ...
      \partial 4 \repeat volta 2 {
        fis8\genmark "B" g | a4 a8 c,8 c4 e | d8 d d b g4 e
        | c'8 c c a fis4 d | g2.
      }
    }
    theLyricsOne = \lyricmode {
...
\beginsong{Santa Maria \\ Declaração}[by={Sonia Maria Palhares},tags={2x},key={D},sks={D}]
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    theMelody = \relative d'' {
      ...
      \repeat volta 2 {
        a8 | d4 d8 a d4 \parenthesize d8 a | d4 d8 e cis4 e8 e
...
\beginsong{Luz de Jesus \\ O Virgem Mãe}[by={Isabela Coutinho},key={Dm},sks={Dm, Cm, Bm}]
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    theMelody = \relative a' {
      ...
      \repeat volta 2 {
        a8 d e | f e d e f4 a8 bes~ | bes a g f e8( e8) a8 << \parenthesize a bes( >>
...
\beginsong{São Damião}[by={Madr. Cristina Raulino},key={Dm},sks={Dm, Am}]
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    theMelody = \relative d'' {
      ...
      \repeat volta 2 {
        d4\genmark "1." d8 f | a4 a g a | d,2 a'4 a | g f e a | d,2
      } \break
      \repeat volta 2 {
        d4 e | f g a bes | g2 g4 f | e f g a | d,2
      } \break
      \repeat volta 2 {
        r4\genmark "2." a' | a d, e f | g4. g8 g4 f | e f g a | d,2
      } \break
      \repeat volta 2 {
        r4 a' | d, e f g | e2 e4 d | cis d e f | d2
      } \break
      \repeat volta 2 {
        r4\genmark "3." a'4\pomark | a f e d | cis2 cis4 d | e d e f | d2
      } \break
      \repeat volta 2 {
        d4 e | f g a bes | g2 g4 f | e f g a | d,2
      }
    ...
    \layout { #(layout-set-staff-size 16) } % to fit on one spread
    \include "tex/lp-include-tail.ly"
  \end{lilypond}\end{lilywrap}
  \translationoff
  \begin{translation}
...
\beginsong{Estrelas Divinas}[by={Madrinho Tetê},key={C},sks={C}]
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    ...
    theMelody = \relative c'' {
      \key c \major \time 4/4 \partial 4.
      \repeat volta 2 {
        c8\genmark "1." c e | g g e c a'4 g | e4 c8 c a'4 g | e4. c8 d4 e | c2 c8
      }
      \repeat volta 2 {
        c8 b c | d4 d8 c a4 e'4 | c8 c c b a4 e' | d8 d d c a4 e'4 | c2 c8 
      } \break
      \repeat volta 2 {
        r8\genmark "2." c e | g4. e8 c4 a'4 | g2 e4 g | e8 e e d c4 f | e2~ e8
      }
      \repeat volta 2 {
        r8 b c | d4. c8 a4 e' | c8 c c b a4 e'4 | d d8 c a4 e'4 | c2~ c8
      } \break
      \repeat volta 2 {
        c8\genmark "3." c\pomark e | g g e c a'4 g | e8 c c c a'4 g | e8 c c c d4 e | c2~ c8
      }
      \repeat volta 2 {
...
\beginsong{São Irineu}[by={Solon Brito},tags={2x},key={C},sks={C, A}]
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    ...
    theMelody = \relative c''' {
      ...
      \repeat volta 2 {
        g'8\genmark "B" g | g4 g8 g8 c2 | c2.~ c8
        g8 | g4 e8 c g'2~ | g2.
        g8 g | g g e d c2~ | c2.
        g'8 g | g g e d c2~ | c2.
      }
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    theMelody = \relative e' {
      ...
      \mark \markup {"4x"} \bar ".|:" \repeat volta 4 {
        e8\genmark "1. & 2." e8 e8 | e'4. e8 e8 e8 | d8.( d16 d8) e8 f8 e8  | c4 a2~ | a4. e'8 e8 e8 | a4. g8 g8 g8 | g4. f8 e8 f8 | e4( d2)~ | d4. d8 d8 e8
        | f4.( f8) f8( f8) | f4. f8 a8 a8 | a4 e2~ | e4. d8 d8 c8
        | b4.( b8 b8 b8) | b4. b8 c8 b8 | b4( a2)~ | a4.
      } \break
      \repeat volta 2 {
        e'8\genmark "3." a8 g8 | f8 f8 f8 e8 d8 c8 | b4 b8 d8 g8 f8 | e8 e8 e8 d8 c8 b8 | a4 a8 e'8 f8 e8
    ...
    theLyricsOne = \lyricmode {
      \repeat volta 4 {
        ...
        Tra -- zen -- do~as | for -- cas da Ra -- | in -- ha da flo -- | res -- ta; __ _
