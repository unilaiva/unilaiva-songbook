...
\beginsong{Juurilaulu \\ Kuulumme piiriin}[tags={piiri 1}]
  \begin{lilypond}[fragment] % present melody using lilypond
    {\key a \minor \time 4/4
...
\beginsong{Sadelaulu}[by={Sanna Kurki-Suonio},tags={vesi 1}]
  ...
  \beginverse
    |\[Dm]Sade syöksyy|\[F]vi sy\[Am7]lihin |\[Dm]pisaraiset |\[F]paian \[Am7]päälle |
    |\[Dm]Vesi vihmo|\[F]en ve\[Am7]tävi |\[Dm]kaiken alleen |\[F]kaste\[Am7]levi |
    |\[Dm]Minä vain sa|\[F]teessa \[Am7]seison |\[Dm]satehessa |\[F]suloi\[Am7]sessa |
  \endverse
  \beginverse
    |^Oi kaalinna... |^ ^ |^ |^ ^ |
  \endverse
  ...
  \endverse
  \beginverse
    \chorusindent |\[Am]Aaa... |\[E] |\[Am] |\[E] | \rep{2}
  \endverse
  \beginverse
