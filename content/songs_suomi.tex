...
\beginsong{Juurilaulu \\ Kuulumme piiriin}[id={juurilaulu-wjgvhj},tags={piiri},ph={I, V},key={Am},gk={Bm, Am--G#m}]
  \mnbeginverse
    \beginrep
...
\beginsong{Lampaanpolska \\ Kekrilaulu \\ Yksi kaksi kolme neljä}[id={lampaanpolska-bq3p97},ph={III},key={Am},gk={Am, G#m--Em}]
  \meter{3}{4}
  \beginverse
...
\beginsong{Taivas on sininen ja valkoinen}[id={taivas-on-sininen-ja-valkoinen-np1mkf},by={trad.},ph={II},key={Am},gk={Am, G#m--Am}]
  \meter{4}{4}
...
\beginsong{On suuri sun rantas' autius}[id={on-suuri-sun-rantas-autius-p26yly},by={trad.},key={Dm},gk={Em, Dm--F#m}]
...
\beginsong{Yksin kuljen autiolla tiellä}[id={yksin-kuljen-autiolla-tiella-ucnxop},by={trad., Russian},key={Em},gk={Gm, Gm--Am}]
  ...
  \mnbeginverse
    ...
    \[^<B>]Yö \[^<G>]on |\[<F#>B7]vai\[^<B>]ti. \[<* F#>]Hil\[^<B>]jai\[^<F#>]si\[^<G>]na |\[<E>C]si\[<D C>D7]el\[<B>G]lä \altchords{|D7 |E& F7 B& Cm6}
...
\beginsong{Tuonne taakse metsämaan}[id={tuonne-taakse-metsamaan-gkwb09},by={trad. (2nd verse: Reinhold Roine)},key={Am},gk={Am, G#m--Bm},tags={you}]
  \mnbeginverse
...
\beginsong{Yksi ruusu on kasvanut laaksossa}[id={yksi-ruusu-on-kasvanut-laaksossa-da05ur},by={trad. (lyr. Kaarle Krohn)},key={Dm},gk={C#m, Cm--C#m}]
  \newchords{chords_yksiruusu_a}\newchords{chords_yksiruusu_b}
  \mnbeginverse\memorize[chords_yksiruusu_a]
    \[^<A>]Yksi |\[<F>Dm]ruusu \[^<E>]on \[<D>Gm]kas\[^<E>]va\[^<F>]nut |\[<D>Dm]laak\[^<A>]sos\[<*>]sa \altchords{\id[1]{(C#m)}|C#m F#m |C#m}
    \[^<A>]ja se |\[F]kau\[^<C>]niisti \[<G>C7]ku\[^<B&>]kois|\[<A>F]taa. \[A7] \altchords{|E B7 |E G#7}
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_yksiruusu_b]
      \[^<A>]Yksi |\[\ac{1}{Dm} \ac{2}{F}]kulkija\[<C B&>C]poi\[^<G>]ka \[^<B&>]on |\[<A>F]näh\[^<D>]nyt \[B&]sen \altchords{|\ac{1}{C#m} \ac{2}{E} B |E A}
      \[^<A>]eikä |\[<G>Gm]voi \[^<F>]si\[^<E>]tä \[<A>A7]un\[^<C#>]hoit|\[<D>Dm]taa. \[<*>] \altchords{|F#m G#7 |C#m}
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_yksiruusu_a]
    Ja sen |^olisi ^kyllä hän |^poimi^nut \altchords{\id[2]{(Bm)}|Bm Em |Bm}
    ja sen |^painanut ^povel|^leen, ^ \altchords{|D A7 |D F#7}
    \endverse\glueverses\beginverse\replay[chords_yksiruusu_b]
    \beginrep
      mutta |^köyhänä ^ei ole |^tohti^nut, \altchords{|Bm \ac{2}{D} A |D G}
      vaan on |^jättänyt ^paikoil|^leen. ^ \altchords{|Em F#7 |Bm}
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[]
...
\beginsong{Lemminkäisen äiti}[id={lemminkaisen-aiti-qpdubw},index={Tuima on tuuli},by={Oskar Merikanto, Eino Leino},key={Am},gk={Cm, Cm--Em}]
  ...
  \mnbeginverse
    ...
    |\[<A>Am]suuri \[^<C>]on \[<D>G]ula\[^<B>]pal\[^<D>]la |\[<E>E]aalto\[^<D>]jen \[<E>E7]rai\[^<D>]vo, \altchords{|Cm B& |G G7}
    |\[<C>C]lahti on \[<B>G]tyy\[^<G>]ni \[^<B>]ja |\[<A>Am]selkeä \[<* E>]vaan. \altchords{|E& B& |Cm}
    |\[<E>C]Kus\[^<C>]sa mun \[<B>E7]kot\[^<E>]ka\[^<G#>]ni |\[<A>Am]kulkee\[<*>]kaan? \altchords{|E& G7 |Cm}
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Talven valtakunta}[id={talven-valtakunta-1wf63f},index={Äsken aalto heitti vain kuohun valkoisen},by={trad.},key={Am},gk={Am, Am--Bm}]
  ...
  \beginverse
    ...
    Talven |^valtakunta |^on niin valkoi|^nen | \e \altchords{|B& |Dm |Gm | \e}
  \endverse
  \begin{lilywrap}\begin{lilypond}[]
    % transcribed by larva, latest update on 2023-10
    \include "ulsbs-include-head.ly"
...
\beginsong{Sadelaulu}[id={sadelaulu-zdxb91},by={Sanna Kurki-Suonio},tags={vesi},ph={II},key={\~Am},gk={\~Cm, \~Gm--\~C#m}]
...
\beginsong{Varpunen jouluaamuna}[id={varpunen-jouluaamuna-p4e4tl},by={Otto Kotilainen, Z. Topelius},key={Am},gk={Am, Gm--Bm}]
  ...
  \notesoff
  \beginverse
    |^Pienen pirtin |^portailla |^{oli tyttö}|^kulta: \altchords{\id[1]{(Bm)}|Bm |Em |Bm |F#m}
    |^tule, varpu, |^riemulla |^ota siemen |^multa! \altchords{|Bm |Em |A |D}
    |^Joulu on, |^koditon |^varpuseni |^onneton, \altchords{|Bm |F#m |D |C#7}
    |^tule tänne, |^riemulla |^ota siemen |^multa! \altchords{|Bm |F#7 |Em |Bm}
  \endverse
  \beginverse
...
\beginsong{Kosketa minua henki}[id={kosketa-minua-henki-wai9fz},by={Ilkka Kuusisto 1979},ex={Virsi 125},ph={III},key={G},gk={G, E&--G}]
  ...
  \ifchorded\ifshowaltchords
    \beginverse\small % for alt key (F) chords only
      \altchords{\id[1]{(F)}|F |Am |Dm | - |Gm7 |Am |B& |D7/A}
...
\beginsong{Pieni tytön tylleröinen}[id={pieni-tyton-tylleroinen-eiwdpt},tags={uni},key={Dm},gk={Dm, Cm--D#m}]
...
\beginsong{Tuuditan tulisoroista}[id={tuuditan-tulisoroista-dr2w3b},by={trad.},key={Am},gk={Am, Gm--Bm},tags={uni}]
  \audio[key=B&m]{https://www.youtube.com/watch?v=mpHEc8SjfZc}
...
\beginsong{Tuuin yössä muukalaista}[id={tuuin-yossa-muukalaista-7uznww},by={Neilikka},tags={uni},key={Bm},gk={Cm, Cm--D#m}]
...
\beginsong{Nyt on laulut laulettu}[id={nyt-on-laulut-laulettu-t2wggj},by={trad.},ex={based on a Hungarian folk song},ph={V},key={Am},gk={Am, Gm--D#m}]
...
\beginsong{Ystävän laulu}[id={ystavan-laulu-dei717},by={Vladimir Vysotski},key={Am},gk={Am, G#m--(Am)}]
