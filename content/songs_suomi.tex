...
\beginsong{Juurilaulu \\ Kuulumme piiriin}[tags={piiri 1, (chords missing) 1},ph={I, V}]
  \begin{lilypond}[fragment] % present melody using lilypond
    {\key a \minor \time 4/4
...
\beginsong{Lampaanpolska \\ Kekrilaulu \\ Yksi kaksi kolme neljä}[ph={III}]
  ...
  \begin{center}%
    \vfill%
    % Downloaded from: https://www.maxpixel.net/Musical-Instruments-Drum-Music-Jazz-Cat-1287910
    % 0.618^2 ~ 0.382 (Golden Ratio)
    \includegraphics[width=0.382\textwidth]{cat_drumming_bw_transparent_bg_CC0_1264x1788px.png}
    \vfill%
  \end{center}
\endsong
...
\beginsong{Sadelaulu}[by={Sanna Kurki-Suonio},tags={vesi 1},ph={II}]
  ...
  \begin{center}%
    \vfill%
    % Downloaded from: https://imgbin.com/png/psfPETyB/water-png
    % License: Free for non-commercial use
    % 0.618^4 ~ 0.146 (Golden Ratio)
    \includegraphics[width=0.146\textwidth]{water_bw_transparent_bg_254x784px.png}
    \vfill%
  \end{center}
\endsong
...
\beginsong{Äidin laulu}[index={Laulan sinulle lapsoseni},by={Marika Salo},tags={Äiti Maa 1},ph={III}]
  \meter{4}{4}
  \beginverse
...
\beginsong{Tuuin yössä muukalaista}[by={Neilikka},tags={uni 1}]
...
\beginsong{Leppäkerttu}[by={Kansanlaulu},tags={uni 1},ph={V}]
  ...
  \endverse
  \vfill%
  % 0.618^5 ~ 0.090 (Golden Ratio)
  \hfill\includegraphics[width=0.090\textwidth]{leppakerttu_transparent_bg_353x279px.png}
  \begin{lilypond}[fragment] % present melody using lilypond
    {\key d \minor \time 4/4
...
\beginsong{En etsi valtaa loistoa}[by={Jean Sibelius, Sakari Topelius}]
  \meter{4}{4}
  \beginverse
    \[^\noteU{F#}]En |\[D]etsi \[^\noteU{G}]val\[^\noteU{F#}]taa, |\[Em]loisto\[A7]a, en |\[D]kaipaa \[A7]kul\[D]taa|\[A]kaan,
...
\begin{intersong}
  \begin{center}%
    \vfill%
    % Original downloaded from: https://commons.wikimedia.org/wiki/File:Harmonic_series_to_32.png
    % License: Public Domain
    % Edited by: larva
    \includegraphics[width=1\textwidth]{harmonic_series_to_32_PD__1641x1299px.png}
    \vfill%
    % Harmonic series (sum):
