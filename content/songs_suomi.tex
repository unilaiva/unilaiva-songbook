...
\beginsong{Kalevala-sävelmä}[key={Am}, sks={Dm, Gm--Em}]
...
\beginsong{Juurilaulu \\ Kuulumme piiriin}[tags={piiri}, ph={I, V}, key={Am}, sks={Bm, Am--G\shrp{}m}]
  % Present the melody on a staff using Lilypond
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
...
\beginsong{Lampaanpolska \\ Kekrilaulu \\ Yksi kaksi kolme neljä}[ph={III}, key={Am}, sks={Am, G\shrp{}m--Em}]
  \meter{3}{4}
  \beginverse
...
\beginsong{Taivas on sininen ja valkoinen}[by={Kansanlaulu}, ph={II}, key={Am}, sks={Am, G\shrp{}m--Am}]
  \meter{4}{4}
...
\beginsong{Päivänsäde ja menninkäinen}[by={Reino Helismaa},ph={IV},key={C},sks={C, (B)--(C)}]
  \beginverse
...
\beginsong{Täss' on nainen}[by={Hedningarna},ph={II},key={Am},sks={Am, Am--Em}]
...
\beginsong{Sadelaulu}[by={Sanna Kurki-Suonio},tags={vesi},ph={II},key={\~Dm}, sks={\~Dm, \~Gm--\~Dm}]
...
\beginsong{Sisältäni portin löysin}[by={Pekka Streng},ph={III, IV},key={D},sks={D, C--D}]
...
\beginsong{Siunattu voima}[by={Lotta Maija}, ph={III}, key={Am}, sks={Am, Am--Em}]
...
\beginsong{Nyt on laulut laulettu}[ex={based on a Hungarian folk song},ph={V},key={Am}]
...
\beginsong{Pieni tytön tylleröinen}[tags={uni},key={Dm},sks={Dm, Cm--D\shrp{}m}]
...
\beginsong{Tuuin yössä muukalaista}[by={Neilikka},tags={uni},key={Dm},sks={Cm, Cm--D\shrp{}m}]
...
\beginsong{Kosketa minua henki}[by={Ilkka Kuusisto 1979},ex={Virsi 125},ph={III},key={G},sks={G, E\flt{}--G}]
...
\beginsong{Rakastan sinua elämä}[by={Eduard Komanovski, Konstantin Vanshenkin}, key={Am}, sks={Am, (Am)--(Cm)}]
