...
\beginsong{Leppäkerttu}[by={Kansanlaulu}]
  \meter{2}{4}
  \beginverse
    |\[Dm]Lennä, \[A]lennä |\[Gm]lep\[Dm]pä\[A7]kert\[Dm]tu,|
    |\[Dm]ison \[Gm]kiven |\[A7]juu\[Dm]reen.|
    |\[Dm]Lennä \[A]leikki|\[Gm]ke\[Dm]don \[A7]kaut\[Dm]ta|
    |\[Dm]uni\[Gm]puuhun   |\[A7]suu\[Dm]reen.|
  \endverse
  \beginverse
    |^Kulta-^kulta|^leh^den ^al^la|
    |^äiti ^puuron |^keit^tää.|
    |^Uni^tuutu |^lep^pä^ker^tun|
    |^lämpi^mästi|^peit^tää.|
  \endverse
  \beginverse  
    |^Laula, ^laula,|^u^ni^lin^tu,|
    |^tuoksu, ^tuomen|^tert^tu.|
    |^Nuku, ^puna|^pai^tu^lai^nen,|
    |^pikku ^leppä|^kert^tu.|
  \endverse 
\endsong
