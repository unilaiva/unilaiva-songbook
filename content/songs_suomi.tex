...
\beginsong{Kalevalainen vieraan tervehdys}[id={kalevalainen-vieraan-tervehdys-3wtfyc},index={Kamanat kohottukohot},by={Ilmari Hannikainen},ex={Kalevala 21: 137--144},ph={I},key={C},gk={D, C--D}]
  \meter{2}{4}
  \mnbeginverse
    |\[\mnc{G}C]Kama|\[^\mn{C}]nat \[^\mn{D}]ko|\[^\mn{E}]hot\[^\mn{G}]tu|\[\mnc{D}G]ko|hot, |\[\mnc{F}F]lakin |\[\mnc{E}C]pääs\[^\mn{C}]tä |\[\mnc{D}G]las\[^\mn{E}]ke|\[\mnc{C}C]mat|ta,
    |\[^\mn{G}]kynnyk|\[^\mn{C}]set \[^\mn{D}]a|\[^\mn{E}]len\[^\mn{C}]tu|\[\mnc{D}G]ko|hot, |\[\mnc{F}F]kengän |\[\mnc{E}C]kan\[^\mn{C}]nan |\[\mnc{D}G]kos\[^\mn{E}]ke|\[\mnc{C}C]mat|ta,
    |\[\mnc{A}F]pihti|puolet |\[^\mn{F}\mn{G}]vält\[^\mn{A}]ty|\[\mnc{G}G]kö|höt, |\[\mnc{F}F]ovet |\[\mnc{E}C]il\[^\mn{C}]man |\[^\mn{E}]au\[^\mn{G}]et|\[\mnc{D}G]ko|hot
    |\[\mnc{C}C]vieraan |\[\mnc{D}G]tulles|\[\mnc{E}C]sa \[^\mn{G}]tu|\[\mnc{D}Dm]pa|\[^\mn{E}\mn{F}]han, |\[\mnc{G}G]as\[^\mn{A}]tu|\[^\mn{G}]es\[^\mn{E}]sa |\[\mnc{D}G7]ai\[^\mn{E}]mo |\[\mnc{C}C]mie|hen!
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Yksi ruusu on kasvanut laaksossa}[id={yksi-ruusu-on-kasvanut-laaksossa-da05ur},by={trad. (lyr. Kaarle Krohn)},key={Dm},gk={C\shrp{}m, Cm--C\shrp{}m}]
  ...
  \mnbeginverse\memorize[chords_yksiruusu_a]
    ...
    \beginrep\memorize[chords_yksiruusu_b]
      \[^\mn{A}]Yksi |\[\ac<1>{Dm} \ac<2>{F}]kulkija\[\mncii{C}{B&}C]poi\[^\mn{G}]ka \[^\mn{B&}]on |\[\mnc{A}F]näh\[^\mn{D}]nyt \[B&]sen \altchords{|\ac<1>{C\shrp{}m} \ac<2>{E} B |E A}
...
\beginsong{Talven valtakunta}[id={talven-valtakunta-1wf63f},index={Äsken aalto heitti vain kuohun valkoisen},by={trad.},key={Am},gk={Am, Am--Bm}]
  ...
  \mnbeginverse\memorize
    \ilsl{\[^\mn{E}]Äs}\[^\mn{D}]ken |\[\mnc{C}Am]aal\[^\mn{E}]to |\[\mnc{B}Em]heit\[^\mn{E}]ti vain |\[\mnc{A}Am]kuohun \[^\mn{C}]valkoi|\[^\mn{E}]sen \altchords{\id[1]{(Em)}|Em |Bm |Em | \e}
...
\beginsong{Maailma on kaunis}[id={maailma-on-kaunis-5xa42c},by={Kalervo Halonen, Vexi Salmi},key={Am},gk={Am, (Am)--(Cm)},ph={III}]
  ...
  \mnbeginverse[1]
    |\[\mnc{A}Am]Maail\[\mn{C}]ma \[\mn{E}]on \[\mnc{G}F9]kau\[\mn{F}]nis \[\mn{C}]ja |\[\mnc{B}E7]hy\[\mn{C}]vä \[\mn{D}]e\[\mn{F}]lää \[\mnc{E}Am]sil\[\mn{C}]le,
    |\[\mn{A}]jol\[\mn{C}]la \[\mn{E}]on \[\mnc{G}Dm7]ai\[\mn{F}]kaa \[\mn{C}]ja |\[\mnc{B}G7]tilaa \[\mn{C}]u\[\mn{D}]nel\[\mnc{E}C]mille
    ja |\[Dm6]mie\[\mn{D}]len \[\mn{A}]va\[\mn{B}]pa\[\mnc{C}Am/E]us \[\mn{E}]ja \meter{2}{4}|\[\mnc{C}E7]mie\[\mn{B}]len \[\mn{D}]va\[\mn{C}]pa\meter{4}{4}|\[\mnc{A}Am]us. \[\bm]{} | { } \[\bm]{} \e
  \mnendverse
...
\beginsong{Täss' on nainen}[id={tass-on-nainen-87ldp2},by={Hedningarna},ph={II},key={Am},gk={Am, Am--Em}]
  ...
  \mnbeginverse
    \beginrep\memorize
      \beginrep \[^\mn{A}]Täss' \[^\mn{G}]on |\[\mnc{A}Am]nainen tuu\[^\mn{G}]len |\[^\mn{A}]tuoma
      \[\mnc{B&}Amadd9-]Tuulen |\[\mnc{C}C]tuoma \[\mnc{B&}C7]ve'en \[^\mn{C}]ve|\[\mnc{A}Am]tämä \endrep
      \beginrep \[^\mn{E}]Me\[^\mn{D}]ren |\[\mncii{E}{D}Am/E]aal\[^\mn{E}]to\[\mnc{D}(B&)]jen \[^\mn{E}]a|\[\mnc{A}Am]jama
      \[\mnc{B&}Amadd9-]Meren |\[\mnc{C}C]tyrskyn \[\mnc{B&}C7]työn\[^\mn{C}]te|\[\mnc{A}Am]lemä \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay
...
\beginsong{Sadelaulu}[id={sadelaulu-zdxb91},by={Sanna Kurki-Suonio},tags={vesi},ph={II},key={\~Am},gk={\~Cm, \~Gm--\~C\shrp{}m}]
  ...
  \beginverse[1]
    \beginrep\noteson
      |\[\mnc{A}Am]Aaa-\[\mn{B}]aa |\[\mnc{G#}E]Aaa-\[\mn{E}]aa |\[\mnc{A}Am]Aaa-\[\mn{G}]aa-\[\mn{A}]aa-\[\mn{B}]aa |\[\mncii{C}{B}E]Aai-\[\mn{A}\mn{B}]aai-\[\mn{G#}]aaa-\[\mn{E}]aaa
    \endrep
  \endverse
  \beginverse
...
\beginsong{Sisältäni portin löysin}[id={sisaltani-portin-loysin-n0gjs6},by={Pekka Streng},ph={III, IV},key={C},gk={D, C--D}]
  ...
  \noteson
  \beginverse[1]
    |\[\mnc{A}A]Aaa\ldots |\[\mn{E}] |\[\mnc{F#}D]{} |\[\mn{D}] \[\mn{A}] |\[\mnc{C#}A] | |\[D]\[\mn{D}] |\[\mn{F#}] \[\mn{A}]
    |\[A]Aaa\ldots | |\[D]{} | |\[A] | |\[D]{} | \e
  \endverse
  \notesoff
  \beginverse
...
\beginsong{Nouse luontoni lovesta}[id={nouse-luontoni-lovesta-yb7xo5},by={Antti Tuonela},ph={I}]
  ...
  \beginverse[1]
    \beginrep
      |\[\mnc{G}E&]Tuekseni turvakseni |väekseni \[\mn{F}]voi\[\mn{E&}]makse|\[\mnc{D}Dm]ni | \e
...
\beginsong{Varpunen jouluaamuna}[id={varpunen-jouluaamuna-p4e4tl},by={Otto Kotilainen, Z. Topelius},key={Am},gk={Am, Gm--Bm}]
  \meter{3}{4}
  \mnbeginverse
    |\[\mnc{A}Am]Lumi \[^\mn{B}]on \[^\mn{C}]jo |\[\mnc{D}Dm]peit\[^\mn{C}]tä\[^\mn{B}]nyt |\[\mnc{C}Am]ku\[^\mn{D}]kat \[^\mn{E}]laak\[^\mn{D}]so|\[\mnc{E}Em]sessa,
...
\beginsong{Tuuditan tulisoroista}[id={tuuditan-tulisoroista-dr2w3b},by={trad.},key={Am},gk={Am, Gm--Bm},tags={uni}]
  ...
  \mnbeginverse\memorize[chords_tulisoroinen_a]
    ...
    \endrep
  \mnendverse
  \usealtmnstyletrue% use alternate melody note color
  \beginverse% notes (\mn) in this verse signify the 2nd voice
...
\beginsong{Ystävän laulu}[id={ystavan-laulu-dei717},by={Vladimir Vysotski},key={Am},gk={Am, G\shrp{}m--(Am)}]
  ...
  \mnbeginverse\memorize[chords_ystava_a]
    \[^\mn{A}]Mis\[^\mn{B}]tä |\[\mnc{C}Am]tun\[^\mn{B}]net \[^\mn{A}]sä |{ } ys\[^\mn{G#}]tä|\[\mnc{B}E]vän |\[E7] \e
    \[^\mn{D}]Onko |oi\[^\mn{C}]ke\[^\mnc{B}]a |{ } sul\[^\mn{A}]le |\[\mnc{C}Am]hän |\[A7] \e
    \[^\mn{G}]Anna |me\[^\mn{F}]ren \[^\mn{E}]se |sel\[^\mn{D}]vit|\[\mnc{F}Dm]tää | \e
    Kuka |vie\[^\mn{E}]ree\[^\mn{F}]si |\[\mnc{G}{G7}]jää |\[E] | \e
  \mnendverse\glueverses
  \mnbeginverse[2]\memorize[chords_ystava_b]
    \[^\mn{A}]Ja \[^\mn{B}]jos |\[\mnc{C}Am]sil\[^\mn{B}]loin \[^\mn{A}]kun |\[\mnc{F}Dm]myrs\[^\mn{D}]ky |\[^\mn{F}]soi | \e
    \[^\mn{A}]Vain \[^\mn{B}]sun |\[\mnc{C}Dm7]kump\[^\mn{B}]pa\[^\mn{A}]nis |\[\mnc{E}Am]vai\[^\mn{C}]ke|\[^\mn{E}]roi | \e
    Ve\[^\mn{F}]ne |\[\mnc{G}Am7]lä\[^\mn{F}]him\[^\mn{E}]pään |\[\mnc{D}E7]ran\[^\mn{B}]taan |\[^\mn{D}]vie |\[G7] \e
    \[^\mn{G}]Jää\[^\mn{F}]köön |\[\mnc{E}E7]pois { } \[^\mn{G#}]mikä |\[\mnc{A}Am]lie | | \e
  \mnendverse
  ...
  \vspace{1ex}
  \beginverse[2]
    \[\mn{\pomarkr{}A}]Sii\[\mn{B}]tä |\[\mnc{C}Am]tun\[\mn{B}]net \[\mn{A}]sä |\[\mnc{F}Dm]ys\[\mn{D}]tä|\[\mn{F}]vän | \e
    \[\mn{A}]Kun \[\mn{B}]on |\[\mnc{C}Dm7]vie\[\mn{B}]rel\[\mn{A}]läs |\[\mnc{E}Am]vie\[\mn{C}]lä |\[\mn{E}]hän | \e
    Tur\[\mn{F}]hat |\[\mnc{G}Am7]tut\[\mn{F}]ta\[\mn{E}]vat |\[\mnc{D}E7]sil\[\mn{B}]loin |\[\mn{D}]ois |\[G7] \e
    \[\mn{G}]Hä\[\mn{F}]vin|\[\mnc{E}E7]neet { } \[\mn{G#}]pian |\[\mnc{A}Am]pois | | | \e
  \endverse
  \showlilypondfalse % to save space
  \begin{lilywrap}\begin{lilypond}[]
