...
\beginsong{Juurilaulu \\ Kuulumme piiriin}[tags={piiri, (chords missing)},ph={I, V}]
  ...
  \begin{lilywrap}\begin{lilypond}[fragment, staffsize=18]
    {\key a \minor \time 4/4
      ...
      c''8 b'8~ b'8 g'8 g'4 a'4~ | a'2 r2 \bar "|."
    }\addlyrics {
      Kuu -- lum -- me pii -- riin
      Kuu -- lum -- me pii -- riin
      Ai -- ko -- jen ta -- kaa
...
\beginsong{Siunattu voima}[by={Lotta Maija},ph={III}]
  ...
  \mnbeginverse
    |\[\mncii{A}{B}Am]Illan \[^\mn{A}]suus\[^\mn{G}]sa |\[^\mn{A}]va\[^\mn{B}]lon \[^\mn{A}]voi\[^\mn{G}]ma, |\emph{\[^\mn{A}\mn{B}\mn{C}]siunat\[^\mn{D}]tu |\[^\mn{E}]voima}
    |\[\mnc{D}G]Las\[^\mn{C}]ku \[^\mn{B}]au\[^\mn{A}]rin|\[^\mn{G}]koi\[^\mn{A}]sen \[^\mn{B}\mn{G}]illan, |\emph{\[\mnciii{A}{B}{A}\emph{Am}]siunat\[^\mn{G}]tu |\[^\mn{A}]voima}
