...
\beginsong{Talven valtakunta}[index={Äsken aalto heitti vain kuohun valkoisen},by={trad.}, key={Am}, gk={Am, Am--Bm}]
  ...
  \beginverse
    ...
    Tuolta |^taiva|iltaan katsoo |^suuri |puu
    Honka |^latvas|saan taivaan |^kaarta |kantaa | \e
    Hangel|^le se antaa |^tähtihohdet|^taan | \e
  \endverse
  \beginverse
  ...
  \begin{lilywrap}\begin{lilypond}[]
    ...
    theLyricsTwo = \lyricmode {
      ...
      Tuol -- ta | tai -- va _ -- | il -- taan kat -- soo | suu -- ri | puu;
      Hon -- ka | lat -- vas _ -- | saan tai -- vaan | kaar -- ta | kan -- taa; | _
      Han -- gel -- | le se an -- taa | täh -- ti -- hoh -- det -- | taan. | _
    }
    theLyricsThree = \lyricmode {
      \set stanza = "3."
