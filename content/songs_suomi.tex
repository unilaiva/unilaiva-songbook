...
\beginsong{Lampaanpolska \\ Kekrilaulu \\ Yksi kaksi kolme neljä}[ph={III}]
  ...
  \begin{center}%
    ...
    \includegraphics[width=0.382\textwidth]{cat_drumming_bw_transparent_bg_CC0__1440px.png}
    \vfill%
  \end{center}
\endsong
...
\beginsong{Finlandia-hymni}[by={Jean Sibelius, Veikko Koskenniemi}]
  ...
  \beginverse
    ...
    |\[Em] kuin \[D/F#]itse |\[G]taiva|han \[D]kan\[A]si |\[F#]sois.
...
\beginsong{Leppäkerttu}[by={Kansanlaulu},tags={uni 1},ph={V}]
  ...
  \hfill\includegraphics[width=0.090\textwidth]{leppakerttu_354x280px.png}
  \begin{lilypond}[fragment] % present melody using lilypond
    {\key d \minor \time 4/4
