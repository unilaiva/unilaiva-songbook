...
\beginsong{Sadelaulu}[by={Sanna Kurki-Suonio},tags={vesi 1},ph={II}]
  ...
  \endchorus
  \beginchorus
    \chorusindent |\[Am]Aaa.. |\[E] |\[Am] |\[E] \rep{4}
  \endchorus
  \beginverse
...
\beginsong{Sisältäni portin löysin}[by={Pekka Streng},ph={III, IV}]
  ...
  \noteson
  \beginverse
    \chorusindent |\[\mnc{A}A]Aaa\ldots |\[\mn{E}] |\[\mnc{F#}D] |\[\mn{D}] \[\mn{A}] |\[\mnc{C#}A] | |\[D]\[\mn{D}] |\[\mn{F#}] \[\mn{A}]
...
\beginsong{Tupakkarulla}[by={Kansanlaulu},tags={uni 1}]
  \meter{2}{4}
  \beginverse
    |\[\mnc{D}Dm]Tuu |\[^\mn{A}]tuu |tupakka|\[A]rul|la
  ...
  \endverse
  \imagecc[2]{sleeping_baby_bw_transparent_bg_1280px.png}%
  \vfill\noendsongvfill%
  \begin{lilypond}[fragment] % present melody using lilypond
    {\key d \minor \time 2/4
