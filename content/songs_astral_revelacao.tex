...
\beginsong{Sete Montanhas}[by={Emilio Dias}, key={C}, sks={}]
  \audio[key={C}]{https://soundcloud.com/johannesbatista/00setemontanhas}
  \beginchorus\memorize
    Lai |\[C]vem \[G] Sete Mon|\[C]tanhas
...
\beginsong{Na terra como no Céu}[by={Simja Johannes Lempinen}, key={D}, sks={}]
  \audio[key={D}]{https://soundcloud.com/johannesbatista/01-2n}
  \beginchorus\memorize
    Eu |\[D]brilho, sou uma e|\[A]strela
    Assim na |Terra como no |\[D]Céu
  \endchorus
  \beginchorus
  ...
  \endchorus
  \beginchorus
    O meu |^guia é o Padrinho Sebasti|^ão
    Eterna |vida encontrei no cora|^ção
  \endchorus
  \beginchorus
    Con|^fia confia na ale|^gria
    Assim na |Terra como no |^Céu
  \endchorus
\endsong


\beginsong{Jardim de belas flores}[by={Simja Johannes Lempinen}, key={Em}, sks={}]
  \audio[key={Em}]{https://soundcloud.com/johannesbatista/02-2j}
  \beginchorus\memorize
    É meu |\[Em]Deus e é meu |\[G]Mestre
    I|\[Am]ê ga\[B7]lo can|\[Em]tou
  \endchorus
  \beginchorus
...
\beginsong{Na presença do Senhor}[by={Simja Johannes Lempinen}, key={Bm}, sks={}]
  \audio[key={Bm}]{https://soundcloud.com/johannesbatista/03-2n}
  \beginchorus\memorize
    Estou a|\[Bm]qui na presença do Se|\[F#m]nhor
    Meu Di|\[A]vino Rei Cria|\[Bm]dor
  \endchorus
  \beginchorus
    É a |^Vós quem eu peço meu per|^dão
    Dai-me con|^forto e limpai meu cora|^ção
  \endchorus
  \beginchorus
  ...
  \endchorus
  \beginchorus
    Para |^sempre, sempre estou a|^qui
    Com minha |^Mãe juntinho a |^mim
  \endchorus
  \beginchorus
    Minha |^Mãe é quem dá estes en|^sinos
    Para |^todos bem apren|^der
  \endchorus
  \beginchorus
    Ôh Virgem |^Mãe sois tão bela e tão |^pura
    O vosso |^brilho é que traz a santa |^cura
  \endchorus
  \beginchorus
    Eu peço a |^Vós no meu cora|^ção
    Aju|^dai a todos meus ir|^mãos
  \endchorus
\endsong


\beginsong{Meu Divino Pai Eterno}[by={Simja Johannes Lempinen}, key={Dm}, sks={}]
  \audio[key={Dm}]{https://soundcloud.com/johannesbatista/04-2m}
  \beginchorus\memorize
    Meu Di|\[Dm]vino Pai E|\[A]terno
    Quem me |deu este po|\[Dm]der
  \endchorus
  \beginchorus
    Para |^mim compreen|^der
    Para eu |poder rece|^ber
  \endchorus
  \beginchorus
    A |^Gloria do meu |^Pai
    Para |sempre resplande|^cer
  \endchorus
  \beginchorus
...
\beginsong{Peço força do Céu}[by={Simja Johannes Lempinen}, key={Am}, sks={}, tags={valsa}]
  ...
  \beginchorus\memorize[chords_pecoforca_a]
    Peço |\[Am]força do |\[F]Céu, da |\[Dm]Terra e do |Mar
    Peço |força do |\[C]Vento pa|\[E]ra me cu|\[Am]rar
    \endchorus\glueverses\beginchorus\memorize[chords_pecoforca_b]
    Eu |\[Am]peço a meu |\[C]Pai, ve|nha clare|\[Dm]ar
    Pe|ço a minha |\[Am]Mãe pra nos |\[E7]ilumi|\[Am]nar
  \endchorus
  \beginchorus\replay[chords_pecoforca_a]
    O |^Sol, a |^Lua, as Es|^trelas a gui|ar
    Para |sempre esta |^Luz eterna|^mente a bri|^lhar
    \endchorus\glueverses\beginchorus\replay[chords_pecoforca_b]
    E|^terna|^mente a |nós gui|^ar
    Tenho |a minha |^Mãe tambem |^tenho meu |^Pai
  \endchorus
  \beginchorus\replay[chords_pecoforca_a]
    Vou pe|^dindo e ro|^gando a to|^dos meus ir|mãos
    Va|mos com a|^mor rece|^ber nosso |^Pai
    \endchorus\glueverses\beginchorus\replay[chords_pecoforca_b]
    Va|^mos se fir|^mar nes|ta luz Di|^vina
    Do nos|so Salva|^dor, de |^quem nos en|^sina
  \endchorus
\endsong


\beginsong{O poder do nosso Pai}[by={Simja Johannes Lempinen}, key={Dm}, sks={}]
...
\beginsong{Estou aqui}[by={Simja Johannes Lempinen}, key={Dm}, tags={mazurca}]
...
\beginsong{Eu peço a meu Pai do Céu}[by={Simja Johannes Lempinen}, key={Am}, sks={}]
...
\beginsong{Minha Mãe Minha Rainha}[by={Simja Johannes Lempinen}, key={Bm}, sks={}]
...
\beginsong{Vivo aqui neste mundo pecador}[by={Simja Johannes Lempinen}, key={C}, sks={}]
...
\beginsong{Divina Estrela}[by={Simja Johannes Lempinen}, key={Dm}, sks={}]
...
\beginsong{Abençoai a minha vida}[by={Simja Johannes Lempinen}, key={Dm}, sks={}, tags={valsa}]
...
\beginsong{O Leão chegou}[by={Simja Johannes Lempinen}, key={E}, sks={}, tags={de pé}]
...
\beginsong{Corneta de São Miguel}[by={Simja Johannes Lempinen}, key={}, sks={Dm}, tags={valsa}]
...
\beginsong{Mistério da Santa Cruz}[by={Simja Johannes Lempinen}, key={Bm}, sks={}, tags={valsa}]
...
\beginsong{Príncipe Imperial}[by={Simja Johannes Lempinen}, key={Dm}, sks={}, tags={valsa}]
...
\beginsong{Salmo}[by={Simja Johannes Lempinen}, key={C}, sks={}, tags={2x}]
...
\beginsong{Santo Guerreiro}[by={Simja Johannes Lempinen}, key={C}, sks={}]
...
\beginsong{A Disciplina}[by={Simja Johannes Lempinen}, key={Am}, sks={}]
...
\beginsong{Olhei para o firmamento}[by={Simja Johannes Lempinen}, key={D}, sks={}]
...
\beginsong{Transmutação}[by={Simja Johannes Lempinen}, key={D}, sks={}]
...
\beginsong{Espuma Branca}[by={Simja Johannes Lempinen}, key={D}, sks={}]
...
\beginsong{Amor}[by={Simja Johannes Lempinen}, key={D}, sks={}]
...
\beginsong{Arcanjo Curador}[by={Simja Johannes Lempinen}, key={Am}, sks={}]
...
\beginsong{Meu caminho a seguir}[by={Simja Johannes Lempinen}, key={Bm}, sks={}]
...
\beginsong{Reino da verdade}[by={Simja Johannes Lempinen}, key={Bm}, sks={}, tags={valsa}]
...
\beginsong{Mãe das águas}[by={Simja Johannes Lempinen}, key={D}, sks={}]
