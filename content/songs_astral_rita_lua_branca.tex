...
\beginsong{Eu Vou Trabalhar}[by={Rita}]
...
\beginsong{A Meu Pai Eu Peço Força}[by={Rita}]
...
\beginsong{Peço Uma Ajuda a Meu Mestre}[by={Rita}]
...
\beginsong{Há Tempo Estou Nesta Casa}[by={Rita}]
...
\beginsong{Meu Mestre a Vós Eu Peço}[by={Rita}]
...
\beginsong{Peço Firmeza a Meu Pai}[by={Rita}]
...
\beginsong{Oh! Minha Senhora Mãe}[by={Rita}, tags={valsa}]
...
\beginsong{Eu Peço Força a Meu Pai}[by={Rita}, tags={valsa}]
...
\beginsong{A Disciplina É Geral}[by={Rita}, tags={mazurca}]
...
\beginsong{A Lua Tem Uma Força}[by={Rita}, tags={valsa}]
...
\beginsong{Três Seres}[by={Rita}, tags={mazurca}]
...
\beginsong{Vamos Todos Com Amor}[by={Rita}]
...
\beginsong{Eu Peço Força a Meu Pai}[by={Rita}]
  \audio{https://soundcloud.com/igreja-mestre-irineu/eu-peco-forca-a-meu-pai?in=igreja-mestre-irineu/sets/hinario-lua-branca-madrinha-rita}
  \beginverse
    \beginrep
    Eu peço força a meu Pai
...
\beginsong{Eu e Meu Pai É um Só}[by={Rita}]
...
\beginsong{Divina Estrela}[by={Rita}]
...
\beginsong{Minha História}[by={Rita}]
...
\beginsong{Eu Vivo na Floresta}[by={Rita},key={C},gk={C, G--B--(C)}]
