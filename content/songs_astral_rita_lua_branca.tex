...
\beginsong{Estou Firme}[id={estou-firme-iumop0},by={Rita}]
...
\beginsong{Eu Vou Trabalhar}[id={eu-vou-trabalhar-dh15ou},by={Rita}]
...
\beginsong{Meu Mestre Me Cure}[id={meu-mestre-me-cure-mb0chn},by={Rita},key={C},gk={C}]
...
\beginsong{A Meu Pai Eu Peço Força}[id={a-meu-pai-eu-peco-forca-ktzqod},by={Rita}]
...
\beginsong{Peço Uma Ajuda a Meu Mestre}[id={peco-uma-ajuda-a-meu-mestre-y12t6f},by={Rita}]
...
\beginsong{Há Tempo Estou Nesta Casa}[id={ha-tempo-estou-nesta-casa-dsh0pr},by={Rita}]
...
\beginsong{Meu Mestre a Vós Eu Peço}[id={meu-mestre-a-vos-eu-peco-qxd1hd},by={Rita}]
  ...
  \beginverse
    \beginrep
      ...
      \beginrep
        Eu tenho fé de chegar
        Aos pés de Juramidam
      \endrep
    \endrep
  \endverse
  \beginverse
...
\beginsong{Duas Flores}[id={duas-flores-c0d6n5},by={Rita}]
...
\beginsong{Peço Firmeza a Meu Pai}[id={peco-firmeza-a-meu-pai-8ntqzi},by={Rita}]
...
\beginsong{Oh! Minha Senhora Mãe}[id={oh-minha-senhora-mae-aom0zh},by={Rita},tags={valsa}]
...
\beginsong{Eu Peço Força a Meu Pai}[id={eu-peco-forca-a-meu-pai-k33y4e},by={Rita},tags={valsa}]
...
\beginsong{A Disciplina É Geral}[id={a-disciplina-e-geral-0h25tt},by={Rita},tags={mazurca}]
...
\beginsong{É Pedindo e Rogando}[id={e-pedindo-e-rogando-wtwtx3},by={Rita},key={C},gk={D, C--D}]
  % Also in: songs_astral_cura_ii.tex
...
\beginsong{Estou Aqui}[id={estou-aqui-yczw9y},by={Rita}]
...
\beginsong{A Lua Tem Uma Força}[id={a-lua-tem-uma-forca-42byj5},by={Rita},tags={valsa}]
...
\beginsong{Três Seres}[id={tres-seres-abs309},by={Rita},tags={mazurca}]
...
\beginsong{Lua Branca}[id={lua-branca-8qlwp3},by={Rita}]
...
\beginsong{Vamos Todos Com Amor}[id={vamos-todos-com-amor-9ben6g},by={Rita}]
...
\beginsong{Eu Peço Força a Meu Pai}[id={eu-peco-forca-a-meu-pai-fp68s0},by={Rita}]
  \audio{https://soundcloud.com/igreja-mestre-irineu/eu-peco-forca-a-meu-pai?in=igreja-mestre-irineu/sets/hinario-lua-branca-madrinha-rita}
  \beginverse
    \beginrep
      Eu peço força a meu Pai
...
\beginsong{Lá Vêm o Sol}[id={la-vem-o-sol-v2ic2i},by={Rita},key={C},gk={D, C--E},tags={valsa}]
  % Also in: songs_astral_cura_ii.tex
...
\beginsong{Frei Damião}[id={frei-damiao-olv232},by={Rita}]
...
\beginsong{Eu e Meu Pai É um Só}[id={eu-e-meu-pai-e-um-so-nwglkk},by={Rita}]
...
\beginsong{Divina Estrela}[id={divina-estrela-omk62q},by={Rita}]
...
\beginsong{Minha História}[id={minha-historia-g8uo17},by={Rita}]
...
\beginsong{Eu Vivo na Floresta}[id={eu-vivo-na-floresta-290p4l},by={Rita},key={C},gk={C, G--B--(C)}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_euvivonafloresta_a]
      \[^<C>]Eu |\[C]vivo \[^<E>]na \[^<G>]flo\[<C>Am]res\[^<E>]ta, a\[^<A>]pren|\[<G>G]dendo a \[^<D>]me \[^<E>]cu\[<C>C]rar
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_euvivonafloresta_b]
      \[^<C>]Eu con|\[<E>Am]vido os \[^<D>]meus \[^<C>]ir\[<E>C]mãos, \[^<C>]va\[^<E>]mos |\[<G>G]todos \[^<D>]se \[^<E>]cui\[<C>C]dar
    \endrep
  \mnendverse
  \notesoff
