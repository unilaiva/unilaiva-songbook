...
\beginsong{Com Fé em Deus}[by={Júlia}, key={C}, gk={D, C--E}]
...
\beginsong{Peço a Vós Minha Firmeza \\ Meu Deus}[by={Valdete},key={Am},gk={Am, Am--(Bm)},tags={2x}]
...
\beginsong{Força de Cura}[by={Lúcio Mortimer}, key={C}, gk={C, G\shrp{}--D}, tags={marcha e meia valsa}]
  ...
  \mnbeginverse
    \beginrep\memorize
    \beginrep \[\bm]{} \[^\mn{C}]Chamei \[^\mn{E}]a |\[\mnc{G}C]for\[^\mn{E}]ça \[\bm]
    \[^\mn{G}]E\[^\mn{A}]la é \[^\mn{G}]de |\[\mnc{F}G7]cu\[^\mn{D}]ra \endrep
    \beginrep \[\bmc\mnc{C}C]Sempre pedindo \[^\mn{E}]ao |\[^\mn{G}]Mes\[^\mn{C}]tre
    No plano \[^\mn{E}]ter\[\bmc\mnc{G}G7]res\[^\mn{C}]tre
    Ele é \[^\mn{D}]quem \[^\mn{B}]nos se|\[\mnc{C}C]gura \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    \beginrep
    \beginrep ^ Nesta ses|^são ^
    Só tem bon|^dade \endrep
    \beginrep ^Vamos rezar pro do|ente
    Que é dever da ^gente
    Ter a cari|^dade \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    \beginrep ^ Jesus a|^tende ^
    Quem Lhe pro|^cura \endrep
    \beginrep ^Peço firmeza na |mente
    Fechar a cor^rente
    Que a força é de |^cura \endrep
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
...
\beginsong{Vim Pedir o Meu Perdão}[by={Gercila}, off={Geraldine}, key={Em}, gk={Em, Cm--Em}]
  ...
  \mnbeginverse
    ...
    \beginrep \[^\mn{A}]Eu sei que |\[Am]Vós \[\mnc{B}Asus2]tem po|\[\mnc{E}Em]der \altchords{|Gm Gsus2 |Dm }
    E \[\bmc\mn{G}]me dê |\[\mnc{F#}B7]se \[^\mn{G}]eu \[\bm\mn{A}]me\[^\mn{G}]re|\[\mnc{E}Em]cer\[\bm]{} \altchords{|A7 |Dm } \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    ...
    \beginrep Eu peço a |^Vós um en^tendi|^mento
    ^Que é pa|^ra meu ^segui|^men^to \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    ...
    \beginrep Mas sei que |^Vós a^{i de} |^cima
    ^Me es|^tende as ^vossas |^mãos^ \endrep
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
