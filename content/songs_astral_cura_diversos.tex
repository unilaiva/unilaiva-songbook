...
\beginsong{Jesus}[id={jesus-gpph0o},by={Lúcio Mortimer},key={C},gk={D, C--E},tags={valsa}]
  ...
  \mnbeginverse
    \beginrep
      ...
      \beginrep
        \[\mn{G}]E |\[C]Vós, Se|nhor \altchords{|D | \e}
        Per|\[G]do\[\mn{F}]a \[\mn{E}]a |\[\mnc{D}G7]nós \[\mn{E}]pe\[\mn{D}]ca|\[\mnc{C}C]dor \altchords{|A |A7 |D}
      \endrep
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep
      ...
      \beginrep
        \[\mn{G}]No |\[C]cora|ção \altchords{|D | \e}
        Eu |\[G]re\[\mn{F}]ce\[\mn{E}]ber |\[\mnc{D}G7]meu \[\mn{E}]per|\[\mnc{C}C]dão \altchords{|A |A7 |D}
      \endrep
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep
      ...
      \beginrep
        \[\mn{G}]Com a|\[C]mor \altchords{|D}
        Na |\[G]mis\[\mn{F}]são \[\mn{E}]do |\[\mnc{D}G7]Re\[\mn{E}]den|\[\mnc{C}C]tor \altchords{|A |A7 |D}
      \endrep
    \endrep
  \mnendverse
  \begin{translation}[EN]
...
\beginsong{Força de Cura}[id={forca-de-cura-71uzts},by={Lúcio Mortimer},key={C},gk={C, G\shrp{}--D},tags={marcha e meia valsa}]
  ...
  \mnbeginverse
    \beginrep\memorize
      \beginrep
        \[\bm]{} \[^\mn{C}]Chamei \[^\mn{E}]a |\[\mnc{G}C]for\[^\mn{E}]ça \[\bm]
        \[^\mn{G}]E\[^\mn{A}]la é \[^\mn{G}]de |\[\mnc{F}G7]cu\[^\mn{D}]ra
      \endrep
      \beginrep
        \[\bmc\mnc{C}C]Sempre pedindo \[^\mn{E}]ao |\[^\mn{G}]Mes\[^\mn{C}]tre
        No plano \[^\mn{E}]ter\[\bmc\mnc{G}G7]res\[^\mn{C}]tre
        Ele é \[^\mn{D}]quem \[^\mn{B}]nos se|\[\mnc{C}C]gura
      \endrep
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Vim Pedir o Meu Perdão}[id={vim-pedir-o-meu-perdao-w7wit2},by={Gercila},off={Geraldine},key={Em},gk={Em, Cm--Em}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep
        \[^\mn{A}]Eu sei que |\[Am]Vós \[\mnc{B}Asus2]tem po|\[\mnc{E}Em]der \altchords{|Gm Gsus2 |Dm }
        E \[\bmc\mn{G}]me dê |\[\mnc{F#}B7]se \[^\mn{G}]eu \[\bm\mn{A}]me\[^\mn{G}]re|\[\mnc{E}Em]cer\[\bm]{} \altchords{|A7 |Dm }
      \endrep
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Eu Tenho Fé}[id={eu-tenho-fe-grsad6},by={Luiz Mendes},tags={3x},key={Gm},gk={Gm, Gm--Bm}]
  ...
  \mnbeginverse
    \beginrep
      \ilsl{\[\mn{A}]É} \[\mn{B&}]cu\[\mn{E&}]ra|\[\mnc{D}Gm]dor, \[\mn{A}]é \[\mn{B&}]cu\[\mn{E&}]ra|\[\mn{D}]dor \altchords{|Am | \e}
