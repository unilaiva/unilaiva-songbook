...
\beginsong{A Cura \\ Eu Venho Acrescentar}[id={a-cura-3zu3go},by={Alfredo},off={Liza},key={A},gk={A, A\flt{}--A}]
...
\beginsong{Peço a Vós Minha Firmeza \\ Meu Deus}[id={peco-a-vos-minha-firmeza-lqnvh0},by={Valdete},key={Am},gk={Am, Am--(Bm)},tags={2x}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_pecoavos_a]
      \[^<E>]Meu |\[<A>Am]Deus,\[<*>]{} \[^<B>]meu |\[<G# E>E]Pai,\[<*>]{} minha |\[<D B>E7/D]Mãe \[<*>]{} \altchords{\id[1]{(Bm)}|Bm |F\shrp{} |F\shrp{}7/E}
      Eu pe|\[<E>E7]ço \[^<D>]que \[<C>(C)]Vós \[^<B>]me |\[Am]cu\[^<A>]re \[<*>]{} \altchords{|F\shrp{}7 (D) |Bm}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_pecoavos_b]
      \[^<A>]A \[^<C>]ma|\[<E D>Am/E]téria \[<B>(Bm7&5)]das \[^<A>]do|\[<G#>E]en\[^<E>]ças\[<*>]{} \altchords{|Bm/F\shrp{} (C\shrp{}m7\flt{}5) |F\shrp{}}
      E \[^<G#>]o \[^<B>]es|\[<E>E7]píri\[^<D>]to \[<* B>]do \[^<G#>]es|\[<A>Am]cu\[<*>]ro \altchords{|F\shrp{}7 |Bm}
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Se Afrouxar}[id={se-afrouxar-19w7le},by={Lúcio Mortimer},key={C},gk={C, B\flt{}--D}]
...
\beginsong{Força de Cura}[id={forca-de-cura-71uzts},by={Lúcio Mortimer},key={C},gk={C, G\shrp{}--D},tags={marcha e meia valsa}]
...
\beginsong{Vim Pedir o Meu Perdão}[id={vim-pedir-o-meu-perdao-w7wit2},by={Gercila},off={Geraldine},key={Em},gk={Em, Cm--Em}]
  ...
  \mnbeginverse
    \beginrep\memorize
      \[^<E>]Mi\[^<F#>]nha |\[<G>Em]Mãe es\[<* F#>]tou \[^<E>]a|\[<C>C]qui\[<*>]{} \altchords{\id[1]{(Dm)}|Dm |B\flt{} }
