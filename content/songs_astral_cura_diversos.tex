...
\beginsong{Com Fé em Deus}[by={Madr. Júlia}, key={C}, sks={D, C--E}]
...
\beginsong{A Cura \\ Eu Venho Acrescentar}[by={Padr. Alfredo}, key={A}, sks={A, A\flt{}--A}]
...
\beginsong{Força de Cura}[by={Lúcio Mortimer},key={C},sks={C, D},tags={marcha e valsa}]
...
\beginsong{Pequenininho}[by={Saturnito Brito}, off={Ana Emilly}, tags={2x}, key={B}, sks={B}]
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    ...
    theMelody = \relative b' {
      ...
      \repeat volta 2 { % final without alt. endings
        b8 \sectionmark "i." cis dis | e2 e8 cis'8 cis8 b | b2 b8 gis8 gis8 fis8
    ...
    theLyricsOne = \lyricmode {
      ...
      \set stanza = "i." % final without alt. endings
      \repeat volta 2 {
        Pe -- que -- ni -- | ni -- nho, pe -- que -- ni -- | ni -- nho;
...
\beginsong{Lá Vem Mestre Irineu}[by={Maria de Conceição}, off={Saturnino Brito}, key={D}, sks={D, C--E}]
