...
\beginsong{Aqui Eu Vou Expor}[by={Padr. Sebastião},key={C},sks={D, C}]
  ...
  \beginchorus
    ...
    ^E en|^trar em ^comun|^hão \altchords{|C7 |F}
...
\beginsong{O Amor}[by={Padr. Sebastião},key={D},sks={D}]
  ...
  \beginchorus\replay[chords_oamor_a]
    ...
    Onde está a majes|^tade Cris^to Nosso Sen|^hor \altchords{Bm |A A7 |D}
...
\beginsong{Eu Não sou Deus}[by={Padr. Sebastião},tags={2x, de pé},key={D},sks={D, C}]
  ...
  \beginchorus\replay[chords_eunaosoudeus_a]
    ...
    Mas ^sou sua semel|^hança \altchords{|D}
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lilypond-settings-include.ly"
    theMelody = \transpose c d \relative c'' {
      ...
      } % \break % no break here, takes too much space
      \repeat volta 2 {
...
\beginsong{Recebendo}[by={Odemir Raulino da Silva},tags={valsa},key={C},sks={D, C}]
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lilypond-settings-include.ly"
    ...
    theLyricsOne = \lyricmode {
      \set stanza = "1. "
      Re -- ce -- ben -- do no meu co -- ra -- çã -- o; __
      U -- ma flor __ que me con -- for -- te.
      A -- gra -- de -- ço por tu -- do de bom; __ _
