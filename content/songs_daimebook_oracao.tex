...
\beginsong{Examine a Consciência}[by={Padr. Sebastião}]
...
\beginsong{A meu Pai Peço Firmeza}[by={Padr. Sebastião},tags={á capela, de pé}]
...
\beginsong{Eu Vivo com meu Mestre}[by={Padr. Sebastião}]
...
\beginsong{É Pedindo e é Rogando}[by={Padr. Sebastião}]
...
\beginsong{Dem Dum}[by={Padr. Sebastião}]
...
\beginsong{Aqui Eu Vou Expor}[by={Padr. Sebastião}]
...
\brk
\beginsong{Eu Vou Rezar}[by={Padr. Sebastião}]
...
\beginsong{Para Estar Junto a Este Cruzeiro}[by={Padr. Sebastião}]
...
\beginsong{Não Creia nos Mestres que te Aparecem}[by={Padr. Sebastião}]
...
\beginsong{Peço que Vós me Ouça}[by={Padr. Sebastião},tags={valsa}]
...
\beginsong{O Amor}[by={Padr. Sebastião}]
...
\beginsong{Eu Não sou Deus}[by={Padr. Sebastião},tags={2x, de pé}]
...
\brk
\beginsong{Eu Pedi e Tive o Toque}[by={Padr. Alfredo}]
...
\scleardpage
\beginsong{A Magia da Oração}[by={Madr. Nonata}]
  ...
  \begin{lilywrap}\begin{lilypond}[fragment, staffsize=18]
    ...
    {\key c \major \time 3/4 \partial 2
      ...
      \repeat volta 2 {
        ...
        e'4 d4 | g4 f4 d4 | g,4 b4 d4 | c2. | c4
      }
    }\addlyrics{
