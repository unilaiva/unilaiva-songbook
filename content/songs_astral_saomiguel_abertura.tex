...
\scleardpage
\beginsong{Sol, Lua, Estrela}[id={sol-lua-estrela-g1aubl},by={Mestre Irineu Serra},key={C},gk={C, (B)--(C)},tags={perfilado, 3x}]
  \audio{https://www.nossairmandade.com/hymn/219/Sol,Lua,Estrela}
  \mnbeginverse
    \beginrep\memorize
      |\[<E>C]Sol, \[<*>]Lua, \[^<D>]Es|\[^<E>]tre\[<* C>]la \altchords{\id[1]{(A) \capo{3}}|A | \e}
      \[^<E>]A |\[<G>G]Ter\[^<A>]ra o \[<* G>]Ven\[^<A>]to e o |\[<G F>C]Mar\[<* E>] \altchords{|E |A}
      \ilsl{\[^<G>]É} a |\[<C>F]Luz \[^<B>]do \[<* A>]Fir\[^<G>]ma|\[<E>C]men\[^<G>]to \[<*>]{} \altchords{|D |A}
      É \[^<E>]só |\[<G>G]quem \[^<C>]eu \[<* E>]de\[^<G>]vo a|\[<C>C]mar \[<*>]{} \altchords{|E |A}
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Prece para o Começo da Reunião}[id={prece-para-o-comeco-da-reuniao-9bb0h9},by={Allan Kardec}]
  \begin{passage}[PT]{}
...
\scleardpage
\beginsong{Prece para os Médiuns}[id={prece-para-os-mediuns-5sjv4i},by={Allan Kardec}]
  \begin{passage}[PT]{}
...
\scleardpage
\beginsong{Com o Poder do Céu}[id={com-o-poder-do-ceu-wpe9md},by={Alfredo},key={Am},gk={Am, G\shrp{}m--Bm},tags={perfilado, valsa, 3x}]
  \newchords{chords_comopoderdoceu_a}\newchords{chords_comopoderdoceu_b}
  \meter{3}{4}
  \mnbeginverse\memorize[chords_comopoderdoceu_a]
    \beginrep
      |\[<E>Am]Com o |\[^<C>]po\[^<A>]der \[^<C>]do |\[^<E>]Céu, | \[^<A>]da |\[<E>A]Ter\[^<C#>]ra \[^<A>]e |\[<E>A7]tam\[^<C#>]bém \[^<A>]do |\[<D>Dm]Mar | \e
      \beginrep
        \[^<D>]Or|\[Dm]deno |a \[^<C>]São \[^<B>]Mi|\[<A>Am]guel, | \[^<E>]a |\[<B>E7]for\[^<G#>]ça |\[^<C>]Deus é \[^<B>]quem |\[<A>Am]dá | \e
      \endrep
    \endrep
  \mnendverse\glueverses
  \mnbeginverse[1]\memorize[chords_comopoderdoceu_b]
    \beginrep
      \[^<A>]A |\[A]força |\[A7]Deus é quem |\[<D>Dm]dá, | \[^<F>]pa\[^<G>]ra |\[<A>F]quem tem |\[<G>G]conhe\[^<A>]ci|\[<E>Am]men|to
      Re|\[<G>C]conhe|\[<F>Dm]cendo os \[^<E>]pri|\[<B>E]mo|res, \[^<E>]e |\[<C>Am]não \[^<A>]tirar |\[<C>E7]do \[^<B>]pen\[^<C>]sa|\[<A>Am]men|to
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_comopoderdoceu_a]
    \beginrep
      Só |^Deus, só |Deus, só |Deus, | é |^quem pode |^nos segu|^rar | \e
      \beginrep
        Para |^nós ven|cer a ba|^ta|lha, para a|^diante |se alcan|^çar | \e
      \endrep
    \endrep
  \endverse\glueverses
  \beginverse[1]\replay[chords_comopoderdoceu_b]
    \beginrep
      Para a|^diante |^se alcan|^çar, | o que |^custa gran|^de sofri|^men|to
      Que |^é a|^mar com fir|^me|za, a |^Deus Pai |^do firma|^men|to
    \endrep
  \endverse
  \beginverse\replay[chords_comopoderdoceu_a]
    \beginrep
      ...
      \beginrep
        No firma|^mento es|tá o car|^rei|ro, e o Cru|^zeiro, ca|minhada |^su|a
      \endrep
    \endrep
  \endverse\glueverses
  \beginverse[1]\replay[chords_comopoderdoceu_b]
    \beginrep
      A |^conste|^lação che|^gou, | bem jun|^tinho da |^Virgem Ma|^ri|a
  ...
  \beginverse\replay[chords_comopoderdoceu_a]
    \beginrep
      ...
      \beginrep
        Tudo |^no cora|ção de Ma|^ri|a, na |^Terra e em to|do firma|^men|to
      \endrep
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
...
\scleardpage
\beginsong{Prece para afastar os maus espîritos}[id={prece-para-afastar-os-maus-espiritos-qnbfwo},by={Allan Kardec}]
  \begin{passage}[PT]{}
