...
\beginsong{Com o Poder do Céu}[by={Padr. Alfredo}, key={Am}, gk={Am, G\shrp{}m--Bm}, tags={perfilado, valsa, 3x}]
  ...
  \meter{3}{4}
  \mnbeginverse
    \beginrep\memorize[chords_comopoderdoceu_a]
    ...
    \beginrep \[^\mn{D}]Or|\[Dm]deno |a \[^\mn{C}]São \[^\mn{B}]Mi|\[\mnc{A}Am]guel, | \[^\mn{E}]a |\[\mnc{B}E7]for\[^\mn{G#}]ça |\[^\mn{C}]Deus é \[^\mn{B}]quem |\[\mnc{A}Am]dá | \e \endrep
    \endrep
  \mnendverse\glueverses
  \mnbeginverse
    \beginrep\memorize[chords_comopoderdoceu_b]
  ...
  \beginverse\replay[chords_comopoderdoceu_a]
    ...
    \beginrep Para |^nós ven|cer a ba|^ta|lha, para a|^diante |se alcan|^çar | \e \endrep
    \endrep
  \endverse\glueverses
  \beginverse\replay[chords_comopoderdoceu_b]
    \beginrep
  ...
  \beginverse\replay[chords_comopoderdoceu_a]
    ...
    \beginrep No firma|^mento es|tá o car|^rei|ro, e o Cru|^zeiro, ca|minhada |^su|a \endrep
    \endrep
  \endverse\glueverses
  \beginverse\replay[chords_comopoderdoceu_b]
    \beginrep
  ...
  \beginverse\replay[chords_comopoderdoceu_a]
    ...
    \beginrep Tudo |^no cora|ção de Ma|^ri|a, na |^Terra e em to|do firma|^men|to \endrep
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
