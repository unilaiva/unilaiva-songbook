...
\beginsong{Com o Poder do Céu}[id={com-o-poder-do-ceu-wpe9md},by={Alfredo},key={Am},gk={Am, G\shrp{}m--Bm},tags={perfilado, valsa, 3x}]
  ...
  \mnbeginverse\memorize[chords_comopoderdoceu_a]
    \beginrep
      ...
      \beginrep
        \[^\mn{D}]Or|\[Dm]deno |a \[^\mn{C}]São \[^\mn{B}]Mi|\[\mnc{A}Am]guel, | \[^\mn{E}]a |\[\mnc{B}E7]for\[^\mn{G#}]ça |\[^\mn{C}]Deus é \[^\mn{B}]quem |\[\mnc{A}Am]dá | \e
      \endrep
    \endrep
  \mnendverse\glueverses
  \mnbeginverse[1]\memorize[chords_comopoderdoceu_b]
    \beginrep
      \[^\mn{A}]A |\[A]força |\[A7]Deus é quem |\[\mnc{D}Dm]dá, | \[^\mn{F}]pa\[^\mn{G}]ra |\[\mnc{A}F]quem tem |\[\mnc{G}G]conhe\[^\mn{A}]ci|\[\mnc{E}Am]men|to
      Re|\[\mnc{G}C]conhe|\[\mnc{F}Dm]cendo os \[^\mn{E}]pri|\[\mnc{B}E]mo|res, \[^\mn{E}]e |\[\mnc{C}Am]não \[^\mn{A}]tirar |\[\mnc{C}E7]do \[^\mn{B}]pen\[^\mn{C}]sa|\[\mnc{A}Am]men|to
    \endrep
  \mnendverse
  \notesoff
