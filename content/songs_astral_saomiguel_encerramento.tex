...
\beginsong{Devo Amar Aquela Luz}[id={devo-amar-aquela-luz-qcvksr},by={Mestre Irineu Serra},tags={perfilado, 2x},key={Am},gk={Am, (G\shrp{}m)--(Cm)}]
  ...
  \mnbeginverse[1]\memorize
    \[^\mn{A}]A \[^\mn{C}]Vir\[^\mn{E}]gem |\[\mnc{A}Am]Mãe |\[\mnc{G}A7]foi \[^\mn{E}]quem \[^\mn{C}]me |\[\mnc{D}Dm]deu | \e
    Para en\[^\mn{F}]si|\[^\mn{A}]nar |\[^\mn{G}]os \[^\mn{F}]meus \[^\mn{E}]ir|\[^\mn{D}]mãos
    |\[\mnc{C}Am]Para |\[\mnc{B}E7]ser \[^\mn{D}]um |\[^\mn{B}]fi\[^\mn{C}]lho |\[\mnc{A}Am]seu
    |\[^\mn{A}]Pa\[^\mn{B}]ra |\[\mnc{C}C]ser \[^\mn{D}]um |\[\mnc{E}E7]fi\[^\mn{F}]lho |\[^\mn{E}]seu \[^\mn{C}]de a|\[\mnc{A}Am]mor | \e
  \mnendverse
  \notesoff
  \beginverse[1]
