...
\beginsong{Em Pé Firme na Floresta}[id={em-pe-firme-na-floresta-9afldj},by={Alfredo},tags={perfilado, mazurca, 3x},off={Tratorista},key={Am},gk={Am, G\shrp{}m--(Am)}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_empefirme_a]
      \[^<E>]Em pé |\[<A>Am]fir\[^<E>]me \[^<C>]na \[^<B>]Flo\[<* A>]res\[^<E>]ta
      \[^<C>]Re\[^<A>]ce|\[<C>E7]ben\[^<B>]do a \[^<A>]san\[^<G#>]ta \[<A>Am]Luz
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_empefirme_b]
      \[^<A>]Sou \[^<B>]hu|\[<C>Am]mil\[^<E>]de, \[^<D>]sou \[^<C>]hu\[Fmaj7]mil\[^<B>]de
      \[^<G#>]Sou \[^<B>]hu|\[<E>E7]mil\[^<D>]de \[^<C>]de \[^<B>]Je\[<A>Am]sus
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Devo Amar Aquela Luz}[id={devo-amar-aquela-luz-qcvksr},by={Mestre Irineu Serra},tags={perfilado, 2x},key={Am},gk={Am, (G\shrp{}m)--(Cm)}]
  \audio{https://www.nossairmandade.com/hymn/220/DevoAmarAquelaLuz}
  \meter{2}{4}
  \mnbeginverse
    \[<A>]De\[<B>]vo a|\[<C>Am]mar |\[<B>E7]a\[<A>]que\[<G#>]la |\[<A>Am]luz | \e
    \[<C>]O \[<E>]Di|\[<A>]vi|\[<G>A7]no a\[<E>]on\[<C>]de es|\[<D>Dm]tá | \e
    Pa\[<F>]ra |\[<A>]ser |\[<G>]um \[<F>]fi\[<E>]lho |\[<D>]seu
    \[<C>]No |\[Am]cora|\[<B>E7]ção \[<D>]eu |\[<B>]de\[<C>]vo a|\[<A>Am]mar
    \[<E>]No |\[<A>]co\[<B>]ra|\[<C>C]ção \[<D>]eu |\[<E>E7]de\[<F>]vo a|\[<E>]mar \[<C>]a |\[<A>Am]luz | \e
  \mnendverse
  \mnbeginverse[1]\memorize
    \[^<A>]A \[^<C>]Vir\[^<E>]gem |\[<A>Am]Mãe |\[<G>A7]foi \[^<E>]quem \[^<C>]me |\[<D>Dm]deu | \e
    Para en\[^<F>]si|\[^<A>]nar |\[^<G>]os \[^<F>]meus \[^<E>]ir|\[^<D>]mãos
    |\[<C>Am]Para |\[<B>E7]ser \[^<D>]um |\[^<B>]fi\[^<C>]lho |\[<A>Am]seu
    |\[^<A>]Pa\[^<B>]ra |\[<C>C]ser \[^<D>]um |\[<E>E7]fi\[^<F>]lho |\[^<E>]seu \[^<C>]de a|\[<A>Am]mor | \e
  \mnendverse
  \notesoff
  \beginverse[1]
    No cora|^ção |^este pri|^mor | \e
    Conhe|cer |esta ver|dade
    |^Deus do |^Céu foi |quem man|^dou
    |Deus do |^Céu foi |^quem man|dou a |^luz | \e
  \endverse
  \begin{translation}[EN]
...
\beginsong{Prece para o Encerramento da Reunião}[id={prece-para-o-encerramento-da-reuniao-ltbs1m},by={Allan Kardec}]
  \begin{passage}[PT]{}
