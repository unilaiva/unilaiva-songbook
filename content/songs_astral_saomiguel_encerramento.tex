...
\beginsong{Em Pé Firme na Floresta}[by={Padr. Alfredo}, tags={perfilado, mazurca, 3x}, off={Tratorista}, key={Am}, sks={Am, G\shrp{}m--(Am)}]
...
\beginsong{Devo Amar Aquela Luz}[by={Mestre Irineu Serra}, tags={perfilado, 2x}, key={Am}, sks={Am, (G\shrp{}m)--(Cm)}]
...
\beginsong{Prece para o Encerramento da Reunião}[by={Allan Kardec}]
  ...
  \endverse
  \beginverse
    \translationtitle{EN}{Prayer to Close the Meeting}
