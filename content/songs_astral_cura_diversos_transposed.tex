...
\beginsong{Com Fé em Deus}[by={Júlia}, key={D}, gk={D, C--E}]
...
\beginsong{A Cura \\ Eu Venho Acrescentar}[by={Alfredo}, key={B}, gk={A, A\flt{}--A}]
...
\beginsong{Peço a Vós Minha Firmeza \\ Meu Deus}[by={Valdete},key={Bm},gk={Am, Am--(Bm)},tags={2x}]
