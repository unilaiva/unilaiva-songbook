...
\beginsong{Om Namo Amitābhaya}[id={om-namo-amitabhaya-khseh1},ph={I},key={Am},gk={G\shrp{}m, Gm--G\shrp{}m--(Am)}]
  \mnbeginverse
    \beginrep
      |\[\mnc{A}Am]Om \[\mnc{E}]namo\[\bmadj{-.5ex}]{} \[\mnc{D}]A\[\mn{E}]mi|\[\mnc{F}G]tā\[\mn{E}]bha\[\mn{D}]ya\[\bmadj{-.7ex}] \altchords{\id[1]{(Gm)}|Gm |F}
      |\[\mnc{E}C]Bud\[\mn{D}]dha\[\mn{C}]ya, \[\mnc{D}Em7]Dhar\[\mn{C}]ma\[\mn{B}]ya, |\[\mnc{C}Am]San\[\mn{B}]gha\[\mn{A}]ya\[\bmadj{-.7ex}] \altchords{|B\flt{} Dm7 |Gm}
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep
      |\[\mnc{A}Am]Om na\[\bm]m\[\mn{B}\mn{C}\mn{A}]o, |\[\mnc{G}G]Om na\[\bm]m\[\mn{A}\mn{B}\mn{G}]o \altchords{|Gm |F}
      |\[\mnc{F}F]Om na\[\bm]mo \[\mnc{G}]A\[\mn{F}]mi|\[\mnc{E}E]tā\[\mn{F}]bha\[\mn{E}]ya\[\bmadj{-.7ex}] \altchords{|E\flt{} |D}
    \endrep
  \mnendverse
  \begin{explanation}[EN]
