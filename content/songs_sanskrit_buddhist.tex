\beginsong{Compassion Mantra \\ Mantra of Avalokiteshvara}[index={Om Mani Pame Hum}]
...
\beginsong{Jewel in the Lotus Flower}[index={Om Mani Padme Hum}]
  \meter{4}{4}
  \beginverse
    \[\note{A}]There is a |\[Dm]jewel in the Lotus |flower
...
\beginsong{Padmasambhava Mantra \\ Vajra Guru Mantra}[index={Om Ah Hum}]
  ...
  \textnote{song:}
  \beginchorus
    |\[Em\note{B}]Om Ah |Hum |Vajra Guru |\[Asus2]Padme Siddhi |\[Em]Hum | |
  \endchorus
  \begin{explanation}
...
\beginsong{White Tara Mantra}[index={Om Tare Tu Tare},by={traditional, Deva Premal}]
  ...
  \textnote{song:}
  \beginchorus
    \[\note{E}]Om |\[Am]Tare Tu |\[Fmaj7]Tare Tu|\[G]re So |\[C]Ha
...
\beginsong{Perfection Mantra \\ Gate Gate}[index={Teyata Gate Gate}]
  ...
  \meter{6}{8}
  \beginchorus
    \[\note{B}]Gate |\[Em]Gate Para|\[D]gate
...
\beginsong{Medicine Buddha Mantra \\ Healing Mantra}[index={Teyata Om Bekanze Bekanze},tags={healing 1}]
  ...
  \textnote{song:}
  \beginchorus
    |\[Dm\note{D}]Teyata Om |\[F]Bekanze Bekanze |\[C] Maha Bekanze |
