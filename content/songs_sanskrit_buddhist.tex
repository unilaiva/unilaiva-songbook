...
\beginsong{Compassion Mantra \\ Mantra of Avalokiteshvara}[id={compassion-mantra-er8rfe},index={Om Mani Padme Hum},tags={compassion},ph={I, II}]
...
\beginsong{Jewel in the Lotus Flower}[id={jewel-in-the-lotus-flower-ime5i0},index={Om Mani Padme Hum},tags={compassion},ph={I, II}]
  \meter{4}{4}
  \beginverse
    \[<A>]There's \[^<C>]a |\[<D>Dm]jewel in \[^<C>]the \[^<D>]Lo\[^<C>]tus |\[^<D>]flower
...
\beginsong{Padmasambhava Mantra \\ Vajra Guru Mantra}[id={padmasambhava-mantra-7gm575},index={Om Ah Hum},ph={I, II}]
  ...
  \beginverse
    \beginrep
      |\[<B>Em]Om A\[<A>]h |\[<B>]Hum |Vajra \[<C>]Gu\[<A>]ru |\[Asus2]Padme \[<C>]Sid\[<D>]dhi |\[<B>Em]Hum | \e
    \endrep
  \endverse
  \begin{explanation}[EN]
...
\beginsong{Om Namo Amitābhaya}[id={om-namo-amitabhaya-khseh1},ph={I},key={Am},gk={G\shrp{}m, Gm--G\shrp{}m--(Am)}]
  \mnbeginverse
    \beginrep
      |\[<A>Am]Om \[<E>]namo\[<* @-.375ex>]{} \[<D>]A\[<E>]mi|\[<F>G]tā\[<E>]bha\[<D>]ya\[<* @-.525ex>] \altchords{\id[1]{(Gm)}|Gm |F}
      |\[<E>C]Bud\[<D>]dha\[<C>]ya, \[<D>Em7]Dhar\[<C>]ma\[<B>]ya, |\[<C>Am]San\[<B>]gha\[<A>]ya\[<* @-.525ex>] \altchords{|B\flt{} Dm7 |Gm}
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep
      |\[<A>Am]Om na\[<*>]m\[<B C A>]o, |\[<G>G]Om na\[<*>]m\[<A B G>]o \altchords{|Gm |F}
      |\[<F>F]Om na\[<*>]mo \[<G>]A\[<F>]mi|\[<E>E]tā\[<F>]bha\[<E>]ya\[<* @-.525ex>] \altchords{|E\flt{} |D}
    \endrep
  \mnendverse
  \begin{explanation}[EN]
...
\beginsong{Perfection Mantra \\ Gate Gate}[id={perfection-mantra-64t5td},index={Teyata Gate Gate},ph={II}]
  ...
  \beginverse
    \beginrep
      \[<B>]Ga\[<D>]te |\[<E>Em]Gate Pa\[<D>]ra|\[D]gate
...
\beginsong{Tara Mantra}[id={tara-mantra-spg47g},index={Om Tare Tu Tare},by={traditional, Deva Premal},ph={III}]
  ...
  \beginverse
    \beginrep
      \[<E>]Om |\[<A>Am]Tare Tu |\[<C>Fmaj7]Tare Tu|\[<D>G]re \[<F D>]So |\[<E>C]Ha
...
\beginsong{Medicine Buddha Mantra \\ Healing Mantra}[id={medicine-buddha-mantra-mysv1m},index={Teyata Om Bekanze Bekanze},tags={health},ph={III}]
  ...
  \beginverse
    \beginrep
      |\[<D>Dm]Teyata Om |\[<F>F]Bekanze Bekanze |\[C]{} \[<E>]Ma\[<D>]ha \[<E>]Be\[<D>]kan\[<E>]ze
...
\beginsong{Purification Mantra}[id={purification-mantra-lfpx0d},index={Om Benza Satto Hung},ph={I}]
...
\beginsong{Teacher Buddha Mantra}[id={teacher-buddha-mantra-pqn16w},index={Om Muni Muni},tags={teacher},ph={I}]
...
\beginsong{Wisdom Mantra}[id={wisdom-mantra-y3cs1z},index={Om Ah Ra Pa Tsa Na},tags={wisdom},ph={II}]
