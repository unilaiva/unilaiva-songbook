...
\beginsong{Emamaa \\ Moder Jord}[by={trad., Tane Mahuta},ex={eesti, suomi, svenska; based on a Swedish folk song},tags={Mother Earth},ph={III},key={Dm}, gk={Dm, Dm--F\shrp{}m}]
  ...
  \mnbeginverse
    \beginrep\memorize
    \beginrep \[^\mn{A}]Ema |\[\mnc{D}Dm]Maa, ema \[\mnc{C}C]Maa, \[^\mn{E}]Maa|\[\mnc{D}Dm]e\[\mnc{A}Am]ma \altchords{\id[1]{(Em)}|Em D |Em Bm} \endrep
  ...
  \beginverse
    \beginrep
    \beginrep Äiti |^Maa, äiti ^Maa, Maa|^äi^ti \endrep
  ...
  \beginverse
    \beginrep
    \beginrep Moder |^Jord, moder ^Jord, Jord|^mo^der \endrep
