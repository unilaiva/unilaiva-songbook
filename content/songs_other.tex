...
\beginsong{\texorpdfstring{Wild Gazelle --- \textpersian{اهوی وحشی}}{Wild Gazelle}}
  ...
  \endverse
  \beginverse
    Ke mi|\[B7]binäm ke in däshte mosh|\[Em]avash \hfill{\scriptsize\textpersian{که می‌بینم که این دشت مشوش}}
  ...
  \beginverse
    ...
    be io|\[C]mne hemmätäsh kari gosha|\[Am]{-yäd}, \hfill{\scriptsize\textpersian{ز یـُمن همتش کاری گشاید}}
    gosha|\[Em]{-yäd}
  \endverse
  \beginverse
    |\[Em] | | |\[Am] | |\[Em] |\[B7] \e
  ...
  \beginverse
    ...
    mäd|\[Am]äd bäkhshash ze \[B7]abe dide|\[Em]ye khish \hfill{\scriptsize\textpersian{مدد بخشش ز آب دیدۀ خویش}}
    |\[B7] |\[Em] \e
  \endverse
  \beginverse
