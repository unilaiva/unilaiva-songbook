...
\beginsong{Ave Maria}[by={Franz Schubert}, ex={latina}, ph={III}, key={C}, gk={D, C--E}]
  ...
  \begin{lilywrap}\begin{lilypond}[]
    ...
    %   poet = "[these lyrics are from the Ave Maria prayer]"
    % }
    %% NOTE:
    %%  - the original is notated in double time compared to this
    %%  - the accompaniment plays triplets
    \include "tex/lp-include-head.ly"
    theMelody = \relative c'' {
      \mark \markup \with-color #darkgreen \italic "Accompaniment plays chords arpeggiated as sextuplets."
      \tempo 4 = 64
      \key a \minor \time 4/4
