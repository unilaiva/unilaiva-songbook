...
\beginsong{Ishq Allah\\Love, Lover and Beloved}[by={James Burgess},tags={source 1, love 1},ex={arabic, english}]
  \beginchorus
    \chorusindent |\[Bm]Ishq Allah Mah|bud lillah
    \chorusindent Ishq Al|lah Mah\[A]bud lil|\[Bm]lah |
  \endchorus
  \beginverse
  ...
  \begin{explanation}
    \begin{description}
      \item[Ishq Allah Mahbud lillah] translates to 'I am One with God'.
    \end{description}
  \end{explanation}
\endsong
