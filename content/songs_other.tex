...
\beginsong{Eskawatã kayawey}[by={pajé Agostinho Inkamuru},ex={Hancha Kuin},ph={III, IV}]
  ...
  \begin{explanation}
    This song from the \textit{Huni Kuin} tribe \textit{(Kaxinawá)} calls the spirits of nature, the elements, the sun, the moon, the stars, and \textit{Yuxibu} to bring transformation.
    \begin{description}
...
\beginsong{Emamaa \\ Moder Jord}[by={trad., Tane Mahuta},ex={estonian, finnish, swedish; based on a Swedish folk song},tags={Mother Earth 1},ph={III}]
