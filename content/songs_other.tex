...
\beginsong{\texorpdfstring{Wild Gazelle --- \textpersian{اهوی وحشی}}{Wild Gazelle}}
    [id={wild-gazelle-wild-gazelle-403d28},by={\texorpdfstring{Faramarz Aslani --- \textpersian{فرامرز اصلانی}, Hafez --- \textpersian{حافظ}}{Faramarz Aslani, Hafez}},ex={persian},key={Am},gk={Am, Gm--C\shrp{}m}]
  \audio[]{https://music.youtube.com/watch?v=cuo1WaTGAnM}
  \meter{12}{8} %
  \capo{3}
  %TODO: needs refining!
  \beginverse
    \ilsl{\[\mn{B}]Äl}|\[\mncii{D}{B}Em]{a e}|-\[\mn{A}]i a\[\mn{B}]huy|\[\mncii{C}{A}Am]e vähshi | - \[B7]{} \[\mn{G}]ko\[\mn{A}]ja|\[\mnc{B}Em]ii \hfill{\scriptsize\textpersian{الا ای آهوی وحشی کجائی}}
    | |\[Cmaj7]{} |\[B7]{} \e
  ...
  \endverse
  \beginverse[1]
    \[\mn{B}]Ke kha|\[Em]häd shod beguiid \[\mn{A}]ey \[\mn{B}]räf|\[\mncii{C}{A}Am]ighan \hfill{\scriptsize\textpersian{که خواهد شد بگویید ای رفیقان}}
    Räfig|\[C]he bikäsan yare ghär|\[Am]iban \hfill{\scriptsize\textpersian{رفیق بیکسان یار غریبان}}
  \endverse
  \beginverse[1]
    \[\mn{A}]Mägär |\[B7]Khezre mobaräk pei |\[\mnc{B}Em]dä\[\mn{A}]ra\[\mn{G}]yd \hfill{\scriptsize\textpersian{مگر خضر مبارک پی درآید}}
  ...
  \endverse
  \beginverse[1]
    \[\mn{B}]Näkärd |\[Em]an hamdame dir\[\mn{A}]in \[\mn{B}]mo|\[\mnc{C}Am]da\[\mn{A}]ra \hfill{\scriptsize\textpersian{نکرد آن همدم دیرین مدارا}}
    mosä|lmanan, mosä\[B7]lmanan khod|\[Em]ara \hfill{\scriptsize\textpersian{مسلمانان مسلمانان خدا را}}
  \endverse
  \beginverse[1]
    \[\mn{G}]Mägä|\[C]r Khezre mobaräk pey \[\mn{A}]tä|\[\mnc{B}Am]va\[\mn{A}]näd \[B7]{} \hfill{\scriptsize\textpersian{مگر خضر مبارک ‌پی تواند}}
...
\beginsong{Ishq Allāh\\Love, Lover and Beloved}[id={ishq-allah-h9cjt1},by={James Burgess},tags={source, love},ex={arabic, english},ph={IV}]
  \beginverse[1]
    \beginrep
      |\[\mnc{B}Bm]Ishq \[\mn{F#}]Allāh ma'|\[\mn{B}]būd \[\mn{F#}]Allāh
...
\beginsong{Asse Wana Hey Wana \\ Hey Niketi}[id={asse-wana-hey-wana-82d3so},ex={hopílavayi, english},tags={heart, circle},ph={III, IV}]
  ...
  \beginverse[1]
    \beginrep
      |\[\mnc{B}Em]Hey ni\[\mn{A}]ke\[\mn{G}]ti |\[\mnc{A}D]hey wana |\[Bm]hey ni\[\mn{G}]ke\[\mn{F#}]ti |\[\mnc{G}Em]hey \[\mn{E}]wana
    \endrep
  \endverse
  \notesoff
  \beginverse
...
\beginsong{Weha Ehayo}[id={weha-ehayo-sw5wqc},by={Lakota},ex={lakȟótiyapi, español, english},ph={III}]
  \beginverse[1] % 25 beats in this verse
    \[\bmc\mnc{D}D]Weha eh\[\bmadj{-.5ex}]ay\[\bmadj{-.5ex}]o \[\bmc\mnc{C#}A]weha eh\[\bmadj{-.5ex}]ay\[\bmadj{-.5ex}]o
    W\[\bmadj{-.5ex}]eha e\[\bmc C]hay\[\bmadj{-.5ex}]o \[\bmc G]weha eh\[\bmadj{-.5ex}]ay\[\bmadj{-.5ex}]o
    W\[\bmadj{-.5ex}]eha e\[\bmc C]hay\[\bmadj{-.5ex}]o \[\bmc G]weha \[\bmadj{-.5ex}]eha\[\bmc D]yo! \[\bm]{} \[\bm]{} \[\bm]{} \[\bm]{} \[\bm]{} \[\bm]{} \[\bm]
  \endverse
...
\beginsong{Ayahuasca Takimuyki}[id={ayahuasca-takimuyki-vn6ci1},by={Don José Campos},ex={quechua, español},tags={Aya},ex={quechua, español},ph={II},key={Bm},gk={Cm, (Bm)--Cm--C\shrp{}m}]
  ...
  \mnbeginverse[1]
    \beginrep\prep{4}
      \meter{3}{4}|\[\bmc\mnc{E}Em]Chuyay \[\bm]chuyay \[\bmc\mn{G}]ham\[\mn{E}]pi\meter{2}{4}|\[\bmc\mncii{D}{C}Am]kuy\[\bm]niy\altchords{|Em . . |Am . }
      \meter{3}{4}|\[\bmc\mnc{A}F]Mişki \[\bm]ñuñu \[\bm]kur\[\mn{G}]ku\meter{2}{4}|\[\bmc\mnc{A}Am]chay\[\bm]paq \up{4}(\meter{3}{4}|\[\bm]{} \[\bm]{} \[\bm]{} ) \altchords{|F . . |Am . \ac<4>{| . . .}}
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Vem, Mãe Natureza}[id={vem-mae-natureza-vixwb4},by={trad., version by Curawaka},ex={hancha kuin, português},ph={II, III},key={Am},gk={Am, Gm--Bm}]
  ...
  \mnbeginverse[1]\memorize
    \beginrep\noteson
      \[^\mn{A}]Kene|\[Am]ya \[^\mn{E}]hãwã \[\mnc{C}\bm]beru \[^\mn{A}]kene|ya; \[\bm] \[^\mn{G}]kene|\[G]ya \[^\mn{D}]hãwã \[\mnc{B}\bm]beru \[^\mn{G}]kene|ya \[\bm]
      \[^\mn{D}]Kene|\[\mnc{E}Am]ya hãwã \[\bm]beru kene|\[\mncadj{1ex}{D}E7]ya; Yube \[\mnc{E}E]beru kene|\[\mnc{A}Am]ya \[\bm] |{ } { }\[\bm] \e
    \endrep
  \mnendverse
  \beginverse[1]
    \beginrep
...
\beginsong{Te Nande}[id={te-nande-0n0kwc},ex={yawanawa},ph={III, IV},key={Em},gk={Em, Cm--G\shrp{}m}]
  ...
  \mnbeginverse[1]
    \beginrep
      |\[\mnc{E}Em]Te \[\bm] nan|de te \[\bm]nan|\[\mnc{G}C]de \[\bm] | \[\bm] \e
      |\[\mnc{F#}D]Te \[\bm] nan|de \[\mn{D}]te \[\bmc\mncadj{1.5ex}{E}]nan|\[Em]de \[\bmc\ma{G}\ma{F#}]{} |\[\ma{E}]\[\bm]{} \up{2}(| \[\bm] |) \e
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep
...
\beginsong{Emamaa \\ Moder Jord}[id={emamaa-43pags},by={trad., Tane Mahuta},ex={eesti, suomi, svenska; based on a Swedish folk song},tags={Mother Earth},ph={III},key={Dm},gk={Dm, Dm--F\shrp{}m}]
  ...
  \mnbeginverse
    \beginrep\memorize
      \beginrep
        \[^\mn{A}]Ema |\[\mnc{D}Dm]Maa, ema \[\mnc{C}C]Maa, \[^\mn{E}]Maa|\[\mnc{D}Dm]e\[\mnc{A}Am]ma \altchords{\id[1]{(Em)}|Em D |Em Bm}
      \endrep
      Su |\[\mnc{F}F]sees \[^\mn{E}\mn{F}]elab \[\mnc{G}C]ürg\[^\mn{E}]ne |\[\mncii{F}{D}Dm]vägi mis |toob mul \[\mnc{C}\mnc{E}Am]lohu|\[\mnc{D}Dm]tust \altchords{|G D |Em | - Bm |Em}
    \endrep
