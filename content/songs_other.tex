...
\beginsong{Ishq Allāh\\Love, Lover and Beloved}[by={James Burgess},tags={source, love},ex={arabic, english},ph={IV}]
  \beginchorus
    \chorusindent |\[\mnc{B}Bm]Ishq \[\mn{F#}]Allāh ma'|būd Allāh
...
\beginsong{Weha Ehayo}[by={Lakota},ex={lakȟótiyapi, español, english},ph={III}]
  \beginverse % 25 beats in this verse
    \chorusindent \[\bmc\mnc{D}D]Weha eh\[\bmadj{-.5ex}]ay\[\bmadj{-.5ex}]o \[\bmc\mnc{C#}A]weha eh\[\bmadj{-.5ex}]ay\[\bmadj{-.5ex}]o
    \chorusindent W\[\bmadj{-.5ex}]eha e\[\bmc C]hay\[\bmadj{-.5ex}]o \[\bmc G]weha eh\[\bmadj{-.5ex}]ay\[\bmadj{-.5ex}]o
    \chorusindent W\[\bmadj{-.5ex}]eha e\[\bmc C]hay\[\bmadj{-.5ex}]o \[\bmc G]weha \[\bmadj{-.5ex}]eha\[\bmc D]yo! \[\bm] \[\bm] \[\bm] \[\bm] \[\bm] \[\bm] \[\bm]
  \endverse
...
\beginsong{Ayahuasca Takimuyki}[by={Don José Campos},ex={quechua, español},tags={Aya},ex={quechua, español},ph={II}]
  ...
  \notesoff
  \beginchorus
    \chorusindent \meter{3}{4}|\[\bmc Em]Chuyay \[\bm]chuyay \[\bm]hampi\meter{2}{4}|\[\bmc Am]kuy\[\bm]niy
    \chorusindent \meter{3}{4}|\[\bmc F]Mişki \[\bm]ñuñu \[\bm]kurku\meter{2}{4}|\[\bmc Am]chay\[\bm]paq \up{4}(\meter{3}{4}|\[\bm] \[\bm] \[\bm] )
    \rep{4}
  \endchorus
  \beginchorus
...
\beginsong{Ide Were}[by={traditional},tags={water},ex={yoruba},ph={IV}]
  \beginverse
...
\beginsong{O Mileko}[ex={swahili},ph={I, IV}]
  \meter{2}{4}
  \beginverse
    \[\mn{C}]Aka|túm\[\mn{A}]bale \[\mn{G}]aka|túm\[\mn{E}]bale \[\mn{C}]Be|\[\mn{E}]lele \[\mn{C}]be|\[\mn{E}]lele
    Be|le tzimi be|le tzimi Tzi|mimi tzi|mimi
  \endverse
  \beginverse
    Atzi|mi tzaya atzi|mi tzaya Tza|yaya tza|yaya
    Tza|ya butu tza|ya butu Bu|tutu bu|tutu
  \endverse
  \beginverse
    Abu|tu gnda abu|tu gnda Gn|danga gn|danga
    Kun|da leli kun|da leli Ale|lila ale|lila
  \endverse
  \beginverse
    Ale|li manga ale|li manga Man|ganga man|ganga
    \up{*}o man|ganga man|ganga o | | \e
  \endverse
