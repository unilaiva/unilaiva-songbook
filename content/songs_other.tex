...
\beginsong{Ancient Aramaic Prayer}
  ...
  \begin{center} % center the lines
    ...
    \includegraphics[width=0.15\textwidth]{ancient_aramaic_symbol_bw_transparent_bg_184x225px.png}
  \end{center}
...
\beginsong{Ide Were}[by={Yoruba, traditional},ah={125}]
  ...
  \vfill
  \begin{center}
    \includegraphics[width=0.67\textwidth]{oshun_bw_transparent_bg_650x811px.png}
  \end{center}
\endsong
