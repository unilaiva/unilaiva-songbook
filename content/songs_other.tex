...
\beginsong{Ancient Aramaic Prayer}
  ...
  \begin{center} % center the lines
    ...
    \includegraphics[width=0.15\textwidth]{ancient_aramaic_symbol.png}
  \end{center}
  \brk % to suggest putting a page break here
  \begin{translation}
    \vskip 9em % try to align with the original prayer
    \large % scale up from ordinary translation, to align (there is space on the page)
    \begin{center}
