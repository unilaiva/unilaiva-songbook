...
\beginsong{Ide Were}[by={traditional},tags={water},ex={yoruba},ph={III, IV},key={Gm},sks={Gm, Gm--Bm}]
  \audio[key=Gm]{https://www.youtube.com/watch?v=YUeIFRkthb8}
  \transpose{3}\preferflats
  \mnbeginverse
    \[\mn{B}]Ide |\[\mnc{E}Em]were were \[\mn{D}]nita \[\mn{B}]Osh|\[\mnc{A}D]un \altchords{\id[1]{(Em) \capo{3}}|Em |D}
    \[\mn{G}]I\[\mn{A}]de |\[\mnc{B}Cmaj7]were \[\mn{D}]we\[\mn{B}]re | \e \altchords{|Cmaj7 | \e}
    Ide |\[\mnc{E}Em]were were \[\mn{D}]nita \[\mn{B}]Osh|\[\mnc{A}D]un \altchords{|Em |D}
    \[\mn{G}]I\[\mn{A}]de |\[\mnc{B}Cmaj7]were \[\mn{D}]we\[\mn{B}]re \[\mn{G}]nita \[\mn{E}]ya | \e \altchords{|Cmaj7 | \e}
