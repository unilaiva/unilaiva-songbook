...
\beginsong{Ganesha Sharanam}[id={ganesha-sharanam-a5b1pc},tags={Ganesha},ph={I, IV}]
  ...
  \beginverse
    ...
    Na|'maha Shi|\[\mnd{G}\mnd{F#}]va\[\mnd{E}]ya
    |\[C]{} Ganga Par|vati Ma
...
\beginsong{Ek Ong Kar Sat Gur Prasad}[id={ek-ong-kar-sat-gur-prasad-a4n3rz},key={A},gk={A, G--B},ph={III},tags={Kundalini}]
  ...
  \mnbeginverse
    \beginrep
      |\[\mnc{E}A]Ek \[\bmc\mn{C#}]Ong |\[\mnc{D}D\hspace{1ex}\mn{E}\mn{D}\bmc\mn{C#}\mn{B}]Kar |\[A]{} \[\mn{A}]Sa\[\mnc{C#}]t \[\bm]Gu\[\mnc{B}]r \[\mn{A}]Pra\[\mnc{B}]s|\[E]ad \[\bm]
      \[\mn{C#}]Sa\[\mnc{D}]t |\[\mnc{E}A]Gu\[\bmcadj{.618ex}\mn{A}\mn{E}]r Pras|\[\mnc{F#}D\hspace{1ex}\mn{G#}\mn{F#}\bmc\mn{E}\mn{D}]ad
      |\[\mnc{E}A]Ek \[\bmc\mn{C#}]On\[\mncadj{.5ex}{E}]g |\[E]{} Kar \[\bm]
    \endrep
  \mnendverse
  % part B
  \mnbeginverse
    |\[D]{} \[\bmc\mn{D}]Ek Ong K|\[\mnc{E}E]ar \[\bmc\mn{G#}]Sat \[\mnc{A}]G|\[A\mn{E}]u\[\bmcadj{.618ex}]r \[\mn{D}]Pras|a\[\mn{E}\mn{D}\mn{C#}]d \[\bmcadj{-.5ex}]
    \[\mn{A}]Sa\[\mn{E}]t |\[D\mn{F#}\mn{E}]Gu\[\bmcadj{0.618ex}]r \[\mn{D}]Pras|\[\mnc{E}A\hspace{1ex}\mn{D}]ad
    \[\bmc\mn{C#}]Ek On|\[E]g \[\mn{D}\mn{C#}\mn{B}]Kar \[\bm]{ } |{ }{ }{ }\[E7]\e
  \mnendverse
  \begin{lilywrap}\begin{lilypond}[]
