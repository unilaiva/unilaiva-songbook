...
\beginsong{Eu Vivo na Floresta}[by={Padr. Sebastião}, key={C}, sks={C, B\flt{}--C}]
...
\beginsong{Beija-Flor}[by={Padr. Sebastião}, key={A}, sks={A, G--A}]
...
\beginsong{Eu Invoco Meu Mestre}[by={Padr. Sebastião}, key={D}, sks={D, D--E}]
...
\beginsong{Cuidado no Julgamento}[by={Padr. Sebastião}, key={C}, sks={D, C--F\shrp{}}]
...
\beginsong{Lá Vêm o Sol}[by={Madr. Rita}, key={C}, sks={D, C--E}, tags={valsa}]
  \meter{3}{4}
  \mnbeginchorus\memorize
...
\beginsong{Encostado a Minha Mãe}[by={Mestre Irineu Serra}, key={Bm}, sks={Cm, (Bm)--Cm--D\shrp{}m}]
  \transpose{-3}
  \mnbeginchorus\memorize
  ...
  \notesoff
  \beginchorus
    Minha |^flor, minha ^espe|^rança \altchords{\id[2]{(Dm)}|Dm |B\flt{} }
    ^Minha |^rosa ^do jar|^dim^ \altchords{|Em7\flt{}5 |A }
