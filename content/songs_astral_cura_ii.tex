...
\beginsong{Encostado a Minha Mãe}[by={Mestre Irineu Serra}, key={Dm}, sks={Cm, Cm--D\#m}]
  \mnbeginchorus\memorize
  ...
  \beginchorus
    ...
    ^Minha |^rosa ^do jar|^dim^ \altchords{|C\#m7b5 |F\# }
    \lrep Para |^sempre eu ^quero es|^tar \altchords{|Em |Bm }
    Com ^minha |^Mãe jun^tinho a |^mim^ \rrep \altchords{|F\#7 |Bm }
  \endchorus
  \beginchorus
    Eu |^moro ^nesta |^casa
