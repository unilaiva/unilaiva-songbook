...
\beginsong{Eu Vivo na Floresta}[id={eu-vivo-na-floresta-qyz4c4},by={Sebastião},key={C},gk={C, B\flt{}--C}]
...
\beginsong{Princesa Janaína}[id={princesa-janaina-auvbn2},by={Sebastião},key={G},gk={A, G--B}]
  ...
  \mnbeginverse
    ...
    \beginrep\memorize[chords_princesajanaina_b]
      ...
      \[(Em)]E\[^<B>]la |\[<D>D]veio pa\[^<C>]ra \[<* A>]me en\[^<B>]si|\[<G>G]nar \[<*>]{} \altchords{(F\shrp{}m) |E |A}
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Deus É Para Todos}[id={deus-e-para-todos-6ccugf},by={Sebastião},key={D},gk={D, (D)--(D\shrp{})}]
...
\beginsong{Cuidado no Julgamento}[id={cuidado-no-julgamento-hqg24t},by={Sebastião},key={C},gk={D, C--F\shrp{}}]
...
\beginsong{Tão Bonito é meu Pai}[id={tao-bonito-e-meu-pai-woisk9},by={Sebastião},key={G},gk={A, G--B}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_taobonitoemeupai_a]
      \[^<G>]Tão bo|\[<B>G]ni\[^<G>]to \[(Em)]é \[^<B>]meu |\[<D>D]Pai\[<*>]{} \altchords{\id[1]{(A)}|A (F\shrp{}m) |E}
      \ilsl{\[^<G>]É} \[^<F#>]meu |\[<E>Em]Mes\[^<D>]tre en\[<B G>G]si\[^<B>]na|\[<D>D]dor\[<*>]{} \altchords{|F\shrp{}m A |E}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_taobonitoemeupai_b]
      \[^<G>]Va\[^<F#>]mos |\[<E>Em]re\[^<D>]ce\[<B G>G]ber \[^<B>]a |\[<D>D]gló\[<*>]ria \altchords{|F\shrp{}m A |E}
      \[^<G>]Do nosso |\[<B>Bm]Mes\[^<G>]tre \[<A>D]cu\[^<B>]ra|\[<G>G]dor\[<*>]{} \altchords{|C\shrp{}m E |A}
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Curo Tudo \\ Eu Vou Me Levantar}[id={curo-tudo-1kragb},by={Tetê},off={Cristina Raulino},tags={perfilado},key={A},gk={B, A--C}]
  ...
  \mnbeginverse
    ...
    \beginrep\memorize[chords_curotudo_b]
      \[^<A>]Pe|\[A]guei na minha es\[<C#>(C#m)]pa\[^<E>]da \altchords{|B (D\shrp{}m)}
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep
        ...
        \[^<C>]E |\[<E>Em]na Ra|\[<D>G]i\[^<E>]nha \[^<D>]do |\[<C>C]mar \altchords{|F\shrp{}m |A |D}
      \endrep
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Encostado a Minha Mãe}[id={encostado-a-minha-mae-azg2ln},by={Mestre Irineu Serra},key={Dm},gk={Cm, (Bm)--Cm--D\shrp{}m}]
  \mnbeginverse
    \beginrep\memorize
      \[^<A>]Encos|\[<D>Dm]tado \[^<C#>]à \[<* D>]mi\[^<E>]nha |\[<F>B&]Mãe \altchords{\id[1]{(Cm)}|Cm |A\flt{} }
      \[^<D>]E \[<* B&>]meu \[^<A>]Pa|\[<G>Em7&5]pai \[^<E>]lá \[<* F>]no \[^<G>]as|\[<A>A]tral\[<*>]{} \altchords{|Dm7\flt{}5 |G }
      \beginrep
  ...
  \beginverse
    \beginrep
      ...
      \beginrep
        ...
        Com ^minha |^Mãe jun^tinho a |^mim^ \altchords{|F\shrp{}7 |Bm }
      \endrep
    \endrep
  \endverse
  \beginverse
