...
\beginsong{Eu Vivo na Floresta}[by={Sebastião}, key={C}, gk={C, B\flt{}--C}]
...
\beginsong{Princesa Janaína}[by={Sebastião}, key={G}, gk={A, G--B}]
...
\beginsong{Quando Tu Estiver Doente}[by={Sebastião}, key={D}, gk={D, C--E}]
...
\beginsong{Peço Força}[by={Sebastião}, key={D}, gk={D, C--E}]
...
\beginsong{Beija-Flor}[by={Sebastião}, key={A}, gk={A, G--A}]
...
\beginsong{Deus É Para Todos}[by={Sebastião}, key={D}, gk={D, (D)--(D\shrp{})}]
...
\beginsong{Eu Invoco Meu Mestre}[by={Sebastião}, key={D}, gk={D, D--E}]
...
\beginsong{Cuidado no Julgamento}[by={Sebastião}, key={C}, gk={D, C--F\shrp{}}]
...
\beginsong{Sou Luz}[by={Sebastião}, key={C}, gk={D, C--E}, tags={perfilado}]
...
\beginsong{Tão Bonito é meu Pai}[by={Sebastião}, key={G}, gk={A, G--B}]
...
\beginsong{Eu Entrei em Entendimento}[by={Alfredo}, off={Cristina}, key={C}, gk={D, C--E}]
...
\beginsong{Curo Tudo \\ Eu Vou Me Levantar}[by={Tetê}, off={Cristina Raulino}, tags={perfilado}, key={A}, gk={B, A--C}]
...
\beginsong{Meu Mestre Me Cure}[by={Rita}, key={C}, gk={C}]
...
\beginsong{É Pedindo e Rogando}[by={Rita}, key={C}, gk={D, C--D}]
...
\beginsong{Lá Vêm o Sol}[by={Rita}, key={C}, gk={D, C--E}, tags={valsa}]
...
\beginsong{Encostado a Minha Mãe}[by={Mestre Irineu Serra}, key={Dm}, gk={Cm, (Bm)--Cm--D\shrp{}m}]
  \mnbeginverse
    ...
    \beginrep \[^\mn{B&}]Pa\[^\mn{A}]ra |\[\mnc{G}Gm]sem\[^\mn{F}]pre eu \[\bmc\mn{E}]que\[^\mn{D}]ro es|\[\mnc{A}Dm]tar \altchords{|Fm |Cm }
    \[\bmc\mn{D}]Pa\[^\mn{F}]ra |\[\mnc{E}A7]sem\[^\mn{D}]pre eu \[\bmc\mn{C#}]que\[^\mn{E}]ro es|\[\mnc{D}Dm]tar\[\bm]{} \altchords{|G7 |Cm } \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    ...
    \beginrep Para |^sempre eu ^quero es|^tar \altchords{|Em |Bm }
    Com ^minha |^Mãe jun^tinho a |^mim^ \altchords{|F\shrp{}7 |Bm } \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    ...
    \beginrep Eu estan|^do jun^to com |^Ela
    ^Sempre |^dando o ^seu va|^lor^ \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    ...
    \beginrep De bri|^lhantes ^pedras |^finas \altchords{|Gm |Dm }
    ^Para |^sempre a^qui es|^tou^ \altchords{|A |Dm } \endrep
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
