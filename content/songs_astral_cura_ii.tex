...
\beginsong{Eu Vivo na Floresta}[id={eu-vivo-na-floresta-qyz4c4},by={Sebastião},key={C},gk={C, B\flt{}--C}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_cura_euvivonafloresta_a]
      \[^\mn{C}]Eu |\[\mnc{A}C]vi\[^\mn{C}]vo \[\bm]na flo|\[\mnc{A}F]res\[\bmc\mn{F}]ta, \[^\mn{A}]eu |te\[^\mn{G}]nho os \[\bmc\mn{C}]meus \[^\mn{E}]en|\[\mnc{G}G]si\[\bm]nos
    \endrep
...
\beginsong{Beija-Flor}[id={beija-flor-obpsm6},by={Sebastião},key={A},gk={A, G--A}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_beijaflor_a]
      \ilsl{\[^\mn{C#}]É} |\[\mnc{E}A]Bei\[^\mn{C#}]ja é \[\mnc{F#}F#m]Beija-|\[\mncii{D}{B}Bm]Flor \altchords{\id[1]{(G)}|G Em |Am}
...
\beginsong{Cuidado no Julgamento}[id={cuidado-no-julgamento-hqg24t},by={Sebastião},key={C},gk={D, C--F\shrp{}}]
  ...
  \mnbeginverse
    ...
    \beginrep\memorize[chords_cuidadonoj_b]
      ...
      Pa\[^\mn{B}]ra \[\mnc{A}Am]ser \[^\mn{C}]jul|\[\mnc{G}G7]gado e \[^\mn{B}]fi\[^\mn{D}]car\jw em \[\bmc\mn{A}]seu \[^\mn{C}]lu|\[C]gar \[\bm]{} \altchords{Bm |A7 |D}
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Tão Bonito é meu Pai}[id={tao-bonito-e-meu-pai-woisk9},by={Sebastião},key={G},gk={A, G--B}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_taobonitoemeupai_a]
      ...
      \ilsl{\[^\mn{G}]É} \[^\mn{F#}]meu |\[\mnc{E}Em]Mes\[^\mn{D}]tre en\[\mncii{B}{G}G]si\[^\mn{B}]na|\[\mnc{D}D]dor\[\bm]{} \altchords{|F\shrp{}m A |E}
    \endrep
    \mnendverse\glueverses\mnbeginverse
...
\beginsong{É Pedindo e Rogando}[id={e-pedindo-e-rogando-di7gvy},by={Rita},key={C},gk={D, C--D}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep
        \[^\mn{C}]Eu pe|\[\mnc{F}F]di \[^\mn{G}]a \[\bmc\mn{A}]Vir\[^\mn{G}]gem |\[\mncii{E}{C}C]Mãe\[\bmc (Am)] \altchords{|G |D (Bm)}
        Para |\[^\mn{E}]ela vir \[\bmc\mnc{D}G]nos cu|\[\mnc{C}C]rar\[\bmc \ac<1>{C7}] \altchords{| - A |D \ac<1>{D7}}
      \endrep
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Lá Vêm o Sol}[id={la-vem-o-sol-aj92uq},by={Rita},key={C},gk={D, C--E},tags={valsa}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep
        \[^\mn{C}]No |\[\mnc{F}F]sol, na lu|\[(G7)]{a e nas} \[^\mn{E}]es|\[\mnc{G}C]tre\[^\mn{E}]las \altchords{|G |(A7) |D}
        \[^\mn{C}]E |\[\mnc{E}Em]na Ra|\[\mnc{D}G]i\[^\mn{E}]nha \[^\mn{D}]do |\[\mnc{C}C]mar \altchords{|F\shrp{}m |A |D}
      \endrep
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Encostado a Minha Mãe}[id={encostado-a-minha-mae-azg2ln},by={Mestre Irineu Serra},key={Dm},gk={Cm, (Bm)--Cm--D\shrp{}m}]
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep
        \[^\mn{B&}]Pa\[^\mn{A}]ra |\[\mnc{G}Gm]sem\[^\mn{F}]pre eu \[\bmc\mn{E}]que\[^\mn{D}]ro es|\[\mnc{A}Dm]tar \altchords{|Fm |Cm }
        \[\bmc\mn{D}]Pa\[^\mn{F}]ra |\[\mnc{E}A7]sem\[^\mn{D}]pre eu \[\bmc\mn{C#}]que\[^\mn{E}]ro es|\[\mnc{D}Dm]tar\[\bm]{} \altchords{|G7 |Cm }
      \endrep
    \endrep
  \mnendverse
  \notesoff
