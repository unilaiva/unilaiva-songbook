...
\beginsong{Eu Vivo na Floresta}[id={eu-vivo-na-floresta-qyz4c4},by={Sebastião},key={C},gk={C, B&--C}]
  \audio{https://soundcloud.com/canaljagube/1-eu-vivo-na-floresta?in=canaljagube/sets/hinario-de-cura}
  ...
  \mnbeginverse
    \beginrep\memorize[chords_cura_euvivonafloresta_a]
      \[^<C>]Eu |\[<A>C]vi\[^<C>]vo \[<*>]na flo|\[<A>F]res\[<* F>]ta, \[^<A>]eu |te\[^<G>]nho os \[<* C>]meus \[^<E>]en|\[<G>G]si\[<*>]nos
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_cura_euvivonafloresta_b]
      \[^<G>]Eu |\[<E>C]não \[^<C>]me \[<* D>]cha\[^<C>]mo |\[<A>Am]Dai\[<* C>]me, \[^<E>]eu |\[<G>G]sou \[^<E>]é um \[<F>G7]ser \[^<D>]di|\[<C>C]vi\[<*>]no
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_cura_euvivonafloresta_a]
    \beginrep
      Eu |^sou um ^ser di|^vino, eu ^venho a|qui para ^te ensi|^nar ^
    \endrep
    \endverse\glueverses\beginverse\replay[chords_cura_euvivonafloresta_b]
    \beginrep
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
    % transcribed by larva, updated on 2023-11
...
\beginsong{Princesa Janaína}[id={princesa-janaina-auvbn2},by={Sebastião},key={G},gk={A, G--B}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_princesajanaina_a]
      \[^<B>]Je\[^<C>]sus |\[<D>G]Cristo \[^<B>]es\[<* G>]tá \[^<B>]no |\[^<D>]céu \altchords{\id[1]{(A)}|A | \e}
      \[^<B>]Es\[<* G>]tá \[^<B>]na |\[^<D>]terra \[^<B>]es\[<* G>]tá \[^<B>]no |\[^<D>]mar \[<*>]{} \altchords{| - | \e}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_princesajanaina_b]
      \[^<G>]A Prin|\[<C>C]ce\[^<B>]sa \[<A>Am]Ja\[^<C>]na|\[<B>G]í\[^<G>]na \altchords{|D Bm |A }
      \[(Em)]E\[^<B>]la |\[<D>D]veio pa\[^<C>]ra \[<* A>]me en\[^<B>]si|\[<G>G]nar \[<*>]{} \altchords{(F#m) |E |A}
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_princesajanaina_a]
    \beginrep
      Os en|^sinos ^da prin|cesa
      ^Todos |eles ^têm va|lor ^
    \endrep
    \endverse\glueverses\beginverse\replay[chords_princesajanaina_b]
    \beginrep
...
\beginsong{Quando Tu Estiver Doente}[id={quando-tu-estiver-doente-bfqqjo},by={Sebastião},key={D},gk={D, C--E}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_quandotuestiver_a]
      \[^<A>]Quando |\[<D>D]tu es\[^<B>]ti\[<E>A7]ver \[^<D>]do|\[D]e\[<*>]nte \altchords{\id[1]{(C)}|C G7 |C}
      Que \[^<E>]o |\[^<F#>]Dai\[^<D>]me \[<G>A7]for \[^<E>]to|\[<F#>D]mar \[<*>]{} \altchords{| - G7 |C}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_quandotuestiver_b]
      \[^<F#>]Te |\[<G>G]lembran\[^<B>]do \[<* E>]ser \[^<G>]di|\[<F#>D]vino \altchords{|A |C}
      \[^<A>]Que \[<* D>]tu \[^<F#>]to|\[<E>A7]mou pa\[^<A>]ra \[<* C#>]te \[^<E>]cu|\[<D>D]rar \[<*>]{} \altchords{|G7 |C}
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_quandotuestiver_a]
    \beginrep
      Te lem|^brando do ^ser di|^v^ino
      O uni|verso es^treme|^ceu ^
    \endrep
    \endverse\glueverses\beginverse\replay[chords_quandotuestiver_b]
    \beginrep
...
\beginsong{Peço Força}[id={peco-forca-uh1np1},by={Sebastião},key={D},gk={D, C--E}]
  \audio{https://www.nossairmandade.com/hymn/69/Pe\%C3\%A7oFor\%C3\%A7a}
  \mnbeginverse
    \beginrep\memorize
      \[^<A>]Peço |\[<D>D]for\[^<A>]ça\[<*>], \[^<D>]lá vem |\[<F#>(Bm)]for\[^<D>]ça \[<*>]{} \altchords{\id[1]{(C)}|C |(Am)}
      Deus \[^<E>]do |\[<F#>D]céu \[^<A>]foi \[<E>A]quem \[^<F#>]man|\[<E D>D]dou \[<*>]{} \altchords{|C G |C}
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Beija-Flor}[id={beija-flor-obpsm6},by={Sebastião},key={A},gk={A, G--A}]
  \audio{https://www.nossairmandade.com/hymn/70/Beija-Flor}
  \newchords{chords_beijaflor_a}\newchords{chords_beijaflor_b}
  \mnbeginverse
    \beginrep\memorize[chords_beijaflor_a]
      \ilsl{\[^<C#>]É} |\[<E>A]Bei\[^<C#>]ja é \[<F#>F#m]Beija-|\[<D B>Bm]Flor \altchords{\id[1]{(G)}|G Em |Am}
      \[<* B>]Que mi|\[<G#>E]nha \[^<E>]Mãe \[<* F#>]me en\[^<E>]tre|\[<C# A>A]gou\[<*>]{} \altchords{|D |G}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_beijaflor_b]
      \[^<C#>]Pa\[^<D>]ra a|\[<E>A]fas\[^<C#>]tar \[<F#>F#]as do|\[<D>Bm]en\[^<B>]ças \altchords{|G Em |Am}
      \[<* D>]De \[^<F#>]quem |\[<E>E]for \[^<D>]me\[<C#>E7]re\[^<B>]ce|\[<A>A]dor\[<*>]{} \altchords{|D D7 |G}
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_beijaflor_a]
    \beginrep
      Meu |^Mestre es^{tá co}|^migo
      ^Pois e|^le é ^meu a|^mor^
    \endrep
    \endverse\glueverses\beginverse\replay[chords_beijaflor_b]
    \beginrep
      É |^no céu ^e na |^terra
...
\beginsong{Deus É Para Todos}[id={deus-e-para-todos-6ccugf},by={Sebastião},key={D},gk={D, (D)--(D#)}]
  ...
  \mnbeginverse
    \beginrep\memorize
      \[^<E>]Eu |\[<G>C]vim pa\[<A>(F)]ra \[^<G>]lem|\[<E>C]brar \[<*>]{} \altchords{\id[1]{(C)}|C (F) |C}
      \[^<C>]Eu |\[<B>G]te\[^<D>]nho \[<A>(Am)]que \[^<B>]di|\[<G>G]zer \[<*>]{} \altchords{|G (Am) |G}
      |\[<C>C]Deus é \[<*>]para |\[<E>(Am/E)]to\[<*>]dos \altchords{|C |(Am/E)}
      \[^<C>]Não |\[<B>G]se \[^<D>]po\[<A>(F)]{de es}\[^<B>]con|\[<C>C]der \[<*>]{} \altchords{|G (F) |C}
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    \beginrep
      ...
      \noteson\[<* E>]E \[<G>]da\notesoff{} |\[C]onde \[<*>]vem a |\[Am/E]luz
      \[<*>]É do |\[G]nosso \[(F)]Salva|\[C]dor \[<*>]
    \endrep
  \endverse
  \beginverse
    \beginrep
  ...
  \begin{lilywrap}\begin{lilypond}[]
    ...
    %% This would suppresses 1 (iota 1) warning of "No string for pitch",
    %% which comes from having simultaneous G and E (due to differing 2nd verse)
    %% in key C, but is commented out for transposed key D where this problem
    %% doesn't exist.
    %#(for-each (lambda (x) (ly:expect-warning "No string for pitch")) (iota 1))
...
\beginsong{Eu Invoco Meu Mestre}[id={eu-invoco-meu-mestre-thbmze},by={Sebastião},key={D},gk={D, D--E}]
  \audio{https://www.nossairmandade.com/hymn/72/EuInvocoMeuMestre}
  \mnbeginverse
    \beginrep\memorize
      \[^<A>]Eu |\[<D>D]in\[^<F#>]vo\[<E>A]co o \[^<D>]meu |\[D]Mestre \altchords{\id[1]{(F)}|F C |F}
      \[<* F#>]Quan\[^<A>]do |\[^<D>]me \[^<F#>]a\[<E>(Bm)]cho \[^<D>]do|\[<A>A]en\[<*>]te\altchords{| - (Dm) |C}
      \[^<A>]Re|\[<D>D]cebo a \[^<F#>]mi\[<E>A]nha \[^<D>]sa|\[D]ú\[^<A>]de\altchords{|F C |F}
      \[<* F#>]É \[^<A>]de |\[<D>(Bm)]Deus \[^<F#>]O\[<E>A7]ni\[^<D>]po|\[D]ten\[<*>]te\altchords{|(Dm) C7 |F}
    \endrep
  \mnendverse
  \notesoff
  \beginverse
  ...
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
    % transcribed by larva, updated on 2023-07
    theMelody = \relative a' {
      \set melismaBusyProperties = #'() \slurDashed
      \key d \major \time 4/4 \partial 4
      \repeat volta 2 {
...
\beginsong{Cuidado no Julgamento}[id={cuidado-no-julgamento-hqg24t},by={Sebastião},key={C},gk={D, C--F#}]
  \audio{https://www.nossairmandade.com/hymn/73/CuidadoNoJulgamento}
  \newchords{chords_cuidadonoj_a}\newchords{chords_cuidadonoj_b}
  \mnbeginverse
    \beginrep\memorize[chords_cuidadonoj_a]
      \[^<G>]Eu |\[<C>C]chamo os \[<A>Am7]meus \[^<C>]ir|\[<G>G]mã\[<*>]os \altchords{\id[1]{(D)}|D Bm7 |A}
      |\[^<B>]Para \[^<D>]jus\[<A>F]ti\[^<C>]fi|\[C]car \[<*>]{} \altchords{| - G |D}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_cuidadonoj_b]
      \[^<C>]Cui|\[<F>F]dado \[^<E>]no \[<D>G7]jul\[^<E>]ga|\[<C>C]mento \altchords{|G A7 |D}
      Pa\[^<B>]ra \[<A>Am]ser \[^<C>]jul|\[<G>G7]gado e \[^<B>]fi\[^<D>]car\jw em \[<* A>]seu \[^<C>]lu|\[C]gar \[<*>]{} \altchords{Bm |A7 |D}
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_cuidadonoj_a]
    \beginrep
      Não |^fale de ^coisas |^sé^rias \altchords{\id[2]{(E)}|E C#m7 |B}
      Não |sejas blas^fema|^dor ^ \altchords{| - A |E}
    \endrep
    \endverse\glueverses\beginverse\replay[chords_cuidadonoj_b]
    \beginrep
  ...
  \beginverse\replay[chords_cuidadonoj_a]
    ...
    \endverse\glueverses\beginverse\replay[chords_cuidadonoj_b]
    \beginrep
      Quem  |^ama ^coisa\jw à|^toa
      Peran^{te a} ver|^dade vem se\jw en^vergo|^nhar ^
    \endrep
  \endverse
  \beginverse\replay[chords_cuidadonoj_a]
    \beginrep
...
\beginsong{Sou Luz}[id={sou-luz-j8hq32},by={Sebastião},key={C},gk={D, C--E},tags={perfilado}]
  \audio{https://www.nossairmandade.com/hymn/74/SouLuz}
  \newchords{chords_souluz_a}\newchords{chords_souluz_b}
  \mnbeginverse
    \beginrep\memorize[chords_souluz_a]
      \[^<E>]Sou |\[<G>C]Luz\[<*>], \[^<E>]dou |\[<D C>Am]Luz\[<*>]{} \altchords{\id[1]{(D)}|D |Bm}
      \[^<A>]E \[^<B>]fa\[^<C>]ço |\[<D>Dm]tudo i\[<G>G7]lu\[^<E>]mi|\[<D C>C]nar\[<*>]{} \altchords{|Em A7 |D}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_souluz_b]
      \[^<C>]Vejo |\[<E>Am]meu \[^<C>]Pai \[<*>]nas \[^<B>]al|\[<G>G]tu\[<*>]ras \altchords{|Bm |A}
      \[^<D>]E o Po|\[Dm]der a\[<G>G7]on\[^<E>]de es|\[<D C>C]tá\[<*>]{} \altchords{|Em A7 |D}
    \endrep
  \mnendverse
  \notesoff
  \beginverse[1]\replay[chords_souluz_a]
    \beginrep
      A |^fo^rça está co|^migo^
      Falo |^peran^te o Po|^der^
    \endrep
    \endverse\glueverses\beginverse[1]\replay[chords_souluz_b]
    \beginrep
      Fa|^{ço o} que ^Tu me |^pe^des
      Eu quero |^ver es^treme|^cer^
    \endrep
  \endverse
  \beginverse\replay[chords_souluz_a]
    \beginrep
      O a|^mor^ e|^terno^ \altchords{\id[2]{simple (C)}|C | \e}
      Gra|^vei no ^cora|^ção^ \altchords{|G |C}
    \endrep
    \endverse\glueverses\beginverse\replay[chords_souluz_b]
    \beginrep
  ...
  \beginverse[1]\replay[chords_souluz_a]
    \beginrep
      As|^sim ^é que meu Pai |^quer^
      Pe|^rante es^te Po|^der^
    \endrep
    \endverse\glueverses\beginverse[1]\replay[chords_souluz_b]
    \beginrep
      Não |^fazem o que ^Ele |^pe^de
      E todos |^querem ^mere|^cer^
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
    ...
    theChordsA = \chordmode { % chords for part A
       \repeat volta 2 {
...
\beginsong{Tão Bonito é meu Pai}[id={tao-bonito-e-meu-pai-woisk9},by={Sebastião},key={G},gk={A, G--B}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_taobonitoemeupai_a]
      \[^<G>]Tão bo|\[<B>G]ni\[^<G>]to \[(Em)]é \[^<B>]meu |\[<D>D]Pai\[<*>]{} \altchords{\id[1]{(A)}|A (F#m) |E}
      \ilsl{\[^<G>]É} \[^<F#>]meu |\[<E>Em]Mes\[^<D>]tre en\[<B G>G]si\[^<B>]na|\[<D>D]dor\[<*>]{} \altchords{|F#m A |E}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_taobonitoemeupai_b]
      \[^<G>]Va\[^<F#>]mos |\[<E>Em]re\[^<D>]ce\[<B G>G]ber \[^<B>]a |\[<D>D]gló\[<*>]ria \altchords{|F#m A |E}
      \[^<G>]Do nosso |\[<B>Bm]Mes\[^<G>]tre \[<A>D]cu\[^<B>]ra|\[<G>G]dor\[<*>]{} \altchords{|C#m E |A}
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_taobonitoemeupai_a]
    \beginrep
      A |^força ^do meu |^Pai^
      Quem du|^vida é o ^peca|^dor^
    \endrep
    \endverse\glueverses\beginverse\replay[chords_taobonitoemeupai_b]
    \beginrep
...
\beginsong{Eu Entrei em Entendimento}[id={eu-entrei-em-entendimento-cnh9jo},by={Alfredo},off={Cristina},key={C},gk={D, C--E}]
  \audio{https://www.nossairmandade.com/hymn/519/EntreiEmEntendimento}
  \mnbeginverse
    \beginrep\memorize
      \[^<G>](Eu) entrei |\[<C>C]em enten\[^<D>]di\[<C>C7]mento \altchords{\id[1]{(D)}|D D7}
      Entre |\[<F>F]meu eu e \[^<G>]ma\[<* F>]téria \altchords{|G}
      Sou \[^<E>]luz |\[<G>G]ex\[^<D>]pul\[^<F>]so \[^<E>]do\[<C>C]ença \altchords{|A D}
      \[^<G>]E \[^<C>]des|\[<E>G7]trin\[^<D>]cho a \[^<F>]cau\[^<E>]sa \[<C>C]dela \altchords{|A7 D}
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{O Daime, É o Daime}[id={o-daime-e-o-daime-whtkxu},by={Alfredo},off={José Teixeira},tags={mazurka},key={C},gk={C, (B)--(C)}]
...
\beginsong{Curo Tudo \\ Eu Vou Me Levantar}[id={curo-tudo-1kragb},by={Tetê},off={Cristina Raulino},tags={perfilado},key={A},gk={B, A--C}]
  \audio{https://www.nossairmandade.com/hymn/78/EuVouMeLevantar}
  \newchords{chords_curotudo_a}\newchords{chords_curotudo_b}
  \mnbeginverse
    \beginrep\memorize[chords_curotudo_a]
      \[^<A>]Eu |\[A]vou me \[^<C#>]le\[^<E>]van\[<G>G]tar \altchords{\id[1]{(B)}|B A}
      \[^<A>]Com \[^<G>]a|\[<F#>D]ju\[^<E>]da \[^<G>]do \[^<F#>]Se\[<E>A]nhor \altchords{|E B}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_curotudo_b]
      \[^<A>]Pe|\[A]guei na minha es\[<C#>(C#m)]pa\[^<E>]da \altchords{|B (D#m)}
      \[^<C#>]Foi |\[<B>D]pa\[^<A>]ra \[^<F#>]guer\[^<A>]re\[A]ar \altchords{|E B}
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_curotudo_a]
    \beginrep
      Esta |^força quem me ^deu
      Foi o Mes|^tre Jurami^dam
    \endrep
    \endverse\glueverses\beginverse\replay[chords_curotudo_b]
    \beginrep
  ...
  \beginverse\replay[chords_curotudo_a]
    \beginrep
      Curo |^tudo, expulso ^tudo \altchords{\id[2]{(C)}|C B&}
...
\beginsong{Meu Mestre Me Cure}[id={meu-mestre-me-cure-b7ibrl},by={Rita},key={C},gk={C}]
  % Also in: songs_astral_rita_lua_branca.tex (#3)
  \audio{https://soundcloud.com/igreja-mestre-irineu/meu-mestre-me-cure}
  \newchords{chords_meumestremecure_a}\newchords{chords_meumestremecure_b}
  \mnbeginverse
    \beginrep\memorize[chords_meumestremecure_a]
      \[^<E>]Meu |\[<G>C]Mes\[<E>(Am)]tre \[^<C>]me |\[<G>C]cu\[<* C>]re \altchords{\id{alt. (C)}|C | \e}
      Meu |\[<E>Am]Mes\[<D>Dm]tre \[^<C>]me |\[<G>G]o\[<*>]lhe \altchords{| - |G}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_meumestremecure_b]
      \[^<C>]Meu |\[<E>Am]Mes\[<D>Dm]tre \[^<C>]me en|\[<G>G]si\[<*>]ne \altchords{|C |G}
      \[^<C>]Me |\[<E>Am]dê a \[<D>G]Santa |\[<C>C]Gló\[<*>]ria \altchords{|C G |C}
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{É Pedindo e Rogando}[id={e-pedindo-e-rogando-di7gvy},by={Rita},key={C},gk={D, C--D}]
  % Also in: songs_astral_rita_lua_branca.tex (#13)
  \audio{https://soundcloud.com/igreja-mestre-irineu/e-pedindo-e-rogando}
  \mnbeginverse
    \beginrep\memorize
      \ilsl{\[^<G>]É} pe|\[<C>C]din\[^<D>]do \[<* E>]e \[^<D>]ro|\[^<C>]gan\[<*>]do \altchords{\id[1]{(D)}|D |\e}
      Que po|\[<F>F]de\[^<G>]mos \[<* A>]al\[^<G>]can|\[<E>C]çar\[<*> C7]{} \altchords{|G |D D7}
      \beginrep
        \[^<C>]Eu pe|\[<F>F]di \[^<G>]a \[<* A>]Vir\[^<G>]gem |\[<E C>C]Mãe\[<*> (Am)] \altchords{|G |D (Bm)}
        Para |\[^<E>]ela vir \[<* D>G]nos cu|\[<C>C]rar\[<*>\ac{1}{C7}] \altchords{| - A |D \ac{1}{D7}}
      \endrep
    \endrep
  \mnendverse
  \notesoff
  ...
  \beginverse
    \beginrep
      ...
      \beginrep
        Meu |^Mestre ^nos se|^gure^ \altchords{|F Dm |C Am}
        Não |nos dei^xe tom|^bar^ \altchords{|Em G |C \ac{1}{C7}}
      \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
      ...
      \beginrep
        Eu en|^sino é ^ter a|^mor^
        Mas só |querem a ^ilu|^são.^
      \endrep
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
...
\beginsong{Lá Vêm o Sol}[id={la-vem-o-sol-aj92uq},by={Rita},key={C},gk={D, C--E},tags={valsa}]
  % Also in: songs_astral_rita_lua_branca.tex (#20)
  \audio{https://soundcloud.com/igreja-mestre-irineu/la-vem-o-sol}
  \meter{3}{4}
  \mnbeginverse
    \beginrep\memorize
      \[^<G>]Lá |\[<C>C]vem \[^<E>]o |\[<D>G]sol \[^<B>]nos \[^<D>]cu|\[<C>C]rar \altchords{\id[1]{(D)}|D |A |D}
      Va|\[<F>F]mos to|\[(G7)]dos se \[^<E>]fir|\[<G>C]mar \altchords{|G |(A7) |D}
      \beginrep
        \[^<C>]No |\[<F>F]sol, na lu|\[(G7)]{a e nas} \[^<E>]es|\[<G>C]tre\[^<E>]las \altchords{|G |(A7) |D}
        \[^<C>]E |\[<E>Em]na Ra|\[<D>G]i\[^<E>]nha \[^<D>]do |\[<C>C]mar \altchords{|F#m |A |D}
      \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    \beginrep
      ...
      \beginrep
        O |^que meu |^Pai me or|^dena
        Eu |^tenho |^que afir|^mar
      \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
      ...
      \beginrep
        Que |^eu es|^tando com |^Vós
        Ja|^mais me con|^sidero |^morto.
      \endrep
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
...
\beginsong{Encostado a Minha Mãe}[id={encostado-a-minha-mae-azg2ln},by={Mestre Irineu Serra},key={Dm},gk={Cm, (Bm)--Cm--D#m}]
  \mnbeginverse
    \beginrep\memorize
      \[^<A>]Encos|\[<D>Dm]tado \[^<C#>]à \[<* D>]mi\[^<E>]nha |\[<F>B&]Mãe \altchords{\id[1]{(Cm)}|Cm |A& }
      \[^<D>]E \[<* B&>]meu \[^<A>]Pa|\[<G>Em7&5]pai \[^<E>]lá \[<* F>]no \[^<G>]as|\[<A>A]tral\[<*>]{} \altchords{|Dm7&5 |G }
      \beginrep
        \[^<B&>]Pa\[^<A>]ra |\[<G>Gm]sem\[^<F>]pre eu \[<* E>]que\[^<D>]ro es|\[<A>Dm]tar \altchords{|Fm |Cm }
        \[<* D>]Pa\[^<F>]ra |\[<E>A7]sem\[^<D>]pre eu \[<* C#>]que\[^<E>]ro es|\[<D>Dm]tar\[<*>]{} \altchords{|G7 |Cm }
      \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    \beginrep
      ...
      ^Minha |^rosa ^do jar|^dim^ \altchords{|C#m7&5 |F# }
      \beginrep
        Para |^sempre eu ^quero es|^tar \altchords{|Em |Bm }
        Com ^minha |^Mãe jun^tinho a |^mim^ \altchords{|F#7 |Bm }
      \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
      ...
      \beginrep
        Eu estan|^do jun^to com |^Ela
        ^Sempre |^dando o ^seu va|^lor^
      \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
      ...
      \beginrep
        De bri|^lhantes ^pedras |^finas \altchords{|Gm |Dm }
        ^Para |^sempre a^qui es|^tou^ \altchords{|A |Dm }
      \endrep
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
...
\beginsong{Sou Filho do Poder}[id={sou-filho-do-poder-0hwsw6},by={Mestre Irineu Serra},key={C},gk={D, C--D}]
  \mnbeginverse
    \beginrep\memorize
      \[^<C>]Sou |\[<A>Am]filho \[<* C>]do \[^<E>]po|\[^<A>]der \altchords{\id[1]{(D)}|Bm | \e}
      E \[<* G>]den\[^<E>]tro |\[^<C>]des\[^<A>]ta \[<*>]ca\[^<C>]sa es|\[<G>G]tou\[<*>]{} \altchords{| - |A}
      Fa|zendo os \[<* B>]meus \[^<D>]tra|\[<A>Am]balhos \altchords{| - |Bm}
      \[<* G>]Que \[^<E>]mi|\[<C>(C)]nha \[^<A>]Mãe \[<B>G7]me or\[^<D>]de|\[<C>C]nou\[<*>]{} \altchords{|(D) A7 |D}
    \endrep
  \mnendverse
  \notesoff
  \beginverse
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
    ...
    theLyricsThree = \lyricmode {
      ...
      \repeat volta 2 {
        ...
        a -- le -- | gra teu co -- ra -- | ção; __ _ _
        Que __ _ | es -- ta é a ver -- | da -- de;
        Que~eu a -- pre -- | sen -- to~aos meus ir -- | mãos. __ _
      }
    }
    theChords = \chordmode {
      \repeat volta 2 {
        s4 | a1:m | a1:m | a1:m | g1
        | g1 | a1:m | \parenthesize c2 g2:7 | c2.
      }
    }
    %\setStaffSize #15 % for better fit
    \include "ulsbs-include-tail.ly"
  \end{lilypond}\end{lilywrap}
  \begin{translation}[EN]
    I am a son of the Power, and in this house I am
    Doing my spiritual works that my Mother ordered me to do
    \nextverse
    I asked my Father, He gave me His consent
    To work for my brothers and my sisters, those who are ill
    \nextverse
    Confess your conscience and gladden your heart
    For this is the truth that I present to my brothers and my sisters
  \end{translation}
\endsong
