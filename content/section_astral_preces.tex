...
{ % Put everything in this file in a block to not bleed settings
  ...
  \newcommand{\subtitle}[1]{
    \vspace{3ex}\textbf{\textit{#1}}\vspace{1.618034ex}
  }
  ...
  \begin{songs}{}
    ...
    \begin{intersong}
      \textnote{Ao fim do terço, (normalmente) a comandante do pelotão feminino:}
      \parspace
      ...
      \parspace
      \textnote{\textbf{[EN]} At the end of Rosary, (usually) the commander of the feminine batallion:}
      \parspace
    ...
    \beginsong{Consagração do Aposento}
      \textnote{Nos trabalhos de mesa: após Hinos da Oração}
      \parspace
      \beginverse
      ...
      \beginverse
        ...
        \textnote{In sitting works: after Oração}
        \parspace
      ...
      \beginverse
        ...
        \textnote{Istumatöissä: Oraçãon jälkeen}
        \parspace
        ...
        ELÄMÄ. Jumala on kaikkien olentojen elämän ydin. Mielen
        ja ruumiin terveys. Kuka tahansa, joka tulee tähän
        tilaan, saa tuntea elämän ja terveyden jumalallisen
        läsnäolon.
        \parspace
        Täällä on vain yksi läsnäolo, KUKOISTUS. Jumala on
        kukoistus, koska Hän saa kaiken kasvamaan ja menestymään.
  ...
  \begin{songs}{}
    ...
    \beginsong{Encerramento}
      \beginverse
        \textnote{Dirigente do trabalho pronuncia:}
      ...
      \beginverse
        ...
        \textnote{Leader of the work pronounces:}
