...
\beginsong{Ave Maria}[id={ave-maria-7ix1pj},by={Alfredo},tags={valsa},key={G},gk={A, G}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_avemaria_a]
      ...
      \[^\mn{B}]Que |\[\mnc{C#}F#m]é \[^\mn{B}]min\[^\mn{A}]ha |\[\mnc{E}E]Mãe \[^\mn{B}]mãe |\[\mnc{D}\ac<1>{Bm7} \ac<2>{E7}]do \[^\mn{C#}]nos\[^\mn{/}]so |\[\mnc{/}\ac<1>{E} \ac<2>{A}]Pai
    \endrep
    ...
    \beginrep\memorize[chords_avemaria_b]
      ...
      |\[\mnc{F#}\ac<1>{F#m7} \ac<2>{D}]{Que o} \[^\mn{E}]nosso |\[\mnc{B}\ac<1>{Bm} \ac<2>{E}]{Pai é} \[^\mn{C#}]o |\[\mnc{/}\ac<1>{Bm7} \ac<2>{E7}]Rei \[^\mn{C#}]do \[^\mn{/}]Po|\[\mnc{/}\ac<1>{E} \ac<2>{A}]der
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Santa Maria \\ Louvada Seja}[id={santa-maria-1fgrov},by={Paulo Roberto},key={Am},gk={Am, Gm--G\shrp{}m--(Am)}]
  ...
  \mnbeginverse
    ...
    \beginrep\memorize[chords_louvada_b]
      ...
      Com o Di\[\bm]vino Pai \[^\mn{E}]E|\[\mnc{B}\ac<1>{Bm7&5} \ac<2>{E7}]{terno, para} \[^\mn{C}]sem\[^\mn{B}]pre eu de\[^\mauiic{A}{B}]{vo a}|\[\mauiic{A}{E}\ac<1>{E} \ac<2>{Am}]mar
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Luz de Jesus \\ O Virgem Mãe}[id={luz-de-jesus-pmrugh},by={Isabela Coutinho},key={Dm},gk={Dm, Cm, Bm}]
  ...
  \beginverse
    \beginrep
      ...
      No di\[A]{a de} \[\mnd{A}]sua \[\mnd{A}]pas|sagem consa\[Em7&5]grou a \[\mnd{B&}]u\[\mnd{B&}]ni|\[A]ão\[\bm]{} \altchords{E | - Bm7\flt{}5 |E \e}
      E foi lim|\[Gm]{par bem} o \[A]seu terre|iro \altchords{|Dm E | \e}
      Nos dei\[Dm]xando o \[\mnd{A}]seu \[\mnd{A}]a|\[Gm]mor dentro de \[A7]cada cora|\[Dm]ção\[\bm]
...
\beginsong{São Paulo}[id={sao-paulo-pt7kcq},by={Glauco Villas Boas},key={Am},gk={Am}]
  ...
  \mnbeginverse[1]
    \beginrep\memorize[chords_saopaulo_b]
      \[^\mn{A}]Va\[^\mn{B}]mos |\[\mnc{C}Am]todos \[\mnc{B}E7]fi\[^\mn{A}]car |\[\mnc{C}Am]fir\[^\mn{B}]mes
      \[^\mn{A}]Ca\[^\mn{B}]da |\[^\mn{C}]um em \[\mnc{B}E7]seu \[^\mn{A}]lu|\[\mnc{C}Am]gar
      \[^\mn{B}]Que \[^\mn{A}]vai \[^\mn{B}]che|\[\mnc{C}C]gar \[^\mn{E}]mais apa|\[\mnc{D}Bm7&5]rel\[^\mn{C}]ho
      \[^\mn{B}]Para \[^\mn{C}]mais |\[\mnc{E}E7]for\[^\mn{D}]ça a\[^\mn{C}]pa\[^\mn{B}]rel|\[\mnc{A}Am]har
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Forças da Rainha da Floresta}[id={forcas-da-rainha-da-floresta-h1wewm},ititle={Santa Maria vem chegando},by={Irineu Barsé},tags={valsa},key={Am},gk={Bm, (Am)--(Cm)}]
  ...
  \mnbeginverse[1]
    \beginrep
      \[\mn{E}]Eu \[\mn{A}]vou \[\mn{G}]se|\[\mnc{F}Dm]guindo sem\[\mn{E}]pre \[\mn{D}]no \[\mn{C}]ca|\[\mnc{B}G]minho
      \[\mn{D}]Sem\[\mn{G}]pre \[\mn{F}]gui|\[\mnc{E}C]ado pe\[\mn{D}]la \[\mn{C}]luz \[\mn{B}]di|\[\mnc{A}F]vina
      \[\mn{E}]Sem\[\mn{F}]pre \[\mn{E}]bus|\[\mnc{D}Dm7]can\[\mn{B}]do apren|\[E]der nes\[\mn{C}]ta \[\mn{B}]dou|\[Am]tri\[\mn{A}]na | \e
    \endrep
  \mnendverse
  \notesoff
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
