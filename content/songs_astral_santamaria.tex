...
\beginsong{Ave Maria}[by={Alfredo},tags={valsa},key={G},gk={A, G}]
...
\beginsong{Santa Maria \\ Conhece Santa Maria}[by={Alfredo},key={C},gk={D, C}]
...
\beginsong{Amor, Verdade e Justiça \\ Vou Receber Minha Mãe}[by={Alfredo},key={C},gk={C}]
...
\beginsong{Santa Maria \\ Louvada Seja}[by={Paulo Roberto},key={Am},gk={Am, Gm--G\shrp{}m--(Am)}]
...
\beginsong{E ê Santa Maria}[by={Maria Alice},key={D},gk={D}]
...
\beginsong{Minha Santa Maria é Livre}[by={Nonato Texeira},key={A},gk={A}]
...
\beginsong{Santa Maria foi quem me Chamou}[by={Ronaldo Rocha},tags={mazurca},key={C},gk={D, C}]
...
\beginsong{Salve Rainha}[by={Alex Polari},tags={valsa},key={C},gk={D, C}]
...
\beginsong{Santa Maria \\ Declaração}[by={Sonia Maria Palhares},tags={2x},key={D},gk={D}]
...
\beginsong{São Paulo}[by={Glauco Villas Boas},key={Am},gk={Am}]
...
\beginsong{São Damião}[by={Cristina Raulino},key={Dm},gk={Dm, Am}]
...
\beginsong{Estrelas Divinas}[by={Tetê}, key={C}, gk={C}]
...
\beginsong{São Irineu}[by={Solon Brito},tags={2x},key={C},gk={C, A}]
