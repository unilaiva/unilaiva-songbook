...
\beginsong{Mensageiro da Luz}[by={Albertina Corrente}, key={C}, sks={C, C--D}, tags={valsa}, ex={not in all books}]
  ...
  \begin{translation}
    ...
    \nextverse
    I played my bugle to remember
    \nextverse
    To follow this Path, everyone has to firm
    \nextverse
    I'm a hummingbird, I'm from the realm of love
    \nextverse
