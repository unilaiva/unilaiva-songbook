...
\beginsong{Pai nosso \& Ave Maria}[id={pai-nosso-ave-maria-k0tjju},tags={3x}]
  \vspace*{3.65ex}
...
\beginsong{Credo}[id={credo-rizcnf},tags={Mesa Branca, São Miguel}]
  \begin{passage}[PT]{}
...
\sclearpage
\beginsong{Prece de Cáritas}[id={prece-de-caritas-4mjaof},tags={cura},by={Medium Madame W. Krell (25 de Dezembro de 1873 em Bordeaux, França)}]
  \begin{passage}[PT]{}
...
\beginsong{Salve Rainha}
  [id={salve-rainha-cqh6na}]\begin{passage}[PT]{}
...
\beginsong{Encerramento}
  [id={encerramento-nwu6uo}]\begin{passage}[PT]{}\vspace{-1ex}% to fit on page
...
\beginsong{Sinal da Cruz}[id={sinal-da-cruz-6uzryk},tags={bailado, São Miguel, Mesa Branca}]
