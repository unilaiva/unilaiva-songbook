...
\beginsong{Firmeza}[id={firmeza-34kaiz},by={Sebastião},tags={à capela},key={A},gk={A, G--B}]
  ...
  \mnbeginverse
    ...
    \beginrep
      \meter{4}{4}
      \[\mn{A}]Eu \[\mn{B}]es\[\mn{C#}]tou |\[\mnc{D}D]firme com \[\bm]meu Je|sus \altchords{|D |Bm}
      \[\mn{F#}]Eu \[\bm]estou |\[\mnc{A}A]fir\[\mn{A}]me \[E]nes\[\mn{B}]ta |\[\mnc{C#}A]luz \altchords{|A |F\shrp{}m}
      \[\mn{E}]A\[\mnc{D}E7]on\[\mn{B}]de es|\[\mnc{A}A]tou \altchords{E7 |A}
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep
    ...
    \beginrep
      \meter{4}{4}
      \[\mn{A}]O \[\mn{B}]Mes\[\mn{C#}]tre |\[\mnc{D}D]manda eu \[\bm]traba|lhar \altchords{|D |Bm}
      \[\mn{F#}]O \[\bm]Mestre |\[\mnc{A}A]man\[\mn{A}]da eu \[E]me \[\mn{B}]fir|\[\mnc{C#}A]mar \altchords{A |F\shrp{}m}
      \[\bm]No \[\mn{D}]lu|\[\mnc{E}E7]gar \[\mn{D}]on\[\bmc\mn{B}]de E\[\mn{C#}]le es|\[\mnc{A}A]tá \altchords{|E7 A}
    \endrep
  \mnendverse
...
\beginsong{Eu Estou Firme com meu Jesus}[id={eu-estou-firme-com-meu-jesus-mafhl7},by={Sebastião},tags={2x},key={D},gk={D, (D)--D\shrp{}--G}]
  ...
  \beginverse\replay[chords_euestoufirme_a]
    \beginrep
      Foi \[\bm]Ela quem man|^dou eu me u^nir \noteson\[\mnd{A}]com \[\mnd{F#}]meus \[\mnd{A}]ir\notesoff |^mãos
...
\beginsong{Eu Vivo Neste Mundo}[id={eu-vivo-neste-mundo-mpklf9},by={Sebastião},key={C},gk={D, C--D}]
  ...
  \beginverse\replay[chords_euvivonestemundo_a]
    \beginrep
      Meu |^Mes\noteson\[\mnd{G}]tre é \[\bmc\mnd{C}]quem \[\mnd{E}]me \notesoff|^gui^a
      Meu |^Me\noteson\[\mnd{F}]stre \[\mnd{E}]é \notesoff^quem me en|^si^na
    \endrep
  ...
  \beginverse\replay[chords_euvivonestemundo_a]
    \beginrep
      Foi |^E\noteson\[\mnd{G}]le \[\bmc\mnd{C}]quem \[\mnd{E}]me \notesoff|^deu ^
      Foi |^E\noteson\[\mnd{F}]le \[\mnd{E}]quem \notesoff^me man|^dou^
    \endrep
    \endverse\glueverses\beginverse\replay[chords_euvivonestemundo_b]
    \beginrep
  ...
  \beginverse\replay[chords_euvivonestemundo_a]
    \beginrep
      |^Pa\noteson\[\mnd{G}]ra \[\bmc\mnd{C}]ter \[\mnd{E}]o a\notesoff|^mor
      ^E sen|^tir no ^cora|^ção^
    \endrep
    \endverse\glueverses\beginverse\replay[chords_euvivonestemundo_b]
    \beginrep
      Ro|^gar ao ^Pai E|^terno
      Pa\noteson\[\mnd{E}]ra \[\bmc\mnd{A}]rece\notesoff|\[Dm]ber o \[G7]meu per|\[C]dão\[\bm]
    \endrep
  \endverse
  \brk
  \beginverse\replay[chords_euvivonestemundo_a]
    \beginrep
      |^Pa\noteson\[\mnd{G}]ra \[\bmc\mnd{C}]ter \[\mnd{E}]o per\notesoff|^dão
      ^E tra|^balhar ^com a|^mor^
    \endrep
    \endverse\glueverses\beginverse\replay[chords_euvivonestemundo_b]
    \beginrep
      Pres|^tar bem ^aten|^ção
      ^Os en|^si\noteson\[\mnd{F}]nos \[\mnd{E}]do\notesoff{} ^profes|^sor^
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
    % transcribed by larva, latest update on 2024-03
