...
\beginsong{Firmeza}[by={Sebastião}, tags={à capela}, key={A}, gk={A, G--B}]
...
\beginsong{Eu Estou Firme com meu Jesus}[by={Sebastião}, tags={2x}, key={D}, gk={D, (D)--D\shrp{}--G}]
...
\beginsong{Eu Vivo Neste Mundo}[by={Sebastião}, key={C}, gk={D, C--D}]
...
\beginsong{Tábuas de Moisés}[by={Sebastião}, key={A}, gk={A, G--B}]
...
\beginsong{O Valor que o Mestre Tem}[by={Sebastião}, key={C}, gk={D, C--D}]
