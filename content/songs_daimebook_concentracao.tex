...
\beginsong{Tábuas de Moisés}[by={Padr. Sebastião},key={A},sks={A, B, G}]
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    ...
    \include "tex/lp-include-tail.ly"
  \end{lilypond}\end{lilywrap}
  \begin{translation}\scriptsize % to fit all on one spread
...
\beginsong{O Valor que o Mestre Tem}[by={Padr. Sebastião},key={C},sks={D, C}]
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    ...
    \layout { #(layout-set-staff-size 16) } % to fit all on one spread
    \include "tex/lp-include-tail-vocalsbelow.ly"
    \end{lilypond}\end{lilywrap}
  \translationoff
  \begin{translation}
