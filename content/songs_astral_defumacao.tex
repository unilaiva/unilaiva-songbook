...
\scleardpage
\beginsong{Defumação 1}[ph={I},tags={2x},key={Am},sks={Am, Bm}]
...
\beginsong{Defumação 2}[tags={valsa, 2x},ph={I},key={Am},sks={Am}]
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    ...
    theMelody = \relative e'' {
      ...
      \repeat volta 2 {
        ...
        d4 | d4 e4 f4 | e4 f4 e4 | d c b | b a _\markup\italic "D.C."
      }
    }
    theLyricsOne = \lyricmode {
      \repeat volta 2 {
