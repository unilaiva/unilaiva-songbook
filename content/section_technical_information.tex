...
\clearpage
\IfLangTF{portuguese}{%
  \section{Círculo das Quintas}
  \imagecc[0]{Circle_of_Fifths_by_larva__CC-BY-NC-SA_PT.pdf}
  \section{Modos e Acordes}
}{%
  \section{Circle of Fifths}
  \imagecc[0]{Circle_of_Fifths_by_larva__CC-BY-NC-SA.pdf}
  \section{Modes and Chords}
}

\vfill
\renewcommand{\arraystretch}{1.3} % >1.0 increases vertical padding for tabular
...
\ifcharangobook\else\ifbassclefbook\else% % do not show guitar chords for special variants
  \clearpage
  \IfLangTF{portuguese}{%
    \section{Acordes para Violão}
  }{%
  ...
  \imagecc[2]{mandala-illusion_transparent_bg_1280px.png}
\fi\fi%
