...
\begin{intersong}
  ...
  \begin{center}
    \includegraphics[width=0.6\textwidth]{lotus_om_bw_transparent_bg_2000px.png}
  \end{center}
\end{intersong}
...
\beginsong{Ganesha Mantra \\ Om Gam Ganapatayei Namaha \\ Removing of obstacles Mantra }[by={Prembababnda},tags={Ganesha 1}]
  ...
  \begin{explanation}
    ...
    \end{description}
  \end{explanation}
  \begin{center}\includegraphics[width=0.25\textwidth]{ganesha_bw_transparent_background_1280x1232.png}\end{center}
  \textnote{song: part A}
  \beginchorus\memorize % memorize chords even though in 'chorus'
...
\beginsong{Govinda Hari Om}[ah={334},tags={Vishnu 1}]
  \meter{4}{4}
  \beginverse
