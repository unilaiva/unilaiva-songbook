...
\beginsong{Hetki}[by={larva},tags={kiitollisuus 1}]
  \beginchorus\memorize
    |\[Dm]Mieli |\[Gm]kuljettaa |\[Am]mennee\[Am7]seen ja |\[Dm]tulevaan |
    |\[Dm]Hetki |\[Gm]katoaa |\[Am]aja\[C]tusten |\[Dm]mukana |
  \endchorus
  \beginchorus
    |\[Dm]Oi kuinka \[C]kaipaan |\[Dm]niin |
    |\[Bb]Sitä mitä \[C]en osaa |\[Dm]saavuttaa
  \endchorus
  \beginchorus
...
\beginsong{Minne olenkaan matkalla}[by={larva}]
  \beginchorus
    |\[Am]Minne mä olenkaan |\[F]matkalla, |
    |\[C]tiedä sitä |\[Em]en
  \endchorus
  \beginverse
  ...
  \beginchorus
    ...
    |\[Em]Dam padadam-|Padadam-padam-|\[Am]Dam \textsuperscript{2}(| | |)
  \endchorus
  \beginverse
    \chorusindent |\[Dm]Ympärilläni | näen |\[Am]surua, | |
    \chorusindent |\[Dm]paljon | on myös |\[Am]iloa | |
    \chorusindent |\[C]Elämä |\[G]kaunis |\[Am]on | |
  \endverse
  \beginverse
