...
\beginsong{Kyynikolle pelastus}[by={larva},ex={to be removed?}]
  \beginchorus
...
\beginsong{Matkustan}[by={larva},ex={to be removed?}]
  \beginverse
  ...
  \beginchorus
    ...
    |\[Em]Siellä se sisällä (syvällä)\textsuperscript{2} |\[Am]on |
  \endchorus
\endsong
