...
\beginsong{Om Purnam \\ Purnamadah}[by={traditional, Shantala \& Satyaa \& Sari},ex={from Upaniṣad, the first prayer}]
  \beginverse
    |\[Am]\[Am/B] |\[Am]\[Am/B] |\[Am]\[Am/B] |\[Am]\[Am/B] |
  \endverse
  \beginverse
    |\[Am\note{A}]Purnama\[Am/B]dah |\[Am]Purnami\[Am/B]dam |
...
\beginsong{Mahamrityunjaya Mantra}[index={Om Tryambakam}]
  \capo{2}
  \beginverse
    |\[C\note{E}]Om Tryambaka|\[G]m Yajamah|\[Dm]e |\[Fmaj7] |
...
\beginsong{Moola Mantra}[by={traditional, Seven, Deva Premal},index={Om Satchitananda Parabrahma},tags={source 1}]
  \capo{3}
  \beginchorus
    Om |\[Am\note{A}]Satchitananda |Parabrahma |
...
\beginsong{Gayatri Mantra}[index={Om Bhur Bhuvah Svaha\ldots},tags={enlightenment 1}]
  \capo{5}
  \beginverse
    \[Am] \[\note{A}]Om |\[G]Bhur Bhuvah Sva|\[Am]ha
...
\beginsong{Om Asato Ma \\ Pavamana Mantra}[ex={from Bṛhadāraṇyaka Upaniṣad},tags={transcendence 1}]
  \beginverse
    |\[Am\note{A}]O|\[Em]om asato ma |\[Am]sat gamaya |
...
\beginsong{Jay Shri Ma \\ Ananda Ma \\ Kali Ma}[tags={Divine Mother 1}]
  \beginchorus
    |\[Dm\note{D}]Jay shri \[F]ma |Kali Kali \[Gm]ma |
    |\[Gm]Jay shri \[Dm]ma | |
  \endchorus
  \beginchorus
...
\beginsong{Jay Ambe}[tags={Divine Mother 1}]
  \beginchorus
    |\[Dm\note{D}]Jay Ambe |\[C]Jagadam\[Am]be |
...
\beginsong{Om Namah Shivaya}[tags={Shiva 1}]
  \beginchorus\memorize % memorize chords even though in 'chorus'
    \textnote{intro:}
    |\[Am\note{A}]Om Namah Shi|\[F]vaya; |\[G]Om Namah Shi|\[Am]vaya |
  \endchorus
  \notesoff
  \beginchorus
...
\beginsong{Shiva Shambo}[tags={Shiva 1, Divine Mother 1}]
  \beginchorus\memorize
    |\[Am\note{A}]Jaya Jaya Shiva Sham|bo, |\[G]Jaya Jaya Shiva Sham|\[Am]bo | \rep{2}
...
\beginsong{Haidakandhi}[tags={Shiva 1, Vishnu 1}]
  \meter{4}{4}
  \beginchorus
    |\[Am] \[\note{A}]Om namah shi|\[F]vaya namah |\[C]om |\[G]haidakandhi |
  \endchorus
  \notesoff
  \beginchorus
...
\beginsong{Ganesha Mantra \\ Removing of obstacles Mantra }[index={Om Gam Ganapatayei Namaha},by={Prembababnda},tags={Ganesha 1}]
  ...
  \textnote{song: part A}
  \beginchorus\memorize % memorize chords even though in 'chorus'
    |\[Em\note{E}]Om Parvati Patayei |\[Bm]Hara Hara Hara Mahadeva |
...
\beginsong{Govinda Hari Om}[tags={Vishnu 1, Krishna 1}]
  \meter{4}{4}
  \beginverse
    |\[Am\note{A}]Govin|\[Dm]da | Hari |\[Am]Om Hari |\[E]Hari |
...
\beginsong{Om Namo Narayana}[tags={transcendence 1}]
...
\begin{intersong}%
  ...
  \end{center}
  \begin{description}
    \item[Sahasrāra] English: "thousand-petaled", the crown chakra.
    \item[Ājñā] English: "command", the third eye chakra.
    \item[Viśuddha] English: "especially pure", the throat chakra.
    \item[Anāhata] English: "unstruck", the heart chakra.
    \item[Maṇipūra] English: "jewel city", the solar plexus chakra.
    \item[Svādhiṣṭhāna] English: "one's own base", the sacral chakra.
    \item[Mūlādhāra] English: "root support", the root chakra.
  \end{description}
\end{intersong}
