...
\beginsong{Ganesha Sharanam}[tags={Ganesha 1},ph={I, IV}]
  % See: https://soundcloud.com/sound-of-light/61-ganesh-sharanam
  \beginverse
...
\beginsong{Jaya Ganesha}[tags={Ganesha 1},ph={I, IV}]
  % See: https://soundcloud.com/sound-of-light/60-jai-ganesh
  \beginchorus
...
\beginsong{Guru Brahma}[by={Adi Sankaracharya},tags={teacher 1},ph={II, III}]
  \transpose{5}
  \beginverse
...
\beginsong{Sudhossi Budhossi \\ Forever Pure}[by={trad., Shimshai},ex={saṃskṛtam, english, español}, tags={liberation 1, transcendence 1},ph={III}]
  % See: https://www.youtube.com/watch?v=AMH7WaiLqWk
  \newchords{sudhossi_a}\newchords{sudhossi_b}
  \meter{3}{4}
