...
\beginsong{Mataji}[by={Elisabet Just},tags={Divine Mother 1},ex={saṃskṛtam, português}]
  %\transpose{3}
  \beginchorus % x 2?
    |\[Am\noteULL{A}]Ayi Ayi Ayi Ayi Di|wa\[\noteU{B}]li \[\noteU{A}]Hai Ye Ayi |
    |\[G]Aise Shubha\[C]wasar Par Hum |\[Em]Puje Maha \[Am]Lakshmi |
    |\[Am]Sabhi Devi Devata |Aapa Hi Ko Puje |
    |\[C]Nirmala \[Em]Ma, O Maiya |\[Am]Nirmala Ma
    \lrep O Chindra|wara, Wali Maha, Laksh|\[C]mi Mata\[Am]ji \rrep
  \endchorus
  \beginverse
    \chordsoff
    \small Ô iê iê iê, ô iê iê xoroodô olomi aiê xorô ómanféé xoroodô
  \endverse
  \beginchorus % 4 x
  ...
  \endchorus
  \beginchorus % 2 x
    Eu |\[Am]vi mamãe O|xum na cacho|\[G]eira | sen-|
    |\[F]tada na bei|\[Em]ra do r|\[Am]io | -
  \endchorus
  \beginchorus % 4 x
