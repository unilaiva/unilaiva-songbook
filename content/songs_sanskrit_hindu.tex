...
\beginsong{Moola Mantra}[index={Om Satchitananda Parabrahma},tags={source 1},ph={I, II}]
  ...
  \endchorus
  \vfill % helps in positioning this song on a spread by itself
  \begin{feeler}
...
\beginsong{Gayatri Mantra}[index={Om Bhur Bhuvah Svaha\ldots},tags={wisdom 1},ph={III}]
  \beginverse
...
\beginsong{Prabhu Aap Jago}[by={Carioca},tags={source 1, transcendence 1},ph={III}]
...
\beginsong{Devi Mantra \\ Sarva Mangala}[tags={Divine Mother 1, Shiva 1},ph={III, IV}]
  ...
  \beginverse
    ...
    \chorusindent |\[Am]Om Namah Shivaya, |\[C]Om \[G]Nama Shiv|\[Am]aya \textsuperscript{1}(| \e)
  \endverse
...
\beginsong{Mataji}[by={trad., \textmd{combined by:} Elisabet Just},tags={Divine Mother 1},ex={saṃskṛtam, português},ph={IV}]
  ...
  \endchorus
  \beginchorus
    Ô iê iê i|\[Am]ê, ô iê iê |Xoroodô {\small\hfill \textsuperscript{*}|Ayi Ayi\ldots}
    Ô iê iê i|\[Am]ê, ô iê iê |Xoroodô {\small\hfill \textsuperscript{*}|Ayi Ayi\ldots}
  ...
  \beginchorus\musicnote{decelerando}
    |\[Am]Om Mani Padme Hum | \e {\small\hfill \textsuperscript{*}Ô iê iê i|ê, ô iê iê |Xoroodô}
  \endchorus
  \beginchorus
  ...
  \end{translation}
  \vfill%
  % Downloaded from: https://openclipart.org/detail/185904/lily
  % Original: Drinks of the World --- James Mew and John Ashton, 1892
  % License: Public Domain
  % 0.618^5 ~ 0.090 (Golden Ratio)
  \hfill\includegraphics[width=0.090\textwidth]{lily_drawing_bw_transparent_bg_PD__1025px.png}%
  \vfill%
  \begin{explanation}
    \begin{description}
...
\beginsong{Om Namah Shivaya}[tags={Shiva 1},ph={IV}]
  ...
  \begin{center}
    \vfill%
    % Downloaded from: https://imgbin.com/png/VxTaSrxf/shiva-hanuman-art-ganesha-sai-baba-of-shirdi-png
    % License: Free for non-commercial use
    % 0.618^3 ~ 0.236 (Golden Ratio)
    \includegraphics[width=0.236\textwidth]{shiva_bw_transparent_bg_760x859px.png}%
    \vfill%
  \end{center}
\endsong
...
\beginsong{Guru Brahma}[by={Adi Sankaracharya},ph={II, III}]
  \transpose{5}
  \beginverse
    \[\noteU{E}]Gur|\[C]ur Brahm|\[Am]a Gur|\[B7\noteUL{F#}]ur \[\noteU{E}]Vishn|\[Em\noteULL{G}]u
...
\begin{intersong}%
  ...
  \begin{center}
    \vfill%
    \includegraphics[width=0.618\textwidth]{Chakras_map_997x1132px.png}%
    \vfill
  \end{center}
  \begin{description}
