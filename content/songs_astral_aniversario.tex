...
\beginsong{Parabens}[id={parabens-m5u2v9},key={D},gk={E, C--E}]
  \audio[key=F]{https://www.youtube.com/watch?v=oLbncgnf8Q4}
  \mnbeginverse
    \beginrep
      \[^<A>]Para|\[<B>D]bens \[<* A>]pra \[^<D>]vo|\[<C#>A]cê\[<*>]
      \[^<A>]Nesta |\[^<B>]da\[<* A>]ta \[^<E>]que|\[<D>D]ri\[<*>]da
      Muitas |\[^<A>]fe\[<* F#>]li\[^<D>]ci|\[<C#>A]da\[<B>G]des
      \[^<G>]Muitos |\[<F#>D]a\[<C#>A7]nos \[^<E>]de |\[<D>D]vi\[<*>]da
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Estamos Todos Reunidos}[id={estamos-todos-reunidos-thg92n},by={Odemir},key={D},gk={D, C--E}]
  \audio[key=D]{https://www.youtube.com/watch?v=Tu7ulMvgS50}
  \mnbeginverse
    \beginrep
      \[^<D>]Es\[^<F#>]ta\[^<A>]mos |\[<F#>D]to\[^<D>]dos \[<* C#>]re\[^<B>]u|\[<G>Em]ni\[^<E>]dos
      \[<* C#>]Com \[^<A>]a|\[<G>A7]mor \[^<E>]no \[<* C#>]co\[^<A>]ra|\[<A F#>D]ção\[<*>]
      Co\[^<A>]mo é |\[^<F#>]lin\[^<D>]do \[<* C#>]nós \[^<B>]bai|\[<G>G]larmos
      \[<*>]Nes\[^<A>]te |\[<F#>D]di\[^<D>]a \[<E>A7]de \[^<C#>]São |\[<D>D]João\[<*>]
    \endrep
  \mnendverse
  \notesoff
  \beginverse
