...
\beginsong{Eu Peço}[by={Mestre Irineu Serra},key={C},sks={D, C}]
  ...
  \fi
  \mnbeginchorus
    \[\mn{E}]Eu |\[\mnc{C}C]pe\[\mnc{G}(G)]ço, \[\mn{E}]eu |\[\mnc{C}C]pe\[\mnc{G}(G)]ço \altchords{\id[1]{(D)}|D (A) |D (A)}
    \[\mn{E}]Eu |\[\mnc{C}C]pe\[\mn{G}]ço ao \[\mn{C}]Pai \[\mn{E}]Di|\[\mnc{D}Dm]vino \altchords{|D |Em}
    Que me |dê a Santa |\[\mnc{G}G7]Luz \altchords{|- |A7}
    Para ilu\[\mn{F}]mi|\[\mnc{E}(Em)]nar \[\mn{D}]o \[\mnc{C}G7]meu \[\mn{B}]ca|\[\mnc{C}C]minho \altchords{|(F\#m) A7 |D}
  \mnendchorus
  \mnbeginchorus\memorize
  ...
  \beginchorus
    ...
    Que só |Vós pode no |^dar \altchords{|- |G}
...
\beginsong{Está Força}[by={Mestre Irineu Serra},tags={2x, valsa}, key={C},sks={D, C}]
  ...
  \mnbeginchorus\memorize[chords_estaforca_a]
    ...
    |\[^\mn{G}]Eu de\[^\mn{C}]vo a|\[\mnc{A}Am]mar \[^\mn{C}]no |\[\mnc{B}G/B]meu \[^\mn{C}]co\[^\mn{D}]ra|\[\mnc{G}G]ção. | \e \altchords{|- |Bm |A/C\# |A | \e}
  \mnendchorus\glueverses\mnbeginchorus\memorize[chords_estaforca_b]
    ...
    |\[Em]A be\[^\mn{C}]ne|\[\mnc{A}Am]fí\[^\mn{C}]cio |\[\mnc{B}G7/B]dos \[^\mn{C}]meus \[^\mn{D}]ir|\[\mnc{C}C]maõs. | \e \altchords{|F\#m |Bm |A7/C\# |D | \e}
  \mnendchorus
  \notesoff
...
\beginsong{Aqui Estou Dizendo}[by={Mestre Irineu Serra},key={Am},sks={Am, Bm}]
  ...
  \mnbeginchorus\memorize
    \[^\mn{E}]A|\[\mnc{A}Am]qui \[^\mn{G}]es\[^\mn{F}]tou \[^\mn{E}]di|\[\mnc{G}Dm]zen\[^\mn{F}]do\[(Dm/F)]
    \[^\mn{D}]A|\[\mnc{G}G]qui \[^\mn{F}]es\[^\mn{E}]tou \[^\mn{D}]can|\[\mnc{F}F]tan\[^\mn{E}]do\[E7]
    \lrep \[^\mn{C}]Eu |\[\mnc{A}Am]digo \[\mnc{C}(C)]pa\[^\mn{E}]ra |\[\mnc{D}Dm]todos
    \[^\mn{E}]E \[^\mn{F}]os |\[\mnc{E}E7]hinos \[^\mn{D}]estão \[\mnc{C}(C)]en\[^\mn{B}]si|\[\mnc{A}Am]nando \rrep
  \mnendchorus
  \notesoff
  \beginchorus
...
\beginsong{Flor das Águas}[by={Mestre Irineu Serra},tags={2x},key={Am},sks={Cm, Am, Dm}]
  ...
  \beginchorus
    |\[\mnc{E}Am]Flor \[\mn{C}]das |\[\mnc{D}Dm]águas
    \[\mn{C}]Da \[\mn{D}]on\[\mn{F}]de |\[\mnc{E}E]vens, para \[\mnc{D}(E7/D)]on\[\mn{E}]de |\[\mnc{C}Am]vais
    Vou \[\mn{B}]fa|\[\mn{A}]zer a mi\[\mnc{C}C]nha \[\mn{D}]lim|\[\mnc{E}E]peza
    No \[\mnc{D}(E7/D)]cora|\[\mnc{C}C]ção \[\mn{B}]es\[\mnc{G#}E]tá \[\mn{B}]meu |\[\mnc{A}Am]Pai
  \endchorus
  \mnbeginchorus\memorize
...
\beginsong{Eu Pedi}[by={Mestre Irineu Serra},key={G},sks={G, A}]
  ...
  \mnbeginchorus\memorize
    \[^\mn{D}]Eu pe|\[\mnc{G}G]di, \[^\mn{D}]eu pe\[^\mn{G}]di, \[^\mn{D}]eu pe|\[\mnc{G}(C)]di
    \[^\mn{B}]Eu \[^\mn{D}]pe|\[\mnc{G}G]di Ma\[^\mn{A}]mãe \[^\mn{G}]me |\[\mnc{E}C]deu
    \[^\mn{A}]Para |\[Am]mim \[^\mn{C}]a\[\mnc{B}(D)]pre\[^\mn{A}]sen|\[\mncii{B}{G}G]tar \[(Em)]
    \[^\mn{B}]Ao \[^\mn{E}]Di|\[\mnc{D}D7]vi\[^\mn{C}]no \[\mnc{A}(Am)]Se\[^\mn{B}]nhor |\[\mnc{G}G]Deus
  \mnendchorus
  \notesoff
  \beginchorus
    Meu Di|^vino Senhor \noteson|^De\[\mnlow{D}]us \notesoff
    É Pai |^de todo a|^mor
...
\beginsong{Eu Cheguei Nesta Casa}[by={Mestre Irineu Serra},key={G},sks={G, A}]
  ...
  \mnbeginchorus\memorize[chords_eucheguei_a]
    \[^\mn{B}]Eu |\[\mnc{D}G]cheguei \[\mnc{B}(Em/B)]nes\[^\mn{E}]ta |\[\mncii{D}{G}G]casa
    \[\bm]Eu \[^\mn{F#}]en|\[\mnc{A}D7]trei \[^\mn{F#}]por \[\bmc\mn{D}]es\[^\mn{C}]ta |\[\mnc{B}G]por\[^\mn{G}]ta \[\bm]
  \mnendchorus\glueverses\mnbeginchorus\memorize[chords_eucheguei_b]
    \[^\mn{G}]Eu ve\[^\mn{F#}]nho |\[\mnc{A}D7]dar os a\[^\mn{F#}]gra\[\bmc\mn{D}]de\[^\mn{C}]ci|\[\mnc{B}G]mentos
    \[^\mn{G}]A \[\mnc{B}(Em/B)]quem \[^\mn{E}]ro|\[\mnc{D}D7]gou \[^\mn{C}]por \[\bmc\mn{A}]mi\[^\mn{B}]nha |\[\mnc{G}G]volta \[\bm]
  \mnendchorus
  \notesoff
...
\beginsong{Pisei na Terra Fria}[by={Mestre Irineu Serra},key={Am},sks={Am, Bm, Cm}]
  ...
  \mnbeginchorus\memorize
    \[^\mn{E}]Pi|\[\mnc{A}Am]sei \[\bm] \[^\mn{A}]na terra |\[\mnc{C}(C)]fri\[^\mn{A}]a
    \[\bmc\mn{C}]Ne\[^\mn{E}]la |\[\mnc{G}G]eu \[^\mn{D}]sen\[\bm]ti ca|\[Dm]lor \[\bm]
    Ela é |quem \[^\mn{A}]me \[\bm]dá o |\[\mnc{E}Am]pão
    \[^\mn{C}]A \[\bmc\mn{A}]mi\[^\mn{C}]nha |\[\mnc{E}E7]Mãe\[\bm] \[^\mn{A}]que nos cri|\[Am]ou \[\bm]
  \mnendchorus
  \notesoff
  \beginchorus
