...
\beginsong{Hospede}[id={hospede-dslvgd},by={Glauco Villas Boas},key={Am},gk={Am, Bm}]
  % Offered to Eduardo
  \audio[key=Am]{https://www.nossairmandade.com/hymn/2249/Hospede}
  \newchords{chords_hospede_a}\newchords{chords_hospede_b}
  \mnbeginverse
    \beginrep\memorize[chords_hospede_a]
      |\[<A>Am]Eu convi\[<*>]dei \[^<B>]no \[^<C>]meu |\[<D>Dm]so\[<*>]nho
      Meu |Mestre va\[<F>(F)]mos passe|\[<E>E]ar
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_hospede_b]
      \[^<E>]Meu |\[<D>Dm]mestre \[<* F>]veio co|\[<E C>Am]migo
      \[<* E>]Na minha |\[<D B>E7]casa \[<* D>]me \[^<G#>]visi|\[<A>Am]tar
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_hospede_a]
    \beginrep
      |^Eu abra^çando o meu |^Mes^tre
      |Ai, meu ^Deus como é |^bom
    \endrep
    \endverse\glueverses\beginverse\replay[chords_hospede_b]
    \beginrep
...
\beginsong{Caboclo Véio}[id={caboclo-veio-vw97bb},by={Glauco Villas Boas}]
  ...
  \mnbeginverse\memorize[chords_cabocloveio_a]
    \[^<D>]Cabo\[^<F>]clo |\[<A>Dm]Véio vem a\[^<F>]qui bus\[^<E>]car um |\[^<D>]povo
    Pra nós \[^<F>]can|\[^<A>]tar e vossa \[^<F>]luz bri\[^<D>]lhar de |\[<E>A]novo
  \mnendverse
  \mnbeginverse
    \beginrep\memorize[chords_cabocloveio_b]
      Da alta es|\[Gm]fera manda a nossa luz bri|lhante
      para nós neste ins|\[A]tante ver quem sois Jurami|\[\ac{2}{Dm}]dam
    \endrep
  \mnendverse
  \notesoff
  ...
  \endverse
  \beginverse\replay[chords_cabocloveio_b]
    \beginrep
