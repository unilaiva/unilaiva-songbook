...
\beginsong{Avaruus aukeaa sisältä}[id={avaruus-aukeaa-sisalta-mp9kho},by={larva},tags={sydän, avaruus},ph={II, III},key={Am},gk={Am}]
  ...
  \beginverse
    \beginrep
      \beginrep
        |\[\mnc{E}Em]Joskus luulen \[\bm]olevani |\[\mnc{F#}D]jotain mitä \sublyr{\up{2}en}\up{1}\[\bmc\mn{G}]min' \sublyr{vaan}\[\mn{F#}]en |\[\mnc{E}Em]oo \[\bm]|{ } \[\bm]\e
      \endrep
  ...
  \beginverse
    \beginrep
      \beginrep
        |\[\mnc{G}G]A-\[\bmc\mn{B}]va|\[\mnc{C}C]ru-\[\bm]u-|\[\mnc{B}Em]uus \[\bm]{} |{ } \[\bm]\e
      \endrep
...
\beginsong{Ajan takaa}[id={ajan-takaa-4ml5nr},by={larva},tags={rakkaus, lähde}]
  \beginverse
    \beginrep
      \beginrep
        |\[\mnc{E}Am]A-\[\bm]{} \[\mnc{D}Am7]jan |\[Em]takaa,\[\bm]{} |\[Dm]totu\[\bm]uden |\[Am]luota\[\bm]{}
      \endrep
      \beginrep
        |\[Em]To-\[\bm]{} |{ }{ }{ } \[\bm]otuu|\[Am]den \[\bm]aijjai|jajajaja\[\bm]jajajaja
      \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
      \beginrep
        |\[Am]A-\[\bm]{} \[Am7]jan |\[Em]takaa,\[\bm]{} |\[Dm]totu\[\bm]uden |\[Am]luota\[\bm]{}
      \endrep
      \beginrep
        |\[Dm]Jospa saisin \[\bm]sieltä |\[G]mukaani \[\bm]palan |\[Am]rakkaut\[\bm]ta |{ }{ }{ } \[\bm]\e
        |\[Em]Sitä kylväi\[\bm]sin |\[G]{} \[\bm]maail|\[Am]maan\[\bm]{} |{ }{ }{ } \[\bm]\e
      \endrep
    \endrep
  \endverse
...
\beginsong{Kyynikolle pelastus}[id={kyynikolle-pelastus-ovc84v},by={larva}]
  \beginverse
    \beginrep
      |\[\mnc{C}C]Mikä tääll' \[\mn{B}]on |\[\mnc{A}F]aitoo?
