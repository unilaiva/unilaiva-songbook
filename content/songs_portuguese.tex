...
\beginsong{Forças Encantadas}[by={Vinícius Rocha}, ph={I}, key={A}, gk={B, G--D\shrp{}}]
  ...
  \mnbeginchorus\memorize
    ...
    \lrep \[\bm]Es\[^\mn{F#}]sas |\[\mnc{G}G]for\[^\mn{F#}]ças \[\bmc\mnc{E}Em]en\[^\mn{D#}]can|\[\mnc{F#}B]ta\[^\mn{D#}]das \[\bmc\mn{F#}]da \[^\mn{D#}]Ra|\[^\mn{B}]in\[^\mn{D#}]ha \[\bmc\mn{F#}]da \[^\mn{/}]Flo|\[\mnc{/}\ac(1){Em}]resta \rrep
  \mnendchorus
  \notesoff
  \beginchorus
...
\beginsong{Companheiro na Escuridão}[by={Amu Ahava, Bettina Maureenji}, ph={II}, key={Am}, gk={Am, Gm--Bm}]
  ...
  \beginchorus
    ...
    \endchorus\glueverses\beginverse
    |\[Em]Niin |\[F]kuin |\[Am]ystä|vä, \lrep ys|\[F]tävä pi|\[Em \ac(3){F}]meydes|\[Am]sä | \e \rrep
  \endverse
...
\beginsong{Minha Mãe Oxumaré}[ph={II, III}, key={Em}, gk={Em, Em--F\shrp{}m}]
  ...
  \beginchorus
    ...
    Minha |\[C]mãe O\[E7]xuma|\[Am]ré \[\ac(1){A7}] \rrep \altchords{|A C\shrp{}7 |F\shrp{}m \ac(1){F\shrp{}7}}
  \endchorus
  \beginchorus
    ...
    \ind Desce |\[C]venha nos a\[E7]benço|\[Am]ar \[\ac(1){A7}] \rrep \altchords{|A C\shrp{}7 |F\shrp{}m \ac(1){F\shrp{}7}}
  \endchorus
  \begin{translation}[EN]
    My mother is Oxum
...
\beginsong{Corações da Luz}[by={Corações da Luz}, ph={III}, key={Am}, gk={Am, Gm--C\shrp{}m}]
  ...
  \beginchorus\memorize
    ...
    % maybe: \lrep |\[\ac(1){G} (\up{2}Em)]Lindo Passa|\[\ac(1){A]rinho beija-|\[Bm}]flor | \e
