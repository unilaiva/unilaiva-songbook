...
\beginsong{Guerreiro da Paz \\ Warrior of Peace}[by={Orestes Grokar},tags={Santo Daime},ph={I}]
  % See: https://www.youtube.com/watch?v=qy8G2J6ZHlw
  \beginchorus
  ...
  \endchorus
  \beginchorus
    \chorusindent[1]\[\mn{B}]Eu chamo o |\[Bm]vento, eu chamo o vento, eu chamo o |\[F#m\mn{A}]vento
    \chorusindent[1]Eu chamo o |vento vem me ele|\[Bm]var
    \chorusindent[1]Eu chamo o |fogo, eu chamo o fogo, eu chamo o |\[F#m]fogo
    \chorusindent[1]Eu chamo o |fogo para me purifi|\[Bm]car
  \endchorus
  \beginchorus
    \chorusindent[2]\[\mn{D}]Eu chamo a |\[Bm]Lua, chamo o Sol, chamo as es|\[A]tre\[\mn{C#}]las
    \chorusindent[2]Chamo o uni|verso para me ilumi|\[Bm]nar
    \chorusindent[2]Eu chamo a |água, chamo a chuva, e chamo o |\[A]rio
    \chorusindent[2]Eu chamo |todos para me la|\[Bm]var
  \endchorus
  \beginchorus
    \chorusindent[3]\[\mn{F#}]Eu chamo o |\[D]raio, o relâmpago e o tro|\[A\mn{E}]vão
    \chorusindent[3]Eu chamo |todo o poder da cria|\[Bm]ção
    \chorusindent[3]Eu chamo o |\[D]mar, chamo o céu e o infi|\[A]nito
    \chorusindent[3]Eu chamo |todos para nos liber|\[Bm]tar
  \endchorus
  \beginchorus
    \chorusindent[2]\[\mn{D}]Eu chamo |\[Bm]Cristo, eu chamo Budha, eu chamo |\[A]Krish\[\mn{C#}]na
    \chorusindent[2]Eu chamo a |força de todos ori|\[Bm]xás
    \chorusindent[2]Eu chamo |todos com suas forças di|\[A]vinas
    \chorusindent[2]Eu quero |ver o universo ilumi|\[Bm]nar
  \endchorus
  \beginchorus
    \chorusindent[3]\[\mn{F#}]Eu agra|\[D]deço pela vida e a co|\[A\mn{E}]ragem
    \chorusindent[3]Ao uni|verso pela oportuni|\[Bm]dade
    \chorusindent[3]E a minha |\[D]vida eu dedico com a|\[A]mor
    \chorusindent[3]Ao sonho |vivo da nossa humani|\[Bm]dade
  \endchorus
  \beginchorus
    \chorusindent[2]\[\mn{D}]Sou mensa|\[Bm]geiro, sou cometa, eu sou indí|\[A\mn{C#}]gena
    \chorusindent[2]Eu sou |filho da nação do Arco |\[Bm]Íris
    \chorusindent[2]Com meus ir|mãos eu vou ser mais um guer|\[A]reiro
    \chorusindent[2]Na nobre |causa do Inka Reden|\[Bm]tor
  \endchorus
  \beginchorus
    \chorusindent[3]\[\mn{F#}]Eu sou guer|\[D]reiro, eu sou guerreiro e vou lu|\[A]tan\[\mn{E}]do
    \chorusindent[3]A minha e|spada é a palavra do a|\[Bm]mor
    \chorusindent[3]O meu e|\[D]scudo é a bondade no meu |\[A]peito
    \chorusindent[3]E o meu |elmo são os dons do meu sen|\[Bm]hor
  \endchorus
  \beginchorus
    \chorusindent[2]\[\mn{D}]Eu agra|\[Bm]deço a nossa Mãe e ao nosso |\[A\mn{C#}]Pai
    \chorusindent[2]E aos meus ir|mãos por todos me aju|\[Bm]dar
    \chorusindent[2]A minha |glória para todos eu en|\[A]trego
    \chorusindent[2]Porque nós |todos somos um nesta uni|\[Bm]ão
  \endchorus
  \beginchorus
    \chorusindent[1]\[\mn{B}]Ñdarei a |\[Bm]sã, ñdarei a sã, ñdarei a |\[F#m\mn{A}]sã
    \chorusindent[1]Desde o prin|cipio, todos nós somos ir|\[Bm]mãos!
    \chorusindent[1]Orei ou|á, orei ouá, orei ou|\[F#m]á
    \chorusindent[1]Viva o Po|der de todo o uni|\[Bm]verso!
    \vspace{1em}
    \chorusindent[2]\[\mn{D}]Ñdarei a |\[Bm]sã, ñdarei a sã, ñdarei a |\[A\mn{C#}]sã
    \chorusindent[2]Desde o prin|cipio, todos nós somos ir|\[Bm]mãos!
    \chorusindent[2]Orei ou|á, orei ouá, orei ou|\[A]á
    \chorusindent[2]Viva o Po|der de todo o uni|\[Bm]verso!
    \vspace{1em}
    \chorusindent[3]\[\mn{F#}]Ñdarei a |\[D]sã, ñdarei a sã, ñdarei a |\[A\mn{E}]sã
    \chorusindent[3]Desde o prin|cipio, todos nós somos ir|\[Bm]mãos!
    \chorusindent[3]Orei ou|\[D]á, orei ouá, orei ou|\[A]á
    \chorusindent[3]Viva o Po|der de todo o uni|\[Bm]verso!
    \vspace{1em}
...
\beginsong{Luz de Vida}[by={Amu Ahava},tags={source, light},ph={III}]
...
\beginsong{Brilho da Verdade}[by={Chandra Lacombe},ph={II, III}]
  % See: https://www.youtube.com/watch?v=-wK2sENHmGU
  % See: https://soundcloud.com/paulmallon-2/brilho-da-verdade
  \beginchorus\memorize
  ...
  \endchorus
  \beginchorus
    \chorusindent \[\mn{E}]Quem a|inda está dor|\[\mnc{A}Am]min\[\mn{E}]do, na ilus|ão a se de\[\mn{G}]mo|\[\mnc{F}Dm]rar
    \chorusindent Não dá |mais pra viver fu|\[C]gindo, é pre|ciso desape|\[E]gar
  \endchorus
  \notesoff
  \beginchorus
  ...
  \endchorus
  \beginchorus
    \chorusindent Se a |ordem é se|^vera, é para |quem não se fir|^mou
    \chorusindent Quando o pen|sar é como |^vela, a luz dis|sipa o te|^rror
  \endchorus
  \beginchorus
  ...
  \endchorus
  \beginchorus
    \chorusindent Com o |brilho da ver|^dade divina es|trela vem confir|^mar
    \chorusindent Que o a|mor e a bon|^dade nessa es|fera é que vão rei|^nar
  \endchorus
  \begin{translation}
...
\beginsong{Sou Beija-flor}[by={Cristina Tati},tags={Santo Daime},ph={II, III}]
  % See: http://www.nossairmandade.com/hymn.php?hid=3664
...
\beginsong{Cura}[by={Rainer Scheurenbrand},tags={learning, sea},ph={III}]
  % See: https://rainerscheurenbrand.bandcamp.com/track/cura
  % See: https://soundcloud.com/jee-red/rainer-scheurenbrand-cura
...
\beginsong{Valor do Pedido}[by={Rainer Scheurenbrand},ph={IV}]
  % See: https://rainerscheurenbrand.bandcamp.com/track/valor-do-pedido
  % See: https://www.youtube.com/watch?v=aapo3wVFhk8
...
\beginsong{Caminhando com Fé}[by={Ambika},ph={IV}]
  % See: https://soundcloud.com/mantric-mambo/01-seguindo-com-fe
  ...
  \endverse
  \beginverse\replay[chords_caminhando_b]
    \chorusindent Vi|^rando os olhos pra |frente man|^tendo focada a |mente
...
\beginsong{Caboclo na Mata}[ph={IV}]
  % See: https://soundcloud.com/pachamamachurch/caboblo-na-mata
  \beginchorus\memorize
...
\beginsong{Eu Canto nas Alturas}[by={Mestre Irineu Serra},tags={Santo Daime},ph={IV}]
  % See: http://www.nossairmandade.com/hymn.php?hid=230
  % See: https://www.youtube.com/watch?v=-2GYf9ASAxA
  \beginchorus\memorize
  ...
  \beginchorus
    ...
    \lrep Não |^é com fingi|^mento \rrep
