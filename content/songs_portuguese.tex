...
\beginsong{Passarinho}[by={Rainer Scheurenbrand},ph={III}]
  ...
  \beginchorus\memorize[chords_passarinho_a]
    ...
    No mundo sofre|dor, dentro da ilu|\[Am]são \textsuperscript{2}(|\[Am] |\[Em] | |\[Am] )
  \endchorus
  \notesoff
  ...
  \beginchorus\replay[chords_passarinho_a]
    ...
    Olha aqui es|ta a estrela do a|^mor \textsuperscript{2}(|^ |^ | |^ )
  \endchorus
  \beginchorus\replay[chords_passarinho_a]
  ...
  \begin{center}%
    ...
    % 0.618^3 ~ 0.236 (Golden Ratio)
    \hfill\includegraphics[width=0.236\textwidth]{hummingbird_drawing_bw_transparent_bg_PD__1000px.png}%
    \vfill%
  \end{center}
  \begin{translation}
    I'm here, here with my pain,
    in the suffering world, within the illusion.
    \nextverse
    I'm here, I'm going out one day.
    One day I'll rise to the star of love.
    \nextverse
    I'm here to learn
    the mystery of my being.
    I'm here to heal.
    I'm open\ldots to the little bird.
    \nextverse
    I'm here, a voice told me:
    "look, here is the star of love."
    \nextverse
    I'm here, I came to wake up.
    I came to clear the world of illusion.
    \nextverse
    My little bird, my singer,
    take me to the star of love.
    My little bird, my teacher,
    teach me\ldots the song of love.
    \nextverse
...
\beginsong{Ó Lua}[by={Cristina Tati},tags={Moon 1, Santo Daime 1},ph={II, IV}]
  ...
  \beginchorus\memorize[chords_olua_b]
    Re|\[Am]cebe | esta prenda de A|\[Em]mor no Cora|ção.
