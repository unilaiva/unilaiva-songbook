...
\beginsong{Silencio}[by={Elves do Juruá}, ph={II}, key={Am}, gk={B\flt{}m, Gm--Bm}]
  ...
  \endverse
  \beginverse\memorize[chords_silencio_c]
    \beginrep
  ...
  \endverse
  \beginverse\replay[chords_silencio_c]
    \beginrep
...
\beginsong{Ilumina Minha Mãe}[by={Marie Gabriella}, ph={II, III}, key={Am}, gk={Am, Am--Bm}]
  ...
  \beginverse\memorize
    \beginrep
    \ind \ilsl{\[^\mn{C}]Óh} |\[\mnc{A}Am]mãe, | \[^\mn{E}]óh mãe \[^\mn{C}]de |\[\mnc{D}Dm]De|us
...
\beginsong{Ilumina}[by={Guilherme Henrique Mendonça da Silva}, tags={Sun, Moon, stars, Aya},ph={II, III}, key={C}, gk={D, C--F\shrp{}}]
  ...
  \beginverse
    ...
    \ind ilu|\[F]mi\[\bm]- |\[Am]na \[\bm]{} ilu|\[G]mi\[\bm]- |\[C]na \[\bm]{} \altchords{|Dm G |C Am |Dm G |C \ac(1){F}}
    %% with full chords:
...
\beginsong{Minha Mãe Oxumaré}[ph={II, III}, key={Em}, gk={Em, Em--F\shrp{}m}]
  ...
  \beginverse
    ...
    \beginrep Aye|\[Dm]yeo ayeyeo, aye|\[Am]yeo ayeyeo \altchords{|Bm |F\shrp{}m}
    Minha |\[C]mãe O\[E7]xuma|\[Am]ré \[\ac(1){A7}] \altchords{|A C\shrp{}7 |F\shrp{}m \ac(1){F\shrp{}7}} \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    ...
    \beginrep
    \ind Mamãe O|\[Dm]xum, ayeyeo, Mamãe O|\[Am]xum, Orixá \altchords{|Bm |F\shrp{}m}
    \ind Desce |\[C]venha nos a\[E7]benço|\[Am]ar \[\ac(1){A7}] \altchords{|A C\shrp{}7 |F\shrp{}m \ac(1){F\shrp{}7}}
    \endrep
    \endrep
  \endverse
  \begin{translation}[EN]
...
\beginsong{O Bálsamo do Céu}[by={Baixinha}, tags={Santo Daime}, ph={III}, key={Dm}, gk={Dm, Cm--D\shrp{}m}]
  ...
  \mnbeginverse
    \beginrep
    \beginrep \[\mn{A}]O |\[\mnc{D}Dm]bálsamo \[\mn{E}]do |\[\mnc{F}F]Céu \[\mn{A}]des|\[\mnc{E}A]ceu \[\mn{F}]à |\[\mnc{E}Dm]Ter\[\mn{D}]ra \endrep
    \beginrep \[\mn{A}]As |\[\mnc{B&}Gm]flo\[\mn{A}]res \[\mn{G}]da |\[\mnc{F}F]Ter\[\mn{E}]ra \[\mn{D}]rece|\[\mnc{A}A7]be\[\mn{C#}]ram \[\mn{E}]a |\[\mnc{D}Dm]Luz \endrep
    \endrep
  \mnendverse
  \beginverse\memorize
    \beginrep
    \beginrep
    \ind \[\mn{A}]Os |\[\mnc{D}Dm]homens \[\mn{E}]na |\[\mn{F}]Ter\[\mn{D}]ra \[\mn{F}]pre|\[\mnc{E}A]ci\[\mn{C#}]sam \[\mn{E}]do |\[\mnc{D}Dm]Bem
    \endrep
    \beginrep
    \ind Meu |\[Gm]Pai é quem |\[F]manda mensa|\[A7]geiros do A|\[Dm]lém
    \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    \beginrep
    \ind ^Os |^seres ^di|^vi^nos ^quem |^vem ^nos ^cu|^rar \notesoff
    \endrep
    \beginrep
    \ind Com seus |^raios de |^Luz vem nos |^ilumi|^nar
    \endrep
    \endrep
  \endverse
  \begin{translation}[EN]
...
%     \renewcommand{\chordfont}{\sffamily\bfseries\tiny\color{chordcolor}}%
%     % songs: make space between chord and lyric line smaller:
%     \renewcommand{\clineBaselineskip}{6pt}%
...
\beginsong{Mãe Verdadeira}[by={Totó}, ph={IV}, key={Am}, gk={Am, Gm--(Am)}]
  ...
  \beginverse
    \beginrep
    \ind |\[\ac(2){!}] \[\mn{F}]Olha a |linda \[\mn{D}]se|\[\mncii{F}{D}Dm]reia, | \e
...
\beginsong{Ciranda para Janaína}[ph={IV}, key={Am}, gk={Am, G\shrp{}m--(Am)}]
  ...
  \mnendverse
  \mnbeginverse
    \ind[2] \ilsl{\[\mn{D}]Ó} Ja\[\mn{C#}]na|\[\mncii{B}{F#}Bm]ína quando es|tou fe\[\mn{G}]liz \[\mn{F#}]eu |\[\mnc{C#}F#]choro | \e
    \ind[2] \ilsl{\[\mn{C#}]Ó} Ja\[\mn{B}]na|\[\mn{B&}]í\[\mn{F#}]na dei\[\mn{G}]xa eu |\[\mn{F#}]dor\[\mn{E}]mir \[\mn{D}]no \[\mn{C#}]seu |\[\mnc{B}Bm]colo | \e
    \ind[2] \echo{\ilsl{\[\mn{D}]Ó} Ja\[\mn{C#}]na|\[\mncii{B}{F#}Bm]ína quando es|tou fe\[\mn{G}]liz \[\mn{F#}]eu |\[\mnc{C#}F#]choro | \e
    \ind[2] \ilsl{\[\mn{C#}]Ó} Ja\[\mn{B}]na|\[\mn{B&}]í\[\mn{F#}]na dei\[\mn{G}]xa eu |\[\mn{F#}]dor\[\mn{E}]mir \[\mn{D}]no \[\mn{C#}]seu |\[\mnc{B}Bm]colo} | \e
  \mnendverse
  \mnbeginverse
...
\beginsong{Recado da Mãe Divina}[by={Chandra Lacombe}, ph={IV}, key={D}, gk={D, B\flt{}--E}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_recado_da_mae_a]
  ...
  \mnendverse
  \mnbeginverse
    \beginrep\memorize[chords_recado_da_mae_b]
  ...
  \beginverse\replay[chords_recado_da_mae_a]
    ...
    \endrep
  \endverse
  \beginverse\replay[chords_recado_da_mae_b]
    \beginrep
