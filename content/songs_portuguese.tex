...
\beginsong{Ela é um Ponto de Luz}[by={Marcos Trench},ph={IV}]
  ...
  \beginchorus\memorize
    |\[^\mnc{C}(C)] Ela é um ponto \[^\mn{E}]de |\[\mncii{G}{E}C]Luz | ela está na Ju|\[\mncii{D}{C}F]rema
...
\beginsong{Recado da Mãe Divina}[by={Chandra Lacombe},ph={IV}]
  ...
  \beginchorus\replay[chords_recado_da_mae_a]
    ...
    Provo o |^néctar do a^mor ma|^duro
  \endchorus
  \beginchorus\replay[chords_recado_da_mae_b]
    \ind[2] Heya he|^ya heya, ha|^yee
    \ind[2] Ha|^yee hayee ha|^yaa
    \ind[2] Ha|^yee hayaa ha|^yaa
    \ind[2] Ha|^yee ha^yee ha|^ \e
  ...
  \begin{translation}
    ...
    And I do not even yuearn for the future
