...
\beginsong{Defumação}[tags={censing 1}]
  \meter{4}{4}
  \beginchorus
...
\beginsong{Sou Brilho Do Sol \\ Olen paiste auringon}[by={Padrinho Sebastião},tags={Sun 1}]
...
\sclearpage
\beginsong{Flor Das Águas}[by={Mestre Irineu Serra},tags={water 1, sea 1}]
  \beginchorus
  ...
  \vspace{2em}
  \begin{explanation}
    It is said that after \textit{Flor Das Águas} was presented at a Santo Daime
...
\beginsong{Luz de Vida}[by={Amu Ahava},tags={source 1, light 1}]
  \meter{6}{8}
  \beginchorus
    \chorusindent |\[Dm]Luz \[Dm/F]de |\[C9/E]Vi\[C9]da |
...
\beginsong{Luz Amor e Paz}[tags={love 1, light 1, peace 1}]
...
\beginsong{Forças da Rainha da floresta}[by={Irineu Barsé}]
  \meter{3}{4}
  \beginchorus\memorize
    Santa Ma|\[Am]ria vem che|\[E]gando nesse bata|\[Am]lhão |\[A7] -
  ...
  \beginchorus
    ...
    Sempre bus|\[Dm7]cando apren|\[E]der nesta dou|\[Am]trina | -
  \endchorus
  \begin{translation}
    Santa Maria has been arriving in this company
    Bringing the forces of the Queen of the rainforest
    These are the forces that come from our Lady
    Who centralizes this light here on Earth
    \nextverse
    I always ask for my courage
    To follow in this battle of love
    With the comfort of my mother
    With its light with its radiance
    \nextverse
    I always follow the path
    Always guided by divine light
    Always seeking to learn in this doctrine
  \end{translation}
\endsong


\beginsong{Coração Do Mundo}[tags={Mother Earth 1, heart 1}]
\meter{3}{4}
  \beginverse
...
\beginsong{Sou Beija-Flor}[by={Cristina Tati}]
  \beginverse
    \lrep Sou canta|\[Am]dor; minha \[E7]vida é can|\[Am]tar \rrep
...
\beginsong{Na força da mata eu tomo meu rapé}[tags={rapé 1}]
  \beginchorus\memorize
    \lrep Na for|\[Am]ça da m\[E]ata eu tomo o |\[Dm]meu rap\[E]é \rrep
