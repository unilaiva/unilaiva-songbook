...
\beginsong{Jardim do Universo}[by={Bettina Maureenji},ph={II}]
  ...
  \endchorus
  \beginchorus
    \chorusindent\chorusindent Neste jar|\[Dm/F]dim do uni|\[Am]verso,
    \chorusindent\chorusindent luz di|\[G]vina a me ilumi|\[Am]nar
    \chorusindent\chorusindent Neste jar|\[Dm/F]dim do uni|\[Am]verso,
    \chorusindent\chorusindent sempre, |\[G]sempre a te a|\[Am]mar
  \endchorus
  \beginchorus\replay[chords_jardim_a]
