...
\beginsong{Companheiro na Escuridão}[by={Bettina Maureenji, Amu Ahava}, ph={II}, key={Am}, gk={Am, Gm--Bm}]
  ...
  \mnbeginchorus\memorize
    ...
    Ca|\[\mnc{G}Em]lor que |\[\mnc{F}F]limpa \[^\mn{E}]minha |\[\mncii{C}{B}Am]al|\[^\mn{A}]ma \[^\mn{B}]cla|\[\mnc{C}F]rea \[^\mn{F}]a |\[\mncii{B}{C}Em]men|\[\mnc{A}Am]te | \e
  \mnendchorus
  \notesoff
  \beginchorus
  ...
  \begin{lilywrap}\begin{lilypond}[]
    ...
    theMelody = \relative a' {
      ...
      \repeat volta 2 {
        ...
        | g2 g4 | f4 f e8 e | c2( b4) | a2 b4 | c2 f4 | \once\slurSolid b,2( c4) | a2.~ | a2.
      } \break
      % p2
      \repeat volta 2 {
        | c4 c4 c4 | b4 \altcol c4 \altcol b4 | a2.~ | a2. | a'4 a a | g2 a4 | e2.~ | e2. \break
        | g4 g g4 | f4 f e4 | c2( b4) | a2 b4 | c2 f4 | b,2 c4 | a2.~ | a2.
      } \break
      % p3
      \repeat volta 2 {
        | c2 c4 | b2 c4 | a2. | a2 a4 | a'4 a a | g2 a4 | e2.~ | e2. \break
        | g2 g4 | f2 e4 | c2( b4) | a4 a b | c4 c f | b,2 c4 | a2.~ | a2.
      }
      | g'2 g4 | f2 e4 | c2( b4) | a4 \break
      \repeat volta 4 {
        a b | c4 c f
        \alternative {
          \volta 1,2 { | b,2 c4 | a2.~ | a4 }
    ...
    theLyricsOne = \lyricmode {
      ...
      \repeat volta 2 {
        ...
        Ca -- | lor que | lim -- pa mi -- nha | al -- _ | ma,  cla -- | rea a | men -- _ | te. _
      }
      \set stanza = "2."
      \repeat volta 2 {
        Ve -- jo mun -- | do~u -- \altcol ni -- \altcol ver -- | sal | _ | sin -- to a | u -- ni -- | ão; | _
        | For -- ça da | luz a -- fa -- | gai -- _ | me,  dai -- | me con -- | sci -- ên -- | cia. | _
      }
      \set stanza = "3."
      \repeat volta 2 {
        | Oh tran -- | qui -- li -- | da -- | de to -- | can -- do meu | co -- ra -- | ção; | _
        | Co -- mo | um a -- | mi -- _ | go, com -- pa -- | nhei -- ro na~es -- | cu -- ri -- | dão. | _
      }
      | Co -- mo | um a -- | mi -- _ | go,
      \repeat volta 4 {
    ...
    theChords = \chordmode {
      ...
      \repeat volta 4 {
        s2 | f2.
        \alternative {
          \volta 1,2 { | e:m | a:m | a4:m }
          \volta 3 { | f2 e4:m | a2.:m | a4:m }
...
%     \layout { #(layout-set-staff-size 15) } % for better fit
  ...
  \begin{translation}\scriptsize % to save space on page
