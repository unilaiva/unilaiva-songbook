...
\beginsong{Conselho}[by={Adilson Bispo, Zé Roberto},key={C},gk={C, (B)--(C)}, ph={IV}]
  ...
  \mnendverse
  \mnbeginchorus
    \echo{\[\bmc\mn{C}]Tem \[\mn{B}]que \[\mn{A}]lu|\[\mnc{G}G7]tar}
  ...
  \begin{translation}[EN]
    ...
    \nextverse
    You have to struggle, not give in. Only surrender to those who embrace you
    I'm not giving up or selling out, as the saying goes.
