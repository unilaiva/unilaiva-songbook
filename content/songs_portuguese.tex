...
\beginsong{Salve o Rapé}[tags={rapé},key={Am},gk={Am, Gm--G\shrp{}m--(Am)}]
  ...
  \mnbeginverse\memorize[chords_salve_o_rape_a]
    \[^\mn{C}]Salve \[^\mn{D}]Tu|\[\mnc{E}Am]pã, Ju\[^\mn{C}]ra\[^\mn{D}]mi|\[^\mn{E}]dam, sal\[^\mn{F}]ve \[^\mn{E}]O|\[\mnc{D}G]xós\[^\mn{B}]si | \e \altchords{\id[1]{(Gm)}|Gm | - |F | \e}
    \[^\mn{C}]Salve \[^\mn{D}]Os|\[\mnc{E}Am]sain, Tu\[^\mn{C}]pi\[^\mn{D}]nam|\[^\mn{E}]bá, Ma\[^\mn{F}]ra\[^\mn{E}]xim|\[\mncii{D}{B}G]bé | \e \altchords{|Gm | - |F | \e}
  \mnendverse\glueverses
  \mnbeginchorus\memorize[chords_salve_o_rape_b]
    \[^\mn{B}]Salve os Ca|\[\mnc{C}F]boclos que trou|xeram \[^\mn{D}]da \[^\mn{C}]flo|\[\mncadj{1ex}{B}Am]res\[^\mn{A}]ta | \e \altchords{|E\flt{} | - |Gm | \e}
