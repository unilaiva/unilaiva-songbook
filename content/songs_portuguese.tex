...
\beginsong{Linda Verdage}[ititle={Beautiful Truth},tags={source 1}]
  ...
  \textnote{suomeksi:}
  \beginchorus
    |\[Am]Salli \[G]Jumalan |\[F]tulla to\[E]deksi |
  \endchorus
  \beginchorus
...
\beginsong{Ilumina}[by={Guilherme Henrique Mendonça da Silva},tags={Sun 1, Moon 1, stars 1, Ayahuasca 1}]
  \beginchorus\memorize
...
\beginsong{Aya Aya Ayahuasca}[tags={Ayahuasca 1}]
  \beginchorus\memorize
  ...
  \begin{explanation}
    ...
    the spirit of \emph{Banisteriopsis Caapi} is considered male, contrary to the common view
...
\beginsong{Aqui na Terra}[ititle={Here on the Earth},by={Joseph Sulla},ex={english, português},tags={Santo Daime 1}]
  ...
  \meter{3}{4}
  \beginverse
    \lrep |\[Am]Here on the |Earth I |see so much |beauty
