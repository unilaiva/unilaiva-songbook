...
\beginsong{Manto de Maria}[by={Pedro Gonçalves},ph={III, IV}]
  ...
  \endverse
  \beginchorus
    |Saia do mar linda sereia\ldots
  \endchorus
  \begin{translation}
    ...
    \nextverse
    Exit the sea, beautiful mermaid\ldots
  \end{translation}
\endsong
...
\beginsong{Chama}[by={Nei Zigma},ph={III},tags={fire}]
  \audio[key={E&m}]{https://www.youtube.com/watch?v=mpW5eVY-4Jw} % No repeats in this one by the author
  ...
  \mnbeginchorus\memorize
    ...
    \[^\mn{E}]Quero a\[^\mn{F#}]pren|\[\mnc{G}C]der a \[\mnc{F#}Am]sem\[^\mn{E}]pre \[^\mn{G}]es|\[\mnc{D#}B7]tar
  \mnendchorus
  \notesoff
  \beginchorus
