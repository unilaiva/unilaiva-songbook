...
\beginsong{Ciranda para Janaína}[ph={IV}, key={Am}, sks={Am, G\shrp{}m--(Am)}]
  ...
  \mnbeginverse
    \[\bmc\mn{F#}]O seu co\[\mn{G}]lar é \[\mn{F#}]de |\[\mnc{D}Bm]con\[\mn{B}]cha
    Seu ves\[\bmc\mn{B}]tido se ar\[\mn{F#}]ras\[\mn{G}]ta \[\mn{F#}]na a|\[\mnc{E}Em]reia
    \[\bmc]Ela tem \[\mn{F#}]chei\[\mn{G}]ro de |\[\mnc{F#}F#]mar
    \[\mn{E}]Ela \[\mn{F#}]sa\[\mn{G}]be can\[\bmc\mn{F#}]tar, \[\mn{C#}]ponto de \[\mn{D}]se|\[\mncii{C#}{B}Bm]reia
  \mnendverse
  \mnbeginverse
    \[\bmc\mn{F#}]O seu co\[\mn{G}]lar é \[\mn{F#}]de |\[\mnc{D}Bm]con\[\mn{B}]cha
    Seu ves\[\bmc\mn{B}]tido se ar\[\mn{F#}]ras\[\mn{G}]ta \[\mn{F#}]na a|\[\mnc{E}Em]reia
    \echo{\[\bmc]Ela tem \[\mn{F#}]chei\[\mn{G}]ro de |\[\mnc{F#}F#]mar
    \[\mn{E}]Ela \[\mn{F#}]sa\[\mn{G}]be can\[\bmc\mn{F#}]tar, \[\mn{C#}]ponto de \[\mn{D}]se|\[\mncii{C#}{B}Bm]reia} \[\bm]
  \mnendverse
  \mnbeginverse
    \ind[2] \[\mn{D}]Ó Ja\[\mn{C#}]na|\[\mncii{B}{F#}Bm]ína quando es\[\bm]tou fe\[\mn{G}]liz \[\mn{F#}]eu |\[\mnc{C#}F#]choro \[\bm]
    \ind[2] \[\mn{C#}]Ó Ja\[\mn{B}]na|\[\mn{B&}]í\[\mn{F#}]na dei\[\mn{G}]xa eu \[\bmc\mn{F#}]dor\[\mn{E}]mir \[\mn{D}]no \[\mn{C#}]seu |\[\mnc{B}Bm]colo \[\bm]
    \ind[2] \echo{\[\mn{D}]Ó Ja\[\mn{C#}]na|\[\mncii{B}{F#}Bm]ína quando es\[\bm]tou fe\[\mn{G}]liz \[\mn{F#}]eu |\[\mnc{C#}F#]choro \[\bm]
    \ind[2] \[\mn{C#}]Ó Ja\[\mn{B}]na|\[\mn{B&}]í\[\mn{F#}]na dei\[\mn{G}]xa eu \[\bmc\mn{F#}]dor\[\mn{E}]mir \[\mn{D}]no \[\mn{C#}]seu |\[\mnc{B}Bm]colo} \[\bm]
  \mnendverse
  \mnbeginverse
    \ind \[\mn{E}]E é no \[\mn{F#}]seu |\[\mncii{G}{E}Em]colo que \[\mn{F#}]a\[\bmc\mn{G}]fo\[\mn{E}]go a min\[\mn{F#}]ha s|\[\mn{G}]e\[\mn{E}]de \[\bm]
    \ind \[\mn{B}]Quis te \[\mn{G}]pes|\[\mnc{F#}Bm]car, \[\mn{D}]mas \[\mn{E}]ca\[\bmc\mn{F#}]í na \[\mn{A}]su\[\mn{G}]a r|\[\mn{F#}]ede \[\bm]
    \ind Fei\[\mn{G}]ta \[\mn{F#}]de |\[\mnc{E}F#]fi\[\mn{D}]os \[\mn{C#}]de \[\mn{D}]ca\[\bmc\mn{E}]be\[\mn{D}]lo \[\mn{C#}]ma\[\mn{B}]ra\[\mn{A#}]nh|ado \[\bm]
    \ind \[\mn{F#}]Moro \[\mn{G}]no \[\mn{F#}]ma|\[Em]{r e} ho\[\mn{G}]je \[\mnc{F#}F#7]sou \[\mn{E}]seu \[\mn{D}]na\[\mn{C#}]mor|\[\mncadj{.5ex}{B}Bm]ado
    \ind \echo{\[\mn{F#}]Eu\[\bm] \[\mn{A}]mo\[\mn{G}]ro \[\mn{F#}]no \[\mn{E}]ma|\[Em]r \[\mn{C#}]e ho\[\mn{D}]je \[\mnc{E}F#7]sou \[\mn{F#}]seu \[\mn{D}]na\[\mn{C#}]mor|\[\mncadj{.5ex}{B}Bm]ado} \[\bm]
  \mnendverse
  \beginverse
    \textnote{Instrumental, on 1st playthrough:}
    \ind[3] |\[Em] \[\bm]{ }{ } |\[Bm] \[\bm]{ }{ } |\[F#] \[\bm]{ }{ } |\[Bm] \[\bm] \e
    \ind[3] |\[Em] \[\bm]{ }{ } |\[Bm] \[\bm]{ }{ } |\[F#] \[\bm]{ }{ } |\[Bm] \e
  \endverse
