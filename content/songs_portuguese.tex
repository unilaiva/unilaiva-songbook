...
\beginsong{Companheiro na escuridão}[by={Bettina Maureenji, Amu Ahava},ph={II}]
  ...
  \beginchorus\memorize
    |\[Am\noteULL{C}]Sinto a |\[Em\noteULL{B}]tu\[^\noteU{C}]a |\[Am\noteULL{A}]mã|o
    To|\[F]cando meu |\[G]cora|\[Am]ção | -
    Ca|\[Em]lor que |\[F]limpa minha |\[Am]al|ma
    Cla|\[F]rea a |\[Em]men|\[Am]te | |
  \endchorus
  \notesoff
  \beginchorus
    |^Vejo mun|^do univer|^sal | |
    |^Sinto a |^uni|^ão | |
    |^Força da |^luz afa|^gai |me
    Dai-|^me con|^cien|^çia | |
  \endchorus
  \beginchorus
    |^Oh tran|^quili|^da|de
    To|^cando meu |^cora|^ção | |
    |^Como |^um a|^mi|go
    Compa|^nheiro na es|^curi|^dão | |
  \endchorus\glueverses
  \beginverse
  ...
  \begin{translation}
    I feel your hand
    Touching my heart
    Warmth that cleanses my soul
    Clears the mind
    \nextverse
    I see universal world
    I feel the union
    Force of light, fondle me
    Give me conscience
    \nextverse
    Oh tranquility
    Touching my heart
