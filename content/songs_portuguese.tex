...
\beginsong{Jardim do Universo}[by={Bettina Maureenji},ph={II}]
  ...
  \begin{center}%
    ...
    % 0.618^3 ~ 0.236 (Golden Ratio)
    \includegraphics[width=0.236\textwidth]{jasmin_flower_transparent_bg_ed_by_larva_CC0_798x576px.png}%
    \vfill%
  \end{center}
  \begin{translation}
...
\beginsong{Voo do Beija-flor}[by={Elisa Cristal},ph={II, III}]
  ...
  \begin{center}%
    ...
    \includegraphics[width=0.382\textwidth]{hummingbird_drawing_bw_transparent_bg_PD_991x711px.png}%
    \vfill%
  \end{center}
\endsong
...
\beginsong{Aqui na Terra}[index={Here on the Earth},by={Joseph Sulla},ex={english, português},tags={Santo Daime 1},ph={II, IV}]
  ...
  \beginchorus\replay[chords_aquinaterra_b]
    ...
    Com minha |^Mãe jun|tinho a |^mim | \e
  \endchorus
%   % Commented out, as this image is now used as the front image of this chapter
%   \begin{center}%
%     \vspace*{\fill}%
%     % Original downloaded from: https://imgbin.com/png/az0Q1MFH/flower-art-floral-design-color-png
%     % Edited by: larva
%     % License: Free for non-commercial use
%     % 0.618 (Golden Ratio)
%     \includegraphics[width=0.618\textwidth]{caapi_heart_drawing_transparent_bg_1000x797px.png}
%     \vspace*{\fill}%
%   \end{center}
  \begin{explanation}
...
\beginsong{Pachamama}[index={Os Segredos Vem da Floresta},ph={II, III}]
  ...
  \begin{center}%
    \vfill%
    % Original downloaded from: https://imgbin.com/png/76Nznkqy/crystal-drawing-mineral-quartz-amethyst-png
    % License: Free for non-commercial use
    \hfill\includegraphics[width=0.236\textwidth]{amethyst_drawing_bw_transparent_bg_472x470px.png}
    % 0.618^3 ~ 0.236 (Golden Ratio)
    %\vfill
  \end{center}
\endsong
