...
\beginsong{Defumação}[id={defumacao-u8lurw},tags={censing, Santo Daime},ph={I},key={Am},gk={Am, Gm--Am}]
  ...
  \mnbeginverse
    \beginrep
      \beginrep \[\bm]{} \[\mn{E}]De|\[\mnc{A}Am]fuma \[\mn{B}]de\[\bmc\mn{C}]fu\[\mn{D}]ma|\[\mnc{E}E]dor
      \[\bm]Esta |\[\mnc{A}Am]casa de \[\mn{B}]Nos\[\bmc\mn{C}]so \[\mn{B}]Se|\[\mn{A}]nhor \endrep
      \beginrep \[\bmc\mn{E}]Leva pra's |\[\mnc{A}Am]on\[\mnc{E}A7]das \[\mn{F}]do |\[\mnc{D}Dm]mar
      O \[\bmc\mn{E}]mal \[\mn{F}]que a|\[\mnc{E}E]qui \[\bmc\mn{B}]pos\[\mn{C}]sa es|\[\mnc{A}Am]tar \endrep
    \endrep
  \mnendverse
  \meter{3}{4}
  \mnbeginverse
    \beginrep
      \beginrep \[\mn{E}]De|\[\mnc{A}Am]fuma es\[\mn{E}]ta |\[\mn{A}]ca\[\mn{E}]sa |\[A7]bem \[\mn{F}]de\[\mn{E}]fu|\[\mnc{D}Dm]ma\[\mn{B}]da
      \[\mn{D}]Com |\[\mnc{B}E/B]a \[\mnc{G#}]Cruz \[\mn{E}]de |\[\mnc{B}E]Deus \[\mn{G#}]e\[\mn{E}]la |\[\mnc{D}E7/D]vai \[\mn{C}]ser \[\mn{B}]re|\[Am]za\[\mn{A}]da \endrep
      \beginrep \[\mn{C}]Eu |\[C]sou reza|dor sou |fi\[\mn{D}]lho \[\mn{E}]de Um|\[\mnc{D}Dm]ban\[\mn{B}]da
      \[\mn{D}]Com |a \[\mn{E}]Cruz \[\mn{F}]de |\[\mnc{E}E]Deus \[\mn{F}]to\[\mn{E}]do |\[\mnc{D}E7/D]mal \[\mn{C}]se \[\mn{B}]a|\[Am]bran\[\mn{A}]da \endrep
    \endrep
  \mnendverse
...
\beginsong{Forças Encantadas}[id={forcas-encantadas-ppk9ll},by={Vinícius Rocha},ph={I},key={A},gk={B, G--D\shrp{}}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep \[\bm]Es\[^\mn{F#}]sas |\[\mnc{G}G]for\[^\mn{F#}]ças \[\bmc\mnc{E}Em]en\[^\mn{D#}]can|\[\mnc{F#}B]ta\[^\mn{D#}]das \[\bmc\mn{F#}]da \[^\mn{D#}]Ra|\[^\mn{B}]in\[^\mn{D#}]ha \[\bmc\mn{F#}]da \[^\mn{/}]Flo|\[\mnc{/}\ac<1>{Em}]resta \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Guerreiro da Paz}[id={guerreiro-da-paz-c8opel},ititle={Warrior of Peace},by={Orestes Grokar},tags={Santo Daime},ph={I},key={Em},gk={Em}]
  ...
  \beginverse[1]
    \beginrep
      \[\mn{B}]Eu chamo o |\[Bm]vento, eu chamo o vento, eu chamo o |\[F#m]ven\[\mn{A}]to
      Eu chamo o |vento vem me \[\mn{G}]e\[\mn{A}]le|\[\mnc{B}Bm]var
      Eu chamo o |fogo, eu chamo o fogo, eu chamo o |\[F#m]fo\[\mn{A}]go
      Eu chamo o |fogo para me pu\[\mn{G}]ri\[\mn{A}]fi|\[\mnc{B}Bm]car
    \endrep
  \endverse
  \beginverse[2]
    \beginrep
      \[\mn{D}]Eu chamo a |\[Bm]Lua, chamo o Sol, chamo as es|\[A]tre\[\mn{C#}]las
      Chamo o uni|verso para me i\[\mn{B}]lu\[\mn{C#}]mi|\[\mnc{D}Bm]nar
      Eu chamo a |água, chamo a chuva, e chamo o |\[A]ri\[\mn{C#}]o
      Eu chamo |todos para \[\mn{B}]me \[\mn{A}]la|\[\mnc{B}Bm]var
    \endrep
  \endverse
  \beginverse[3]
    \beginrep
      \[\mn{F#}]Eu chamo o |\[D]raio, o relâmpago e o tro|\[A]vã\[\mn{E}]o
      Eu chamo |todo o poder da \[\mn{D}]cri\[\mn{E}]a|\[\mnc{F#}Bm]ção
      Eu chamo o |\[D]mar, chamo o céu e o infi|\[A]ni\[\mn{E}]to
      Eu chamo |todos para nos \[\mn{D}]li\[\mn{C#}]ber|\[\mnc{B}Bm]tar
    \endrep
  \endverse
  \brk
  \beginverse[2]
    \beginrep
      \[\mn{D}]Eu chamo |\[Bm]Cristo, eu chamo Budha, eu chamo |\[A\mn{C#}]Krishna
  ...
  \beginverse[3]
    \beginrep
      \[\mn{F#}]Eu agra|\[D]deço pela vida e a co|\[A\mn{E}]ragem
  ...
  \beginverse[2]
    \beginrep
      \[\mn{D}]Sou mensa|\[Bm]geiro, sou cometa, eu sou indí|\[A]ge\[\mn{C#}]na
  ...
  \beginverse[3]
    \beginrep
      \[\mn{F#}]Eu sou guer|\[D]reiro, eu sou guerreiro e vou lu|\[A]tan\[\mn{E}]do
  ...
  \beginverse[2]
    \beginrep
      \[\mn{D}]Eu agra|\[Bm]deço a nossa Mãe e ao nosso |\[A]Pa\[\mn{C#}]i
...
\beginsong{Calma e Tranquilidade}[id={calma-e-tranquilidade-p3i2fh},by={Deva Premal, Miten},ph={II, III},key={Am},gk={Bm, Am--Em}]
  ...
  \beginverse
    \[^\mn{E}]Cal\[^\mn{F#}]ma |\[\mnc{G}Em]e Tran\[\mnc{F#}D]qui\[^\mn{E}]li|\[\mnc{G}Em]dade, são as |ordens \[D]do Se|\[Em]nhor
...
\beginsong{Silencio}[id={silencio-l7t3zb},by={Elves do Juruá},ph={II},key={Am},gk={B\flt{}m, Gm--Bm}]
  ...
  \beginverse[1]\memorize[chords_silencio_c]
    \beginrep
      \[^\mn{A}]E \[^\mn{B}]traz \[^\mn{C}]a |\[\mnc{D}Dm]Fo|'rça, e traz \[^\mn{F}]a |\[\mnc{E}Am]Paz | \e
      |\[C]{} Eu an\[\bm]dando com si|\[Dm]lencio
      Pois so\[\bm]mente o si|lencio é que sem\[\bm]pre me satis|\[Am]faz | \e
    \endrep
  \endverse
  \notesoff
...
\beginsong{Oh Jurema}[id={oh-jurema-xl456b},ph={II},key={Em},gk={Em, Am--F\shrp{}m}]
  ...
  \beginverse[1]
    \noteson
    \beginrep
      \[\mn{E}]Ju|\[Em]rema \[\mn{G}]ôh \[\mn{F#}]Ju\[\mn{E}]re|\[\mnc{A}D]ma
  ...
  \beginverse
    \beginrep
      \[\bm]Cabocla Ju|^rema, Cabocla guerre|^ira
...
\beginsong{Ilumina Minha Mãe}[id={ilumina-minha-mae-3npmo2},by={Marie Gabriella},ph={II, III},key={Am},gk={Am, Am--Bm}]
  ...
  \beginverse[1]\memorize
    \beginrep
      \ilsl{\[^\mn{C}]Óh} |\[\mnc{A}Am]mãe, | \[^\mn{E}]óh mãe \[^\mn{C}]de |\[\mnc{D}Dm]De|us
      \[^\mn{B}]Pro|\[\mnc{G}G]te|ja \[^\mn{D}]os fil\[^\mn{B}]hos |\[\mnc{C}Am]se|us \replay\notesoff
  ...
  \beginverse[2]\memorize
    \beginrep
      \[^\mn{D}]Dei|\[\mnc{F}Dm]xa a \[^\mn{E}]luz \[^\mn{D}]bril|\[^\mn{F}]har, |\[^\mn{A}]a flor \[^\mn{G}]flo\[^\mn{F}]res|\[\mnc{E}Am]cer
...
\beginsong{Oh Lua}[id={oh-lua-77kzh9},by={Carioca Chandra Edgar},ph={III},tags={moon, sun, stars, wind},key={Gm},gk={Gm, Gm--G\shrp{}m}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_ohluaedgar_a]
      ...
      Por |\[\mnc{C}Cm]este \[^\mn{B&}]lu|\[^\mn{G}]ar cri\[^\mn{B&}]a|\[\mnc{D}Gm]dor |\[\ac<2>{G7}]
    \endrep
    ...
    \beginrep\memorize[chords_ohluaedgar_b]
      ...
      |\[\mnc{D}Dm]Es\[^\mn{E&}]ta \[^\mn{D}]can|\[\mnc{C}D7]ção \[^\mn{B&}]com \[^\mn{A}]a|\[\mnc{G}Gm]mor |\[\ac<1>{G7}]
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{O Lua}[id={o-lua-sizriy},by={Cristina Tati},tags={Moon, Santo Daime},ph={II},key={Am},gk={Am, G\shrp{}m--(Am)}]
  ...
  \beginverse\memorize[chords_olua_a]
    \beginrep
      \ilsl{\[^\mn{B}]Ó} |\[\mnc{E}Em]Lua! | Tu\[^\mn{F#}]a \[^\mn{G}]luz \[^\mn{F#}]vei\[^\mn{E}]o e |\[^\mn{B}]me \[^\mn{G}]i\[^\mn{E}]lu\[^\mn{G}]min|\[\mnc{B}Bm]ou.
    \endrep
  \endverse\glueverses
...
\beginsong{Ilumina}[id={ilumina-thjot0},by={Guilherme Henrique Mendonça da Silva},tags={Sun, Moon, stars, Aya},ph={II, III},key={C},gk={D, C--F\shrp{}}]
  ...
  \beginverse[1]
    \beginrep
      %% with simplified chords:
      |\[C]Me \[\bm]{} i\[\mn{D}]lu|\[\mnc{F}F]mi\[\bm]- |\[\mnc{E}Am]na \[\bm]{} \[\mn{F}]i\[\mn{E}]lu|\[\mnc{D}G]mi\[\bm]- |\[\mnc{C}C]na \[\bm]{} \altchords{|Am Am7 |Dm G |C Am |Dm G |C C7}
      ilu|\[F]mi\[\bm]- |\[Am]na \[\bm]{} ilu|\[G]mi\[\bm]- |\[C]na \[\bm]{} \altchords{|Dm G |C Am |Dm G |C \ac<1>{F}}
      %% with full chords:
...
\beginsong{Luz \& Chuva de Esmeralda}[id={luz-chuva-de-esmeralda-9swb38},by={João Pedro G Afonso},ph={II},key={Am},gk={Cm, Am--C\shrp{}m}]
  ...
  \beginverse
    \beginrep
      \ilsl{\[\mn{A}]Ó} \[\bmc\mn{G}]san\[\mn{F}]ta \[\mn{E}]Mi\[\mn{D}]la|\[\mnc{C}C]grosa, \[\mn{D}]Vir\[\bmc\mn{E}]gem \[\mn{C}]da \[\mn{D}]Con\[\mn{E}]cei|\[\mnc{F}F]ção
...
\beginsong{Rosário da Floresta}[id={rosario-da-floresta-ajgtol},by={Antonio Malavoglia},ph={II, III},key={Am},gk={Am, Gm--G\shrp{}m}]
  ...
  \beginverse[1]\memorize[rosario_da_floresta_b]
    \[^\mn{F#}]Vem \[^\mn{G}]lá \[^\mn{F#}]das \[^\mn{E}]Es|\[\mnc{D}D]trelas Do \[^\mn{A}]Mar \[^\mn{D}]a|\[\mnc{E}A]zul do \[^\mn{A}]Infi|\[\mnciii{D}{C#}{B}Bm]nito | \e \altchords{|B\flt{} |F |Gm | \e}
...
\beginsong{Rainha das Águas}[id={rainha-das-aguas-xcbxne},by={Adrian Freedman},ph={II, III},key={Bm},gk={Bm, Am--C\shrp{}m}]
  ...
  \beginverse[1]
    \beginrep
      | \[\mn{D}]Ra|i\[\mn{C#}]nha \[\mn{B}]das |\[\mnc{A}A]Á|guas, | \[\mn{G}]Ra|in\[\mn{F#}]ha \[\mn{E}]do |\[\mnc{F#}D]Mar | \e
      | Ra|inha de |\[Em]to|dos, |\[A]Ela é quem |vem nos cu|\[D]rar | \e
    \endrep
  \endverse
  \beginverse[2]
    |\[\mn{D}]Ra\[\mn{B}]in\[\mn{D}]ha|' \[\mn{B}]Ie\[\mn{D}]man|\[\mnc{B}Bm]já | \e
    |Rainha|' Ieman|já | \e
    |Rainha|' Ieman|já | \e
  \endverse
  \notesoff
...
\beginsong{Brilho da Verdade}[id={brilho-da-verdade-b2jnql},by={Chandra Lacombe},ph={II, III},key={Bm},gk={Bm, (Bm)--(Cm)}]
  ...
  \beginverse\memorize
    \beginrep
      \[^\mn{E}]Che|\[^\mn{C}]gou na \[^\mn{B}]voz do |\[\mnc{A}Am]vento, veio |\[^\mn{C}]pa\[^\mn{A}]ra e\[^\mn{C}]nun\[^\mnc{A}]ci|\[\mnc{D}Dm]ar
      A torm|enta desse |\[C]tempo, e ninguém |queira duvi|\[E]dar
    \endrep
  \endverse
  \beginverse[1]
    \beginrep
      \[\mn{E}]Quem a|inda está dor|\[\mnc{A}Am]min\[\mn{E}]do, na ilus|ão a se de\[\mn{G}]mo|\[\mnc{F}Dm]rar
...
\beginsong{Jardim do Universo}[id={jardim-do-universo-x8ts6h},by={Bettina Maureenji},ph={II},key={Dm},gk={Cm--F\shrp{}m}]
  ...
  \beginverse[1]
    \beginrep
      \[\mn{A}]Neste jar|\[\mnc{F}Dm]dim do \[\mn{G}\mn{F}]uni|\[\mnc{E}Am]verso,
...
\beginsong{Coração do Mundo}[id={coracao-do-mundo-udg8u6},by={Bettina Maureenji, Amu Ahava},tags={Mother Earth, heart},ph={III},key={Am},gk={Am, Am--Bm}]
  ...
  \beginverse[1]
    \beginrep
      |\[\mnc{D}Dm]Cora|\[\mnc{E}Em]ção \[\mn{G}]do |\[\mnc{A}Am]mun|do
...
\beginsong{Luz de Vida}[id={luz-de-vida-o3gd3t},by={Amu Ahava},tags={source, light},ph={II, III},key={Dm},gk={Dm, Dm--Em}]
  ...
  \beginverse[1]
    \beginrep
      |\[\mnc{D}Dm]Luz \[\mnc{F}Dm/F]de |\[\mnc{E}Cadd9/E]Vi\[\mnc{C}Cadd9]da
...
\beginsong{Borboleta}[id={borboleta-9ziokw},by={Mitmeel Ananda},ph={III},key={Am},gk={Am, Gm--G\shrp{}m}]
  ...
  \mnbeginverse[1]
    |\[G]{} \[\mn{D}]Es\[\bm]tá na |\[\mnc{E}A]ho\[\mn{D}]ra \[\bmc\mn{C#}]de \[\mn{D}]rom|\[\mnc{B}Bm]per | \e \altchords{\id[1]{(Bm)}|G |A |Bm | \e}
    |\[G]\ind \[\bmc\mn{B}]O ca|\[\mnc{A}A]su\[\mn{E}]lo que há \[\bm]em \[\mn{G}]vo|\[\mnc{F#}Bm]cê | \e \altchords{|G |A |Bm | \e}
    |\[G]{} \[\mn{B}]Es\[\bm]tá na |\[\mnc{C#}A]ho\[\mn{B}]ra \[\bmc\mn{A}]de \[\mn{G}]vo|\[\mnc{F#}Bm]ar | \e \altchords{|G |A |Bm | \e}
    |\[G]{} \[\mn{D}]Ser \[\bm]borbo|\[\mnc{E}A]le\[\mn{C#}]ta e a\[\bm]sas \[\mn{D}]ba|\[\mnc{B}Bm]ter | \e \altchords{|G |A |Bm | \e}
    |\[G]{} \[\mn{B}]Es\[\bm]tá na |\[\mnc{C#}A]ho\[\mn{B}]ra \[\bmc\mn{A}]de \[\mn{G}]vo|\[\mnc{F#}Bm]ar | \e \altchords{|G |A |Bm | \e}
    |\[G]{} \[\mn{D}]Ba\[\bm]ter suas a|\[\mnc{E}A]sas \[\mn{C#}]{e borbo}\[\bm]le\[\mn{D}]ta |\[\mnc{B}Bm]ser | \e \altchords{|G |A |Bm | \e}
  \mnendverse
  \mnbeginverse
  ...
  \beginverse\memorize
    \beginrep
      \ind |\[G]{} \[^\mnd{D}]Es\[^\bm]tá na |\[A]hora \[^\bm]de rei|\[Bm]nar \sublyrpush{está na} |\sublyr{hora de rei-} \e\replay
      \ind |\sublyr{nar}^ \[\mnd{B}]Os \[\bm]pensa|^mentos que há \[\bm]em vo|^cê \sublyrpush{os pensa}|\sublyr{mentos que há em vo-} \e\replay
      \ind |\sublyr{cê}^ \[\mnd{B}]Es\[\bm]tá na |^hora \[\bm]{de im}pe|^rar \sublyrpush{está na} |\sublyr{hora de impe-} \e\replay
      \ind |\sublyr{rar}^ \[\mnd{D}]O \[\bm]grande |^reino \[\bm]{que é} seu |^ser \sublyrpush{o grande} |\sublyr{reino que é seu} \e\replay
      \ind |\sublyr{ser}^ \[\mnd{B}]Es\[\bm]tá na |^hora \[\bm]{de im}pe|^rar \sublyrpush{está na} |\sublyr{hora de impe-} \e\replay
      \ind |\sublyr{rar}^ \[\mnd{D}]O \[\bm]grande |^reino que és vo|^cê \sublyrpush{o grande} |\sublyr{reino} \e
      \emptyline
      \sublyr{ que és}\[\bmc\mnd{B}]Bor\sublyr{  vo-}bo|\sublyr{cê}\[G]le\[\bm]ta | { }{ }{ }\sublyrpush{borbo}|\sublyrpush{leta}{ } | \e
      Po\[\bmc\mnd{D}]des vo|\[Bm]ar | { }\sublyrpush{podes vo}|\sublyrpush{ar}{ }{ }{ } | \e
      \[\mnd{D}]{É seu} me\[\bm]reci|\[Em]men\[\bm]to | \sublyrpush{é seu mereci}|\sublyrpush{mento}{ } | \e
      \[\mnd{B}]Por sa\[\bm]ber espe|\[Bm]rar | { }\sublyrpush{por saber espe}|\sublyrpush{rar}{ }{ }{ } | \e
      \[\mnd{F#}]Antes \[\bm]eras |\[Em]lar\[\bm]va | { }\sublyrpush{antes eras} |\sublyrpush{larva}{ } | \e
      \[\mnd{B}]A \[\bm]raste|\[Bm]jar | { }\sublyrpush{a raste}|\sublyrpush{jar}{ }{ }{ } | \e
      \[\mnd{F#}]Hoje és \[\bm]borbo|\[Em]le\[\bm]ta | { }\sublyrpush{hoje és borbo}|\sublyrpush{leta}{ } | \e
      \[\mnd{B}]A \[\bm]impe|\[Bm]rar! | { }\sublyrpush{a impe}|\sublyrpush{rar!}{ }{ }{ } | \e
    \endrep
  \endverse
...
\beginsong{Cura do Beija-flor}[id={cura-do-beija-flor-1bawzr},by={Chandra Lacombe},ph={III, IV},key={C},gk={C, B\flt{}--E}]
  ...
  \beginverse[1]\memorize[chords_cura_do_bf_b]
    \[^\mn{B}]Vem sur|\[G]gindo um a|\[\mnc{A}D]migo no mo|\[\mnc{C}Am]mento \[^\mn{D}]es\[^\mn{C}]co|\[\mnc{B}Em]lhido
...
\beginsong{Voo do Beija-flor}[id={voo-do-beija-flor-ca3ujc},by={Elisa Cristal},ph={II, III, IV},key={D},gk={E, D\shrp{}--E}]
  ...
  \beginverse[1]
    \beginrep\noteson
      \[\mn{C}\mn{A}]Beija-|\[\mnc{G}C]flor me |\[\mncii{A}{F}Dm]le|\[\mnc{E}Am]va |\[F]{} \e \replay \altchords{|B |C\shrp{}m |G\shrp{}m |E}
...
\beginsong{Passarinho}[id={passarinho-0kho5q},by={Rainer Scheurenbrand},ph={III},key={Am},gk={Am, Gm--Am}]
  ...
  \beginverse[1]\memorize[chords_passarinho_b]\noteson
    \[^\mn{E}]Es\[\bm]tou aq|\[\mnc{F}Dm]ui pa\[\bmc\mn{G}]ra ap\[^\mn{F}]rend|\[\mnc{E}Am]er \[\bm]
    o mist|\[Em]ério \[\bm]do meu s|\[Am]er
    Es\[\bm]tou aq|\[Dm]ui pa\[\bm]ra cur|\[Am]ar \[\bm]
    Estou a|\[Em]berto\[\bm]{\ldots} | { } \[\bm]para camin|\[Am]har
  \endverse
  \beginverse[2]
    \beginrep
      \[\mn{A}]Sha \[\bmc\mn{B}]la \[\mn{C}]la \[\mn{B}]la \[\mn{C}]la |\[\mnc{A}Am]la Sha \[\bmc\mn{B}]la \[\mn{C}]la \[\mn{B}]la \[\mn{C}]la
      |\[Em]la Sha \[\bm]la la la la |lai la \[\bm]lai lai |\[Am]la
    \endrep
  \endverse
  \beginverse\replay[chords_passarinho_a]
    \beginrep
...
\beginsong{Minha Mãe Oxumaré}[id={minha-mae-oxumare-8iu39a},ph={II, III},key={Em},gk={Em, Em--F\shrp{}m}]
  ...
  \beginverse[1]
    \beginrep
      \[\mn{A}]Ela |\[\mnc{G}G]vem \[\mn{B}]bei\[\mn{D}]ran\[\mn{B}]do o |\[Am]rí\[\mn{A}]o \altchords{|E |F\shrp{}m}
...
\beginsong{Corações da Luz}[id={coracoes-da-luz-vtsk24},by={Corações da Luz},ph={III},key={Am},gk={Am, Gm--C\shrp{}m}]
  ...
  \beginverse\memorize
    \beginrep
      \ilsl{\[^\mn{B}]Ó} |\[\mnc{D}D]grande mis|\[\mnc{E}Em]terio do \[^\mn{D}]u\[^\mn{C#}]ni|\[\mnc{B}Bm]ver|so \altchords{|D |Em |Bm | \e}
...
\beginsong{O Bálsamo do Céu}[id={o-balsamo-do-ceu-rfij48},by={Baixinha},tags={Santo Daime},ph={III},key={Dm},gk={Dm, Cm--D\shrp{}m}]
  ...
  \mnbeginverse
    \beginrep
      \beginrep
      \[\mn{A}]O |\[\mnc{D}Dm]bálsamo \[\mn{E}]do |\[\mnc{F}F]Céu \[\mn{A}]des|\[\mnc{E}A]ceu \[\mn{F}]à |\[\mnc{E}Dm]Ter\[\mn{D}]ra \endrep
      \beginrep \[\mn{A}]As |\[\mnc{B&}Gm]flo\[\mn{A}]res \[\mn{G}]da |\[\mnc{F}F]Ter\[\mn{E}]ra \[\mn{D}]rece|\[\mnc{A}A7]be\[\mn{C#}]ram \[\mn{E}]a |\[\mnc{D}Dm]Luz
      \endrep
    \endrep
  \mnendverse
  \beginverse[1]\memorize
    \beginrep
      \beginrep
        \[\mn{A}]Os |\[\mnc{D}Dm]homens \[\mn{E}]na |\[\mn{F}]Ter\[\mn{D}]ra \[\mn{F}]pre|\[\mnc{E}A]ci\[\mn{C#}]sam \[\mn{E}]do |\[\mnc{D}Dm]Bem
      \endrep
      \beginrep
...
\beginsong{Acreditar}[id={acreditar-z4m8bw},by={Vinicius Seki},ph={III},key={Bm},gk={Bm, (Bm)--Cm--C\shrp{}m}]
  ...
  \beginverse
    \ilsl{\[^\mn{F#}]É} \[\bm]a força que |\[\mnc{G}Bm]move e nos \[^\mn{F#}]en\[\bmc\mn{D}]sina a \[^\mn{C#}]ser \[^\mn{D}]ir|\[\mnc{E}A]mão \altchords{\id[1]{(Dm)}|Dm |C}
  ...
  \beginverse
    ...
    \noteson Com ^graça e harmo|nia nao im^\[\mnd{A}]porta aonde |^for\notesoff
  ...
  \beginverse
    ...
    \noteson A ^força que ha|bita bem den^\[\mnd{A}]tro do cora|^ção\notesoff
...
\beginsong{Manto de Maria}[id={manto-de-maria-5d4d1x},by={Pedro Gonçalves},ph={III, IV},key={Dm},gk={Dm, Cm--Em}]
  ...
  \beginverse*[2]
    |\[\mnc{E}Em]Res\[\bmc\mn{D}]pi|\[\mn{B}]ra, \[\bmc\mn{E}]con|\[\mn{D}]cen\[\bmc\mn{B}]tra, |{ } { }\[\bmc\mn{E}]res|\[\mn{D}]pi\[\bmc\mn{B}]ra, |\[\mn{E}]con\[\bmc\mn{D}]cen|\[\mn{B}]tra
    |Res\[\bm]pi|ra, \[\bm]con|cen\[\bm]tra, |{ } { }\[\bm]Aya-yahuas|ca, \[\bm]Aya-yahuas|ca,
    \[\bm]Aya-yahuas|ca, \[\bm]Aya-yahuas|ca, \[\bm]Ayahuas|ca |{ }\[\bm]{ } |{ }\[\bm]{ } |{ }\[\bm]{ } \e
  \endverse
  \segno
  \beginverse
  ...
  \endverse
  \beginverse[1]
    \[\mn{E}]Ave Ma|\[Em]ria vossa \[\bm]proteção di|vina
    Eu con\[\bm]cebo essa |cura e me per\[\bm]mito ao a|mor \[\bm]
    Todos os |seres dessa \[\bm]cura inten|siva
    Eu per\[\bm]mito total|mente a en\[\bm]trada da sa|bedo\[\bm]ria
    Ave Ma|ria vossa \[\bm]proteção di|vina
    Eu me en\[\bm]trego total|mente e me per\[\bm]mito a essa |luz \[\bm]
    Ave Ma|ri\[\bm]a e |\[C]todos os \[\bmc B]guardi|\[Em]õ\[\bm]{}|{ - }es
    \[\bm]Mani|\[C]fes\[\bm]ta|\[B7]ções \[\bm]de |\[Em]luz \[\bm]
  \endverse
  \brk
  \beginverse
  ...
  \dalsegno
  \beginverse[3]
    |\sublyr{cer}\[\mnc{E}C]Cu\[\mn{F#}]ra \[\mn{G}]nas \[\bmc\mn{E}]gra\[\mn{F#}]ças \[\mn{G}]de |\[\mnc{F#}D]A\[\mn{G}]ve \[\mn{A}]Ma\[\bmc\mn{G}]ri\[\mn{F#}]a
    Ca|\[Em]minho a \[\bm]continui|dade do \[\bm]meu cora-
    |\sublyr{ção}\[C]Cura no \[\bm]manto de n|\[D]ossa Se\[\bm]nhora
    Sen|\[Em]tindo a \[\bm]benção da |imensi\[\bm]dão
    Do |\[C]ser\[\bm], sen|\[D]tir\[\bm]{} e a|\[Em]mar\[\bm]{} |{ }\[\bm]{ } |{ }\[\bm]{ } |{ }\[\bm]{ } \e
  \endverse
  \beginverse[1]
    \beginrep
      |\[\mn{B}]Saia do mar, \[\bmc\mn{A}]linda sereia
      |Saia do mar, vem \[\bm]brincar na areia
      |Saia do mar, \[\bm]sereia bela
      |Saia do mar, vem \[\bm]brincar com ela
    \endrep
  \endverse
  \beginverse[1]
    \beginrep
      \[\mn{E}]Eu |\[\mn{A}]vim \[\mn{G}]eu \[\mn{F#}]vim \[\mn{E}]can\[\bmc\mn{G}]ta\[\mn{E}]r, se|\[\mn{G}]reia do \[\bmc\mn{E}]mar
    \endrep
  \endverse
  \begin{translation}[EN]
...
\beginsong{Santa Cura}[id={santa-cura-sdqe4v},by={Marie Gabriella},key={Bm},gk={Bm, (Bm)--Cm},ph={III}]
  ...
  \mnbeginverse[2]
    \beginrep
      \[\mn{B}]Cura |\[\mnc{D}Bm]vem\[\mn{B}], |\[\mn{D}]vem \[\mn{B}]cu|\[\mnc{F#}F#m]rar | \e \altchords{\id[1]{Am \capo{2}}\meter{3}{4}|Am |  |Em | \e}
      \[\mn{B}]Vem cu|\[Bm]rar to|\[\mn{D}]das \[\mn{B}]do|\[\mnc{F#}D]enças \altchords{|Am |  |C}
      |\[\mnc{E}Em]Santa |\[\mnc{D}D]cu\[\mn{B}]ra |\[\mnc{D}F#m]vem \[\mn{C#}]cu|\[\mnc{B}Bm]rar \altchords{|Dm |C |Em |Am}
    \endrep
  \mnendverse
  \meter{4}{4}
  \mnbeginverse
  ...
  \mnbeginverse[1]
    \beginrep\memorize
      \[\bmc\mn{D}]Co\[^\mn{B}]mo |\[\mnc{D}Bm]tu \[^\mn{B}]és \[\bmc\mn{D}]com\[^\mn{B}]pai|\[\mnc{F#}F#m]xão
      \[\bmc\mn{B}]E o a|\[Bm]mor su\[\mnc{G}Em]a \[^\mn{F#}]pre|\[^\mn{E}]sença
      \[\bmc\mn{G}]Te\[^\mn{F#}]nha |\[^\mn{E}]pi\[^\mn{D}]e\[\bmc\mn{C#}]da\[^\mn{B}]de |\[\mnc{F#}Bm]mãe
      \[\bmc\mn{B}]De tan|\[\mnc{F#}F#m]ta \[^\mn{B}]in\[\bmc\mn{D}]cons\[^\mn{C#}]ci|\[\mnc{B}Bm]ência
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Venho lá da Floresta}[id={venho-la-da-floresta-sar3tc},by={Adailo Borges Sereno Kaxinawa},key={Am},gk={Am, Am--Em},ph={IV}]
  ...
  \mnbeginverse\memorize
    \beginrep
      |\[Em]{} \[^\mn{E}]Eu \[^\mn{B}]ve\[\bmc]nho lá da \[^\mnc{A}]flo|\[D]resta, com \[\bmc\mn{B}]meu \[^\mn{A}]cantar \[^\mn{G}]{de\jw A}|\[\mnc{A}Am]mor
      Sou um \[\bmc\mn{B}]ín\[^\mn{A}]dio men\[^\mn{G}]sa|\[C]gei\[^\mn{E}]ro, mensa\[\bmc\mn{G}]gei\[^\mn{E}]ro do \[^\mn{D}]A|\[\mnc{E}Em]mor\[\bm]{} | \[\bm]\e
    \endrep
  \mnendverse
  \mnbeginverse[1]
    \beginrep
      \[\mn{E}]E\[\mn{F#}]he|\[\mnc{G}G]hee \[\bmc] \[\mn{D}]e\[\mn{B}]he|\[\mnc{A}D]heh he-he-\[\bmc\mn{B}]he-\[\mn{A}]a-he-\[\mn{G}]a-|\[\mnc{A}Am]heh
      he-he-\[\bmc\mn{B}]he-\[\mn{A}]a-he-\[\mn{G}]a-|\[C]hee \[\mn{E}]eh-eh-\[\bmc\mn{G}]eh-\[\mn{E}]a-eh-\[\mn{D}]a-|\[\mnc{E}Em]eh \[\bm]{} | \[\bm]\e
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Caminhando com Fé}[id={caminhando-com-fe-95ay8x},by={Ambika},ph={IV},key={Em},gk={Gm, Gm--G\shrp{}m}]
  ...
  \beginverse[1]\memorize[chords_caminhando_b]\noteson
    \[^\mn{B}]E |\[\mnc{A}Am]ando na terra a ca|n\[^\mn{E}]tar me |\[\mnc{G}Em]banho nas á\[^\mn{E}]guas \[^\mn{G}]do |\[^\mn{B}]mar
  ...
  \beginverse[2]\noteson\memorize[chords_caminhando_c]
    \[^\mn{B}]Ma\[^\mn{G}]mãe \[^\mn{F#}]Ju|\[\mnc{E}Em]re\[^\mn{B}]ma chega a|qui nes\[^\mn{D}]ta \[^\mn{C}]mo|\[\mnc{B}B7]ra\[^\mn{F#}]da
...
\beginsong{Deixa a Gira Girar}[id={deixa-a-gira-girar-2qoori},by={Mateus Alelulia, Heraldo, Dadinho},ph={IV},key={Em},gk={Gm, Gm--G\shrp{}m}]
  ...
  \beginverse
    \beginrep
      ...
      | e a nossa |\[Am]mãe |\[\mnc{D}D]é \[\mn{C}]I\[\mn{B}]an|\[\mnc{G}Em]sã |\[\ac<1>{B7}]{} \e \altchords{| - |Dm |G |Am |\ac<1>{E7}}
    \endrep
  \endverse
  \beginverse
...
\beginsong{Caminho da Luz}[id={caminho-da-luz-tc86lb},ph={IV},key={Am},gk={Am, Gm--Bm}]
  \beginverse
    \beginrep
      \beginrep \[\mn{E}]O Ca|\[\mnc{A}Am]minho \[\mn{C}]da \[\mn{E}]Luz está |\[\mnc{D}Dm]den\[\mn{E}]tro \[\mn{F}]de \[\mn{D}]vo\[\mnc{E}Am]cê \endrep
...
\beginsong{Mãe Verdadeira}[id={mae-verdadeira-02e5gl},by={Totó},ph={IV},key={Am},gk={Am, Gm--(Am)}]
  ...
  \beginverse
    \beginrep
      |\[\ac<1>{Dm}]{} \[\mn{D}]Minha |mãe \[\mn{F}]ver\[\mn{G}]da|\[\mnc{A}Dm]dei|ra \[\mn{C}]me
  ...
  \beginverse[1]
    \beginrep
      |\[\ac<2>{!}] \[\mn{F}]Olha a |linda \[\mn{D}]se|\[\mncii{F}{D}Dm]reia, | \e
...
\beginsong{Medicina Ancestral}[id={medicina-ancestral-v6fhfi},by={Vinícius Santos Rocha},ph={IV},key={Am},gk={Am, Gm--G\shrp{}m--(Am)}]
  ...
  \beginverse\memorize
    \beginrep
      \beginrep \[^\mn{E}]A|\[\mnc{A}Am]ho \[^\mn{C}]meus |\[\mnc{B}E]ir\[^\mn{G#}]mãos \[^\mn{B}]de |\[\mnc{A}Am]fé \endrep
...
\beginsong{Ciranda para Janaína}[id={ciranda-para-janaina-qvuvii},ph={IV},key={Am},gk={Am, G\shrp{}m--(Am)}]
  ...
  \mnendverse
  \mnbeginverse[2]
    \ilsl{\[\mn{D}]Ó} Ja\[\mn{C#}]na|\[\mncii{B}{F#}Bm]ína quando es|tou fe\[\mn{G}]liz \[\mn{F#}]eu |\[\mnc{C#}F#]choro | \e
    \ilsl{\[\mn{C#}]Ó} Ja\[\mn{B}]na|\[\mn{B&}]í\[\mn{F#}]na dei\[\mn{G}]xa eu |\[\mn{F#}]dor\[\mn{E}]mir \[\mn{D}]no \[\mn{C#}]seu |\[\mnc{B}Bm]colo | \e
    \echo{\ilsl{\[\mn{D}]Ó} Ja\[\mn{C#}]na|\[\mncii{B}{F#}Bm]ína quando es|tou fe\[\mn{G}]liz \[\mn{F#}]eu |\[\mnc{C#}F#]choro | \e
    \ilsl{\[\mn{C#}]Ó} Ja\[\mn{B}]na|\[\mn{B&}]í\[\mn{F#}]na dei\[\mn{G}]xa eu |\[\mn{F#}]dor\[\mn{E}]mir \[\mn{D}]no \[\mn{C#}]seu |\[\mnc{B}Bm]colo} | \e
  \mnendverse
  \mnbeginverse[1]
    \[\mn{E}]E é no \[\mn{F#}]seu |\[\mncii{G}{E}Em]colo que \[\mn{F#}]a|\[\mn{G}]fo\[\mn{E}]go a min\[\mn{F#}]ha s|\[\mn{G}]e\[\mn{E}]de | \e
    \[\mn{B}]Quis te \[\mn{G}]pes|\[\mnc{F#}Bm]car, \[\mn{D}]mas \[\mn{E}]ca|\[\mn{F#}]í na \[\mn{A}]su\[\mn{G}]a r|\[\mn{F#}]ede | \e
    Fei\[\mn{G}]ta \[\mn{F#}]de |\[\mnc{E}F#]fi\[\mn{D}]os \[\mn{C#}]de \[\mn{D}]ca|\[\mn{E}]be\[\mn{D}]lo \[\mn{C#}]ma\[\mn{B}]ra\[\mn{A#}]nh|ado | \e
    \[\mn{F#}]Moro \[\mn{G}]no \[\mn{F#}]ma|\[Em]{r e} ho\[\mn{G}]je |\[\mnc{F#}F#7]sou \[\mn{E}]seu \[\mn{D}]na\[\mn{C#}]mor|\[\mncadj{.5ex}{B}Bm]ado
    \echo{\[\mn{F#}]Eu| \[\mn{A}]mo\[\mn{G}]ro \[\mn{F#}]no \[\mn{E}]ma|\[Em]r \[\mn{C#}]e ho\[\mn{D}]je |\[\mnc{E}F#7]sou \[\mn{F#}]seu \[\mn{D}]na\[\mn{C#}]mor|\[\mncadj{.5ex}{B}Bm]ado} | \e
  \mnendverse
  \beginverse[3]
...
\beginsong{Recado da Mãe Divina}[id={recado-da-mae-divina-go54ld},by={Chandra Lacombe},ph={IV},key={D},gk={D, B\flt{}--E}]
  ...
  \mnbeginverse[1]\memorize[chords_recado_da_mae_b]
    \beginrep
      \[^\mn{D}]Mãe di|\[D]vina eu quero |\[\mnc{G}G]ser
      Um fi|\[\mnc{F#}F#7]lho re\[^\mn{G}\mn{A}]ali|\[\mnc{F#}Bm]zado
      E é pe|\[\mnc{G}Em]ran\[^\mn{F#}]te o \[^\mn{E}]seu \[^\mn{D}]po|\[\mnc{E}A]der
      Que me en|\[\mnc{F#}G]trego \[^\mn{E}]pra se \[\mncii{D}{C#}A]liber|\[\mnc{D}D]tado
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Aliança}[id={alianca-dq6ixv},by={Beth},ph={IV},key={Am},gk={Am, Am--Bm}]
  ...
  \mnbeginverse
    \beginrep\memorize
      \beginrep \[^\mn{E}]Esta a\[^\mn{C}]li|\[\mnc{A}Am]an\[^\mn{B}]ça \[^\mn{C}]vei\[^\mn{B}]o \[^\mn{C}]do \[^\mn{D}]as|\[\mnc{E}E]tral \altchords{\id[1]{(Bm)}|Bm |F\shrp{}}
      Vem \[^\mn{A}]do as|\[\mnc{F}Dm]tral \[^\mn{D}]do \[^\mn{E}]as\[^\mn{F}]tral su\[^\mn{A}]peri|\[\mnc{E}E]or \altchords{|Em |F\shrp{}} \endrep
      \beginrep \[^\mn{E}]Ela \[^\mn{A}]é di|\[\mncii{F}{D}Dm]vina e \[^\mn{E}]con\[^\mn{F}]sagra as \[^\mn{A}]medi|\[\mnc{E}C]ci\[^\mn{C}]nas \altchords{|Em |D}
      Essas flo\[^\mn{F}]res \[^\mn{E}]tão |\[\mncii{D}{B}G]finas do nos\[^\mn{C}]so \[^\mn{B}]Pai \[^\mn{A}]Cri\[^\mn{G}]a|\[\mnc{A}Am]dor \altchords{|A |Bm} \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Aya Aya Ayahuasca}[id={aya-aya-ayahuasca-s7ox1j},tags={Aya},ph={IV},key={Am},gk={Am, Gm--Bm}]
  ...
  \beginverse[1]\memorize
    \beginrep
      \[^\mn{G}]A|\[\mnc{A}Am]ya \[^\mn{G}]a\[\bmc\mn{A}]ya \[^\mn{G}]a|\[\mnc{A}G]ya\[^\mn{G}]hu\[^\mn{F}]as\[\bmc\mnc{E}Am]ca \altchords{\id[1]{(Bm)}|Bm |A Bm}
      \[^\mn{D}]A|\[\mnc{E}C]ya \[^\mn{D}]a\[\bmc\mnc{E}Dm]ya \[^\mn{D}]a|\[\mnc{E}G]ya\[\mnc{D}(Em7)]hu\[^\mn{C}]as\[\bmc\mnc{A}Am]ca \altchords{|D Em |A (F\shrp{}m7) Bm}
    \endrep
  \endverse
  \notesoff
  \beginverse
...
\beginsong{Mamãe Maria}[id={mamae-maria-zmo2qt},by={Ale de Maria},ph={IV},key={Am},gk={Am, (Am)--Gm--G\shrp{}m--(Bm)}]
  ...
  \endverse
  \beginverse[2]
    \[\mn{D}]Vo\[\mn{F#}]ar \[\mn{A}]bem |\[\mnc{E}Em]lon\[\mn{D}]ge \[\mn{E}]so\[\mn{D}]bre o |\[\mn{E}]mar \[\mn{D}]na \[\mn{E}]ma\[\mn{D}]ré |\[\mnc{A}D]chei\[\mn{F#}]a | \e
  ...
  \beginverse[3]\memorize
    \[^\mn{F#}]Sal\[^\mn{A}]ve A\[^\mn{D}]ya|\[\mnc{B}Bm]huas\[^\mn{A}]ca, \[^\mn{B}]Vô \[^\mn{A}]Pey|\[^\mn{B}]o\[^\mn{A}]te \[^\mn{B}]e \[^\mn{A}]São |\[^\mn{D}]Ped\[^\mn{B}]ro | \e
...
\beginsong{Eu Canto nas Alturas}[id={eu-canto-nas-alturas-1q8kl8},by={Mestre Irineu Serra},tags={Santo Daime},ph={IV},key={Em},gk={Em, Cm--F\shrp{}m}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep \[^\mn{F}]Porque eu |\[F]sou fi\[\mnc{E}C]lho \[^\mn{G}]de |\[\mnc{E}Am]Deus \altchords{|F C |Am}
      \[^\mn{C}]E \[^\mn{D}]te\[^\mn{E}]nho a |\[\mnc{D}Dm]mi\[^\mn{A}]nha \[\mnc{C}Am7]Mãe \[^\mn{E}]que|\[\mnc{D}Dm]rida \altchords{|Dm Am7 |Dm} \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Flor das Águas}[id={flor-das-aguas-zrmwrj},by={Mestre Irineu Serra},tags={water, sea, Santo Daime},ph={IV},key={Am},gk={Cm, G\shrp{}m--D\shrp{}m}]
  ...
  \mnbeginverse[1]\memorize
    \beginrep
      \[^\mn{A}]A \[^\mn{C}]mo|\[\mnc{E}Am]rada \[\mnc{D}G]do \[^\mn{E}]meu |\[\mncii{C}{B}Am]Pai \[^\mn{A}]é \[^\mn{C}]no |\[\mnc{E}C]cora\[^\mn{D}]ção \[^\mn{E}]do |\[\mnc{D}Dm]mundo
      Aonde e|xiste \[\mnc{C}C]to\[^\mn{B}]do a|\[\mnc{E}E]mor e \[\mnc{D}(E7/D)]{tem um} |\[\mnc{C}C]se\[^\mn{B}]gre\[\mnc{G#}E7]do \[^\mn{B}]pro|\[\mnc{A}Am]fundo
    \endrep
  \mnendverse
  \notesoff
  \beginverse[1]
...
\beginsong{Brilho do Sol \\ Paiste auringon}[id={brilho-do-sol-q2s1gk},by={Sebastião},tags={Sun, Santo Daime},ph={IV, V},key={D},gk={D, C--F\shrp{}m}]
  ...
  \mnbeginverse
    \beginrep\memorize
      \beginrep \[^\mn{A}]Eu |\[\mnc{D}D]sou \[^\mn{F#}]bri\[^\mn{E}]lho \[^\mn{D}]do \[\bm]sol, |sou \[^\mn{F#}]bri\[^\mn{E}]lho \[^\mn{D}]da \[\mnc{F#}Bm/F#]lua \endrep
      \beginrep \[^\mn{F#}]Dou |\[\mnc{G}G]bri\[^\mn{F#}]lho \[^\mn{E}]as \[^\mn{D}]es\[\mnc{F#}D]trelas, \[^\mn{D}]por\[^\mn{F#}]que |\[\mnc{E}A7]todas \[^\mn{B}]me a\[^\mn{C#}]com\[\mnc{D}D]panham \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Na Força da Mata Eu Tomo meu Rapé}[id={na-forca-da-mata-eu-tomo-meu-rape-rl05pr},tags={rapé},key={Am},gk={Am, Gm--G\shrp{}m}]
  \mnbeginverse
    \beginrep\memorize
      \beginrep \[^\mn{A}]Na \[^\mn{B}]for|\[\mnc{C}Am]ça \[^\mn{D}]da \[\mn{E}\bm]mata eu to\[^\mn{D}]mo o |\[\mnc{F}Dm]meu \[^\mn{D}]rap\[\mnc{E}E]é \endrep
      \beginrep \[^\mn{E}]Pa\[^\mn{F}]ra |\[\mnc{E}Am]me \[^\mn{D}]limp\[\mnc{C}C]a, para \[^\mn{D}]me |\[\mnc{C}E]pro\[^\mn{B}]teg\[\mnc{A}Am]er \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Conselho}[id={conselho-rk2plt},by={Adilson Bispo, Zé Roberto},key={A},gk={C, (B)--(C)},ph={IV}]
  ...
  \mnbeginverse
    ...
    \[\mn{B}]Se a\[\mnc{C}]pr|\[C]en\[\mn{E}]de\jw u\[\mnc{D}B&7]ma li\[\mncadj{-.15ex}{C#}]ç|\[A7]ão \altchords{|C B\flt{}7 |A7}
  ...
  \mnbeginverse
    \beginrep
      ...
      \[\mn{A}]O \[\bmc\mn{A&}]meu \[\mn{A}]con\[\mncadj{-.15ex}{E}]s|\[D7]e\[\bm\mn{D}]{lho\jw é} \[\mn{C}]pra \[\mn{A}]te |\[\mnc{D}G7]ver \[\bm{}] \[\mn{E}]fe\[\mncadj{-.45ex}{C}]l|\[C]iz \up{2}(\[\bm{}]{} | \e)\altchords{|D7 |G7 |C \ac<2>{| \e}}
    \endrep
  \mnendverse
