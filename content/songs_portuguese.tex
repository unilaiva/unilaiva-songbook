...
\beginsong{Mamãe dos Ventos}[by={Maria Alice},ph={III},tags={Santo Daime, wind},key={Em},gk={Gm, Gm--G\shrp{}m}]
...
\beginsong{Aliança}[by={Beth}, ph={IV}, tags={Santo Daime}, key={Am}, gk={Am, Am--Bm}]
...
\beginsong{Brilho do Sol \\ Paiste auringon}[by={Sebastião}, tags={Sun, Santo Daime}, ph={IV, V}, key={D}, gk={D, C--F\shrp{}m}]
...
\beginsong{Tomando Rapé}[tags={rapé}]
  ...
  \beginverse\memorize
    ...
    \beginrep Se ma|\[E]mãe Jur\[E7]ema foi que |\[E]nos mando\[Am]u \endrep
    \endrep
  \endverse
  \notesoff
  \beginverse
    ...
    \beginrep Peço |^força o M^estre pra nos |^ajuda^r \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    No mei|^o das matas tocou |^meu tambo^r
    \beginrep Se meu |^pai Ox^ossi Sara|^vá chego^u \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    Peco |^meu Jesus que me |^deu a lu^z
    \beginrep Que me |^deu firm^eza pra nos |^caminha^r \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    A es|^trada é longa tenho |^fé de chega^r
    \beginrep Nos pes |^de Jesus no ^Céu onde e|^le est^a \endrep
    \endrep
  \endverse
  \begin{translation}[EN]
