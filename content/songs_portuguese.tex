...
\beginsong{Chama}[by={Nei Zigma}, ph={III}, key={Am}, sks={Am, G\shrp{}m--Bm}]
  ...
  \beginchorus
    ...
    Eterna |chama queimando |dentro \altchords{|Bm C |B7}
    Que se ali|menta da força do |vento \altchords{|C Am |B7}
  \vspace{1em}\replay
    ...
    Deixando o |solo  bem mais |fértil \altchords{|D7 |G}
    Que of |fruta na terra flo|resça \altchords{|Bm C |B7}
    En|chendo nossos |olhos \altchords{|C Am |B7}
...
\beginsong{Cavalo Marinho}[ph={III, IV}, key={C}, sks={C, C--F\shrp{}}]
  ...
  \textnote{suomeksi:} % by: Outi
  \beginchorus
     \meter{8}{8}|Laukkaa merihevo|nen 
    Näytä mikä \meter{2}{8}|tie mun \meter{3}{8}|tulee ot\meter{8}{8}|taa 
    |Heitä harja tuule\meter{2}{8}|hen 
    \meter{4}{8}|Merihevo\meter{2}{8}|nen, lauk\meter{3}{8}|kaa tuules\meter{8}{8}|sa! 
  \endchorus
  ...
  % \endchorus
  % \beginchorus
  %   \meter{4}{4}|Laukkaa merihevo|nen 
  %   Näytä mikä \meter{5}{8}|tie mun tulee ot\meter{4}{4}|taa 
  %   |Heitä harja tuule\meter{3}{4}|hen
  %   Merihevo\meter{5}{8}|nen, laukkaa tuules\meter{4}{4}|sa! 
  % \endchorus
  \begin{translation}
    Gallop, sea horse
...
\beginsong{Pantera Negra}[by={Leo do Gamarra}, key={Dm}, sks={Dm, Dm--Em}, ph={IV}]
  ...
  \beginchorus\replay[chords_panteranegra_a]
    ...
    trazendo a |força do Arcanjo Gabri|el  \up{2}(|  \e)
  \endchorus
  \beginchorus\replay[chords_panteranegra_a]
    Eu |vi o exercito de |Deus a perfi|lar |  \e
    \endchorus\glueverses\beginchorus\replay[chords_panteranegra_b]
    Pra rece|ber a luz a santa ora|ção 
    da Dou|trina da Virgem da Concei|ção  \up{2}(|  \e)
  \endchorus
  \beginchorus\replay[chords_panteranegra_a]
    Che|gou um Rei todo de |branco e pés no |chão |  \e
    \endchorus\glueverses\beginchorus\replay[chords_panteranegra_b]
    Para mos|trar que nesse mundo de ilu|são 
    o que im|porta é o amor no cora|ção  \up{2}(|  \e)
  \endchorus
  \begin{translation}
...
\beginsong{Recado da Mãe Divina}[by={Chandra Lacombe}, ph={IV}, key={D}, sks={D, B\flt{}--E}]
  ...
  \beginchorus\replay[chords_recado_da_mae_a]
    ...
    Provo o |néctar do amor ma|du\sublyr{\up{2}\textbf{Hey-}}ro
  \endchorus
  \beginchorus\replay[chords_recado_da_mae_b]
    \ind[2] \textbf{-aa hey}|{\textbf{aa heyaa}}, hay|ee
    \ind[2] Hay|ee hayee hay|aa
    \ind[2] Hay|ee hayee hay|aa
    \ind[2] Hay|ee \up{1}(hayee hay)|{a\sublyr{\up{1}\textbf{Hey-}}a}
...
\beginsong{Aya Aya Ayahuasca}[tags={Aya}, ph={IV}, key={Am}, sks={Am, Gm--Bm}]
  ...
  \beginchorus
    ...
    Se ba|lança maracá com a|mor no coração  \goto{Aya aya}
  \endchorus
  \begin{translation}
...
\beginsong{Mamãe Maria}[by={Ale de Maria}, ph={IV}, key={Am}, sks={Am, (Am)--Gm--G\shrp{}m--(Bm)}]
  ...
  \beginverse\replay
    ...
    \ind[2] Honrar o a|mor, a luz pre|sente na fa|mília | \e
...
\beginsong{Flor das Águas}[by={Mestre Irineu Serra},tags={water, sea, Santo Daime},ph={IV},key={Am},sks={Cm, Dm, Am}]
  ...
  \notesoff
  \beginchorus
    \ind Este |segredo pro|fundo está em |toda humani|dade
...
\beginsong{Brilho do Sol \\ Paiste auringon}[by={Padr. Sebastião},tags={Sun, Santo Daime},ph={IV, V},key={D},sks={D, E}]
  ...
  \beginchorus
    ...
    \lrep Eu |brilho na floresta porque |ela me pertence \rrep
  \endchorus
  \textnote{suomeksi:}
  \beginchorus
    \lrep Olen |paiste auringon, |sekä loiste kuun \rrep
    \lrep Va|laisen tähdistön, koska se |on mun seuranain \rrep
  \endchorus
  \beginchorus
    \lrep Olen |välke merenpinnan, hen|gitän tuulessa \rrep
    \lrep Loistan |metsän sydämessä, sillä se |kuuluu minulle \rrep
  \endchorus
...
\beginsong{Na Força da Mata Eu Tomo meu Rapé}[tags={rapé}]
  ...
  \notesoff
  \beginchorus
    \lrep Nos ol|hos da grande Á|guia dourada \rrep
    \lrep Sou o |Corvo negro e vou vo|ar também \rrep
  \endchorus
  \beginchorus
    \lrep Eu |vou seguindo nes|te caminho \rrep
    \lrep Quem vai |me guiando, não me dei|xa sozinho \rrep
  \endchorus
  \beginchorus
    \lrep Salve |esta força, a força |do rapé \rrep
    \lrep Que tem |como Mestre? Caboclos |e Pajés \rrep
  \endchorus
  \begin{translation}
...
\beginsong{Tomando Rapé}[tags={rapé}]
  ...
  \beginchorus
    ...
    \lrep Se meu |pai Oxossi Sara|vá chegou \rrep
  \endchorus
  \beginchorus
