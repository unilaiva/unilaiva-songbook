...
\beginsong{Oh Jurema}[ph={II}, key={Em}, gk={Em, Am--F\shrp{}m}]
  ...
  \goto{Jurema}
  \hardbrk
  \begin{translation}\iflyriconly\scriptsize\fi % to fit on one page in lyrics-only book
...
\beginsong{Rosário da Floresta}[by={Antonio Malavoglia}, ph={II, III}, key={Am}, gk={Am, Gm--G\shrp{}m}--(Am)]
  ...
  \endverse
  \begin{translation}\iflyriconly\footnotesize\fi% to fit on one page in lyrics-only book
...
\beginsong{Borboleta}[by={Mitmeel Ananda}, ph={III}, key={Am}, gk={Am, Gm--G\shrp{}m}]
  ...
  \begin{translation}\iflyriconly\else\scriptsize\fi % for fitting on a spread
