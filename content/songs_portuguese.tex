...
\beginsong{Flor das Águas}[by={Mestre Irineu Serra},tags={water 1, sea 1, Santo Daime 1},ph={IV}]
  \beginchorus
    |\[Am\noteULL{E}]Flor \[Am7] \[\noteU{C}]das |\[Dm\noteULL{D}]águas da \[D\textdegree7]onde |\[E]vens, para \[E7]onde |\[Am]vais
...
\beginsong{Voo do Beija-flor}[by={Elisa Cristal},ph={II, III}]
  \transpose{1}
  \beginchorus\memorize
    \[^\noteU{E}]Vôo silenci|\[B\noteUL{D#}]oso do mistério do a|\[C#m]mor
    Fecho os |\[A]olhos para ver aonde |\[E]vou
  \endchorus\glueverses
  \notesoff
  \beginchorus
    Voar pelo infi|^nito daquilo que eu |^sou
    \textsuperscript{*}desven|^dar o  oceano interi|^or \hfill{\footnotesize\emph{\textsuperscript{*}mergulhar no}}
  \endchorus
  \beginchorus
...
\beginsong{Tomando Rapé}[tags={rapé 1}]
    % TODO: check melody and bar division.
    %   Perhaps the melody could start like this: A,C,D,E like this: {A}Toman{C}do {D}Ra{E}pe
    %   Originally the bars were divided like this:
    %     |Tomando Rapé |A força chegou |
    %     \lrep |Se mamãe Jurema |foi que nos mandou | \rrep
  \meter{4}{4}
  \beginchorus\memorize
    \[^\noteU{E}]Toman|\[Am\noteULL{A}]do \[^\noteU{C}]Ra\[^\noteU{E}]pé a for|\[Fmaj7\noteUDELTAX{F}{-3em}]ça \[^\noteU{E}]che\[^\noteU{B}]go\[E]u
    \lrep Se ma|\[E]mãe Jurema foi que |nos mando\[Am]u \rrep
  \endchorus
  \notesoff
  \beginchorus
    Toman|^do Uni para |^se cura^r
    \lrep Peço |^força o Mestre pra nos |ajuda^r \rrep
  \endchorus
  \beginchorus
    No mei|^o das matas tocou |^meu tambo^r
    \lrep Se meu |^pai Oxossi Sara|vá chego^u \rrep
  \endchorus
  \beginchorus
    Peco |^meu Jesus que me |^deu a lu^z
    \lrep Que me |^deu firmeza pra nos |caminha^r \rrep
  \endchorus
  \beginchorus
    A es|^trada é longa tenho |^fé de chega^r
    \lrep Nos pes |^de Jesus no Céu on|de ele es^ta \rrep
  \endchorus
  \begin{translation}
