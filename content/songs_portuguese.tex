...
\beginsong{Borboleta}[by={Mitmeel Ananda}, ph={III}, key={Am}, gk={Am, Gm--G\shrp{}m}]
  ...
  \begin{translation}[EN]\iflyriconly\else\scriptsize\fi % for fitting on a spread
    It's time to break the cocoon within you
    It's time to fly: be a butterfly and flap your wings
    It's time to fly: flap your wings and be a butterfly
    \nextverse
    Butterfly, you can fly; it is your deserving for knowing how to wait
    Before you were a larva crawling on the ground, now you're a butterfly flying!
    \nextverse
    It's time to reign the thoughts within you
    It's time to rule the great kingdom that is your being
    It's time to rule the great kingdom that you are
    \nextverse
    Butterfly, you can fly; it is your deserving for knowing how to wait
    Before you were a larva crawling on the ground, now you're a butterfly reigning!
  \end{translation}
...
\beginsong{Mamãe dos Ventos}[by={Madr. Maria Alice},ph={III},tags={Santo Daime},key={Em},gk={Gm, Gm--G\shrp{}m}]
...
\beginsong{Oração de São Francisco}[by={Pe. Irala, SJ}, key={Am}, gk={Am, Gm--Am}, ph={III}]
  ...
  %     }
  %     \layout { #(layout-set-staff-size 10.5) } % for better fit
  % %     \include "tex/lp-include-tail-lyricsbelow.ly"
  % %   \end{lilypond}\end{lilywrap}
\endsong
...
\scleardpage
\beginsong{Santa Cura}[by={Marie Gabriella}, key={Bm}, gk={Bm, (Bm)--C}, ph={III}]
