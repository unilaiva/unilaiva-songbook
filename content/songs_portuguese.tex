...
\beginsong{Defumação}[tags={censing, Santo Daime},ph={I},key={Am},sks={Am}]
  \meter{4}{4}
  \mnbeginchorus
...
\beginsong{O Bálsamo Do Céu}[by={Baixinha}, tags={Santo Daime}, ph={III}, key={Dm}, sks={Dm, Cm--D\#m}]
  ...
  \mnendchorus
  \beginchorus\memorize
    \ind \lrep \[\mn{A}]Os |\[\mnc{D}Dm]homens \[\mn{E}]na |\[\mnc{F}F]Ter\[\mn{D}]ra \[\mn{F}]pre|\[\mnc{E}A]ci\[\mn{C#}]sam \[\mn{E}]do |\[\mnc{D}Dm]Bem \rrep
...
\beginsong{Elevei o Pensamento}[by={Ricardo Morais}, tags={Santo Daime}, key={D}, sks={D, C--A}, ph={III}]
  ...
  \mnbeginchorus\memorize
    ...
    O bri\[\bmc\mn{B}]lho da \[^\mn{C#}]formo|\[\mnc{D}D]su\[\bm]ra | \e \altchords{|C | \e}
  \mnendchorus
  \notesoff
  \beginchorus
...
\beginsong{Mamãe dos Ventos}[by={Madr. Maria Alice},ph={III},tags={Santo Daime},key={Em},sks={Gm, Gm--G\#m}]
  ...
  \beginchorus\replay[chords_mamaedosventos_a]
    ...
    Ilumi|^nai toda es^ta escuri|^dão
  \endchorus
  \begin{translation}
...
\beginsong{Nova Consciência}[by={Tiago Lucci}, key={Bm}, sks={C\#m, Cm--Ebm}, ph={II}]
...
\beginsong{Forças Encantadas}[by={Vinícius Rocha}, ph={I}, key={A}, sks={B, G--D\#}]
