...
\beginsong{Borboleta}[by={Mitmeel Ananda}, ph={III}, key={Am}, sks={Am, Gm--G\shrp{}m}]
...
\beginsong{Deixa a Gira Girar}[by={Mateus Alelulia, Heraldo, Dadinho}, ph={IV}, key={Em}, sks={Gm, Gm--G\shrp{}m}]
...
\beginsong{Caminho da Luz}[ph={IV}, key={Am}, sks={Am, Gm--Bm}]
  \beginchorus
...
\scleardpage
\beginsong{Manto de Maria}[by={Pedro Gonçalves}, ph={III, IV}, key={Dm}, sks={Dm, Cm--Em}]
...
\beginsong{Tupinambá}[ph={IV}, key={Dm}, sks={Cm--Fm}]
...
\beginsong{Caboclo das Matas}[ph={IV}, key={Dm}, sks={Dm, Cm--D\shrp{}m}]
...
\beginsong{Ciranda para Janaína}[ph={IV}, key={Am}, sks={Am, G\shrp{}m--(Am)}]
...
\beginsong{Aliança}[by={Madr. Beth}, ph={IV}, tags={Santo Daime}, key={Am}, sks={Am, Am--Bm}]
...
\beginsong{Caboclo na Mata}[ph={IV}, key={Am}, sks={Bm, Gm--Em}]
...
\beginsong{Mamãe Maria}[by={Ale de Maria}, ph={IV}, key={Am}, sks={Am, (Am)--Gm--G\shrp{}m--(Bm)}]
...
\beginsong{Eu Canto nas Alturas}[by={Mestre Irineu Serra}, tags={Santo Daime}, ph={IV}, key={Em}, sks={Em, Cm--F\shrp{}m}]
...
\beginsong{Flor das Águas}[by={Mestre Irineu Serra},tags={water, sea, Santo Daime}, ph={IV}, key={Am}, sks={Cm, G\shrp{}m--D\shrp{}m}]
...
\beginsong{Brilho do Sol \\ Paiste auringon}[by={Padr. Sebastião}, tags={Sun, Santo Daime}, ph={IV, V}, key={D}, sks={D, C--F\shrp{}m}]
...
\beginsong{Oração de São Francisco}[by={Pe. Irala, SJ}, key={Am}, sks={Am, Gm--Am}, ph={III}]
...
\beginsong{Venho lá da Floresta}[by={Mapu Huni Kuin, Ixã Huni Kuin}, key={Am}, sks={Am, Am--Em}, ph={IV}]
  ...
  \endchorus
  \beginchorus
    \ind \[\mn{E}]E\[\mn{F#}]he|\[\mnc{G}G]heh \[\bmc\mn{D}]e\[\mn{B}]he|\[\mnc{A}D]heh \[\mn{G}]a-\[\bmc\mn{A}]eh-\[\mn{G}]a-\[\mn{A}]eh-\[\mn{G}]a-|\[\mnc{A}Am]eh \altchords{\id[1]{(Em) \capo{5}}|G |D |Am}
    \ind a-\[\bm]eh-a-eh-a-|\[C]eh a-eh-a-\[\bm]eh-a-eh-a-|\[Em]eh \[\bm] | \[\bm]\e \altchords{|C |Em | \e}
  \endchorus
  \notesoff
  \beginchorus
    |^ Peço ^à mãe Ra|^inha, toda ^hora todo |^dia \altchords{|Em |D |Am}
    Para ^trazer a |^cura, e a nos ^dar muita ale|^gria^ | ^\e \altchords{|C |Em | \e}
  \endchorus
  \goto{Eheheh}
  \beginchorus
