...
\beginsong{O Bálsamo Do Céu}[by={Baixinha},tags={Santo Daime},ph={III}]
...
\beginsong{Elevei o Pensamento}[by={Ricardo Morais},tags={Santo Daime},ph={III}]
...
\beginsong{Nova Consciência}[by={Tiago Lucci}, key={Bm}, sks={C\#m, Cm--Ebm}, ph={II}]
  ...
  \mnbeginverse
    ...
    |\[^\mn{A}]Desatar o i\[^\mn{G}]ni|\[^\mn{F#}]mi\[^\mn{B}]go |\[\mnc{C}F#\textdegree7]para a luz reen\[^\mn{B}]con|\[\mnc{G}Em]trar
