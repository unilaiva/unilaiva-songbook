...
\beginsong{Verdade Pura}[by={William Vilas Boas}, key={Gm}, gk={Gm}]
  ...
  \mnbeginverse
    \beginrep\memorize
    \beginrep \[^\mn{D}]Esta é \[\bmc\mn{B&}]a \[^\mn{A}]dou|\[\mnc{D}Gm]tri\[\bm]na, | do Sol \[\bmc\mn{E&}]e \[^\mn{D}]da |\[\mnc{C}Cm]Lu\[\bm]a |\[Cm6]{} \e
    \[^\mn{A}]E \[\bm]das \[^\mn{G}]Es|\[\mnc{F#}D]tre\[\bmc\mn{D}]las, |\[D7]{} e da \[^\mn{E&}]Ver\[\bmc\mn{D}]da\[^\mn{C}]de |\[\mnc{D}Gm]Pu\[\bm]ra |\[\ac(2){G7}]{} \e \endrep
    \beginrep
  ...
  \beginverse
    \beginrep
    \beginrep Quem ^mais quer |^ser ^ | é quem ^menos |^é ^ |^
    Sigamos ^o ex|^em^plo |^ do bom Je^sus de Naza|^ré ^ |^ \e \endrep
