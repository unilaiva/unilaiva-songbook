...
\beginsong{O Bálsamo do Céu}[id={o-balsamo-do-ceu-7ffpf7},by={Baixinha},tags={valsa},key={Dm},gk={Dm, Cm--D#m}]
...
\beginsong{Chamei Mamãe Jurema}[id={chamei-mamae-jurema-b2bqc5},by={Valdete},key={Bm},gk={Cm, (Bm)--Cm--D#m}]
...
\beginsong{Santíssimo Daime}[id={santissimo-daime-6ug4u9},by={José Ricardo},off={Cyrenia},key={Am},gk={Am, Gm--Bm}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \[^<A>]Um di\[^<C>]a a|\[<E>E]in\[E7]{-} \[^<D>]{da eu} \[^<E>]che\[^<D>]go |\[<A>Am]lá \[<*>]{} \altchords{|F# F#7 |Bm}
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Defuma Com as Ervas da Jurema}[id={defuma-com-as-ervas-da-jurema-kma24w},by={?},key={Am},gk={Am, G#--(Am)}]
...
\beginsong{Pena de Prata}[id={pena-de-prata-jwx052},by={Sonia Maria Palhares},key={Dm},gk={Dm, Cm--F#m}]
...
\beginsong{Coração Alado}[id={coracao-alado-9k1e8n},by={Regina Pereira},key={Dm},gk={Dm, Cm--E&m},tags={valsa}]
...
\beginsong{Eu Vi a Mãe Santa Maria}[id={eu-vi-a-mae-santa-maria-269lcr},by={Cidu},key={Am},gk={Am, Gm--G#m--(Am)}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      Cheia \[<* G>]de a\[^<F>]le\[^<E>]gri|\[<B @.68ex>Bm7&5]{-a lá} \[^<D>]no \[<* C>]seu \[^<B>]jar\[^<E>]di|\[E]m \[<*>] \altchords{|Am7&5 |D}
...
\beginsong{Mensageiro das Estrelas}[id={mensageiro-das-estrelas-bu05fs},by={Vitor Vitti},key={Dm},gk={Dm, Cm--E&m}]
