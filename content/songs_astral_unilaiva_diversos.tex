...
\beginsong{O Bálsamo do Céu}[id={o-balsamo-do-ceu-7ffpf7},by={Baixinha},tags={valsa},key={Dm},gk={Dm, Cm--D\shrp{}m}]
  ...
  \mnbeginverse
    \beginrep
      \beginrep
        \[\mn{A}]O |\[\mnc{D}Dm]bálsamo \[\mn{E}]do |\[\mnc{F}F]Céu \[\mn{A}]des|\[\mnc{E}A]ceu \[\mn{F}]à |\[\mnc{E}Dm]Ter\[\mn{D}]ra
      \endrep
      \beginrep
        \[\mn{A}]As |\[\mnc{B&}Gm]flo\[\mn{A}]res \[\mn{G}]da |\[\mnc{F}F]Ter\[\mn{E}]ra \[\mn{D}]rece|\[\mnc{A}A7]be\[\mn{C#}]ram \[\mn{E}]a |\[\mnc{D}Dm]Luz
      \endrep
    \endrep
  \mnendverse
...
\beginsong{Chamei Mamãe Jurema}[id={chamei-mamae-jurema-b2bqc5},by={Valdete},key={Bm},gk={Cm, (Bm)--Cm--D\shrp{}m}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep
        \[^\mn{E}]Cha|\[Em]mei Papai \[\bmc\mn{G}]Ogum \[^\mn{F#}]da |\[\mnc{D}Bm]Ma\[^\mn{B}]ta\[\bm], \[^\mn{D}]cha|\[\mnc{C#}F#]mei Pa\[^\mn{D}]pai \[\mnc{E}F#7]O\[^\mn{D}]gum \[^\mn{C#}]do |\[\mnc{B}Bm]Mar \[\ac<1>{B7}]{}
      \endrep
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Verdade Pura}[id={verdade-pura-3eoicz},by={William Vilas Boas},key={Gm},gk={Gm}]
  ...
  \mnbeginverse\memorize
    \beginrep
      \beginrep
        \[^\mn{D}]Esta é \[\bmc\mn{B&}]a \[^\mn{A}]dou|\[\mnc{D}Gm]tri\[\bm]na, | do Sol \[\bmc\mn{E&}]e \[^\mn{D}]da |\[\mnc{C}Cm]Lu\[\bm]a |\[Cm6]{} \e
        \[^\mn{A}]E \[\bm]das \[^\mn{G}]Es|\[\mnc{F#}D]tre\[\bmc\mn{D}]las, |\[D7]{} e da \[^\mn{E&}]Ver\[\bmc\mn{D}]da\[^\mn{C}]de |\[\mnc{D}Gm]Pu\[\bm]ra |\[\ac<2>{G7}]{} \e
      \endrep
      \beginrep
        \ind \[^\mn{D}]Para \[\bmc\mn{E&}]com\[^\mn{D}]preen|\[\mnc{C}Cm]der, pa\[^\mn{D}]ra \[\bmc\mn{E&}]com\[^\mn{D}]preen|\[^\mn{C}]der
        \ind \ilsl{\[^\mn{A}]É} \[^\mn{B&}]ter \[^\mn{C}]e\[\bmc\mn{D}]du\[^\mn{C}]ca|\[\mnc{B&}B&]ção, \[^\mn{A}]é \[^\mn{B&}]ter \[^\mn{C}]e\[\bmc\mn{D}]du\[^\mn{C}]ca|\[^\mn{B&}]ção
        \ind Não \[\bmc\mn{C}]se \[^\mn{B&}]jul|\[\mnc{A}D]gar,\[\bm]{} |\[D7]{} nem jul\[\bmc\mn{B&}]gar os \[^\mn{A}]seus ir|\[\mnc{/}Gm]mãos\[\bm]{} |\[\ac<1>{G7}]{} \e
      \endrep
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Santíssimo Daime}[id={santissimo-daime-6ug4u9},by={José Ricardo},off={Cyrenia},key={Am},gk={Am, Gm--Bm}]
  ...
  \beginverse
    \beginrep
      Eu chego |^lá \noteson\[\mnd{D}]{e é} \[\mnd{E}]pa\[\mnd{D}]ra\notesoff{} ^nunca mais vol|tar ^
      Voltar pras |tre\noteson\[\mnd{G}]vas \[\mnd{A}]des\[\mnd{G}]se\notesoff{} ^mundo de ilu|^são ^
  ...
  \beginverse
    \beginrep
      Se a|^cor\noteson\[\mnd{D}]dem \[\mnd{E}]meus \[\mnd{D}]ir\notesoff{}^mãos pra esse a|mor ^
      E compre|en\noteson\[\mnd{G}]dam \[\mnd{A}]es\[\mnd{G}]se\notesoff{} ^tempo em que vi|^ve^mos
      É prova|ção mas é ^a transforma|^ção ^
      A grande |^chan\[\mnd{D}]ce \[\mnd{E}]pa\[\mnd{D}]ra a\notesoff{} ^ilumina|^ção ^
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[]
    % transcribed by larva, latest update on 2023-07
...
\beginsong{Defuma Com as Ervas da Jurema}[id={defuma-com-as-ervas-da-jurema-kma24w},by={?},key={Am},gk={Am, G\shrp{}--(Am)}]
  ...
  \endverse
  \mnbeginverse[1]
    \[\mn{A}]Ju|\[\mncadj{1ex}{F}F]re\[\bm]ma, | \[\mn{D}]esta \[\bm]casa é \[\mn{C}]de \[\mn{B}]Ma|\[\mncii{A}{E}Am]ri\[\bm]a
    | \[\mn{C}]Defu\[\bm]mar com \[\mn{G}]har\[\mn{F#}]mo|\[\mncii{F}{E}E]{ni}\[\bm]a
    |\[E7] \[\mn{D}]Queirar a \[\bmc\mn{B}]todos \[\mn{C}]per\[\mn{D}]do|\[\mnc{E}Am]ar \[\bm]
    \[\mn{A}]Ju|\[\mncadj{1ex}{F}F]re\[\bm]ma, | \[\mn{D}]junto \[\bm]com a San\[\mn{C}]ta \[\mn{B}]Ma|\[\mncii{A}{E}Am]ri\[\bm]a
    | \[\mn{C}]Nos traz \[\bm]paz e \[\mn{G}]a\[\mn{F#}]le|\[\mncii{F}{E}E]{gri}\[\bm]a
    |\[E7] \[\mn{D}]Queira a \[\bmc\mn{C}]todos \[\mn{B}]confor|\[\mnc{A}Am]tar \[\bm]
  \mnendverse
...
\beginsong{Mensageiro das Estrelas}[id={mensageiro-das-estrelas-bu05fs},by={Vitor Vitti},key={Dm},gk={Dm, Cm--E\flt{}m}]
  ...
  \mnbeginverse
    \beginrep\memorize
      \[^\mn{A}]Vou se|\[\mnc{D}Dm]guindo no \[^\mn{E}]ca\[\bmc\mn{F}]minho das es|\[^\mn{E}]tre\[^\mn{D}]las \[\bm]
      \[^\mn{A}]No ga|\[^\mn{D}]lope do \[^\mn{E}]meu \[\bmc\mn{F}]cava\[^\mn{E}]lo \[^\mn{D}]ma|\[\mnc{G}Gm]ri\[\bm]nho
      |Sal\[^\mn{A}]ve \[\bmc\mn{B&}]meu pai \[^\mn{A}]O\[^\mn{G}]xa|\[\mncii{F}{D}Dm]lá \[\bm]
      \[^\mn{F}]{E a} minha |\[\mnc{E}A]mãe \[\mnc{G}A7]I\[^\mn{F}]e\[^\mn{E}]man|\[\mnc{D}Dm]já \[\bm]
    \endrep
  \mnendverse
  \notesoff
  \beginverse
