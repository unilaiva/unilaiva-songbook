...
\beginsong{\texorpdfstring{Maailmansynty\-runo}{Maailmansyntyruno}}[id={maailmansynty-runo-maailmansyntyruno-1ks5d8},by={Kalevala: 1. runo}]
  \beginverse
...
\beginsong{Aamulla}[id={aamulla-z4446h},tags={aamu, Aurinko}]
  \beginverse
...
\beginsong{Tuulen sanat}[id={tuulen-sanat-ivt40e},tags={tuuli}]
  \beginverse
...
\beginsong{Löylyn sanat: terve löyly}[id={loylyn-sanat-terve-loyly-1eoh4h},tags={sauna}]
  \beginverse
...
\beginsong{Löylyn sanat: tule löylyhyn}[id={loylyn-sanat-tule-loylyhyn-32vz29},tags={sauna}]
  \musicnotefornext{Melodia: Kalevala-sävelmä tai esim. Hedingarna: Täss' on nainen}
  \beginverse
...
\beginsong{Ihmisen synty}[id={ihmisen-synty-yfrhao}]
  \beginverse
    Ihminen ihala ilme,
...
\beginsong{Karhun synty}[id={karhun-synty-1n3xre}]
  \beginverse
    Otsoseni, ainoiseni,
...
\beginsong{Kiven synty}[id={kiven-synty-uih7mt}]
  \beginverse
...
\beginsong{Noidan synty}[id={noidan-synty-52la0u}]
  \beginverse
...
\beginsong{Puiden synty}[id={puiden-synty-43rr2o}]
  \beginverse
...
\beginsong{Tammen synty}[id={tammen-synty-vfdm9e}]
  \beginverse
...
\beginsong{Tulen synty}[id={tulen-synty-qzshct},tags={tuli}]
  \beginverse
...
%%\beginsong{Tulen synty B}[id={tulen-synty-b-et6wnn},tags={tuli}]
%%  \beginverse
...
\beginsong{Veden synty}[id={veden-synty-xuvwv3},tags={vesi}]
  \beginverse
...
\beginsong{Raudan synty}[id={raudan-synty-3qcolg}]
  \beginverse
...
\beginsong{Varjele vakainen luoja}[id={varjele-vakainen-luoja-pcyyu4},by={Kalevala: 43. runo}]
  \beginverse
...
% \sclearpage
% \beginsong{Höyhensaaret}[id={hoyhensaaret-ioz7mw},by={Eino Leino}]
%   \beginverse
...
% \beginsong{Hymyilevä Apollo}[id={hymyileva-apollo-24wqdy},by={Eino Leino}]
%   \beginverse
...
\beginsong{Soutaja}[id={soutaja-hufxij},by={Unto Kupiainen}]
  \beginverse
