...
\beginsong{Convite}[by={Luiz Mendes},key={Am},sks={Am, Gm, Bm},tags={valsa}]
  ...
  \mnbeginchorus\memorize[chords_convite_a]
    \[^\mn{E}]O \[^\mn{C}]meu |\[\mnc{A}Am]Mestre \[^\mn{E}]con\[^\mn{C}]vi|\[^\mn{A}]dou-me \altchords{\id[1]{(Gm)}|Gm | \e}
    ...
    \[^\mn{E}]To |\[\mnc{A}Fmaj7]{mei o} San\[^\mn{B}]to |\[\mnc{C}Am]Dai\[^\mn{B}]me \altchords{|Ebmaj7 |Gm}
