...
\beginsong{Graças a Deus}[by={Madr. Maria Brilhante},key={G},gk={A, G--A}]
  ...
  %%
  \mnbeginverse
    \beginrep\memorize[chords_gracasadeus_a]
  ...
  \mnendverse
  \mnbeginverse
    \beginrep\memorize[chords_gracasadeus_b]
    \ind \[^\mauii{G}{B}]Sou \[^\mn{B}]u\[^\mn{D}]ma |\[\mnc{G}G]árvore ro\[^\mn{F#}]si\[\mnc{A}Am7]an\[^\mn{G}]te em \[^\mn{F#}]u\[^\mn{E}]ma |\[\mnc{D}D]flor\[\bm]{} \altchords{|A Bm7 |E}
    \ind Graças \[^\mn{E}]a |\[^\mn{D}]Deus aon\[^\mn{E}]de o \[\mnc{D}D7]Dai\[^\mn{C}]me es\[^\mn{B}]tá \[^\mn{A}]es|\[\mnc{G}G]tou\[\bm]{} \altchords{| - E7 |A}
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep%\replay[chords_gracasadeus_a]
  ...
  \mnendverse
  \mnbeginverse
    \beginrep\replay[chords_gracasadeus_b]
    \ind \[\mauii{G}{B}]São \[\mn{B}]João \[\mn{D}]Ba|^tista e a \[\mn{F#}]sem^pre \[\mn{G}]Vir\[\mn{F#}]gem \[\mn{E}]Ma|^ri^a
  ...
  %     \endrep
  %   \mnendverse
  %   \mnbeginverse\memorize[chords_gracasadeus_b]
  %     \beginrep
  ...
  %     \endrep
  %   \endverse
  %   \beginverse\replay[chords_gracasadeus_b]
  %     \beginrep
...
\beginsong{Balanço de São João}[by={Odemir Raulino Da Silva},off={Geraldine},key={C},gk={C, A-F}]
  ...
  \mnbeginverse
    \beginrep
    \beginrep \[\mn{G}]Eu es|\[C]tando \[\mn{E}]com o \[\bmc\mn{C}]Daime, eu |\[Am]nun\[\mn{E}]ca \[\mn{C}]me \[\mnc{D}G]canso
    \[\mn{G}]Eu es|tando com \[\bm]e\[\mn{F}]le
    Eu \[\mn{E}]en\up{1}(|\[\mnc{D}G7]tro \[\mn{E}]no \[\mn{D}]ba\[\mnc{C}C]lanço) \up{2}(|\[\mnc{D}G7]tro \[\mn{E}]no \[\mn{D}]ba\[\mnc{C}C]lan|ço)\endrep
    \beginrep \[\mn{E}]E eu \[\mn{D}]ba\[\bmc\mn{C}]lan|ço \[\mn{G}]e eu ba\[G]lanço
    \[\mn{D}]Nesta |\[\mn{G}]força Di\[\bm]vi\[\mn{F}]na
    \[\mn{E}]Eu \up{1}(|\[\mnc{D}G7]nun\[\mn{E}]ca \[\mn{D}]me \[\mnc{C}C]can|so) \up{2}(|\[\mnc{D}G7]nun\[\mn{E}]ca \[\mn{D}]me \[\mnc{C}C]canso) \endrep
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep
    \beginrep
    \ind \ \[\mn{G}]Venho |\[C]dizer a \[\mn{E}]meu \[\bmc\mn{C}]Mestre, que eu es|\[Am]tou \[\mn{E}]sa\[\mn{C}]tis\[\mnc{D}G]feito
    \ind \[\mn{G}]Pelo |meu cora\[\bm]ção \[\mn{D}]há |\[\mn{G}]quarenta \[\bm]a\[\mn{F}]nos
    \ind \[\mn{E}]Ba\up{1}(|\[\mnc{D}G7]ten\[\mn{E}]do em \[\mn{D}]meu \[\mnc{C}C]peito) \up{2}(|\[\mnc{D}G7]ten\[\mn{E}]do em \[\mn{D}]meu \[\mnc{C}C]pei|to)
    \endrep
    \beginrep
    \ind \[\mn{E}]E eu \[\mn{D}]ba\[\bmc\mn{C}]lanço, cora|ção \[\mn{G}]segue ba\[G]ten\[\mn{D}]do
    \ind Com |\[\mn{G}]meu São Jo\[\bm]ão
    \ind \[\mn{F}]Vou \[\mn{E}]a\up{1}(|\[\mnc{D}G7]le\[\mn{E}]gre \[\mn{D}]vi\[\mnc{C}C]ven|do) \up{2}(|\[\mnc{D}G7]le\[\mn{E}]gre \[\mn{D}]vi\[\mnc{C}C]vendo)
    \endrep
    \endrep
  \mnendverse
  \begin{lilywrap}\begin{lilypond}[]
...
\beginsong{Professor de Estrela}[by={Odemir Raulino Da Silva},key={Dm},gk={Dm, Cm--Dm}]
  ...
  \mnbeginverse
    \beginrep
    \ind |\[Dm]{} \ilsl{\[\mn{D}]És} gran\[\bm]de profes|\[\mnc{B&}B&]sor\[\bm]{} \altchords{|Cm |A\flt{}}
...
\beginsong{Quando o Daime Chega}[by={Baixinha}, off={Jonathan Goldman}, key={C}, gk={C, G--D}]
  ...
  \mnbeginverse
    \beginrep
    \beginrep |\[\mnc{C}C]Quando o \[\bm{}]Dai\[\mn{D}]me |\[\mn{C}]chega \altchords{\id[1]{(D)}|D | \e}
    É \[\bmc\mn{E}]pa\[\mn{G}]ra |\[\mn{E}]to\[\mn{C}]dos \[\bm{}]nós \[\mn{G}]to|\[\mn{E}]mar \[\ac(2){C7}] \altchords{| - | - \ac(2){D7}} \endrep
    \beginrep \[\mn{E}]A|\[\mnc{A}F]gra\[\mn{G}]de\[\bmc\mn{F}]cer \[\mn{E}]a |\[\mnc{C}C]Deus \altchords{|G |D}
    O \[\bmc\mn{E}]que \[\mn{G}]Deus |\[\mnc{D}Dm]tem \[\mn{C}]pa\[(Fmaj7)]ra \[\mn{E}]nós |\[\mnc{C}C]dar \[\ac(1){C7}] \altchords{|Em (Gmaj7) |D \ac(1){D7}} \endrep
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep
    \beginrep
    \ind |\[\mnc{C}C]Quando o \[\bm{}]Dai\[\mn{D}]me |\[\mn{C}]chega \altchords{|D | \e}
    \ind É \[\bm{}]pa\[\mn{E}]ra |\[\mnc{G}G]todos \[\bmc\mn{E}]nós \[\mn{A}]to|\[\mn{G}]mar \[\ac(1){G7}]\altchords{|A | - \ac(1){A7}}
    \endrep
    \beginrep
    \ind \[\mn{E}]A|\[\mnc{A}F]gra\[\mn{G}]de\[\bmc\mn{F}]cer \[\mn{E}]a |\[\mnc{C}C]Deus \altchords{|G |D}
    \ind O \[\bmc\mn{E}]que \[\mn{G}]Deus |\[\mnc{D}Dm]tem \[\mn{C}]pa\[(Fmaj7)]ra \[\mn{E}]nós |\[\mnc{C}C]dar \[\ac(1){C7}] \altchords{|Em (Gmaj7) |D \ac(1){D7}}
    \endrep
    \endrep
  \mnendverse
  \begin{translation}[EN]
