...
\beginsong{O Daime me Balanção}[by={Tetéo},key={C},gk={C, D}]
...
\beginsong{Mesa de Centro}[by={Tetéo},key={D},gk={D, C},tags={2x}]
...
\beginsong{O Daime é o Nosso Pai}[by={Tetéo},key={G},gk={A, G}]
