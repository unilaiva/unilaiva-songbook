...
\beginsong{O Daime é o Nosso Pai}[by={Tetéo},key={G},sks={A, G}]
...
\beginsong{Um, Dois e Três}[by={Tetéo},key={C},sks={D, C, E}]
...
\beginsong{O Lindo Daime}[by={Luiz Mendes},key={Am},sks={Cm, Bm, Am}]
...
\beginsong{Convite}[by={Luiz Mendes},key={Am},sks={Am, Gm, Bm},tags={mazurca}]
  ...
  \mnbeginchorus\memorize[chords_convite_a]
    ...
    \[^\mn{E}]To |\[\mnc{A}Fmaj7]{mei o} San\[^\mn{B}]to \[\bmc\mnc{C}Am]Dai\[^\mn{B}]me \altchords{|Ebmaj7 Gm}
...
\beginsong{Eu Tomo Daime}[by={Vera Gall},key={Bm},sks={Cm, Bm, Am, Dm}]
...
\beginsong{É com Deus}[by={Baixinha},key={C},sks={C, A-D}]
  ...
  \mnbeginchorus
     ...
     \[\mn{A}]E com |\[Am]Deus \[\mn{G}]eu \[G]che\[\mn{F}]go |\[\mnc{F}F]lá \[\bm] \rrep \altchords{|F\#m E |D}
     \lrep \[\mn{A}]Porque |\[F]Deus \[\mn{G}]é \[\bm]quem m\[\mn{F}]e en|\[\mnc{E}C]si\[\mn{C}]na\[\bm] \altchords{|D |A}
     \[\mn{E}]Tudo |\[Am]que eu \[\mn{D}]te(nho) \[G7]que \[\mn{C}]sa|\[C]ber \[\bm] \rrep \altchords{|F\#m E7 |A}
  \mnendchorus
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    theMelody = \relative e'' {
      \set melismaBusyProperties = #'() \slurDashed
...
\beginsong{Ser Divino}[by={Odemir Raulino Da Silva},key={A},sks={A, B, C, G}]
...
\beginsong{Balanço de São João}[by={Odemir Raulino Da Silva},key={C},sks={C, A-F}]
  ...
  \mnbeginchorus
    ...
    \[\mn{E}]Eu \up{1}(|\[\mnc{D}G7]nun\[\mn{D}]ca \[\mn{D}]me \[\bmc\mnc{C}C]can|so) \up{2}(|\[\mnc{D}G7]nun\[\mn{E}]ca \[\mn{D}]me \[\bmc\mnc{C}C]canso) \rrep
  \mnendchorus
  \mnbeginchorus
...
\beginsong{Professor de Estrela}[by={Odemir Raulino Da Silva},key={Dm},sks={Dm, Cm, Em}]
  \audio{https://www.nossairmandade.com/hymn/1557/ProfessorDeEstrela}
  \mnbeginchorus
    \[\mn{A}]O Daime é \[\bm]meu profes|\[\mnc{A}Dm]sor \[\bm] | \e \altchords{\id[1]{(Am)}|Am | \e}
    Ele \[\bm]es\[\mn{B&}]tá \[\mn{A}]de |\[\mnc{G}Gm]o\[\bmc\mn{E}]lho | \e \altchords{|Dm | \e}
    \[\mn{G}]Ele \[\bm]es\[\mn{A}]tá \[\mn{G}]de |\[\mnc{F}Dm]o\[\bmc\mn{D}]lho | \e \altchords{|Am | \e}
    \[\mn{F}]Ele \[\bm]es\[\mn{G}]tá \[\mn{F}]de |\[\mnc{E}A]o\[\bm]lho | \e \altchords{|E | \e}
    Na \[\bm]mi\[\mn{D}]nha \[\mn{C#}]mu|\[\mnc{B&}B&]dan\[\mnc{A}A]ça | \e \altchords{|F E | \e}
  \mnendchorus
  \mnbeginchorus
    \[\mn{A}]Daime é \[\bm]meu profes|\[\mnc{A}Dm]sor \[\bm] | \e \altchords{|Am | \e}
    Sempre \[\bm]es\[\mn{B&}]tá \[\mn{A}]de |\[\mnc{G}Gm]o\[\bmc\mn{E}]lho | \e \altchords{|Dm | \e}
    \[\mn{G}]Sempre \[\bm]es\[\mn{A}]tá \[\mn{G}]de |\[\mnc{F}Dm]o\[\bmc\mn{D}]lho | \e \altchords{|Am | \e}
    \[\mn{F}]Sempre \[\bm]es\[\mn{G}]tá \[\mn{F}]de |\[\mnc{E}A]o\[\bm]lho | \e \altchords{|E | \e}
    Na \[\bm]mi\[\mn{D}]nha es\[\mn{C#}]pe|\[\mnc{E}A7]ran\[\mnc{D}Dm]ça | \e \altchords{|E7 Am | \e}
  \mnendchorus
  \mnbeginchorus
    \[\mn{D}]És gran\[\bm]de profes|\[\mnc{B&}B&]sor\[\bm] | \e \altchords{|F | \e}
    \[\mn{D}]De pa\[\bm]lavra \[\mn{E}]ver\[\mn{D}]da|\[\mnc{A}A]dei\[\bm]ra | \e \altchords{|E | \e}
    \[\mn{A}]Obri\[\bm]ga\[\mn{B&}]do \[\mn{A}]Se|\[\mncii{G}{E}Gm]nhor |\[A] \e \altchords{|Dm |E }
    \[\mn{E}]Profes\[\bm]sor \[\mn{D}]de \[\mn{C#}]es|\[\mnc{E}A7]tre\[\mnc{D}Dm]la | \e \altchords{|E7 |Am \e}
  \mnendchorus
  \translationoff
  \begin{translation}
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    ...
    theMelody = \relative a' {
      \set melismaBusyProperties = #'() % \slurDashed
      \key d \minor \time 4/4 \partial 1*7/8
      \repeat volta 2 {
        a8\sectionmark "1." 8 8 4 8 8 | a'1~ | a4
        a8 a8 a4 bes8 a8 | g2 e2~ | e4
        g8 g8 g4 a8 g8 | f2 d2~ | d4
        f8 f8 f4 g8 f8 | e2 e2~ | e4.
        e8 e4 d8 cis8 | bes2 a2~ | a8
      } \break
      \repeat volta 2 {
        r8\posectionmark "2." a8 8 4 8 8 | a'1~ | a4
        a8 a8 a4 bes8 a8 | g2 e2~ | e4
        g8 g8 g4 a8 g8 | f2 d2~ | d4
        f8 f8 f4 g8 f8 | e2 e2~ | e4.
        e8 e4 d8 cis8 | e2 d2~ | d8
      } \break
      \repeat volta 2 {
        r8\sectionmark "3." d8 d8 d4 d8 d8 | bes1~ | bes4 d8 d8 d8 d8 e8 d8
        | a2 a2~ | a4
        a'8 a8 a4 bes8 a8 | g2( e2)~ | e4
        e8 e8 e4 d8 cis8 | e2 d2~ | d8
      }
    }
    theLyricsOne = \lyricmode {
      \set stanza = "1."
      O Dai -- me~é meu pro -- fes -- | sor; __ | _
      E -- le es -- tá de | o -- lho; __ | _
      E -- le es -- tá de | o -- lho; __ | _
      E -- le es -- tá de | o -- lho; __ | _
      Na mi -- nha mu -- | dan -- ça. __ | _
      \set stanza = "2."
      Dai -- me meu pro -- fes -- | sor; __ | _
      Sem -- pre es -- tá de | o -- lho; __ | _
      Sem -- pre es -- tá de | o -- lho; __ | _
      Sem -- pre es -- tá de | o -- lho; __ | _
      Na mi -- nha~es -- pe -- | ran -- ça. __ | _
      \set stanza = "3."
      És gran -- de pro -- fes -- | sor; __ | _
      De pa -- la -- vra ver -- da -- | dei -- ra; __ | _
      O -- bri -- ga -- do Se -- | nhor; __ _ | _
      Pro -- fes -- sor de es -- | tre -- la. __ | _
    }
    theChords = \chordmode {
      \repeat volta 2 {
        s2~ s4. | d1:m | d1:m | g:m | g:m
        | d:m | d:m | a | a1 | bes2 a2 | a8
      }
      \repeat volta 2 {
        s2~ s4. | d1:m | d1:m | g:m | g:m
        | d:m | d:m | a | a1 | a2:7 d2:m | d8:m
      }
      \repeat volta 2 {
        s2~ s4. | bes1 | bes1 | a1 | a1
        | g1:m | a1 | a2:7 d2:m | d8:m
      }
    }
    \include "tex/lp-include-tail.ly"
  \end{lilypond}\end{lilywrap}
...
\beginsong{Em Minha Memória}[by={Padr. Valdete},key={Am},sks={Cm, Bm, Am}]
  ...
  \mnbeginchorus
    ...
    Porque \[\mn{B}]o |\[\mnc{C}F]grande é Je\[\bmc\mnc{B}E7]sus, es\[\mn{E}]tá a|\[\mnc{A}Am]quí \[\bm] \altchords{|Ab G7 |Cm}
  \mnendchorus
  \mnbeginchorus
