...
\beginsong{Professor de Estrela}[by={Odemir Raulino Da Silva},key={Dm},sks={Dm, Cm, Em}]
  ...
  \mnbeginchorus
    ...
    |\hspace{0.5em} Na \[\bm]mi\[\mn{D}]nha \[\mn{C#}]mu|\[\mnc{B&}B&]dan\[\mnc{A}A]ça \altchords{| - |Ab G}
  \mnendchorus
  \mnbeginchorus
  ...
  \mnendchorus
  \mnbeginchorus
    \ind |\[Dm] \[\mn{D}]És gran\[\bm]de profes|\[\mnc{B&}B&]sor\[\bm] \altchords{|Cm |Ab}
    ...
    \ind |\[A] \[\mn{E}]Profes\[\bm]sor \[\mn{D}]de \[\mn{C#}]es|\[\mnc{E}A7]tre\[\mnc{D}Dm]la \altchords{|G |G7 Cm}
  \mnendchorus
  \translationoff
  \begin{translation}
...
\beginsong{Daime Ele é a Vida}[by={Maria Brilhante},key={C},sks={D, C}]
  \audio{https://www.nossairmandade.com/hymn/37/DaimeEle\%C3\%89AVida}
  \mnbeginchorus
    |\[\mnc{G}C]Daime ele é a \[\bm]vi\[\mn{G}]da \altchords{\id[1]{(D)}|D}
    |\[\mnc{E}Am]Daime ele é \[\mn{D}]o a\[\bmc\mn{E}]mor \altchords{|Bm}
    |\[\mnc{G}C]Daime ele é Je\[\bm]sus \altchords{|D}
    \[\mn{C}]O nos|\[\mnc{E}G7]so Pai \[\mn{D}]cria\[\bmc\mn{C}C]dor \altchords{|A7 D}
  \mnendchorus
  \mnbeginchorus\memorize
    ...
    \ind \[^\mn{G}]Da Vir|\[\mnc{F}F]gem \[^\mn{E}]Mãe \[^\mn{D}]So\[^\mn{E}]be\[\bmc\mnc{C}C]rana \altchords{|G D}
  \mnendchorus
  \notesoff
  \beginchorus
...
\beginsong{O Santo Daime Está Aí}[by={Francisco Grangeiro},key={Am},sks={Gm, Am}]
  ...
  \mnbeginchorus\memorize[chords_osantodaimeestaai_a]
    \[^\mn{E}]O Santo |\[Am]Daime es\[\bm]tá a|\[\mnc{C}F]í \altchords{\id[1]{(Gm)}|Gm |Eb}
