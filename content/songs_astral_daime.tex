...
\beginsong{Aqui Eu Recebi}[by={Sebastião},key={A},gk={A, G--B--(C)}]
...
\beginsong{O Daime, É o Daime}[by={Alfredo}, off={José Teixeira}, tags={mazurka}, key={C}, gk={C, (B)--(C)}]
  % Also in Cura II
...
\beginsong{Graças a Deus}[by={Maria Brilhante},key={G},gk={A, G--A}]
...
\beginsong{O Lindo Daime}[by={Luiz Mendes},key={Am},gk={Bm, Gm--Em}]
  ...
  \mnbeginverse
    ...
    \beginrep |\[\mnc{A}Am]É \[\bmc\mn{C}]ma\[^\mn{A}]ra|\[\mnc{E}E]vilha \altchords{|Bm |F\shrp{}}
    \[\bmc]Pa\[^\mn{D}]ra |\[\mnc{C}(C)]to\[^\mn{B}]dos \[\mnc{E}E7]ten\[^\mn{C}]do |\[\mnc{A}Am]fé \[\bm]{} \altchords{|(D) F\shrp{}7 |Bm} \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    ...
    |^No meu ^cora|^ção ^
    \beginrep |^A ^santa |^luz
    ^Da vir|^gem da ^Concei|^ção ^ \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    ...
    |^Em con^centra|^ção ^
    \beginrep |^Que ^tu te|^rás ^
    A |^san^ta ben|^ção ^ \endrep
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
    theMelody = \relative a' {
...
\beginsong{Eu Tomo Daime}[by={Vera Gall},key={Bm},gk={Bm, Am--Fm}]
  ...
  \mnbeginverse
    \beginrep\memorize
    \beginrep \[^\mn{B}]Eu \[^\mn{D}]to\[^\mn{B}]mo |\[\mnc{D}Bm]Daime \altchords{\id[1]{(Am) \capo{2}}|Am}
    \[^\mn{B}]Que é \[\bmc\mn{D}]pa\[^\mn{B}]ra \[^\mn{D}]co\[^\mn{B}]nhe|\[\mnc{C#}F#m]cer \[\bm]{} \altchords{|Em} \endrep
    \beginrep \[^\mn{A}]Conhe|\[\mnc{B&}Gm]cer a be\[\bmc\mnc{D}]leza de \[^\mn{E}]vi|\[\mncii{F}{D}Dm]ver \altchords{|Fm |Cm}
    \[\bmc\mn{A}]Dentro \[^\mn{B&}]desta |\[\mnc{A}A7]luz \altchords{|G7}
    Do meu \[\bmc\mn{F}]eu su\[^\mn{E}]pe\[^\mn{F}]ri|\[\mncii{E}{D}Dm]or \[\bm]{} \altchords{|Cm} \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    \beginrep
    \beginrep Eu tomo |^Daime
    Que é ^para apren|^der ^ \endrep
    \beginrep Apren|^der a ter a^mor no cora|^ção
    Andar pe^la estrada da |^vida
    Com ^toda a liber|^dade ^ \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    \beginrep Eu tomo |^Daime
    É ^para renas|^cer ^ \endrep
    \beginrep Renas|^cer no ca^minho da ver|^dade
    Para ^encontrar a |^paz
    Vos me ^livre dos en|^ganos ^ \endrep
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[]
    %% transcribed by larva, latest update on 2024-06
...
\beginsong{É com Deus}[by={Baixinha},key={C},gk={C, A-D}]
  ...
  \mnbeginverse
    \beginrep
     \beginrep \ilsl{\[\mn{E}]É} com |\[C]Deus \[\mn{D}]que eu \[G]to\[\mn{C}]mo |\[C]Dai\[\bm]me \altchords{\id[1]{(A)}|A E |A}
     \[\mn{A}]E com |\[Am]Deus \[\mn{G}]eu \[G]che\[\mn{F}]go |\[F]lá \[\bm]{} \altchords{|F\shrp{}m E |D} \endrep
     \beginrep \[\mn{A}]Porque |\[F]Deus \[\mn{G}]é \[\bm]quem m\[\mn{F}]e en|\[\mnc{E}C]si\[\mn{C}]na\[\bm]{} \altchords{|D |A}
     \[\mn{E}]Tudo |\[Am]que eu \[\mn{D}]te(nho) \[G7]que \[\mn{C}]sa|\[C]ber \[\bm]{} \altchords{|F\shrp{}m E7 |A} \endrep
    \endrep
  \mnendverse
  \begin{translation}[EN]
...
\beginsong{Em Minha Memória}[by={Valdete},key={Am},gk={Bm, Gm--Em}]
...
\beginsong{Sou o Daime}[by={Neiva}, off={Manoel Corrente [Caboclo Guerreiro \#20]}, key={C}, gk={C, C--D}]
