...
\beginsong{Aqui Eu Recebi}[id={aqui-eu-recebi-eefho7},by={Sebastião},key={A},gk={A, G--B--(C)}]
  ...
  \beginverse
    \beginrep
      ...
      \noteson |\[\mnd{A}]Tá\[\bm]{} \[\mnd{F}] |\[C\mnd{E}]tum\[\bm], |veja a \[G7]onde es|\[C]tá \notesoff
    \endrep
  \endverse
  \notesoff
  \beginverse
...
\beginsong{Graças a Deus}[id={gracas-a-deus-z22gun},by={Maria Brilhante},key={G},gk={A, G--A}]
  ...
  \mnbeginverse[1]\memorize[chords_gracasadeus_b]
    \beginrep
      \[^\mauii{G}{B}]Sou \[^\mn{B}]u\[^\mn{D}]ma |\[\mnc{G}G]árvore ro\[^\mn{F#}]si\[\mnc{A}Am7]an\[^\mn{G}]te em \[^\mn{F#}]u\[^\mn{E}]ma |\[\mnc{D}D]flor\[\bm]{} \altchords{|A Bm7 |E}
  ...
  \mnbeginverse%\replay[chords_gracasadeus_a]
    \beginrep
      \[\mauiic{D}{G}]Louvar \[\mauiic{E}{B}]a |\[\mauiic{D}{D}D]Deus e \[\mauii{E}{D}]a\[\mauiic{D}{B}(D7)]mar \[\mauiic{C}{B}]com \[\mauiic{B}{A}]to\[\mn{A}]do a|\[\mnc{G}G]mor \[\bm]
  ...
  \mnbeginverse[1]\replay[chords_gracasadeus_b]
    \beginrep
      \[\mauii{G}{B}]São \[\mn{B}]João \[\mn{D}]Ba|^tista e a \[\mn{F#}]sem^pre \[\mn{G}]Vir\[\mn{F#}]gem \[\mn{E}]Ma|^ri^a
      É quem \[\mn{E}]nos |\[\mn{D}]guia nes\[\mn{E}]te ^ca\[\mn{C}]minho \[\mn{B}]com \[\mn{A}]a|^mor^
    \endrep
  \mnendverse
    \begin{translation}[EN]
...
\beginsong{Tomo Daime}[id={tomo-daime-h86w4q},by={Tetéo},key={C},gk={D, B\flt{}--F\shrp{}}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_tomodaime_a]
      \[^\madii{B}{A}]Eu |\[\mnc{C}C]tomo \[\bm]Dai\[^\mn{A}]me eu |\[^\mn{C}]tomo \[\bm]Daime \altchords{\id[1]{D}|D | \e}
...
\beginsong{O Daime é o Nosso Pai}[id={o-daime-e-o-nosso-pai-7u728o},by={Tetéo},key={G},gk={A, G--B}]
  ...
  \mnbeginverse
    ...
    \beginrep\memorize[chords_odaimeeonossopai_b]
      \ilsl{\[^\mn{D}]É} |\[\mnc{G}C]E\[^\mn{E}]le é \[\bmc\mn{G}]quem \[^\mn{E}]nos |\[\mnc{G}G]cura \altchords{|D |A}
...
\beginsong{Um, Dois e Três}[id={um-dois-e-tres-nfokhx},by={Tetéo},key={C},gk={D, C--F\shrp{}}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_umdoisetres_a]
      \ilsl{\[^\mn{G}]É} |\[\mnc{C}C]um, \[^\mn{G}]é \[\bmc\mn{C}]dois, \[^\mn{G}]é |\[^\mn{C}]trê\[\bm]s
...
\beginsong{O Lindo Daime}[id={o-lindo-daime-ty058f},by={Luiz Mendes},key={Am},gk={Bm, Gm--Em}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep
        |\[\mnc{A}Am]É \[\bmc\mn{C}]ma\[^\mn{A}]ra|\[\mnc{E}E]vilha \altchords{|Bm |F\shrp{}}
        \[\bmc]Pa\[^\mn{D}]ra |\[\mnc{C}(C)]to\[^\mn{B}]dos \[\mnc{E}E7]ten\[^\mn{C}]do |\[\mnc{A}Am]fé \[\bm]{} \altchords{|(D) F\shrp{}7 |Bm}
      \endrep
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Eu Tomo Daime}[id={eu-tomo-daime-rxag5g},by={Vera Gall},key={Bm},gk={Bm, Am--Fm}]
  ...
  \mnbeginverse
    \beginrep\memorize
      \beginrep
        \[^\mn{B}]Eu \[^\mn{D}]to\[^\mn{B}]mo |\[\mnc{D}Bm]Daime \altchords{\id[1]{(Am) \capo{2}}|Am}
        \[^\mn{B}]Que é \[\bmc\mn{D}]pa\[^\mn{B}]ra \[^\mn{D}]co\[^\mn{B}]nhe|\[\mnc{C#}F#m]cer \[\bm]{} \altchords{|Em}
      \endrep
      \beginrep
        \[^\mn{A}]Conhe|\[\mnc{B&}Gm]cer a be\[\bmc\mnc{D}]leza de \[^\mn{E}]vi|\[\mncii{F}{D}Dm]ver \altchords{|Fm |Cm}
        \[\bmc\mn{A}]Dentro \[^\mn{B&}]desta |\[\mnc{A}A7]luz \altchords{|G7}
        Do meu \[\bmc\mn{F}]eu su\[^\mn{E}]pe\[^\mn{F}]ri|\[\mncii{E}{D}Dm]or \[\bm]{} \altchords{|Cm}
      \endrep
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{É com Deus}[id={e-com-deus-xf26r8},by={Baixinha},key={C},gk={C, A-D}]
  ...
  \mnbeginverse
    \beginrep
      \beginrep
        \ilsl{\[\mn{E}]É} com |\[C]Deus \[\mn{D}]que eu \[G]to\[\mn{C}]mo |\[C]Dai\[\bm]me \altchords{\id[1]{(A)}|A E |A}
        \[\mn{A}]E com |\[Am]Deus \[\mn{G}]eu \[G]che\[\mn{F}]go |\[F]lá \[\bm]{} \altchords{|F\shrp{}m E |D}
      \endrep
      \beginrep
        \[\mn{A}]Porque |\[F]Deus \[\mn{G}]é \[\bm]quem m\[\mn{F}]e en|\[\mnc{E}C]si\[\mn{C}]na\[\bm]{} \altchords{|D |A}
        \[\mn{E}]Tudo |\[Am]que eu \[\mn{D}]te(nho) \[G7]que \[\mn{C}]sa|\[C]ber \[\bm]{} \altchords{|F\shrp{}m E7 |A}
      \endrep
    \endrep
  \mnendverse
  \begin{translation}[EN]
...
\beginsong{Ser Divino}[id={ser-divino-jc0dmv},by={Odemir Raulino Da Silva},key={A},gk={A, G--B}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \[^\mn{/}]Que a\[\ac<2>{E7}]qui es|\[\ac<1>{E}\ac<2>{A}]tá \[\bm]{} |\[\ac<1>{E7}\ac<2>{A}]{} \e \altchords{\ac<2>{D7} |\ac<1>{D}\ac<2>{G} |\ac<1>{D7}\ac<2>{G}}
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Balanço de São João}[id={balanco-de-sao-joao-3yooly},by={Odemir Raulino Da Silva},off={Geraldine},key={C},gk={C, A-F}]
  ...
  \mnbeginverse
    \beginrep
      \beginrep
        \[\mn{G}]Eu es|\[C]tando \[\mn{E}]com o \[\bmc\mn{C}]Daime, eu |\[Am]nun\[\mn{E}]ca \[\mn{C}]me \[\mnc{D}G]canso
        \[\mn{G}]Eu es|tando com \[\bm]e\[\mn{F}]le
        Eu \[\mn{E}]en\up{1}(|\[\mnc{D}G7]tro \[\mn{E}]no \[\mn{D}]ba\[\mnc{C}C]lanço) \up{2}(|\[\mnc{D}G7]tro \[\mn{E}]no \[\mn{D}]ba\[\mnc{C}C]lan|ço)
      \endrep
      \beginrep
        \[\mn{E}]E eu \[\mn{D}]ba\[\bmc\mn{C}]lan|ço \[\mn{G}]e eu ba\[G]lanço
        \[\mn{D}]Nesta |\[\mn{G}]força Di\[\bm]vi\[\mn{F}]na
        \[\mn{E}]Eu \up{1}(|\[\mnc{D}G7]nun\[\mn{E}]ca \[\mn{D}]me \[\mnc{C}C]can|so) \up{2}(|\[\mnc{D}G7]nun\[\mn{E}]ca \[\mn{D}]me \[\mnc{C}C]canso)
      \endrep
    \endrep
  \mnendverse
  \mnbeginverse[1]
    \beginrep
      \beginrep
        \[\mn{G}]Venho |\[C]dizer a \[\mn{E}]meu \[\bmc\mn{C}]Mestre, que eu es|\[Am]tou \[\mn{E}]sa\[\mn{C}]tis\[\mnc{D}G]feito
        \[\mn{G}]Pelo |meu cora\[\bm]ção \[\mn{D}]há |\[\mn{G}]quarenta \[\bm]a\[\mn{F}]nos
        \[\mn{E}]Ba\up{1}(|\[\mnc{D}G7]ten\[\mn{E}]do em \[\mn{D}]meu \[\mnc{C}C]peito) \up{2}(|\[\mnc{D}G7]ten\[\mn{E}]do em \[\mn{D}]meu \[\mnc{C}C]pei|to)
      \endrep
      \beginrep
        \[\mn{E}]E eu \[\mn{D}]ba\[\bmc\mn{C}]lanço, cora|ção \[\mn{G}]segue ba\[G]ten\[\mn{D}]do
        Com |\[\mn{G}]meu São Jo\[\bm]ão
        \[\mn{F}]Vou \[\mn{E}]a\up{1}(|\[\mnc{D}G7]le\[\mn{E}]gre \[\mn{D}]vi\[\mnc{C}C]ven|do) \up{2}(|\[\mnc{D}G7]le\[\mn{E}]gre \[\mn{D}]vi\[\mnc{C}C]vendo)
      \endrep
    \endrep
  \mnendverse
  \begin{lilywrap}\begin{lilypond}[]
...
\beginsong{Professor de Estrela}[id={professor-de-estrela-uekyu4},by={Odemir Raulino Da Silva},key={Dm},gk={Dm, Cm--Dm}]
  ...
  \mnbeginverse[1]
    \beginrep
      |\[Dm]{} \ilsl{\[\mn{D}]És} gran\[\bm]de profes|\[\mnc{B&}B&]sor\[\bm]{} \altchords{|Cm |A\flt{}}
      |\hspace{0.5em} \[\mn{D}]De pa\[\bm]lavra \[\mn{E}]ver\[\mn{D}]da|\[\mnc{A}A]dei\[\bm]ra \altchords{| - |G}
      |\hspace{0.5em} \[\mn{A}]Obri\[\bm]ga\[\mn{B&}]do \[\mn{A}]Se|\[\mnc{G}Gm]nho\[\bmc\mn{E}]r \altchords{| - |Fm}
      |\[A] Profes\[\bm]sor \[\mn{D}]de \[\mn{C#}]es|\[\mnc{E}A7]tre\[\mnc{D}Dm]la \altchords{|G |G7 Cm}
    \endrep
  \mnendverse
  \ifshowlilypond\translationoff\fi % to fit whole song on one spread
  \begin{translation}[EN]
...
\beginsong{Daime Ele é a Vida}[id={daime-ele-e-a-vida-d269iv},by={Maria Brilhante},key={C},gk={D, C--E}]
  ...
  \mnbeginverse[1]
    \beginrep\memorize
      \[^\mn{G}]Da|\[\mnc{C}C]qui estou te \[\bm]ven\[^\mn{G}]do \altchords{|D}
      \[^\mn{E}]Daqui |\[Am]es\[^\mn{D}]tou \[^\mn{F}]te \[^\mn{E}]o\[\mnc{D}G]lhando \altchords{|Bm A}
      \[^\mn{G}]Esta|mos \[^\mn{F}]nu\[^\mn{E}]ma \[^\mn{D}]ba\[\mnc{C}C]talha \altchords{| - D}
      \[^\mn{G}]Da Vir|\[\mnc{C}F]gem \[^\mn{B}]Mãe \[^\mn{A}]So\[^\mn{B}]be\[\mnc{C}C]rana \altchords{|G D}
    \endrep
  \mnendverse
  \notesoff
  \beginverse[1]
...
\beginsong{O Daime É}[id={o-daime-e-b1aiqi},by={Baixinha},off={Iara},key={Dm},gk={Dm, Cm--Em}]
  ...
  \mnbeginverse[1]
    \beginrep
      \[\mn{D}]O \[\mn{A}]Dai\[\mn{F}]me |\[\mnc{D}Dm]é \[\bm] \altchords{|Em}
      \[\mn{A}]For\[\mn{D}]ça \[\mn{F}]do |\[\mn{D}]Sol, \[\bm] clarão \[\mn{E}]da |\[\mnc{F}F]Lu\[\mn{E}]a \altchords{| - |G}
      \[\mn{D}]{É o} \[\mn{F}]a\[\mnc{E}A7]ma\[\mn{D}]nhe\[\mn{C#}]cer \[\mn{E}]do |\[\mnc{D}Dm]di\[\bm]a \altchords{B7 |Em}
    \endrep
  \mnendverse
  \begin{lilywrap}\begin{lilypond}[]
    %% transcribed by larva, latest update on 2024-06
...
\beginsong{Quando o Daime Chega}[id={quando-o-daime-chega-5ed3d2},by={Baixinha},off={Jonathan Goldman},key={C},gk={C, G--D}]
  ...
  \mnbeginverse
    \beginrep
      \beginrep
        |\[\mnc{C}C]Quando o \[\bm{}]Dai\[\mn{D}]me |\[\mn{C}]chega \altchords{\id[1]{(D)}|D | \e}
        É \[\bmc\mn{E}]pa\[\mn{G}]ra |\[\mn{E}]to\[\mn{C}]dos \[\bm{}]nós \[\mn{G}]to|\[\mn{E}]mar \[\ac<2>{C7}] \altchords{| - | - \ac<2>{D7}}
      \endrep
      \beginrep
        \[\mn{E}]A|\[\mnc{A}F]gra\[\mn{G}]de\[\bmc\mn{F}]cer \[\mn{E}]a |\[\mnc{C}C]Deus \altchords{|G |D}
        O \[\bmc\mn{E}]que \[\mn{G}]Deus |\[\mnc{D}Dm]tem \[\mn{C}]pa\[(Fmaj7)]ra \[\mn{E}]nós |\[\mnc{C}C]dar \[\ac<1>{C7}] \altchords{|Em (Gmaj7) |D \ac<1>{D7}}
      \endrep
    \endrep
  \mnendverse
  \mnbeginverse[1]
    \beginrep
      \beginrep
        |\[\mnc{C}C]Quando o \[\bm{}]Dai\[\mn{D}]me |\[\mn{C}]chega \altchords{|D | \e}
        É \[\bm{}]pa\[\mn{E}]ra |\[\mnc{G}G]todos \[\bmc\mn{E}]nós \[\mn{A}]to|\[\mn{G}]mar \[\ac<1>{G7}]\altchords{|A | - \ac<1>{A7}}
      \endrep
      \beginrep
        \[\mn{E}]A|\[\mnc{A}F]gra\[\mn{G}]de\[\bmc\mn{F}]cer \[\mn{E}]a |\[\mnc{C}C]Deus \altchords{|G |D}
        O \[\bmc\mn{E}]que \[\mn{G}]Deus |\[\mnc{D}Dm]tem \[\mn{C}]pa\[(Fmaj7)]ra \[\mn{E}]nós |\[\mnc{C}C]dar \[\ac<1>{C7}] \altchords{|Em (Gmaj7) |D \ac<1>{D7}}
