...
\beginsong{Firmado em Concentração}[by={Alfredo},tags={valsa}, key={Am}, gk={Am, G\shrp{}m--Am}]
  ...
  \mnbeginverse
    ...
    \beginrep \[^\mn{A}]Eu |\[\mnc{D}Dm]vou ol|\[^\mn{F}]hand\[^\mn{E}]{o e} dou |\[\mnc{C}Am]chan\[^\mn{A}]ce
    A |\[^\mn{E}]quem ol|\[\mnc{B}E7]har pa\[^\mn{D}]ra |\[^\mn{G#}]esta \[^\mn{B}]ban|\[\mnc{A}Am]dei|\[\ac(1){A7}]ra \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay
    ...
    \beginrep Das |^cores |desta ban|^deira
    Do |Pai verda|^deiro, ver|de azul e |^bran|^ca \endrep
    \endrep
  \endverse
  \beginverse\replay
    \beginrep
    ...
    \beginrep Por |^isto a|qui eu es|^tou
    Com a |paz do Se|^nhor, acal|mando a |^guer|^ra \endrep
    \endrep
  \endverse
  \beginverse\replay
    \beginrep
    ...
    \beginrep Faz |^calmar o |meu cora|^ção
    E |dos meus ir|^mãos, os |que não es|^que|^cem \endrep
    \endrep
  \endverse
  \beginverse\replay
    \beginrep
    ...
    \beginrep Com |^todos |seres do |^alto
    Que |nos ilu|^mina jun|tamente ao |^Sol |^ \e \endrep
    \endrep
  \endverse
  \beginverse\replay
    \beginrep
    ...
    \beginrep Para |^todos |se reu|^nir \altchords{|Dm | |Am}
    Pro|vando a|^qui sua |capaci|^da|^de \altchords{| - |Bm7\flt{}5 |E7 |Am |\ac(1){A}} \endrep
    \endrep
  \endverse
...
\beginsong{Firmeza}[by={Valdete}, key={F}, gk={F, C--B}]
...
\beginsong{São João na Terra}[by={Sebastião}, tags={2x}, key={C}, gk={C, C--D}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_saojoaonaterra_a]
  ...
  \mnendverse\glueverses\mnbeginverse[1]
    \beginrep\memorize[chords_saojoaonaterra_b]
...
\beginsong{Conforto}[by={Alfredo}, key={Bm}, gk={Cm, Bm--Cm--(Dm)}]
...
\beginsong{Chamo o Tempo}[by={Mestre Irineu Serra}, key={A}, gk={A, G--A}]
  ...
  \mnbeginverse
    ...
    \beginrep \[^\mn{D}]Apren|\[\mnc{E}C]der com \[\mnc{F#}D]per\[^\mn{A}]fei|\[\mnc{G}G]ção\[\bm]{} \altchords{|C D |G}
    \[^\mn{G}]Pa\[^\mn{A}]ra |\[^\mn{B}]po\[^\mn{A}]der \[\mncii{D}{B}D]ensi|\[\mnc{G}G]nar\[\ac(1){G7}]{} \altchords{| - D |G \ac(1){G7}} \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    ...
    \beginrep Para |^ser e^terna|^men^te
    Para |Deus lhe ^aten|^der^ \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    ...
    \beginrep De|^pois que ^refle|^tir^ \altchords{|D E |A F\shrp{}m}
    É que |vai se ar^repen|^der^ \altchords{|Bm E |A A7} \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    ...
    \beginrep Embora |^que não a^prenda |^mui^to
    Aprenda |sempre um ^boca|^di^nho \endrep
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
    % transcribed by larva, latest update on 2024-03
...
\beginsong{Eu Peço a Deus\\Vi Deus no Sol, na Lua e nas Estrelas}[by={Francisco Corrente}, tags={2x}, key={C}, gk={C, C--D}]
  ...
  \mnendverse\glueverses\mnbeginverse
    ...
    \[^\mn{/}]Eu peço a |\[\ac(1){C} \ac(2){Am}]{Deus que} me \[^\bm]dê \[^\mn{A}]a San\[^\mn{/}]ta |\[\mnc{/}G]Luz\[^\bm]{} \altchords{|\ac(1){D} \ac(2){Bm} |A}
