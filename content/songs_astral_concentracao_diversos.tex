...
\beginsong{Firmado em Concentração}[id={firmado-em-concentracao-cd46tz},by={Alfredo},tags={valsa},key={Am},gk={Am, G#m--Am}]
  \audio{https://www.nossairmandade.com/hymn/538/FirmadoEmConcentra\%C3\%A7\%C3\%A3o}
  \meter{3}{4}
  \mnbeginverse
    \beginrep\memorize
      |\[<C A>Am]Firmad\[^<E>]{o em} |\[^<C>]con\[^<A>]cen\[^<C>]tra|\[^<E>]ção | \e
      |\[^<C>]Na \[^<A>]Vir\[^<E>]gem |\[<C#>A7]Mãe ver\[^<E>]da|\[<D>Dm]dei|ra
      \beginrep
        \[^<A>]Eu |\[<D>Dm]vou ol|\[^<F>]hand\[^<E>]{o e} dou |\[<C>Am]chan\[^<A>]ce
        A |\[^<E>]quem ol|\[<B>E7]har pa\[^<D>]ra |\[^<G#>]esta \[^<B>]ban|\[<A>Am]dei|\[\ac{1}{A7}]ra
      \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay
    \beginrep
      ...
      \beginrep
        Das |^cores |desta ban|^deira
        Do |Pai verda|^deiro, ver|de azul e |^bran|^ca
      \endrep
    \endrep
  \endverse
  \beginverse\replay
    \beginrep
      ...
      \beginrep
        Por |^isto a|qui eu es|^tou
        Com a |paz do Se|^nhor, acal|mando a |^guer|^ra
      \endrep
    \endrep
  \endverse
  \beginverse\replay
    \beginrep
      ...
      \beginrep
        Faz |^calmar o |meu cora|^ção
        E |dos meus ir|^mãos, os |que não es|^que|^cem
      \endrep
    \endrep
  \endverse
  \beginverse\replay
    \beginrep
      ...
      \beginrep
        ...
        Que |nos ilu|^mina jun|tamente ao |^Sol |^ \e
      \endrep
    \endrep
  \endverse
  \beginverse\replay
    \beginrep
      ...
      \beginrep
        Para |^todos |se reu|^nir \altchords{|Dm | |Am}
        Pro|vando a|^qui sua |capaci|^da|^de \altchords{| - |Bm7&5 |E7 |Am |\ac{1}{A}}
      \endrep
    \endrep
  \endverse
...
\beginsong{Firmeza}[id={firmeza-2jqv9v},by={Valdete},key={F},gk={F, C--B}]
  \audio{https://www.nossairmandade.com/hymn/148/Firmeza}
  \mnbeginverse
    \beginrep\memorize
      \[^<C>]Fir|\[<F>F]meza, bem fir\[<* C>C]meza peço |\[<F>F]em concentra\[<* C>C]ção \altchords{\id[1]{(G)}|G D |G D}
      \[^<F>]Fir|\[F]me\[^<C>]za, \[C]bem \[^<F>]fir\[<*>{}F]me\[^<C>]za \[C]na cor|\[<F>F]rente da ses\[<*>]são \altchords{|G D G D |G}
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Eu Te Dei uma Casa}[id={eu-te-dei-uma-casa-mzca48},by={Sebastião},key={C},gk={C, B&--C}]
...
\beginsong{São João na Terra}[id={sao-joao-na-terra-ry2qt0},by={Sebastião},tags={2x},key={C},gk={C, C--D}]
  % Also in songs_astral_cura_i.tex
...
\beginsong{Conforto}[id={conforto-3np7to},by={Alfredo},key={Bm},gk={Cm, Bm--Cm--(Dm)}]
  \audio[]{https://www.nossairmandade.com/hymn/478/Conforto}
  \transpose{-3}
  \beginverse\memorize
    \beginrep
      \[^<A>]Eu |\[<F>Dm]pe\[^<D>]ço \[^<F>]con\[<E>A7]for\[^<C#>]to \[^<E>]aos |\[<D>Dm]Reis \[<*>]{} \altchords{\id[1]{(Dm)}|Dm A7 |Dm}
      \[^<D>]Do |\[^<A>]Céu, \[^<F>]da \[^<D>]Flo\[<A>D7]rest\[^<F>]{a e} \[^<D>]do |\[<G>Gm]Mar \[<*>]{} \altchords{| - D7 |Gm}
      |\[^<B&>]Pe\[^<G>]ço \[^<E>]con\[<C#>A7]fort\[^<A>]{o as} \[^<E>]Ra|\[<D>Dm]i\[<*>]nhas \altchords{| - A7 |Dm}
      Para |\[<A>A]nos \[<E F E>A7]ilumi|\[<D>Dm]nar \[<*>]{} \altchords{|A A7 |Dm}
    \endrep
  \endverse
  \notesoff
  \beginverse
...
\beginsong{Chamo o Tempo}[id={chamo-o-tempo-bwkeno},by={Mestre Irineu Serra},key={A},gk={A, G--A}]
  \audio[]{https://www.nossairmandade.com/hymn/23/ChamoOTempo}
  \transpose{2}
  \mnbeginverse
    \beginrep\memorize
      \[^<B>]Cha\[^<A>]mo o |\[<G>G]Tempo, eu \[<A>D]cha\[^<G>]{mo o} |\[<D>G]Tempo\[<*>]{} \altchords{\id[1]{(G)}|G D |G}
      \[^<B>]Para e\[^<A>]le |\[^<G>]vir me \[<A G>D]ensi|\[<D>G]nar\[G7]{} \altchords{| - D |G G7}
      \beginrep
        \[^<D>]Apren|\[<E>C]der com \[<F#>D]per\[^<A>]fei|\[<G>G]ção\[<*>]{} \altchords{|C D |G}
        \[^<G>]Pa\[^<A>]ra |\[^<B>]po\[^<A>]der \[<D B>D]ensi|\[<G>G]nar\[\ac{1}{G7}]{} \altchords{| - D |G \ac{1}{G7}}
      \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    \beginrep
      ...
      \beginrep
        Para |^ser e^terna|^men^te
        Para |Deus lhe ^aten|^der^
      \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
      ...
      \beginrep
        De|^pois que ^refle|^tir^ \altchords{|D E |A F#m}
        É que |vai se ar^repen|^der^ \altchords{|Bm E |A A7}
      \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
      ...
      \beginrep
        Embora |^que não a^prenda |^mui^to
        Aprenda |sempre um ^boca|^di^nho
      \endrep
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
...
\beginsong{Chamo a Força}[id={chamo-a-forca-0cdbw4},by={Mestre Irineu Serra},key={Am},gk={Am, Gm--Bm}]
  \audio{https://www.nossairmandade.com/hymn/270/ChamoAFor\%C3\%A7a}
  \mnbeginverse
    \beginrep\memorize
      \[^<C>]Cha\[^<B>]{mo a} |\[<A>Am]força, eu \[<C>(C)]cha\[^<E>]{mo a} |\[<A>Am]força\[<*>]{} \altchords{\id[1]{(Bm)}|Bm (D) |Bm}
      \[^<G>]A força |\[G]vem \[^<E>]nos \[<C A>C]amos|\[<C B A>Am]trar \[<*>]{} \altchords{|A D |Bm}
    \endrep
    \mnendverse\glueverses\notesoff\mnbeginverse
    \beginrep
  ...
  \beginverse
    \beginrep
      Aqui |^dentro ^da ver|^dade^ \altchords{\id[2]{(Gm)}|Gm (B&) |Gm}
      Tem uns |^certos ^menti|^ro^sos \altchords{|F B& |Gm}
    \endrep
    \endverse\glueverses\beginverse
    \beginrep
      Que calu|^niam os ^seus ir|^mãos \altchords{|Gm (B&) |Gm}
      ^Para se tor|^nar mui^to vi|^ço^sos \altchords{|F B& |Gm}
    \endrep
  \endverse
  \brk
  \beginverse
...
\beginsong{Eu Peço a Deus\\Vi Deus no Sol, na Lua e nas Estrelas}[id={eu-peco-a-deus-2y5gre},by={Francisco Corrente},tags={2x},key={C},gk={C, C--D}]
  \audio[]{https://www.nossairmandade.com/hymn/26/EuPe\%C3\%A7oADeus}
  \newchords{chords_eupecoadeus_a}\newchords{chords_eupecoadeus_b}
  \mnbeginverse
    \beginrep\memorize[chords_eupecoadeus_a]
      \[^<C>]Eu pe\[^<E>]{ço a} |\[<G>C]Deus que per\[<A>Am]doe os meus \[^<E>]pe|\[<G>F]ca\[^<F>]dos\[^<*>]{} \altchords{\id[1]{(D)}|D Bm |G}
      Perdoe \[^<G>]a |\[<A>Dm]mim e per\[^<*>]doe \[^<F>]{a meus} \[^<A>]ir|\[<G>G]mã\[^<*>]os \altchords{|Em |A}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_eupecoadeus_b]
      \[^</>]Eu peço a |\[\ac{1}{C} \ac{2}{Am}]{Deus que} me \[^<*>]dê \[^<A>]a San\[^</>]ta |\[</>G]Luz\[^<*>]{} \altchords{|\ac{1}{D} \ac{2}{Bm} |A}
      \[^<D>]Para eu a|\[G7]mar Vós no \[^<* E>]meu co\[^<C>]ra|\[C]ção\[^<*>]{} \altchords{|A7 |D}
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_eupecoadeus_a]
    \beginrep
      Vi Deus no |^sol Deus na ^lua e nas es|^trelas\[<*>]
      Vi Deus no |^vento Deus na \[<*>]terra Deus no |^mar\[<*>]
    \endrep
    \endverse\glueverses\beginverse\replay[chords_eupecoadeus_b]
    \beginrep
