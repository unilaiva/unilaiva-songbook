...
\beginsong{Firmado em Concentração}[by={Padr. Alfredo},tags={valsa}, key={Am}, gk={Am, G\shrp{}m--Am}]
  ...
  \mnbeginchorus\memorize
    ...
    A |\[^\mn{E}]quem ol|\[\mnc{B}E7]har pa\[^\mn{D}]ra |\[^\mn{G#}]esta \[^\mn{B}]ban|\[\mnc{A}Am]dei|\[\ac(1){A7}]ra \rrep
  \mnendchorus
  \notesoff
  \beginchorus\replay
  ...
  \beginchorus\replay
    ...
    Pro|vando a|^qui sua |capaci|^da|^de \rrep \altchords{| - |Bm7\flt{}5 |E7 |Am |\ac(1){A}}
  \endchorus
...
\beginsong{Chamo o Tempo}[by={Mestre Irineu Serra}, key={A}, gk={A, G--A}]
  ...
  \mnbeginchorus\memorize
    ...
    \[^\mn{G}]Pa\[^\mn{A}]ra |\[^\mn{B}]po\[^\mn{A}]der \[\mncii{D}{B}D]ensi|\[\mnc{G}G]nar\[\ac(1){G7}]{} \rrep \altchords{| - D |G \ac(1){G7}}
  \mnendchorus
  \notesoff
  \beginchorus
