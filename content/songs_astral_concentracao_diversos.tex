...
\beginsong{Firmado em Concentração}[id={firmado-em-concentracao-cd46tz},by={Alfredo},tags={valsa},key={Am},gk={Am, G\shrp{}m--Am}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep
        \[^\mn{A}]Eu |\[\mnc{D}Dm]vou ol|\[^\mn{F}]hand\[^\mn{E}]{o e} dou |\[\mnc{C}Am]chan\[^\mn{A}]ce
        A |\[^\mn{E}]quem ol|\[\mnc{B}E7]har pa\[^\mn{D}]ra |\[^\mn{G#}]esta \[^\mn{B}]ban|\[\mnc{A}Am]dei|\[\ac<1>{A7}]ra
      \endrep
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Chamo o Tempo}[id={chamo-o-tempo-bwkeno},by={Mestre Irineu Serra},key={A},gk={A, G--A}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep
        \[^\mn{D}]Apren|\[\mnc{E}C]der com \[\mnc{F#}D]per\[^\mn{A}]fei|\[\mnc{G}G]ção\[\bm]{} \altchords{|C D |G}
        \[^\mn{G}]Pa\[^\mn{A}]ra |\[^\mn{B}]po\[^\mn{A}]der \[\mncii{D}{B}D]ensi|\[\mnc{G}G]nar\[\ac<1>{G7}]{} \altchords{| - D |G \ac<1>{G7}}
      \endrep
    \endrep
  \mnendverse
  \notesoff
