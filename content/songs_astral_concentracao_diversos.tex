...
\beginsong{Firmado em Concentração}[id={firmado-em-concentracao-cd46tz},by={Alfredo},tags={valsa},key={Am},gk={Am, G\shrp{}m--Am}]
  ...
  \beginverse\replay
    \beginrep
      ...
      \beginrep
        ...
        Pro|vando a|^qui sua |capaci|^da|^de \altchords{| - |Bm7\flt{}5 |E7 |Am |\ac{1}{A}}
      \endrep
    \endrep
  \endverse
...
\beginsong{Eu Te Dei uma Casa}[id={eu-te-dei-uma-casa-mzca48},by={Sebastião},key={C},gk={C, B\flt{}--C}]
...
\beginsong{Chamo o Tempo}[id={chamo-o-tempo-bwkeno},by={Mestre Irineu Serra},key={A},gk={A, G--A}]
  ...
  \beginverse
    \beginrep
      ...
      \beginrep
        De|^pois que ^refle|^tir^ \altchords{|D E |A F\shrp{}m}
