...
\beginsong{Marachimbé \\ Sol, Lua, Estrela}[by={Padr. Alfredo},key={D},sks={D, E, F, C}]
  ...
  \mnbeginchorus\memorize
    |\[\mnc{D}D]Sol, \[\bm]Lua, Es|tre\[\mnc{A}A]la
    \[^\mn{C#}]A |\[\mnc{E}Em]Terra, o \[\bm]Ven\[^\mn{F#}]to e o |\[^\mn{E}]Mar \[A7]
    \[^\mn{A}]A Flo|\[\mnc{D}D]resta e \[\bm]seus mis|térios
    \[\bmc\mn{A}]Para |\[\mncii{F}{E}Fmaj7]todos \[\mncii{C#}{E}A7]estu|\[\mnc{D}D]dar \[\bm]
  \mnendchorus
  \notesoff
  \beginchorus
    |^Sol, ^Lua, Es|tre^la
    A |^Terra, o ^Vento e o |Mar ^
    É a |^Luz do ^firma|mento
