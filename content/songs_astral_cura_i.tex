...
\beginsong{Eu Chamei Meu Mestre}[by={Padr. Sebastião}, key={C}, gk={D, C--E}]
  ...
  \begin{lilywrap}\begin{lilypond}[] \include "tex/lp-include-head.ly"
    ...
    \include "tex/lp-include-tail-lyricsbelow.ly"
  \end{lilypond}\end{lilywrap}
  \begin{translation}\scriptsize% to fit on one page in lyrics-only books
...
\beginsong{Peço que Vós me Ouça}[by={Padr. Sebastião}, tags={valsa}, key={C}, tags={2x}, gk={C, C--D}]
