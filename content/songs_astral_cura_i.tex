...
\beginsong{Pai Nosso}[by={Padr. Sebastião}, key={Am}, sks={Bm, Gm--Dm}]
...
\beginsong{As Estrelas}[by={Mestre Irineu Serra}, key={A}, sks={A, G--B}]
...
\beginsong{Linha do Arroxim}[by={Vera Fróes}, key={C}, sks={D, C--D}]
  ...
  \mnbeginchorus\memorize[chords_linhadoarroxim_a]
    ...
    Que o \[\mnc{C}C]Mestre do \[^\mn{D}]as|\[\mnc{E}(Em)]tral está \[^\mn{C}]ol\[\mnc{D}G]hando a \[^\mn{B}]ses|\[\mnc{C}C]são \[\bm] \altchords{D |(F\#m) A |D}
  \mnendchorus
  \notesoff
...
\beginsong{Marachimbé \\ Sol, Lua, Estrela}[by={Padr. Alfredo}, key={D}, sks={D, C--G}]
...
\beginsong{Eu te Dei uma Casa}[by={Padr. Sebastião}, key={C}, sks={C, Bb--C}]
