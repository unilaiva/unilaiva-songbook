...
\beginsong{São João na Terra}[by={Padr. Sebastião}, tags={2x}, key={C}, gk={C, C--D}]
  ...
  \mnendverse\glueverses\mnbeginverse
    ...
    \ind \ilsl{\[^\mn{C}]É} |\[\mnc{D}Dm]fora \[^\mn{C}]de \[\bmc\mn{A}]con\[^\mn{C}]fu|\[\mnc{E}C]são \altchords{|Em |D}
  ...
  \beginverse\replay[chords_cura_saojoaonaterra_a]
    ...
    \endrep
  \endverse\glueverses\beginverse\replay[chords_cura_saojoaonaterra_b]
    \beginrep
