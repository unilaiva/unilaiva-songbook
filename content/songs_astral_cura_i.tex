...
\beginsong{Pai Nosso}[id={pai-nosso-z9d35r},by={Sebastião},key={C},gk={D, B\flt{}--G}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_painosso_a]
      ...
      San\[<* C>]ti\[^<E>]fi|\[<C>C]cado\jw é \[^<B>]nos\[<A>Am]so \[^<C>]Se|\[<E>Em]nhor\[<*>]{} \altchords{|D Bm |F\shrp{}m}
    \endrep
...
\beginsong{Chamei o Mestre Juramidam}[id={chamei-o-mestre-juramidam-ehyuzi},by={Sebastião},key={C},gk={D, C--E}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \[^<C>]Pa\[^<E>]ra\jw o |\[<G>G]meu \[^<C>]Mes\[<E>Em]tre \[^<G>]vir |\[<C>C]cá \[<*>]{} \altchords{|A F\shrp{}m |D}
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Linha do Arroxim}[id={linha-do-arroxim-psqgav},by={Vera Fróes},key={C},gk={D, C--D}]
  ...
  \mnbeginverse
    ...
    \beginrep\memorize[chords_linhadoarroxim_b]
      ...
      Que o \[<C>C]Mestre do \[^<D>]as|\[<E>(Em)]tral está \[^<C>]o\[<D>G]lhando a \[^<B>]ses|\[<C>C]são \[<*>]{} \altchords{D |(F\shrp{}m) A |D}
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Olho Para o Firmamento}[id={olho-para-o-firmamento-f84e5q},by={Alfredo},key={Am},gk={Am, Gm--Am}]
  ...
  \mnbeginverse
    ...
    \beginrep\memorize[chords_olhopara_b]
      \[^<A>]Es\[^<B>]ta |\[<C>C]força \[<B>E]que re|\[<A>Am]cebo \altchords{|B\flt{} D |Gm}
...
\beginsong{Marachimbé \\ Sol, Lua, Estrela}[id={marachimbe-hntl0i},by={Alfredo},key={D},gk={D, C--G}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \[^<C#>]A |\[<E>Em]Terra, o \[<*>]Ven\[^<F#>]to\jw e o |\[^<E>]Mar \[A7]{} \altchords{|F\shrp{}m | - B7}
...
\beginsong{Eu Te Dei uma Casa}[id={eu-te-dei-uma-casa-u8r2mk},by={Sebastião},key={C},gk={C, B\flt{}--C}]
