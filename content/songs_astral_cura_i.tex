...
\beginsong{Pai Nosso}[by={Sebastião}, key={C}, gk={D, B\flt{}--G}]
...
\beginsong{Eu Chamei Meu Mestre}[by={Sebastião}, key={C}, gk={D, C--E}]
...
\beginsong{Chamei o Mestre Juramidam}[by={Sebastião}, key={C}, gk={D, C--E}]
...
\beginsong{Olho Para o Firmamento}[by={Alfredo},key={Am},gk={Am, Gm--Am}]
...
\beginsong{Marachimbé \\ Sol, Lua, Estrela}[by={Alfredo}, key={D}, gk={D, C--G}]
...
\beginsong{Eu Agora Paro Peço}[by={Alfredo}, key={D}, gk={D, D--E}]
...
\beginsong{Eu Te Dei uma Casa}[by={Sebastião}, key={C}, gk={C, B\flt{}--C}]
...
\beginsong{São João na Terra}[by={Sebastião}, tags={2x}, key={C}, gk={C, C--D}]
  % Also in songs_astral_concentracao_diversos.tex
  ...
  \mnbeginverse
    \beginrep\memorize[chords_cura_saojoaonaterra_a]
  ...
  \mnendverse\glueverses\mnbeginverse[1]
    \beginrep\memorize[chords_cura_saojoaonaterra_b]
    \ilsl{\[^\mn{C}]É} |\[\mnc{D}Dm]fora \[^\mn{C}]de \[\bmc\mn{A}]con\[^\mn{C}]fu|\[\mnc{E}C]são \altchords{|Em |D}
    \[^\mn{A}]Che\[\bmc\mn{C}]gou \[^\mn{E}]São |\[\mnc{D}Dm]Pedro com \[^\mn{C}]seus \[\mnc{A}F]dois \[^\mn{C}]ir|\[C]mãos \altchords{|Em G |D}
    \endrep
  \mnendverse
  \notesoff
  \beginverse\replay[chords_cura_saojoaonaterra_a]
    \beginrep
    Os an^jinhos do |^céu é quem ^vem co|^lher \altchords{\id[4]{MK (C)}|C |Am}
    Para ^ajun|^tar em um ^{só lu}|^gar \altchords{|G F |C}
    \endrep
  \endverse\glueverses\beginverse[1]\replay[chords_cura_saojoaonaterra_b]
    \beginrep
...
\beginsong{Peço que Vós me Ouça}[by={Sebastião}, tags={valsa, 2x}, key={C}, gk={C, C--D}]
