...
\beginsong{Eu Te Dei uma Casa}[id={eu-te-dei-uma-casa-u8r2mk},by={Sebastião},key={C},gk={C, B\flt{}--C}]
  ...
  \mnbeginverse
    \beginrep
      ...
      \[^\mn{C}]Per\[^\mn{B}]do|\[\mnc{A}Am]ai \[^\mn{C}]as \[\mnc{E}(A7)]min\[^\mn{G}]has |\[\mnc{D}Dm]cul\[\bm]pas, \[^\mn{C}]se \[^\mn{B}]de |\[\mnc{A}Am]Vós \[^\mn{C}]eu \[\bm]me\[^\mn{E}]re|\[\mnc{C}C]cer\[\bm]
    \endrep
  \mnendverse
  \notesoff
  \beginverse
  ...
  \beginverse
    \beginrep
      ...
      \noteson\[\bmc\mnd{E}]Ol\[\mnd{C}]han\notesoff|\[Am]{do\jw as} coi\[(A7)]{sas de} |\[Dm]Deus e \[\bm]prestan|\[Am]{do bem} \[\bm]aten|\[C]ção\[\bm]
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
...
\beginsong{São João na Terra}[id={sao-joao-na-terra-gv9opq},by={Sebastião},tags={2x},key={C},gk={C, C--D}]
  ...
  \mnbeginverse
    \beginrep
      \[^\mn{G}]Quando\jw ou\[\bmc\mn{C}]vir \[^\mn{E}]fa|\[\mnc{G}C]lar de São \[^\mn{E}]Jo\[\bmc\mn{A}]ão \[^\mn{G}]na |\[\mncii{E}{C}Am]terra \altchords{\id[1]{(D)}|D |Bm}
      É \[^\mn{A}]si\[\mnc{C}C]nal \[^\mn{E}]de |\[\mnc{D}Dm]guerra em \[^\mn{C}]to\[\mnc{A}F]do \[^\mn{C}]lu|\[C]gar \altchords{D |Em G |D}
    \endrep
    \beginrep
      \[\bm]{} \ilsl{\[^\mn{C}]É} |\[\mnc{D}Dm]fora \[^\mn{C}]de \[\bmc\mn{A}]con\[^\mn{C}]fu|\[\mnc{E}C]são \altchords{|Em |D}
      \[^\mn{A}]Che\[\bmc\mn{C}]gou \[^\mn{E}]São |\[\mnc{D}Dm]Pedro com \[^\mn{C}]seus \[\mnc{A}F]dois \[^\mn{C}]ir|\[C]mãos \altchords{|Em G |D}
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Peço que Vós me Ouça}[id={peco-que-vos-me-ouca-s0epoa},by={Sebastião},tags={valsa, 2x},key={C},gk={C, C--D}]
  ...
  \mnbeginverse
    ...
    \beginrep\memorize[chords_cura_pecoquevosmeouca_b]
      ...
      \[^\mn{A}]Pa\[^\mn{C}]ra |\[\mnc{E}C]mim \[^\mn{G}]e |\[\mnc{D}G7]os \[^\mn{F}]meus \[^\mn{E}]ir|\[\mnc{C}C]mãos |\[\ac<1>{C7}]{} \e \altchords{|D |A7 |D |\ac<1>{D7}}
    \endrep
  \mnendverse
  \notesoff
  ...
  \beginverse\replay[chords_cura_pecoquevosmeouca_a]
    ...
    \beginrep
      ...
      Bati|^zou {\noteson\[\mnd{G}]no \[\mnd{F}]ri}|^{o de} Jor|^dão |^ \e \altchords{|C |G7 |C |\ac<1>{C7}}
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
