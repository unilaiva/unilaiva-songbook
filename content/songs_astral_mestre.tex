...
\beginsong{Refeição}[by={Mestre Irineu Serra},key={A},gk={A, (A) -- (B\flt{})}]
  ...
  \mnbeginverse\memorize
    ...
    É \[^\mn{G#}]quem \[\mnc{F#}F#m]{dá o} \[^\mn{C#}]nos\[^\mn{C}]so |\[\mnc{B}Bm]pão \altlyr{Foi qem deu o nosso |pão}
  ...
  \beginverse
    ...
    Que ^hoje neste |^dia
    É quem ^{dá o} nosso |^pão \altlyr{Foi qem deu o nosso |pão}
    Lou^vado seja |^Deus ^
  \endverse
  \begin{translation}
