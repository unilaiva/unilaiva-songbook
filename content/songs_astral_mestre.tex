...
\beginsong{Papai Paxá}[id={papai-paxa-1iquig},by={Mestre Irineu Serra},key={B dor.},gk={B dor., (B dor.) -- (C dor.)}]
  ...
  \beginverse\replay[chords_papaipaxa_a]
    ...
    \beginrep
      É |^vós ^quem me |^guia
      \noteson\[\bmc\mnd{A}]No \[\mnd{G#}]ca|minho da \[\bm]salva|\[Bm]ção \[\bm]
    \endrep
  \endverse
  \beginverse\replay[chords_papaipaxa_a]
    \beginrep
...
\beginsong{Estrela D'alva}[id={estrela-d-alva-n48g3g},by={Mestre Irineu Serra},key={Bm},gk={Cm, (Bm)--(Cm)},tags={valsa}]
  ...
  \beginverse[1]\memorize
    \beginrep
      \[^\mn{A#}]São \[^\mn{B}]fe|\[\mnc{C#}F#]lizes \[^\mn{A#}]os |\[\mnc{F#}F#7]pas\[^\mn{E}]sos |\[\mnc{D}Bm]meus | \e \altchords{|G |G7 |Cm | \e}
      Com \[^\mn{F#}]cer|\[\mnc{E}Em]te\[^\mn{C#}]{za eu} |\[^\mn{E}]en\[^\mn{G}]con|\[\mnc{F#}Bm]trar | \e \altchords{|Fm | - |Cm | \e}
      Um di|\[\mnc{G}Em]a, \[^\mn{E}]seu |\[^\mn{G}]res\[^\mn{B}]plen|\[\mnc{F#}Bm]dor | \e \altchords{|Fm | - |Cm | \e}
      \ilsl{\[^\mn{E}]É} só |\[\mnc{D}D]quem \[^\mn{F#}]eu |\[\mnc{C#}F#7]de\[^\mn{A#}]{vo a}|\[\mnc{B}Bm]mar | \e \altchords{|E\flt{} |G7 |Cm | \e}
    \endrep
  \endverse
  \notesoff
  \beginverse[1]
