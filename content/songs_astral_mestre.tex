...
\beginsong{Unaqui}[by={Mestre Irineu Serra},key={A},gk={B\flt{}, B\flt{}--B}]
  ...
  \mnbeginchorus\memorize
    \[^\mn{E}]Es|\[\mnc{A}A]tou\[\bmc]{} \[^\mn{G#}]a|\[^\mn{E}\mn{C#}]qui \[A7] \altchords{\id[1]{(B\flt{})}|B\flt{} | - B\flt{}7}
    \[^\mn{G}]Foi Deus do |Céu quem \[\bmc\mn{F#}]me \[^\mn{A}]man|\[\mnc{F#}D]dou\[\bm] \altchords{| - |E\flt{}}
  ...
  \beginchorus
    ...
    Neste |mundo ^{de i}lu|^são ^ \altchords{| - |E}
    Eu fa|ço por a^gradar |^todos \altchords{| - |B}
  ...
  \begin{lilywrap}\begin{lilypond}[]
    ...
    theMelody = \relative d'' {
      ...
      \repeat volta 2 {
        ...
        \parenthesize d8 d8( d8) | fis4 d8 d fis4 d | cis4.( cis8)
    ...
    theLyricsOne = \lyricmode {
      ...
      \repeat volta 2 {
        ...
        Sou __ _ | fi -- lho da Vir -- gem | Mãe; __ _
    ...
    theLyricsTwo = \lyricmode {
      ...
      \repeat volta 2 {
        ...
        Quem o ma -- | tou fo -- ram os ju -- | deus; __ _
