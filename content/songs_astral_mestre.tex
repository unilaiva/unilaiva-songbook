...
\beginsong{Meu Divino Pai}[by={Mestre Irineu Serra},key={D},gk={D, C--F\shrp{}}]
  ...
  \mnbeginchorus\memorize
    \[^\mn{A}]Oh |\[\mnc{D}D]Meu \[^\mn{C#}]Di\[\bmc\mn{B}]vi\[^\mn{D}]no |Pai \[\bm]
    Só por |\[\mnc{G}G]Vós \[^\mn{F#}]de\[\mnc{E}A7]vo \[^\mn{G}]cha|\[\mnc{F#}D]mar \[\bm]
    \[^\mn{D}]Tantas |\[\mnc{G}G]vez(es) \[^\mn{F#}]Vós \[\mnc{E}A]o\[^\mn{D}]fen|\[D]di \[\bm]
    \[^\mn{A}]{E vós} me |\[^\mn{D}]quei\[^\mn{C#}]ra \[\mnc{B}Bm]per\[^\mn{D}]do|\[D]ar \[\bm]
  \mnendchorus
  \notesoff
  \beginchorus
