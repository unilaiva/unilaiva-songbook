...
\beginsong{Junto?}[by={Lari Natri}, key={Am}, gk={Am, Gm--G\shrp{}m--(Am)}, tags={valsa}, off={todos os amigos}]
  ...
  \mnbeginverse
    ...
    \beginrep \[^\mn{C}]Per\[^\mn{B}]gun|\[\mnc{A}Am]tando: po\[^\mn{B}]de\[^\mn{C}]mos |\[\mnc{D}Dm]flutuar
    Da \[^\mn{E}]mes\[^\mn{F}]ma |\[\mnc{E}E]for\[^\mn{D}]ma \[^\mn{C}]por \[^\mn{B}]um |\[\mnc{C}C \ac(2){Am}]tem\[^\mn{/}]po? \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    ...
    Agora |^que\jw estamos aqui um |^tempo. \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    ...
    \beginrep Pergun|^tando: podemos |^caminhar
    Na mesma |^dire\emph{ção} por um |^tempo? \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    ...
    Agora\jw e |^sentir \emph{paz} por um |^tempo. \altchords{|A |F \ac(2){Dm}} \endrep
    \endrep
  \endverse
  \begin{lilywrap}\begin{lilypond}[]
    % transcribed by larva, latest update on 2024-11
...
\beginsong{Força da Cura}[by={Lari Natri}, key={Am}, gk={Am, (Em)--(Gm)}, tags={valsa}]
  ...
  \mnbeginverse
    \beginrep
    \beginrep |\[\mnc{E}Am]Oh! |\[\mnc{D}G]For\[^\mn{C}]ça \[^\mn{B}]da |\[\mnc{A}Am]Cu\[^\mn{E}]{ra,\jw e}|\[\mncii{F}{E}Dm]leva \[^\mn{D}]meu |\[\mnc{E}Am]can\[^\mn{A}]to |\[\mnc{B}E7]às \[^\mn{C}\mn{D}]{\emph{al}}|\[\mnc{E}Am]tu|ras! \endrep
  ...
  \beginverse
    \beginrep
    \beginrep |^Oh! |^Força da |^Cura, |^abra meu |^cora|^ção para\jw a|^mor! | \e \endrep
  ...
  \beginverse
    \beginrep
    \beginrep |^Oh! |^Força da |^Cura, |^{\emph{es}}cla|^rece mi|^nhas pensa|^men|tos! \endrep
  ...
  \beginverse
    \beginrep
    \beginrep |^Oh! |^Força da |^Cura, |^sensibi|^lize |^meu cora|^ção! | \e \endrep
