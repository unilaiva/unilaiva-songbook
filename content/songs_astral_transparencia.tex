...
\beginsong{O Ego}[id={o-ego-te1qvb},by={Lari Natri},key={Am},gk={Am, Gm--G\shrp{}m--(Am)}]
  ...
  \mnbeginverse
    \beginrep
      ...
      Mas \[\bmc\mn{C}]não \[^\mn{B}]vou \[^\mn{E}]m|\[Am]ais \[\bmc\mn{C}]resis\[^\mnc{B}]t|\[E]ir, não \[\bmc\mn{C}]vou \[^\mn{B}]com\[^\mn{A}]pe|\[Am]tir. \[A7]
      Em |\[\mnc{D}Dm]to\[\bm]dos, | ve\[\bmc\mn{E}]jo \[^\mn{F}]a\[^\mn{E}]m|\[Am]{or ---} \[^\mn{C}]um \[\bm]dom da \[^\mnc{B}]s|\[E]orte ---
      \[^\mn{A}]No \[\bmc\mn{B}]co\[^\mn{A}]ra\[^\mnc{B}]ç|ão, a \[E7]luz \[^\mn{C}]que |\[\mnc{B}Am]vai \[^\mn{A}]brilh\[\bm]ar. |{ }{ }\[\bm]{ }{ }{ } \e
    \endrep
  \mnendverse
  \notesoff
  \beginverse
  ...
  \beginverse
    \beginrep
      ...
      Na \noteson\[\bmc\mnd{B}]paz do San\[\mnd{A}]to |\[\mnd{B}]Daime,\notesoff{} \[E7] vou |\[Am]medit\[\bm]ar. |{ }{ }\[\bm]{ }{ }{ } \e
    \endrep
  \endverse
...
\beginsong{Junto?}[id={junto-a0ezxr},by={Lari Natri},key={Am},gk={Am, Gm--G\shrp{}m--(Am)},tags={valsa},off={todos os amigos}]
  ...
  \mnbeginverse
    \beginrep
      ...
      \beginrep
        \[^\mn{C}]Per\[^\mn{B}]gun|\[\mnc{A}Am]tando: po\[^\mn{B}]de\[^\mn{C}]mos |\[\mnc{D}Dm]flutuar
        Da \[^\mn{E}]mes\[^\mn{F}]ma |\[\mnc{E}E]for\[^\mn{D}]ma \[^\mn{C}]por \[^\mn{B}]um |\[\mnc{C}C \ac<2>{Am}]tem\[^\mn{/}]po?
      \endrep
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Força da Cura}[id={forca-da-cura-7sj13t},by={Lari Natri},key={Am},gk={Am, (Em)--(Gm)},tags={valsa}]
  ...
  \mnbeginverse
    \beginrep
      \beginrep
        |\[\mnc{E}Am]Oh! |\[\mnc{D}G]For\[^\mn{C}]ça \[^\mn{B}]da |\[\mnc{A}Am]Cu\[^\mn{E}]{ra,\jw e}|\[\mncii{F}{E}Dm]leva \[^\mn{D}]meu |\[\mnc{E}Am]can\[^\mn{A}]to |\[\mnc{B}E7]às \[^\mn{C}\mn{D}]{\emph{al}}|\[\mnc{E}Am]tu|ras!
      \endrep
      |\[\mnc{D}Dm]Estou \[^\mn{E}]can|\[^\mn{F}]tando, \[^\mn{G}]can|\[\mnc{A}Am]tan\[^\mn{E}]do |\[^\mn{C}]mi\[^\mn{A}]nha |\[\mnc{B}G]al\[^\mn{C}]ma \[^\mn{D}]ao |\[\mnc{F}G7]Céu al|\[\mnc{E}Am]to. | \e
      |\[\mnc{D}Dm]Estou \[^\mn{E}]can|\[^\mn{F}]tando, \[^\mn{G}]can|\[\mnc{A}Am]tan\[^\mn{E}]do |\[^\mn{C}]mi\[^\mn{A}]nha |\[\mnc{F}F]alma ao |\[\mnc{G#}E7]Céu al|\[\mnc{A}Am]to. | \e
      | | \e
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Sentido da Vida}[id={sentido-da-vida-3vriy7},by={Lari Natri},key={Am},gk={Am, Gm--G\shrp{}m--(Am)}]
  ...
  \mnbeginverse
    \beginrep
      \[^\mn{A}]Talvez \[^\mn{C}]um |\[\mnc{E}Am]{dia o} \[^\mn{F}]sen\[\bmc\mn{E}]ti\[^\mn{D}]do \[^\mn{C}]da \[^\mnc{E}]vi|-da se \[^\mn{F}]re\[\bmc\mnc{E}]vele, | \[\bm] | \[\bmc] \e
    \endrep
    \beginrep
      \[^\mn{E}]Mas a|\[\mnc{A}F]gora não \[^\mnc{G}]é \[\bmc\mnc{F}]o \[^\mn{E}]mo\[^\mn{D}]men\[^\mn{F}]to, | \e
      es\[\bmc]tamos \[^\mn{G}]presos \[^\mn{F}]ao |\[\mnc{E}Am]Eu \[\bmc]\[^\mac{C}]{ }{ }{ } |\[^\mac{A}] \[\bmc] \e
    \endrep
  \mnendverse
  \notesoff
  % verse 2:
  ...
  \mnbeginverse
    ...
    \beginrep
      \[\mn{E}]Está \[\mn{A}]es|\[\mnc{C}Am]crito \[\mn{B}]em \[\bmc\mn{A}]to\[\mn{F}]das \[\mn{E}]as \[\mn{A}]nos|{ - }sas \[\mn{G}]cé\[\bmc\mn{E}]lulas, | \[\bm] | \[\bmc] \e
    \endrep
    \beginrep
      \[\mnc{E}]E há |\[\mnc{F}F]infini\[\mn{G}]tas \[\bmc\mn{A}]ma\[\mn{C}]nei\[\mn{B}]ras \[\mn{A}]de | \e
      vi\[\bmc]ver e \[\mn{G}]pro\[\mn{C}]ce|\[\mnc{A}Am]der \[\bmc]\[\mac{C}]{ }{ }{ } |\[\mn{A}] \[\bmc] \e
    \endrep
  \mnendverse
  \notesoff
  % verse 4:
