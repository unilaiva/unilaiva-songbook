...
\beginsong{Cantar Me Apareceu}[by={Mestre Irineu Serra}, key={A}, gk={A, G--A}, tags={2x}]
  ...
  \mnbeginverse
    ...
    \beginrep \[\mn{E}]Fe|\[\mnc{F#}D]liz, \[\mn{B}]fe|\[\mncii{A}{C#}A]liz \[\bm] \altchords{|C |G}
    \[\mn{F#}]Fe|\[\mncii{E}{D}E]liz { }\[\bmc\mn{B}] \[\mn{C#}]a|\[\mnc{A}A]deus \[\bm] \altchords{|D |G} \endrep
    \endrep
  \mnendverse
  \vspace{1ex}
  \mnbeginverse
    ...
    \beginrep \[\mn{E}]Eu não |\[\mnc{F#}D]te \[\mn{D}]dis\[\bmc\mn{F#}]se \[\mn{B}]quem |\[\mnc{A}A]era \altchords{|E |B}
    \[\bmc\mn{E}]Pa\[\mn{F#}]ra |\[\mnc{E}E]ti \[\mn{D}]me \[\bmc\mn{B}]per\[\mn{C#}]gun|\[\mnc{A}A]tar \[\bm] \altchords{|F\shrp{} |B} \endrep
    \endrep
  \mnendverse
  \begin{translation}[EN]
