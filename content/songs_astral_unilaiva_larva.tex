...
\beginsong{Força da Cura}[by={larva}, key={Am}, gk={Am, (Em)--(Gm)}, tags={valsa}]
  ...
  \mnbeginchorus\memorize
    ...
    |\[\mnc{D}Dm]Estou \[^\mn{E}]can|\[^\mn{F}]tando, \[^\mn{G}]can|\[\mnc{A}Am]tan\[^\mn{E}]do |\[^\mn{C}]mi\[^\mn{A}]nha |\[\mnc{B}G]al\[^\mn{C}]ma ao \[^\mn{D}]Céu |\[\mnc{F}G7]al|\[\mnc{E}Am]to. | \e
    |\[\mnc{D}Dm]Estou \[^\mn{E}]can|\[^\mn{F}]tando, \[^\mn{G}]can|\[\mnc{A}Am]tan\[^\mn{E}]do |\[^\mn{C}]mi\[^\mn{A}]nha |\[\mnc{F}F]alma ao Céu |\[\mnc{G#}E7]al|\[\mnc{A}Am]to. | \e
    | | \e
  \mnendchorus
  \notesoff
  \beginchorus
