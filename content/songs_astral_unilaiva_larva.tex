...
\beginsong{Junto?}[by={larva}, key={Am}, gk={Am, Gm--G\shrp{}m--(Am)}, tags={valsa}]
  \meter{3}{4}
  \mnbeginchorus\memorize
...
\beginsong{Força da Cura}[by={larva}, key={Am}, gk={Am, (Em)--(Gm)}, tags={valsa}]
  ...
  \beginchorus
    ...
    |^Estou a|brindo, a|^brindo |meu cora|^{\emph{ção}} pa|^ra a|^mor. | \e
    |^Estou a|brindo, a|^brindo |meu cora|^ção pa|^ra a|^mor. | \e
    | | \e
  \endchorus
  \beginchorus
  ...
  \beginchorus
    ...
    |^Estou escu|tando, escu|^tando as ne|cessi|^{\emph{da}des} |^do ou|^tro. | \e
  ...
  \begin{lilywrap}\begin{lilypond}[]
    ...
    theLyricsOne = \lyricmode {
      \repeat segno 2 {
        ...
        | Es -- tou can _ -- | tan -- do, can _ -- | tan _ -- do __ _ | mi _ -- nha | al -- ma ao | Céu al -- | to. | _
        | Es -- tou can _ -- | tan -- do, can _ -- | tan _ -- do __ _ | mi _ -- nha | al -- ma ao | Céu al -- | to. | _ | |
      }
    }
    theLyricsTwo = \lyricmode {
      \repeat segno 2 {
        ...
        | Es -- tou a _ -- | brin -- do, a _ -- | brin _ -- do __ _ | meu co -- ra -- | ção __ _ pa -- | ra a -- | mor. | _
        | Es -- tou a _ -- | brin -- do, a _ -- | brin _ -- do __ _ | meu co -- ra -- | ção __ _ pa -- | ra a -- | mor. | _ | |
      }
    }
    theLyricsThree = \lyricmode {
    ...
    theLyricsFour = \lyricmode {
      ...
      | Es -- tou es -- cu -- | tan -- do, es -- cu -- | tan -- do as ne -- | ces _ -- si -- | da _ -- des | do ou -- | tro. | _
      | Es -- tou es -- cu -- | tan -- do, es -- cu -- | tan -- do as ne -- | ces _ -- si -- | da _ -- des | do ou -- | tro. | _ | |
    }
    theChords = \chordmode {
      \repeat segno 2 {
    ...
    \layout { #(layout-set-staff-size 13.8) } % for better fit
   \include "tex/lp-include-tail-lyricsbelow.ly"
  \end{lilypond}\end{lilywrap}
  \begin{translation}[EN]
