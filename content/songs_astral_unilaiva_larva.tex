...
\beginsong{Sou Daime, Sou um Espelho}[by={larva}, key={Am}, gk={Bm, (Am)--(Bm)--(Cm)}]
  \mnbeginchorus\memorize
    ...
    \[^\mn{E}]Pa|\[^\mn{A}]ra \[A\up{sus2}]{}\[^\mn{B}]{te mos}|\[\mnc{D}A\up{sus4}]trar \[Am]{}\[^\mn{C}]{} |\[\mnc{B}A\up{sus2}]a \[Am]{}\[^\mn{C}]ti |\[\mncii{B}{A}A\up{sus2}]{mes}mo{}\[A\up{sus4}]
    Se esti|\[\mnc{D}Dm]ve\[\bm]res | dis\[\mnc{E}D\up{sus2}]pos\[^\mn{F}]{to a} |\[\mncii{A}{E}Am]ver \[\bm]{} |{ }{ } \[A\up{sus2}]{} \e
    Se esti|\[\mnc{B}Em]ve\[\bm]res | dis\[\mnc{D}E7]pos\[^\mn{C}\mn{B}]{to a} |\[\mnc{A}Am]ver \[\bm]{} |{ }{ } \[\bm]{} \e
  \mnendchorus
  \notesoff
  \beginchorus
  ...
  \begin{lilywrap}\begin{lilypond}[]
    ...
    theChords = \chordmode {
      \repeat volta 2 {
        ...
        | a:m a:sus2 | a:sus4 a:m | a:sus2 a:m | a:sus2 a:sus4
        | d:m d:m | d:m d:sus2 | a:m a:m | a:m a:sus2
        | e:m e:m | e:m e:7 | a:m a:m | a1:m
      }
    }
   % \layout { #(layout-set-staff-size 15) } % for better fit
   \include "tex/lp-include-tail-lyricsbelow.ly"
