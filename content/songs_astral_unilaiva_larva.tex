...
\beginsong{Junto?}[by={larva}, key={Am}, gk={Am, Gm--G\shrp{}m--(Am)}, tags={valsa}]
  ...
  \mnbeginchorus\memorize
    ...
    batendo |\[\mnc{D}Dm]gentilm\[^\mncadj{.25ex}{C}]en\[^\mn{D}]te \[^\mn{E}]com |\[E]outros;
    \lrep \[^\mn{C}]Per\[^\mn{B}]gun|\[\mnc{A}Am]tando: po\[^\mn{B}]de\[^\mn{C}]mos |\[\mnc{D}Dm]flutuar
    Da \[^\mn{E}]mes\[^\mn{F}]ma |\[\mnc{E}E]form\[^\mn{D}]a \[^\mn{C}]por \[^\mn{B}]um |\[\mnc{C}C \up{2}(Am)]tem\[^\mn{/}]po? \rrep
  \mnendchorus
  \notesoff
  \beginchorus
    Assim |^como eu, assim |vós,
    Os mesmos |^ventos nos levam a |^todos.
    \lrep Vamos cri|^ar algo |^juntos
  ...
  \beginchorus
    ...
    Na mesma |^direção por um |^tempo? \rrep
  \endchorus
  \beginchorus
    Assim |^como eu, assim |vós,
    Os mesmos |^rios nos levam para |^frente.
    \lrep Vamos be|^ber do mesmo |^fonte
    Agora e |^sentir paz por um |^tempo. \rrep
  \endchorus
  \begin{lilywrap}\begin{lilypond}[]
    ...
    theMelody = \relative d'' {
      ...
      \time 3/4 \partial 4.
        \repeat segno 2 {
          ...
          e e e | d8 d8 d8( c8) d8 e16( e16) | e4 e8
          \sectionLabel "B"
          \repeat volta 2 {
            \parenthesize c8 c8 b | a4( a8) \parenthesize a b c | d8( d8) d8
    ...
    theLyricsOne = \lyricmode {
      ...
      \repeat segno 2 {
        ...
        ba -- ten -- do | gen -- til -- men _ -- te com __ _ | ou -- tros;
        \repeat volta 2 {
          "" Per -- gun -- | tan -- do: po -- de -- mos | flu -- tu -- ar;
          Da mes -- ma | for _ -- ma __ _ por um
        } \alternative {
          { | tem -- po? }
          { | tem -- po? }
        }
    ...
    theLyricsTwo = \lyricmode {
      \set stanza = "2."
        ...
        Os mes -- mos | ven -- tos nos le -- vam a __ _ | to -- dos.
        \repeat volta 2 {
    ...
    theLyricsThree = \lyricmode {
      ...
      \repeat segno 2 {
        ...
        con -- tran -- do | har -- mo -- ni -- a com~as es _ -- | tre -- las;
        \repeat volta 2 {
    ...
    theLyricsFour = \lyricmode {
      ...
      \repeat segno 2 {
        As -- sim | co -- mo eu, as -- sim __ _ | vós; __ _
        Os mes -- mos | ri -- os nos le -- vam pa -- ra | fren -- te.
        \repeat volta 2 {
