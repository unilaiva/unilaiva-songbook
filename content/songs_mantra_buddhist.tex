...
\beginsong{Jewel in the Lotus Flower \\ Om Mani Padme Hum}[ah={335}]
  ...
  \vfill
  \begin{center}
    \includegraphics[width=0.67\textwidth]{om_mani_padme_hum_script_bw_transparent_bg_2000px.png}
  \end{center}
\endsong
...
\beginsong{Teyata Om Bekanze Bekanze\ldots \\ Healing Mantra}[]
  \showmantra{Teyata Om Bekanze Bekanze Maha Bekanze Bekanze Radza Samut Gate So Ha}
  \begin{feeler}
