...
\beginsong{Jesus}[id={jesus-4edtme},by={Lúcio Mortimer},key={C},gk={D, C--E},tags={valsa}]
  ...
  \mnbeginverse
    \beginrep
      ...
      \beginrep \[\mn{G}]E |\[C]Vós, Se|nhor \altchords{|D | \e}
      Per|\[G]do\[\mn{F}]a \[\mn{E}]a |\[\mnc{D}G7]nós \[\mn{E}]pe\[\mn{D}]ca|\[\mnc{C}C]dor \altchords{|A |A7 |D} \endrep
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep
      ...
      \beginrep \[\mn{G}]No |\[C]cora|ção \altchords{|D | \e}
      Eu |\[G]re\[\mn{F}]ce\[\mn{E}]ber |\[\mnc{D}G7]meu \[\mn{E}]per|\[\mnc{C}C]dão \altchords{|A |A7 |D} \endrep
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep
      ...
      \beginrep \[\mn{G}]Com a|\[C]mor \altchords{|D}
      Na |\[G]mis\[\mn{F}]são \[\mn{E}]do |\[\mnc{D}G7]Re\[\mn{E}]den|\[\mnc{C}C]tor \altchords{|A |A7 |D} \endrep
    \endrep
  \mnendverse
  \begin{translation}[EN]
...
\beginsong{Triunfo Maior}[id={triunfo-maior-wkv1ks},by={Lúcio Mortimer},off={Orlando Villas Boas e Luisa},key={G},gk={G, D\shrp{}--B}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep
        \[^\mn{G}]Agra\[\bm]deço a São |\[\mnc{E}Em]João, \[^\mn{G}]meu \[\bm]Mestre que|\[\mnc{D}G]ri\[^\mn{G}]do \altchords{|Dm |F}
        Que \[\bm]bom ter ou|\[\mnc{F#}D]vido \[\bm]o \[^\mn{E}]seu \[^\mn{F#}]cha|\[\mnc{G}G]ma\[\bm]do | \e \altchords{|C |F | \e}
      \endrep
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Eu Sou Filha do Mestre}[id={eu-sou-filha-do-mestre-7uoap2},by={Malla},key={A},gk={A, G--B},tags={2x}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_eu_sou_filha_do_mestre_a]
      \[^\mn{A}]Eu |\[\mnc{E}A]sou \[^\mn{C#}]fi\[\bmc\mn{A}]lha \[^\mn{C#}]do |\[^\mn{E}]Mes\[\bm]tre \altchords{\id[1]{(B)}|B | \e}
      E|\[\mnc{F#}D]le \[^\mn{D}]tem \[\bm]gran\[^\mn{E}]{de\jw A}|\[^\mn{F#}]mor \[\bm] \altchords{|E | \e}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_eu_sou_filha_do_mestre_b]
      \[^\mn{A}]Vamos can|\[A]tar, \[^\mn{E}]va\[\bmc\mn{C#}]mos \[^\mn{A}]can|\[^\mn{E}]tar \[\bm] \altchords{|B | \e}
      Com |\[\mnc{F#}D]to\[^\mn{D}]{do\jw o} \[\bm]co\[^\mn{E}]ra|\[^\mn{F#}]ção \[\bm] \altchords{|E | \e}
    \endrep
  \mnendverse
  \notesoff
