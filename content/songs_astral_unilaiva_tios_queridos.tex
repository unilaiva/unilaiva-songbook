...
\beginsong{Eu Sou Filha do Mestre}[by={Malla}, key={A}, gk={A, G--B}, tags={2x}]
  ...
  \mnbeginchorus\memorize[chords_eu_sou_filha_do_mestre_a]
  ...
  \mnendchorus\glueverses\mnbeginchorus\memorize[chords_eu_sou_filha_do_mestre_b]
  ...
  \mnendchorus
  \notesoff
  \beginchorus\replay[chords_eu_sou_filha_do_mestre_a]
    E o |^Lúcio ^é meu |Ti^o \altchords{\id[2]{(G)}|G | \e}
    Ele |^{é\jw um} gran^de A|mi^go \altchords{|C | \e}
  \endchorus\glueverses\beginchorus\replay[chords_eu_sou_filha_do_mestre_b]
