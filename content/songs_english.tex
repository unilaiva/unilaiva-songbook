...
\beginsong{I Hear the Silence}[by={Annie Burns}, tags={source}, ph={II}, key={Dm}, sks={Cm, Cm--Em}]
...
\beginsong{I Just Close My Eyes \\ The Sound of Water}[by={Deva Madhuro},tags={peace},ph={II},key={Am},sks={Bm, Am--Em}]
  \beginchorus
    |\[\mnc{E}Am]I just close my |\[\mnc{D}G]eyes \altchords{\id[1]{(Bm)}|Bm |A}
    And the |\[F]Earth is carried a|\[Em]way \altchords{|G |F\shrp{}m}
    by the |\[Am]river | \e \altchords{|Bm | \e}
  \endchorus
  \beginchorus
    |\[Fmaj7] \[\mn{C}]What is left be|hind I \[\mn{D}\mn{C}]can't |\[Em] \[\mn{B}]say |\[Em7] \altchords{|Gmaj7 | - |F\shrp{}m |F\shrp{}m7}
    |\[Dm7] It's just the |\[Em]sound of the |\[Am]water | \e  \altchords{|Em7 |F\shrp{}m |Bm | \e}
  \endchorus
  \textnote{suomeksi:}
  \beginchorus
...
\beginsong{Above and Below}[by={Kailash Kokopelli},tags={source},ph={I, II, IV},key=Bm,sks={Cm, (Bm)--Cm--E\flt{}m}]
...
\beginsong{Celestial Heart}[by={Nick Barber},ph={III},key=Am,sks={Bm, Gm--C\shrp{}m}]
  \meter{3}{4}
...
\beginsong{Heart's Mystery}[by={Nick Barber},tags={heart},ph={III},key={C},sks={C, G--D}]
...
\beginsong{Ho'oponopono}[ph={III}, key={Am}, sks={Am, Gm--Bm}]
