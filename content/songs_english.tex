...
\beginsong{Reconnected}[by={Murray Kyle}]
  ...
  \meter{6}{8}
  \beginverse
    A |\[Em]fresh new breeze is |\[D/F#]growing
    The |\[C]winds of change are |\[D/F#]blowing |
    |\[Em]Every moment's a |\[D/F#]miracle of |\[A]life | -
  \endverse
  \beginverse
  ...
  \beginverse
    ...
    \lrep We are |^reconnected to the |^spirit of the |^ earth | - \rrep\rep{3}
  \endverse
\endsong
