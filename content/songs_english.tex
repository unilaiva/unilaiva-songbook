...
\beginsong{Spirit}[by={Rainer Scheurenbrand}, ph={I}]
  % See: https://rainerscheurenbrand.bandcamp.com/track/spirit
  % See: https://www.youtube.com/watch?v=70M8K3PSWzw
...
\beginsong{Come}[by={Sudhananda, Rumi},tags={circle},ph={I, IV}]
  \meter{6}{8}
  \beginchorus
...
% \beginsong{Home Is Where the Heart Is}[tags={heart, you, (chords missing)}]
%   \beginverse
...
\beginsong{All Related}[by={Nessi Gomes},ex={english, español, lakȟótiyapi},tags={love},ph={III, IV}]
  ...
  \beginverse\replay[chords_allrelated_b]
    ...
    \ind In this |^Nan nana nana |^nanna |^nan nana nana |^Yage
    \ind |^Nan nana nana |^nanna |^nan nana nana |^Yage
    \ind |^Nan nana nana |^nanna |^nan nana nana |^Yage
    \ind |^Nan nana nana |^nanna |^we all all re|^lated
...
%% \beginsong{Coconut Tree}[tags={(chords missing)}]
%%   \beginchorus
...
%% \beginsong{Sketch}[by={Fry and Laurie},tags={(chords missing)}]
%%   \meter{4}{4}
%%   \beginverse
...
\beginsong{More Strength}[by={Second Nature Sounds},ph={III}]
  \beginverse
    ...
    \ind There's mountains to |\[Gm]climb |\[Am]-
    \ind Help me just to |\[Dm]get over |\[Am]-
    \vspace{0.5em}
    \ind Yes, I need a |\[Dm]little more strength, oh |\[Am]Jah
    \ind It's not an easy |\[Dm]road, heavy load, oh |\[Am]Jah
    \ind Been traveling for |\[Gm]miles |\[Am]-
    \ind Help me just to |\[Dm]get over |\[Am]-
  \endverse
  \beginverse\memorize
