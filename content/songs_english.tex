...
\beginsong{Guided and Protected}[tags={protection 1}]
  \beginverse
    We are |\[Am\noteULL{A}]guided and \[\noteU{B}]pro|\[\noteU{C}]tected
    Wher|\[F]ever we are | -
    Wher|\[Dm]ever we are | -
...
\beginsong{We Are One in Harmony}[by={Michael Stillwater},tags={circle 1}]
...
\beginsong{Come}[by={Sudhananda, Rumi},tags={circle 1}]
  \meter{6}{8}
  \beginchorus
...
\beginsong{We Are Circling}[tags={circle 1}]
  \beginverse
...
\beginsong{Merry Meet \\ May the Circle Be Open}[by={Starhawk},tags={circle 1}]
  \beginverse
...
\beginsong{We Are Opening Up}[tags={opening 1}]
...
\beginsong{Wake Up the Heart / Radhe Shyam}[by={Nalini Blossom. Prembabanda},tags={heart 1, love 1, Krishna 1, Radha 1}]
...
\beginsong{Let the Way of the Heart}[by={Rich Stillwell},tags={heart 1}]
  \beginchorus
...
\beginsong{Heart's Mystery}[by={Nick Barber}, tags={heart 1}]
  \meter{3}{4}
  \beginchorus
...
\beginsong{Temple of My Heart}[by={Kevin James Carroll},tags={heart 1}]
  \beginverse
...
\beginsong{Angel Heart}[by={Nick Barber},tags={heart 1}]
  \beginverse
    \[G\noteUL{D}]An\[\noteU{E}]gel |\[C\noteUL{C}]heart | -
...
\beginsong{Beloved of Mine}[by={Bachan Kaur, Suruya Devi},tags={love 1},ex={english, español}]
  \transpose{2}
  \beginchorus\memorize
...
\beginsong{Wake Up}[by={Mirabai},tags={love 1, source 1}]
  \beginchorus
...
\beginsong{Pacha Mama}[by={Ronny Hickel},tags={flight 1}]
  \beginverse
...
\beginsong{Angels Singing \\ Wood Stone}[]
  \beginchorus\memorize
...
\beginsong{I Release}[tags={opening 1, love 1}]
  \beginverse
...
\beginsong{I Just Close My Eyes \\ The Sound of Water}[by={Deva Madhuro},tags={peace 1}]
  \beginchorus
...
\beginsong{Fire Child}[tags={fire 1}]
  \beginchorus\memorize
...
\beginsong{Kali Burn It All Away}[ititle={Om Namo Kali},tags={fire 1, Divine Mother 1, Kali 1}]
  \beginchorus\memorize
...
\beginsong{Angels of Healing}[by={Lisa Thiel}]
  \transpose{-2}
  \meter{3}{4}
  \beginchorus\memorize
...
\beginsong{Jay Ma}[tags={Divine Mother 1}]
  \beginchorus\memorize
    \[^\noteU{E}]When \[^\noteU{G}]the |\[Em\noteULL{B}]fire in my |soul
    Burns a |\[C]longing for the |\[Em]goal
...
\beginsong{Every Part of the Earth}[tags={Mother Earth 1}]
  \beginchorus
...
\beginsong{Mother I Feel You}[by={Dianne Martin},tags={earth 1, water 1, air 1, fire 1}]
  \beginchorus\memorize
...
\beginsong{Earth My Body}[tags={earth 1, water 1, air 1, fire 1}]
  \beginverse
...
\beginsong{Strong Wind \\ Pure Earth}[tags={earth 1, air 1, water 1, fire 1}]
  \beginchorus\memorize
...
\beginsong{The River Is Flowing}[tags={Mother Earth 1, Sun 1, Moon 1, fire 1}]
  \beginverse
...
\beginsong{One Planet \\ Our Planet Is Turning \\ Winter Solstice Chant}[tags={Mother Earth 1}]
  \beginverse
...
\beginsong{Fly Like an Eagle}[tags={flight 1}]
  \beginverse
...
\beginsong{Above and Below}[by={Kailash Kokopelli},tags={source 1}]
  \beginverse
...
\beginsong{Through the Looking Glass}[by={Zeger Vandenbussche}]
  \transpose{5}
  \beginverse
...
\beginsong{Take Me Away}[tags={love 1}]
  \beginverse
...
\beginsong{Universal Lover \\I'm in You and You're in Me}[by={Fantuzzi},tags={source 1}]
  \beginverse
...
\beginsong{Teacher in the Forest}[by={Nick Barber},tags={Aya 1}]
  \meter{3}{4}
  \beginverse
...
\beginsong{Spiral}[by={Denean},tags={source 1, path 1}]
  \beginverse
...
\beginsong{May the Love \\ Loka Samasta Sukino Bhavantu}[by={Peter Makena},tags={love 1, source 1}]
  \beginverse
...
\beginsong{I Hear the Silence}[by={Annie Burns},tags={source 1}]
  \beginchorus
...
\beginsong{Music of Silence}[tags={love 1}]
  \beginchorus
...
\beginsong{Call Me by My True Names}[by={Yopi Jay}]
  \transpose{5}
  \meter{6}{8}
  \beginchorus
  ...
  \endchorus
  \begin{feeler}
    This song has been inspired by the poem “Call me by my true names” by Thích Nhât Hạnh, a Vietnamese Buddhist monk and peace activist.
  \end{feeler}
\endsong
...
\beginsong{How Could Anyone}[by={Shaina Noll},tags={you 1}]
  \beginverse
...
\beginsong{Hadoway}[by={Ashleigh Forest}]
  \meter{3}{4}
  \beginverse
  ...
  \endchorus
  \chordsoff % chords not needed: all the verses only have the 'i' chord
  \beginverse
...
\beginsong{Sudhossi Budhossi \\ Forever Pure}[by={Shimshai},tags={liberation 1, transcendence 1}]
\meter{6}{8}
  \beginverse
...
\beginsong{In the End of Days}[tags={Shiva 1}]
  \beginverse
...
\beginsong{Return Again}[by={Schlomo Carlibach}]
  \meter{3}{4}
  \beginchorus
...
\beginsong{More Strength}[by={Second Nature Sounds}]
  \normalsize % to fit the whole song on two pages
  \beginverse
...
\beginsong{Every Little Cell}[by={Clemens Kuby},tags={happiness 1}]
  \beginchorus
...
\beginsong{Dear Friends}[by={Gabriel Meir Harevy},tags={love 1, peace 1}]
  \beginverse
...
\beginsong{Thank You}[tags={thankfulness 1}]
  \beginchorus
    |\[Dm\noteULL{D}]Thank you \[\noteU{F}]for \[\noteU{G}]the *\[\noteU{A}]day, Lord |
