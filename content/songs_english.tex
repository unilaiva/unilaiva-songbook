...
\beginsong{Come}[by={Sudhananda, Rumi},tags={circle 1},ph={I}]
  \meter{6}{8}
  \beginchorus
...
\beginsong{We Are Circling}[tags={circle 1},ph={IV}]
  \beginverse
...
\beginsong{We Are Opening Up}[tags={opening 1},ph={IV}]
...
\beginsong{Beloved of Mine}[by={Bachan Kaur, Suruya Devi},tags={love 1},ex={english, español},ph={III}]
  \transpose{2}
  \beginchorus\memorize
...
\beginsong{Pacha Mama}[by={Ronny Hickel},tags={flight 1},ph={III, IV}]
  \beginverse
...
\beginsong{Angels Singing \\ Wood Stone}[ph={II, III}]
  \beginchorus\memorize
...
\beginsong{Amazing Grace}[by={John Newton},ph={IV}]
  \meter{3}{4}
  \beginverse
...
\beginsong{Angels of Healing}[by={Lisa Thiel},ph={III}]
  \transpose{-2}
  \meter{3}{4}
  \beginchorus\memorize
...
\beginsong{Mother I Feel You}[by={Dianne Martin},tags={earth 1, water 1, air 1, fire 1},ph={IV}]
  \beginchorus\memorize
...
\beginsong{The River Is Flowing}[tags={Mother Earth 1, Sun 1, Moon 1, fire 1},ph={IV}]
  \beginverse
...
\beginsong{Fly Like an Eagle}[tags={flight 1},ph={II}]
  \beginverse
...
\beginsong{Above and Below}[by={Kailash Kokopelli},tags={source 1},ph={I, IV}]
  \beginverse
...
\beginsong{Spirit of the Plants}[by={Lisa Thiel},ph={IV}]
  \beginchorus
...
\beginsong{Sudhossi Budhossi \\ Forever Pure}[by={Shimshai},tags={liberation 1, transcendence 1},ph={II, III}]
\meter{6}{8}
  \beginverse
...
\beginsong{Clear Blue Sky}[by={Nick Barber},ph={II, III}]
...
\beginsong{Dear Friends}[by={Gabriel Meir Harevy},tags={love 1, peace 1},ph={IV, V}]
  \beginverse
...
\beginsong{Thank You}[tags={thankfulness 1},ph={V}]
  ...
  \vfill
  \begin{feeler}
    \emph{William Blake:} "Gratefulness is heaven itself."
  \end{feeler}
\endsong
