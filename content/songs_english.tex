...
\beginsong{All Related}[by={Nessi Gomes},ex={English, Español},tags={love 1},ph={III, IV}]
  ...
  \beginverse\memorize[chords_allrelated_a]
    ...
    \[^\noteU{E}]Wakan |\[Am\noteULL{A}]Tanka | Gran E|\[Em\noteUL{G}]spíritu | -
    Agra|\[F]dezco | Pacha|\[Em]mama | -
    Wakan |\[Am]Tanka | Tunka|\[Em]shila | -
    Agra|\[F]dezco | Pacha|\[Em]mama | -
  ...
  \endverse
  \beginchorus \rep{4}
    |\[C]Cura cura cura cura |\[B&]cura\ldots |\[Am]mi\ldots |\[Em] |
  ...
  \begin{translation}
    Wakan Tanka, great spirit, I thank you, Pachamama
    Wakan Tanka, Tunkashila, I thank you, Pachamama
