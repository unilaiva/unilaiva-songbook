...
\beginsong{Angels Singing \\ Wood Stone}[tags={angels 1},ph={II}]
  ...
  \begin{center}
    \vfill%
    % Downloaded from: https://imgbin.com/png/6NnwqU2z/angel-halo-light-png
    % License: Free for non-commercial use
    % 0.618^2 ~ 0.382 (Golden Ratio)
    \includegraphics[width=0.382\textwidth]{angel_halo_transparent_bg_465x727px.png}%
    \vfill%
  \end{center}
\endsong
...
\beginsong{Starwalker}[by={Buffy Sainte-Marie},ph={IV}]
  ...
  \begin{center}
    ...
    % 0.618^2 ~ 0.382 (Golden Ratio)
    \includegraphics[width=0.382\textwidth]{mantobird_by_Sandra_Lange_2013_bw_withperm_1195x1158px.png}%
    \vfill%
...
\beginsong{Every Little Cell}[by={Clemens Kuby},tags={happiness 1},ph={IV, V}]
  ...
  \begin{center}
    \vfill%
    % Downloaded from: https://imgbin.com/png/Q5zpDu2j/cell-mitochondrion-dna-organelle-metabolism-png
    % License: Free for non-commercial use
    % 0.618^2 ~ 0.382 0.618^3 ~ 0.236 (Golden Ratio)
    \includegraphics[width=0.382\textwidth]{cells_bw_transparent_bg_551x587px.png}%
    \vfill%
  \end{center}
\endsong
...
\beginsong{Thank You}[tags={thankfulness 1},ph={V}]
  ...
  \endchorus
  \hfill\small * Friends, circle, etc
  \vfill
  \begin{feeler}
