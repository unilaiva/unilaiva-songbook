...
\beginsong{Spirit}[by={Rainer Scheurenbrand}, ph={I}, key={Am}, gk={Bm, Am--C\shrp{}m}]
  ...
  \beginverse\memorize[chords_spirit_a]
    ...
    \endrep
  \endverse
  \beginverse\memorize[chords_spirit_b]
    \beginrep
  ...
  \beginverse\replay[chords_spirit_a]
    ...
    \endrep
  \endverse
  \beginverse\replay[chords_spirit_b]
    \beginrep
...
\beginsong{We Are Opening Up}[tags={opening},ph={II, IV}]
  \beginverse\memorize
    \beginrep   % memorize the chords even though in 'chorus'
...
\beginsong{All Related}[by={Nessi Gomes},ex={english, español, lakȟótiyapi},tags={love},ph={III, IV}]
  ...
  \endverse\glueverses\beginverse\replay[chords_allrelated_b]
    \beginrep
    \ind |^ |^ |^ |^ \rep{4}
    \endrep
  \endverse\glueverses\beginverse
...
\beginsong{Over the Rainbow}[ititle={Somewhere Over the Rainbow}, by={Harold Arlen, lyrics by: Yip Harburg, version by: Israel Kamakawiwo'ole}, key={G}, gk={A, (G)--(B\flt{})}, ph={IV}]
  % intro
  \mnbeginverse
    \ind |\[\mnc{G}G]Ooo-\[\mnc{B}]oo-\[\mnc{A}]o-|\[\mnc{F#}Bm]ooo \[\mn{A}]Oo-\[\mn{F#}]oo-\[\mn{A}]oo-|\[\mnc{G}C]ooo Oo-oo-|\[G]oooo
    \ind |\[C]Oooo |\[\mnc{F#}B7]Ooo-\[\mn{A}]oo-\[\mn{F#}]oo |\[\mnc{E}Em]Oo-\[\mn{G}]oo-ooo |\[C] \[\mn{E}]O-\[\mn{G}]oo-ooo
  \mnendverse
  % verse 1
  \mnbeginverse
