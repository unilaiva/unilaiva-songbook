...
\beginsong{Wake Up}[by={Mirabai},tags={love 1, source 1},ph={III, IV}]
  ...
  \endchorus
  \beginverse
    \lrep The Lord has |\[D]blessed you | in so many |\[Em]ways | \nl \rrep
...
\beginsong{Angels Singing \\ Wood Stone}[tags={angels 1},ph={II}]
  ...
  \beginverse
    ...
    \chorusindent \lrep In my |\[F]soul, in my |\[C]soul, in my |\[Dm]soul | \nl \rrep
  \endverse
  \beginchorus
...
\beginsong{Heart of the Mother}[by={Michael Stillwater},tags={source 1, canon 1}, ph={I, IV}]
  \beginchorus
...
\beginsong{Astral Bliss}[ititle={Divine Star},by={Giita Rani},ph={III}]
  ...
  \beginverse
    ...
    Di|^vine shining |star of \textsuperscript{*}|^love I am a |^part | | | \nl \hfill{\footnotesize\emph{\textsuperscript{*}e|ternal self I |am}}
  \endverse
  \beginverse
    ...
    \lrep Om |^Bhur Bhuwaswa|ha en|^lightening the |^Earth | | | \nl \rrep
  \endverse
\endsong
...
\beginsong{Reconnected}[by={Murray Kyle},tags={wisdom 1, Mother Earth 1},ph={IV}]
  ...
  \beginverse
    ...
    \lrep We are |^reconnected to the \brk|^spirit of the |^ Earth | \nl \rrep\rep{3}
  \endverse
\endsong
...
\beginsong{Above and Below}[by={Kailash Kokopelli},tags={source 1},ph={I, II, IV}]
  \beginverse
    ...
    \lrep Sacred |\[C]one source wit|\[D]hin \[Bm]and be|\[Em]yond | \nl \rrep
  \endverse
\endsong
...
\beginsong{All Related}[by={Nessi Gomes},ex={english, español, lakȟótiyapi},tags={love 1},ph={III, IV}]
  % See: https://soundcloud.com/nessigomes/all-related-album-version
...
\beginsong{I Hear the Silence}[by={Annie Burns},tags={source 1},ph={II}]
  ...
  \endchorus
  \beginverse
    \lrep I am |\[C]burning and |\[G]burning in your |\[Am]grace | \nl \rrep
