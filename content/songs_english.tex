...
\beginsong{Humble}[by={I Chelle},ph={II}]
  \beginverse
    |\[Dm\noteULL{F}]Hum\[\noteU{D}]ble your|\[C]self to the sight of the |\[Dm]mother
...
\beginsong{Holy}[by={Netanel Goldberg},ph={III}]
  \beginverse
    |\[C]Fly like a r|\[Em]iver, |\[C]flow with the |\[Em]ocean |
    |\[Dm]Fly on the w|\[C]ind tha|\[G]t blows throw the w|\[F]inter |
    |\[C]Dream abo|\[Em]ut love, bel|\[C]ieve in you|\[Em]r dreams |
    |\[Dm]Live in the |\[C]ocean o|\[G]f love |
    |Close your eyes and f|\[G7]eel the wind that is b|\[C]lowing |
    |\[Em]Open up your hands and |\[G]sing |
  \endverse
  \beginverse
    \chorusindent |\[C]I am h|\[Em]oly |
    \chorusindent |\[C]I am h|\[Em]oly |
    \chorusindent |\[Dm]I am here t|\[C]o live thi|\[G]s life |
  \endverse
  \beginverse
    |^Dance in not |^knowing, |^know your perfec|^t power |
