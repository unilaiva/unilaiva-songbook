...
\beginsong{Wake up the Heart / Radhe Shyam}[by={Nalini Blossom. Prembabanda},ah={110},tags={heart 1, love 1, Krishna 1, Radha 1}]
  \musicnote{part A: Wake up the heart}
  ...
  \beginchorus
    ...
    So |\[C]love will shine thro|\[Dm]ugh me
  \endchorus
  \musicnote{part B: Radhe Shyam}
  \beginchorus
    | \space Radhe Radhe Radhe |\[Dm]Shyam, | 
    | \space Govinda Radhe Ra|\[Gm]dhe |
    | \space\space\space Gopa|\[C]la |
    | Radha Ramana Gopa|\[Dm]le |
  \endchorus
  \vfill
  \begin{explanation}
    Govinda, Shyam and Gopala are names for \textbf{Krishna}. 
    Radhe and Ramana are \textbf{Radha}'s names.
    Radha Krishna are collectively known within Hinduism as the combination of 
...
\beginsong{Home Is Where the Heart Is}[tags={heart 1}]
  \beginverse
...
\beginsong{Mother I Feel You}[by={Dianne Martin},ah={104},tags={earth 1, water 1, air 1, fire 1}]
  ...
  \begin{center}%
    \vfill%
    \includegraphics[width=0.382\textwidth]{four_elements_transparent_background_2400px.png}%
    % note: 1/0.618 ~ 0.618/0.382, the golden ratio approximated
    \vfill%
  \end{center}
\endsong
...
\beginsong{In the End of Days}[ah={68}]
  ...
  \endverse
  \beginchorus
    \chorusindent |\[Am]Om namah Shivaya | Om |
    \chorusindent |\[Dm]Om namah Shivaya | Om |
    \chorusindent |\[F]Om namah Shivaya |
    \chorusindent |\[Dm]Om namah Shivaya |\[Am]Om | -
  \endchorus
  \beginverse
