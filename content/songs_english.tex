...
\beginsong{I sense Your presence}[by={Shimshai},tags={source 1, love 1}]
  \transpose{7} % could alternative use capo{7} for higher notes
  \beginchorus
...
\beginsong{Teacher in the Forest}[by={Nick Barber},tags={Ayahuasca 1}]
  \meter{3}{4}
  \beginverse
...
\beginsong{Call me by my True Names}[by={Yopi Jay}]
  ...
  \meter{6}{8}
  \beginchorus
    My |\[Am]joy is like Spring so |\[C]warm
...
\beginsong{More strength}[by={Second Nature Sounds}]
  \beginverse
    \chorusindent Give me just a |\[Dm]little more strength, oh |\[Am]Jah
  ...
  \beginverse
    ...
    |^"Hey, bother man, we've |^got to keep the faith"
  \endverse
  \gotochorus{(Give me just a) little more strength}
\endsong
