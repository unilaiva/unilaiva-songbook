...
\beginsong{Spirit}[id={spirit-0ocupw},by={Rainer Scheurenbrand},ph={I},key={Am},gk={Bm, Am--C\shrp{}m}]
...
\beginsong{Come}[id={come-wv6vdo},by={Sudhananda, Rumi},tags={circle},ph={I},key={Am},gk={Bm, Gm--D\shrp{}m}]
  ...
  \beginverse
    \beginrep
      \beginrep
        ...
        This |\[G]isn't a \[<*>]caravan |\[C]{} of des\[Em7]pair \altchords{|A |D F\shrp{}m7}
      \endrep
      \emptyline
      \[<E>]And |\[<F>Dm]{it doesn't} \[<*>]mat\[<E>]ter \[<D>]if \[<C>]you've |\[<D>E7]bro\[<E>]ken your \[<*>]vow \altchords{|Em |F\shrp{}7}
...
\beginsong{Earth My Body}[id={earth-my-body-cpxb4d},tags={earth, water, air, fire},ph={I, II},key={Em},gk={Em, Cm--F\shrp{}m}]
  \mnbeginverse
    |\[<E>Em]Earth my \[<D>D]body |\[<E>Em]water my \[<B>Bm]blood \altchords{\id[1]{(Dm)}|Dm C |Dm Am}
    |\[<E>Em]Air my \[<F#>D]breath and |\[<G>C]fire \[^<A G>]my \[<F# E>D]spi\[^<D>]rit \altchords{|Dm C |B\flt{} C}
  \mnendverse
  \notesoff
...
\beginsong{Guided and Protected}[id={guided-and-protected-gp4ba2},tags={protection},ph={II, IV},key={Am},gk={Bm, G\shrp{}m--E\flt{}m}]
  \mnbeginverse
    \beginrep\memorize
      ...
      \[^<F>]Wher|\[<E>E]ever \[^<F>]we \[^<E>]ar\[<*>]e { } |{ }{ }\[<*>] \e \altchords{|F\shrp{} | \e}
    \endrep
  \mnendverse
  \notesoff
  \textnotefornext{suomeksi:}
...
\beginsong{I Just Close My Eyes \\ The Sound of Water}[id={i-just-close-my-eyes-uex798},by={Deva Madhuro},tags={peace},ph={II},key={Am},gk={Bm, Bm--D\shrp{}m}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_ijustclose_a]
      ...
      \[^<B>]And the |\[<C>F]Earth \[^<A>]is \[^<F>]carried \[^<C B>]aw|\[Em]ay \altchords{|G |F\shrp{}m}
      \[^<A>]by \[^<G>]the \[^<B>]r|\[<A @.375ex>Am]iver | \e \altchords{|Bm | \e}
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep\memorize[chords_ijustclose_b]
      |\[Fmaj7]{} \[^<A>]What \[^<B>]is \[^<C>]left \[^<D>]be\[^<E>]h|ind I \[^<F D>]can't |\[Em]{} \[^<E>]say |\[Em7]{} \altchords{|Gmaj7 | - |F\shrp{}m |F\shrp{}m7}
      |\[Dm7]{} \[^<A>]It's just \[^<C>]the \[^<B>]s|\[Em]ound \[^<A>]of \[^<G>]w|\[<A @.53ex>Am]ater | \e \altchords{|Em7 |F\shrp{}m |Bm | \e}
    \endrep
  \mnendverse
  \notesoff
  \textnotefornext{suomeksi:}
...
\beginsong{Spiral}[id={spiral-klzu7g},by={Denean},tags={source, path},ph={II},key={Em},gk={Em, Cm--G\shrp{}m}]
...
\beginsong{Above and Below}[id={above-and-below-mk5s1l},by={Kailash Kokopelli},tags={source},ph={I, II, IV},key={Bm},gk={Cm, (Bm)--Cm--E\flt{}m}]
...
\scleardpage
\beginsong{The Heart's Song}[id={the-heart-s-song-x5yx13},by={Minna Pyhälä},ph={III},tags={heart},key={G},gk={A, G\shrp{}--D}]
  \audio[key={F\shrp{}m},pitch={432}]{https://soundcloud.com/spirit-sings-minna/a-hearts-song-minna}
  \meter{6}{8}
...
\beginsong{Celestial Heart}[id={celestial-heart-frj8ah},by={Nick Barber},ph={III},key={Am},gk={Bm, Gm--C\shrp{}m}]
  \meter{3}{4}
...
\beginsong{Heart's Mystery}[id={heart-s-mystery-s3fi5v},by={Nick Barber},tags={heart},ph={III},key={C},gk={C, G--E}]
  \audio[key=B\flt{}]{https://soundcloud.com/nickbarbermusic/hearts-mystery}
...
\beginsong{Call Me by My True Name}[id={call-me-by-my-true-name-s7qktf},by={Yopi Jay},key={Am},gk={Cm, (Am)--Cm--C\shrp{}m},ph={III}]
  % in Am, the notes range from E to G'
  \capo{3}
  \meter{6}{8}
  \mnbeginverse
    \beginrep
      \[<E>]My |\[<A>Am]joy is like \[<B>]a \[<C>]spring \[<D>]so |\[<E @.75ex>C]warm \altchords{\id[1]{(Cm)}|Cm |E\flt{}}
      it |\[<D>G]makes \[<B>]flo\[<C>]wers \[<D>]bloom \[<E>]all |\[<C A>Am]over \[<B>]the \[<C>]Earth. \altchords{|B\flt{} |Cm}
      \[<E>]My |\[<A>Am]pain is like \[<B>]a \[<C>]river \[<D>]of |\[<E @.75ex>C]tears, \altchords{|Cm |E\flt{}}
      so |\[<D>G]vast \[<B>]it \[<D>]fills \[<E>]the |\[<C A>Am]four oceans \altchords{|B\flt{} |Cm}
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep
      \[<C>]Please |\[<E>C]call me \[<G>]by my |\[<D C>G]true \[<B>]name, \altchords{|E\flt{} |B\flt{}}
      so I \[<C>]can |\[<D>Dm]hear my \[<E>]cries \[<D>]and |\[<C>Am]laugh\[<A>]ters \[<B>]at \[<C>]once, \altchords{|Fm |Cm}
      |\[C]so \[<D>]I \[<C>]can |\[<B>G]feel \[<G>]that \[<A>]my |\[<B>Em]joy and \[<C>]pain \[<B>]are |\[<A>Am]one. \altchords{|E\flt{} |B\flt{} |Gm |Cm}
      \emptyline
      \[<C>]Please |\[<E>C]call me \[<G>]by my |\[<D C>G]true \[<B>]name \altchords{|E\flt{} |B\flt{}}
      so \[<C>]that |\[<D>Dm]I \[<E>]can \[<D>]wake |\[<C A>Am]up \altchords{|Fm |Cm}
      and \[<B>]the |\[<C>C]doors \[<D>]of \[<C>]my |\[<B>G]heart \[<G>]will \[<A>]be |\[<B>Em]left \[<C B A>]o|\[Am]pen. \altchords{|E\flt{} |B\flt{} |Gm |Cm}
    \endrep
  \mnendverse
  \begin{feeler}
...
\beginsong{Through the Looking Glass}[id={through-the-looking-glass-x2av1x},by={Zeger Vandenbussche},ph={III, IV},key={Am},gk={Cm, Am--D\shrp{}m}]
  \beginverse
...
\beginsong{Strong Wind \\ Pure Earth \\ Pyhä maa}[id={strong-wind-2cgr2j},tags={earth, air, water, fire},ph={IV},key={Em},gk={Em, Cm--Em}]
  ...
  \beginverse
    \beginrep
      ...
      Heya |\[C]he\[<* @-.375ex>]ya heya |\[D]heya \[<*>]{} heya |\[C]heya \[D]heya |\[Em]ho \[<*>]{} \altchords{|B\flt{} |C |B\flt{} C |Dm}
    \endrep
  \endverse
  \notesoff
  \textnotefornext{suomeksi:}
...
\beginsong{Over the Rainbow}[id={over-the-rainbow-1m6rnp},ititle={Somewhere Over the Rainbow},by={Harold Arlen, lyrics by: Yip Harburg, version by: Israel Kamakawiwo'ole},key={G},gk={A, (G)--(B\flt{})},ph={IV}]
  % intro
  \mnbeginverse[1]
...
\beginsong{Nature Boy}[id={nature-boy-p5uk86},by={Eden Ahbez},key={Dm},gk={Cm, (Bm)--(C\shrp{}m)--(Dm)},ph={III}]
  \meter{3}{4}
  % verse 1:
  \beginverse
    \[^<A>]There |\[<A>Dm]was \[^<F>]a \[^<D>]boy \altchords{\id[1]{(Bm)}|Bm}
    |\[Gm] \[^<A>]A \[^<E>]ve\[^<F>]ry \[^<G>]strange, \[^<B&>]en|\[<A>Dm]chan\[^<F>]ted \[^<D>]boy \altchords{|Em |Bm}
    |\[Gm] \[^<A>]They \[^<E>]say \[^<F>]he \[^<G>]wan\[^<B&>]dered |\[<A>Dm]ve\[^<D>]ry \[<C#>A]far \altchords{|Em |Bm F\shrp{}}
    |\[<A>Dm7]Ve\[^<C>]ry \[<B>D\textdegree7]far, |\[<G>Gm]o\[^<B&>]ver \[<A>Dm]land \[^<D>]and |\[<E>Em7&5]sea \altchords{|Bm7 B\textdegree7 |Em Bm |C\shrp{}m7\flt{}5}
    \[^<A>]A |\[<A>A]lit\[^<G>]tle \[^<E>]shy |\[A7]{ }{ }{ } \[^<A>]and |\[<G>Dm]sad \[^<F>]of \[^<D>]eye | \e \altchords{|F\shrp{} |F\shrp{}7 |Bm | \e}
    \[^<G#>]But |\[<F>E]ve\[^<E>]ry \[^<B>]wise |{ }{ }{ } \[^<C>]was |\[<C#>A]he |\[A7] \e \altchords{|C\shrp{} | | F\shrp{} | F\shrp{}7}
  \endverse
  \notesoff
  % verse 2:
  \beginverse
    ...
    |^ And as we spoke of |^many ^things, \altchords{|Em |Bm F\shrp{}}
    |^Fools and ^kings, |^this he ^said to |^me: \altchords{|Bm7 B\textdegree7 |Em Bm |C\shrp{}m7\flt{}5}
    ``The |^greatest thing |^{ }{ }{ } you'll |^ever learn | \e \altchords{|F\shrp{} |F\shrp{}7 |Bm | \e}
    \noteson
    \[<G#>]Is |\[<F>E]just \[<E>]to \[<B>]love |\[<B&>Gm7]and \[<G>]be \[<F>]loved \[<C#>A7]in \[<E>]re|\[<D>Dm]turn'' | \e \altchords{|C\shrp{} |Em7 F\shrp{}7 | Bm | \e}
  \endverse
