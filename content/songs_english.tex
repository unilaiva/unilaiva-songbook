...
\beginsong{Heart's Mystery}[by={Nick Barber}, ah={111}]
  ...
  \beginverse
    ...
    All |beings are |\[Fmaj7]healed so |natural|\[C]ly | | \hfill When\ldots
  \endverse
  \beginverse
    |^ Let your |light show the |^way
    For|ever to |^stay in the |circle of |^friends | |
    |^ Let your |heart be your |^guide
    To |lead you in|^side where |love never |^ends | | \hfill When\ldots
  \endverse
  \beginverse
    |^ And when |love over|^flows
    You can |only let |^go and be |swept out to |^sea | |
    |^ This |journey will |^end
    Where it |started my |^friend: in the |heart's myste|^ry | | \\ \hfill When\ldots
  \endverse
\endsong
