...
\beginsong{Spirit}[by={Rainer Scheurenbrand}, ph={I}]
  % Audio: https://rainerscheurenbrand.bandcamp.com/track/spirit
  % Audio: https://www.youtube.com/watch?v=70M8K3PSWzw
...
\beginsong{Spirit of the Plants}[by={Lisa Thiel},ph={II}]
  \beginchorus % \begin{small}\echo{\up{2}wind, \up{3}earth, \up{4}sea\ldots}\end{small}
