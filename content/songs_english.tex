...
\beginsong{Heart's Mystery}[by={Nick Barber},tags={heart},ph={III},key={C},gk={C, G--D}]
  ...
  \mnbeginchorus
    ...
    \ind \[\mn{E}]The |\[\mn{G}]truth \[\mn{F}]will \[\mn{E}]ap|\[\mnc{D}Dm]pear
    \ind So |\[\mn{F}]sim\[\mn{E}]ple \[\mn{D}]and |\[\mnc{C}C]clear | \e
  \mnendchorus
  \beginverse
    |\[Fmaj7]{} \[^\mn{F}]There's a |fee\[^\mn{G}]ling \[^\mn{A}]in|\[\mnc{C}C]side
    \[^\mn{G}]So |deep \[^\mn{F}]and \[^\mn{E}]so |\[\mnc{C}Fmaj7]wide, \[^\mn{E}]so |o\[^\mn{F}]pen \[^\mn{G}]and |\[\mnc{C}C]free | \e
