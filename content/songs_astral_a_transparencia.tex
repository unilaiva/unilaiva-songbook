...
\beginsong{Junto?}[by={Lari Natri}, key={Am}, gk={Am, Gm--G\shrp{}m--(Am)}, tags={valsa}, off={todos os amigos}]
  ...
  \mnbeginchorus\memorize
    ...
    Da \[^\mn{E}]mes\[^\mn{F}]ma |\[\mnc{E}E]for\[^\mn{D}]ma \[^\mn{C}]por \[^\mn{B}]um |\[\mnc{C}C \ac(2){Am}]tem\[^\mn{/}]po? \rrep
  \mnendchorus
  \notesoff
  \beginchorus
  ...
  \beginchorus
    ...
    Agora\jw e |^sentir \emph{paz} por um |^tempo. \rrep \altchords{|A |F \ac(2){Dm}}
  \endchorus
  \begin{lilywrap}\begin{lilypond}[]
    % transcribed by larva, latest update on 2024-11
    % \header {
