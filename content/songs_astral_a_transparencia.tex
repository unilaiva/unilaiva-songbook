...
\beginsong{Força da Cura}[by={Lari Natri}, key={Am}, gk={Am, (Em)--(Gm)}, tags={valsa}]
  ...
  \mnbeginverse
    \beginrep
    \beginrep |\[\mnc{E}Am]Oh! |\[\mnc{D}G]For\[^\mn{C}]ça \[^\mn{B}]da |\[\mnc{A}Am]Cu\[^\mn{E}]{ra, e}|\[\mncii{F}{E}Dm]leva \[^\mn{D}]meu |\[\mnc{E}Am]can\[^\mn{A}]to |\[\mnc{B}E7]às \[^\mn{C}\mn{D}]{\emph{al}}|\[\mnc{E}Am]tu|ras! \endrep
  ...
  \beginverse
    \beginrep
    \beginrep |^Oh! |^Força da |^Cura, |^abra meu |^cora|^ção para a|^mor! | \e \endrep
