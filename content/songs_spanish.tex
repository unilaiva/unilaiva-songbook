...
\beginsong{En la selva un río}[by={Kike Pinto},tags={healing 1}]
  ...
  \beginverse
    ...
    \chorusindent la |\[Em]vigilan desde la espe|\[G]sura, |
    \chorusindent |\[Am] los jagua\[Bm]res y las |\[Em]boas.
    \chorusindent la |\[Em]protegen desde la espe|\[G]sura, |
    \chorusindent |\[Am] los jagua\[Bm]res y las |\[Em]boas.
    Trai nanai na|\[Bm]nai nanai |\[Em]nai Nanai nanai \[G]nai |
    |\[Am] va surcan\[Bm]do una ca|\[Em]noa
    Trai nanai na|\[Bm]nai nanai |\[Em]nai Nanai nanai \[G]nai |
    |\[Am] mil jagua\[Bm]res y mil |\[Em]boas | | | | -
  \endverse
  \beginverse
    \chorusindent \lrep U|^na voz me canta en el o|^ído |
    \chorusindent |^ una bel^la melo|^día, \
    \chorusindent y u|^na luz dibuja ante mis |^ojos |
    \chorusindent |^ visiones de ^un nuevo |^día,
    \chorusindent y u|^na luz dibuja ante tus |^ojos |
    \chorusindent |^ visiones de ^un nuevo |^día.
  ...
  \endverse
  \beginverse
    \chorusindent \lrep El |^viento me trae un dulce a|^roma |
    \chorusindent |^ alcanfo^res y azu|^cenas, \rrep
    \chorusindent y a|^lza el vuelo en mi alma una pa|^loma |
    ...
    Trai nanai na|^nai nanai |^nai Nanai nanai ^nai |
    |^ rompe rom^pe las ca|^denas | | | | -
  \endverse
  \beginverse
    \chorusindent \lrep Re|^ma rema rema cano|^ero |
    \chorusindent |^ por los ^ríos de mis |^venas. \rrep
    \chorusindent can|^ta canta canta curan|^dero, |
    \chorusindent |^ cura cu^rame mis |^penas.
    \chorusindent so|^pla sopla sopla perfu|^mero, |
    \chorusindent |^ rompe ^rompe mis ca|^denas.
    Trai nanai na|^nai nanai |^nai Nanai nanai ^nai |
    |^ alcanfo^res y azu|^cenas
    Trai nanai na|^nai nanai |^nai Nanai nanai ^nai |
    |^ por los ri^os de mis |^venas | | | | -
  \endverse
  \begin{translation}
