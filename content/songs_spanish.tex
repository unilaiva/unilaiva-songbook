...
\beginsong{Amor y Unidad}[by={Bóveda Celeste},ph={III}]
  ...
  \begin{center}%
    \vfill%
    \includegraphics[width=0.236\textwidth]{eagle_feather_bw_transparent_bg_1280x442px.png}%
    \vfill%
  \end{center}
\endsong
...
\beginsong{Lunita}[by={Danit Treubig},tags={moon 1},ph={II}]
  ...
  \begin{center}%
    ...
    \includegraphics[width=0.236\textwidth]{moon_bw_transparent_bg_939x939px.png}%
    \vfill%
  \end{center}
  \begin{translation}
    Moon, queen of night
...
\beginsong{Tzen Tze Re Rei}[by={Nase Chiriap},ex={shuar, español},ph={III, IV}]
  ...
  \beginverse
    \chorusindent |\[\noteU{E}]Rei \[\noteU{D}]rei |\[\noteU{C}]rei
    \chorusindent \textsuperscript{¤}(Tzen tze re|\[C]rei rei |rei) \hfill{\small \textsuperscript{¤}Skip this line if coming from \emph{``\ldots junto a ti''}}
...
\beginsong{Señora mi Señora}[by={Santiago Andrade, Irina Flores},ex={español, nahuatl},tags={Divine Mother 1},ph={II}]
  ...
  \begin{center}%
    \vfill%
    \includegraphics[width=0.618\textwidth]{snake_sa_bw_transparent_bg_960x262px.png}%
    \vfill%
  \end{center}%
\endsong
