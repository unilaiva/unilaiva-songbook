...
\beginsong{Sirenita Bobinzana}[by={Artur Mena}, ph={III, IV}, key={Am}, sks={G\#m, Gm--Am}]
  ...
  \beginchorus\memorize[chords_sirenita_a]
    \[^\mn{A}]Sire\meter{3}{4}|\[F]nita \[^\mn{C}]de \[^\mn{A}]los |\[C]r\[^\mn{G}]í\[^\mn{E}]os, \[^\mn{G}]danza |\[\mncii{A}{G}Em7]dan\[^\mn{E}]za \[^\mn{D}]con \[^\mn{E}]el |\[\mncii{C}{A}Am]viento \meter{2}{4}| \e
  \endchorus\glueverses\beginchorus\memorize[chords_sirenita_b]
    Con tus \meter{3}{4}|\[C]flores y a|romas, perfu|mas los \[E7]cora|\[Am]zones \meter{2}{4}| \e
  \endchorus
  \notesoff
  \beginchorus\replay[chords_sirenita_a]
    Cura \meter{3}{4}|^cura cuerpe|^citos, limpia |^limpia espiri|^titos \meter{2}{4}| \e
