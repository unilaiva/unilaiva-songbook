...
\beginsong{Plantas Sagradas}[by={Danit Treubig},ph={IV}]
  ...
  \notesoff
  \beginchorus
    \chorusindent |\[\textsuperscript{1}C]\[\textsuperscript{2}(F)] \[F]Siento |vivo, |\[Am]siento la |paz, |
    \chorusindent |\[\textsuperscript{1}C]\[\textsuperscript{2}(F)]siento \[F]el po|der de la |\[Am]mad|re. |
  \endchorus
  \beginchorus
