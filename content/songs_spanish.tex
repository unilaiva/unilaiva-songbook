...
\beginsong{Lunita}[by={Danit Treubig},tags={moon},ph={II}, key={Am}, gk={Gm, Gm--Bm}]
  ...
  \endverse
  \beginverse
    \ind \[\mn{C}]En tu |\[Fmaj7]luz \[\mn{E}]todo el mundo |\[C]bril\[\mn{C}]la, en tu a|\[Fmaj7]brazo \[\mn{E}]la tierra |\[C]can\[\mn{C}]ta
...
\beginsong{Oso Blanco}[by={Bóveda Celeste}, ph={III}, key={Am}, gk={Am, Gm--C\shrp{}m}]
  ...
  \endchorus
  \begin{translation}\iflyriconly\else\footnotesize\fi % to fit on one page in chorded booklets
...
\beginsong{Sirenita Bobinzana}[by={Artur Mena}, ph={III, IV}, key={Am}, gk={G\shrp{}m, Gm--Am}]
  ...
  \endchorus\glueverses\beginverse\replay[chords_sirenita_b]
    ...
    Danza\meter{3}{4}|^remos muy jun|titos sire|nita ^Bobin|^zana \meter{2}{4}| \e
  \endverse
  \begin{translation}\iflyriconly\else\footnotesize\fi % to fit on one page in chorded book
...
\beginsong{Madre Selva}[by={Grupo Putumayo}, tags={Mother Earth}, ph={IV}, key={Dm}, gk={Cm, Bm--Em}]
  ...
  \endchorus
  \beginchorus\replay[chords_madreselva_a]\rep{4}
...
\beginsong{Sol de la Mañana}[by={Bóveda Celeste}, ph={IV}, key={Em}, gk={F\shrp{}m}]
  ...
  \beginchorus
    ...
    |Canta cantor|cito mari|ri-ri-ri-ri-|ri-ri-ri-ri-|riii | | | \e \altchords{| - | - | - | - | - | - | - | \e}
  \endchorus
  \begin{translation}%\footnotesize % make translation smaller to fit on a spread
