...
\beginsong{Señora mi Señora}[by={Santiago Andrade, Irina Flores},ex={español, nahuatl},tags={Divine Mother 1}]
  ...
  \begin{explanation}
    \textbf{Tonāntzin} is the title for the Aztec Mother Goddess, by which Goddesses such as "Mother Earth",
     ...
     can be called, as it is an honorific title comparable to \textit{Our Lady} or \textit{Our Great Mother}.
  \end{explanation}
\endsong
...
\beginsong{Águila Aguilé}[]
  ...
  \beginverse
    ...
    Es mi a|^buela \textsuperscript{*}que canta, | |^canta enamorada | - \hfill{\footnotesize\textit{\textsuperscript{*}Ayahuasca}}
  \endverse
  \beginverse
    Ese |^pájaro | es mi a|^buelo | -
    Es mi a|^buelo \textsuperscript{*}que canta, | |^canta enamorado | - \hfill{\footnotesize\textit{\textsuperscript{*}Peyote}}
  \endverse
  \beginverse
