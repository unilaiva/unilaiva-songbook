...
\beginsong{Colibrí Dorado}[by={Arnaldo Herrera}, ph={III}, key={Dm}, sks={Cm, Cm--Em}]
  ...
  \transpose{5}\preferflats % for Bb instead of A#
  \beginchorus
...
\beginsong{Espíritu Eterno \\ Cayarírirí}[by={Darío Poletti}, ph={III, IV}, key={Em}, sks={Gm, F\#m--Gm}]
...
\beginsong{Como Te Quiero Yo}[by={Irina Florez},ph={III, IV}, tags={love}, key={Dm}, sks={C\#m, Cm--Em}]
  \transpose{5}
...
\beginsong{Todo es mi Familia}[by={Alonso del Río}, tags={unity}, ph={IV}, key={Dm}, sks={Dm, Cm--F\#m}]
...
\beginsong{Cuñaq}[by={Miguel Molina}, tags={water}, ph={IV}, key={Am}, sks={Am, Gm--Bm}]
  ...
  \beginchorus\memorize % memorize chords even though in "chorus"
    |\[\mnc{A}Am]Des\[^\mn{E}]de Cuñaq viene | \[^\mn{G}]a|güi\[^\mn{E}]ta ser\[^\mn{D}]pen\[C]te\[^\mn{C}]ando \altchords{\id[1]{(Gm)}|Gm | | - Bb}
    |Por las a\[Em]cequias |y en remo\[Am]linos \altchords{| - Dm | - Gm}
    |\[C]Hacia nuestras \[Am]vidas | \e \altchords{|Bb Gm | \e}
  \endchorus
  \notesoff
  \beginchorus\noteson
    \ind |\[\mnc{E}Am]De \[\mn{D}]can\[\mn{C}]tar \[\mn{A}]hua\[\mnc{C}C]li\[\mn{A}]nas |y a \[\mn{B}]la \[\mn{C}]vez \[\mn{D}]llo\[\mnc{E}Em]rando \altchords{|Gm Bb | - Dm}
    \ind |Toditas mis \[G]pe|nas se aca\[Am]baron \altchords{| - F | - Gm}
    \ind | Pacha\[C]mama está de |\[Am]fiesta | \e \altchords{| - Bb |Gm | \e}
  \endchorus
  \beginchorus
...
\beginsong{Luna Manta \\ Pachamama}[by={Andrés Córdoba}, tags={Mother Earth}, ph={IV}, key={Am}, sks={Cm, G\#m--Em}]
...
\beginsong{Sol de la Mañana}[by={Bóveda Celeste}, ph={IV}, key={Em}, sks={F\#m}]
  \audio[key={Bm}]{https://www.youtube.com/watch?v=gTGygs833d0}
  \capo{2}
  \transpose{-5}
  \beginchorus
    |\[\mnc{E}Am\mn{C}]Bri|lla, |\hspace{0.5em} \[\mn{E}]bril\[\mn{c}]la y |\[\mn{D}]can\[\mn{E}]ta un \[\mn{C}]nue\[\mn{B}]vo |\[\mn{A}]día | \e \altchords{\id[1]{(F\#m)}|F\#m | - | - | - | - | \e}
  ...
  \endchorus
  \beginchorus
    \[\mn{E}]Can|\[\mnc{A}Am]tar, |\hspace{0.5em} \[\mn{E}]can|\[\mn{A}]tar | \e \altchords{|F\#m | - | - | \e}
