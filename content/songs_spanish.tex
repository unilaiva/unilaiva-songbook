...
\beginsong{Todo es mi Familia}[tags={unity 1},ph={III, IV}]
  \beginchorus
    \[\mn{E}]Ca|\[\mnc{A}A]minaré en belleza, ca|minaré en paz
...
%  \endchorus
  \beginchorus\memorize
    |\[\mnc{E}C]Soy \up{*}un hijo de la |\[\mnciii{F}{E}{D}Fmaj7]tierra, mi |\[G]corazón es una es|\[C]trella
...
\beginsong{Ani Qu Ne'}[ex={tsalagi gawonihisdi, español},tags={Moon 1, fire 1},ph={I, II}]
  \meter{4}{4}
  \beginchorus
    \chorusindent |\[\mnc{A}Am]Ani \[\mnc{D}Dm]qu ne' |\[E7]chawu'na\[Am]ni \rep{2}
...
\beginsong{Madre Selva}[by={Grupo Putumayo},tags={Mother Earth 1},ph={IV}]
  \beginchorus
    \[\mn{A}]Mad\[\mn{B}]re |\[\mnc{C}Am]Tierra Madre \[ .]Tierra yo te a|\[F]labo Madre \[ .]Tierra
...
\beginsong{Elevo mi Canto}[by={Mariana Root},ph={I}]
  \beginchorus\memorize
    \[^\mn{A}]E|\[\mnc{E}Am]levo mi canto al |\[Em]cielo, yo elevo |\[Am] elevo mi |\[Em]voz
...
\beginsong{Abre tus Alas}[by={Nina},tags={path 1, flying 1},ph={II, III}]
  \beginchorus
    \[\mn{E}]Abre tus |\[\mnc{G}Em\mn{E}]alas \[\mn{G}]pájaro vo|\[\mnc{F#}B7]lar
...
\beginsong{Cuatro Vientos}[by={Danit Treubig},tags={wind 1},ph={I, II}]
  \beginchorus\memorize
    |\[\mnc{A}Am]Vien\[^\mn{E}]to | que |\[G]viene de la mon|\[Em]taña;
...
\beginsong{Tzen Tze Re Rei}[by={Nase Chiriap},ex={shuar, español},ph={III, IV}]
  ...
  \endverse
  \beginverse
    \chorusindent |\[\mn{E}]Rei \[\mn{D}]rei |\[\mn{C}]rei
    \chorusindent \up{¤}(Tzen tze re|\[C]rei rei |rei) \altlyr[¤]{\emph{Skip this line if coming from} ``\ldots junto a ti''}
