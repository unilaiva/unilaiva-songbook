...
\beginsong{Bienvenidos Hermanitos}[by={Daniel Osorio},ah={164},tags={Mother Earth 1, Sun 1}]
...
\beginsong{Ábrete corazón}[by={Rosa Giove}]
  \capo{3}
  \beginchorus
    |\[C] Ábrete cora|zón, |\[Am] ábrete senti|miento |
    |\[Fmaj7] ábrete entendi|miento, deja a un |\[C]lado la ra|zón
    y |\[G]deja brillar el |sol escon|\[Fmaj7]dido | en tu inte|\[C]rior | | | |
  \endchorus
  \beginverse
    |\[Fmaj7]Ábrete memoria an|tigua escon|\[G6]dida en la |tierra
    en las |\[F]plantas, | en el |\[G]aire | -
    Re|\[Fmaj7]cuerda lo que apren|diste, bajo |\[G6]agua, bajo |fuego
    hace |\[F]ya, | ya mucho |\[G]tiempo | |
  \endverse
  \beginverse
    Ya es |\[C]hora ya, ya es |\[Em]hora | abre la mente y re|\[G]cuerda
    como el e|\[Em]spíritu cura, como el |\[Am]amor sana |
    |\[F] como el árbol flo|\[G]rece y la \lrep|\[Fmaj7]vida | per|\[G6]dura | | \rrep
  \endverse
  % % extra verse:
  % \beginverse
...
\beginsong{Ayahuasca Takimuyki}[by={Shimshai, Don José Campos}, ah={152}, ex={quechua, español},tags={Ayahuasca 1}]
...
\beginsong{Nadi wewe}[ah={165},tags={Ayahuasca 1}]
  \beginverse
