...
\beginsong{Bienvenidos Hermanitos}[by={Daniel Osorio},tags={morning, Mother Earth, Sun},ph={V}]
...
\beginsong{Niño Salvaje}[index={Soy un Hijo de la Tierra},by={Alberto Kuselman},tags={unity},ph={IV}]
  % See: https://www.youtube.com/watch?v=02DM-kESGzY
  % See: https://www.youtube.com/watch?v=OTJd02cGq10
  \beginchorus\memorize
...
\beginsong{Ani Qu Ne'}[ex={tsalagi gawonihisdi, español},tags={Moon, fire},ph={I, II}]
  \meter{4}{4}
  \beginchorus
    \chorusindent |\[\mnc{A}Am]Ani \[\mnc{D}Dm]qu ne' |\[\mnc{E}E7]cha\[\mn{C}]wu'\[\mn{B}]na\[\mnc{A}Am]ni \rep{2}
...
\beginsong{En el Cielo y en la Tierra}[by={Isabel Ruiz},tags={Mother Earth, fire},ph={II}]
  \beginchorus\memorize
...
\beginsong{Estrella Azul}[by={Narayan Dass}, tags={stars}, ph={II}]
  % See: https://maureenji.bandcamp.com/track/estrella-azul (Cm in A=432Hz)
  % See: https://soundcloud.com/bettinamaureenji/estrella-azul
  \meter{3}{4}
  \beginchorus\memorize
  ...
  \endchorus
  \beginchorus
    Me re|^galas su es|trela bri|llante a|^zul
    |^Yo la |^uso a|^si | \e
...
\beginsong{Taita Inti Padre Sol}[by={Ramón Peregrino}, tags={Sun}, ph={II}]
  % See: https://soundcloud.com/caminorojo/taita-inti-padre-sol-1
  \beginchorus\memorize
...
\beginsong{El Viejo Tambor}[by={Alonso del Río},tags={path, heart},ph={II, III}]
  % See: https://www.youtube.com/watch?v=PTU8DtcFKO4
  % See: https://soundcloud.com/makaruja/el-viejo-tambor
  \beginverse
  ...
  \notesoff
  \beginverse
    \chorusindent |\[Dm] Y voy can|tando por mi ca|\[F]mino
    \chorusindent Me va ale|grando un viejo \[G]tam|\[Am]bor | | | \e
    \chorusindent |\[Dm] Vivo dan|zando por mi ca|\[F]mino
    \chorusindent Me va gui|ando un viejo \[G]tam|\[Am]bor | | | \e
  \endverse
  \beginchorus
...
\beginsong{Corazón es lo Único que Tengo}[by={Nubia Rodriguez},tags={heart}, ph={IV}]
  %\transpose{5}
  \meter{6}{8}
  \beginchorus\memorize
...
\beginsong{Lunita}[by={Danit Treubig},tags={moon},ph={II}]
