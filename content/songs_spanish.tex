...
\beginsong{Abre tus Alas}[by={Nina Almar}, tags={path, flying}, ph={II, III}, key={Em}, gk={Em, Dm--Gm}]
  ...
  \beginverse
    ...
    \ind El sol y las es|\[B7]trellas son mi guía cami|\[Em]nar \[\ac(1){E7}]
    \endrep
  \endverse
  \beginverse
    \beginrep
  ...
  \beginverse
    ...
    \ind Emprendiendo el ca|\[B7]mino de amor y la ale|\[Em]gría \[\ac(1){E7}]
    \endrep
  \endverse
\begin{translation}[EN]
...
\beginsong{Amor y Unidad}[by={Bóveda Celeste}, ph={III}, key={Am}, gk={Am, Em--Am}]
  ...
  \mnbeginverse
    \beginrep
    \ind \[\bmc\mn{C}]Que \[\mn{B}]co|\[\mnc{A}F]me\[\mn{F}]nta \[\bm]que el a|mor es
    \ind \[\bmc\mn{C}]com\[\mn{B}]par|\[\mncii{A}{E}C]tir lo \[\bm]que hay \[\mn{D}]en |\[\mn{E}\mn{D}\mn{C}]ti \[\bm]
    \ind \[\mn{D}]es |\[\mnc{E}Em]nuestra na\[\bm]tura\[\mnc{G}]le|\[\mncii{F}{E}]{-za,} \[\bm]nues\[\mn{D}]tra\jw
    \ind e|\[\mnc{E}Am]sencia \[\bm]más \[\mn{D}]su|\[\mn{E}]til
    \endrep
  \mnendverse
  \beginverse
    \beginrep
  ...
  \beginverse
    \beginrep
    \ind \[\bm]Que nos |\[F]dice \[\bm]que ve|nimos de \[\bm]la misma
    \ind |\[C]fuente y del \[\bm]mismo lu|gar \[\bm]
    \ind to|\[Em]dos somos \[\bm]de la ti|erra,
    \usealtmnstyletrue{}\ind del |\[\mnc{C}Am]agua, del \[\bm]fuego y \[\mn{G}]del |\[\mn{A}]aire
    \endrep
  \endverse
  \begin{translation}[EN]
...
\beginsong{Vuela con el Viento}[by={Ayla Schafer},tags={flying},ph={III}, key={Dm}, gk={Dm, Cm--Em}]
  ...
  \beginverse
    \beginrep
    \ind[2] |\[Em]{} \[\mn{B}]Vue\[\mn{A}]la \[\mn{G}]con \[\mn{A}]el |\[D]vien\[\mn{D}]to, |\[C]{} \[\mn{B}]vue\[\mn{A}]la \[\mn{G}]con \[\mn{A}]el |\[D]vien\[\mn{D}]to
    \endrep
  \endverse
  \notesoff
  \beginverse
...
\beginsong{La Semilla\\Be in the Now}[by={Shimshai},tags={love, heart}, ph={III}, key={Dm}, gk={Dm, Cm--Em}]
  ...
  \beginverse\memorize[chords_lasemilla_a]
    ...
    \endrep
  \endverse\glueverses\beginverse\memorize[chords_lasemilla_b]
    \beginrep
  ...
  \endverse\glueverses\beginverse\memorize[chords_lasemilla_c]
    ...
    \endrep
  \endverse
  \beginverse\memorize[chords_lasemilla_d] % memorize chords into a named register
  ...
  \beginverse\replay[chords_lasemilla_a]
    ...
    \endrep
  \endverse\glueverses\beginverse\replay[chords_lasemilla_b]
    \beginrep
  ...
  \endverse\glueverses\beginverse\replay[chords_lasemilla_c]
    ...
    \endrep
  \endverse
  \beginverse\replay[chords_lasemilla_d] % replay chords from a named register
...
\beginsong{Guacamayo}[by={Danit Treubig}, ph={IV}, key={Am}, gk={C\shrp{}m, Bm--D\shrp{}m}]
  ...
  \mnbeginverse
    \beginrep
      ...
      \ind |\[\mnc{B}G]que me enseña e|\[\mauiic{A}{G}\ac(1)Em \ac(2){Am}]ternamente
    \endrep
  ...
  \mnbeginverse
    \ifchorded\renewcommand{\repbarcontinuingoverlap}{\the\dimexpr 1\baselineskip\relax}%
    \else\renewcommand{\repbarcontinuingoverlap}{\the\dimexpr 2\baselineskip\relax}%
    \fi%
    \beginrep
      \beginrep\prep{4}
      ...
      \endrep
      \vspace{1.5em}% not more to keep the line repeat continuous
...
\beginsong{Cuñaq}[by={Miguel Molina}, tags={water}, ph={IV}, key={Am}, gk={Am, Gm--Bm}]
  ...
  \beginverse
    \beginrep\noteson
    \ind |\[\mnc{E}Am]De \[\mn{D}]can\[\mn{C}]tar \[\mn{A}]hua\[\mnc{C}C]li\[\mn{A}]nas |y a \[\mn{B}]la \[\mn{C}]vez \[\mn{D}]llo\[\mnc{E}Em]rando \altchords{|Gm B\flt{} | - Dm}
