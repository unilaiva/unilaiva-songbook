...
\beginsong{Cuatro Vientos}[by={Danit Treubig}, tags={wind}, ph={I, II}, key={Dm}, sks={C\shrp{}m, Bm--Em}]
...
\beginsong{Cuando la Luna}[by={Keya Maria}, tags={moon}, ph={II}, key={Em}, sks={Em, Dm--F\shrp{}m}]
...
\beginsong{Tierra, tan Sólo}[by={Marta Gómez, Federico García Lorca}, ph={II}, tags={earth}, key={Em}, sks={F\shrp{}m, Em--Gm}]
...
\beginsong{Ayahuasca Ayní}[by={Diego Palma}, tags={Aya}, ph={II}, key={Bm}, sks={C\shrp{}m, Bm--Dm}]
...
\beginsong{Abrete Corazón}[by={Rosa Giove}, tags={opening}, ph={II, III}, key={F}, sks={F, D\shrp{}--G}]
...
\beginsong{Mira como Cura}[by={Alonso del Río},tags={water, air, fire, earth}, ph={III}, key={Am}, sks={Gm, Gm--Am}]
...
\beginsong{Pachamama Pachacamaq}[by={Kike Pinto}, tags={Mother Earth, thankfulness, you}, ph={III}, key={Am}, sks={B\flt{}m, Am--Cm}]
  ...
  \beginverse\memorize[chords_pachamamacamaq_a]
    \[^\mn{B}]Pac\[^\mn{D}]ha|\[\mnc{E}C]mama |Pacha|\[^\mn{G}]ca\[^\mn{E}]maq, | \[^\mn{B}]luz \[^\mn{D}]de |\[^\mn{E}]vida, |\[\mnc{A}Fmaj7]luz \[^\mn{G}]de a|\[\mnc{E}C]mor | \e
...
\beginsong{Luna Manta \\ Pachamama}[by={Andrés Córdoba}, tags={Mother Earth}, ph={IV}, key={Am}, sks={Cm, G\shrp{}m--Em}]
...
\beginsong{Como Te Quiero Yo}[by={Irina Florez},ph={III, IV}, tags={love}, key={Dm}, sks={C\shrp{}m, Cm--Em}]
  \transpose{5}
...
\beginsong{Todo es mi Familia}[by={Alonso del Río}, tags={unity}, ph={IV}, key={Dm}, sks={Dm, Cm--F\shrp{}m}]
...
\beginsong{Cuñaq}[by={Miguel Molina}, tags={water}, ph={IV}, key={Am}, sks={Am, Gm--Bm}]
...
\beginsong{Plantas Sagradas}[by={Danit Treubig}, ph={IV}, key={Am}, sks={Am, Am--Bm}]
...
\beginsong{Buscando el Camino}[by={Karin Micha},tags={path}, ph={IV}, key={Am}, sks={Am}]
...
\beginsong{El Duende}[by={Camino Rojo}, ph={IV}, key={Dm}, sks={Cm, Cm--Em}, tags={elements}]
  \meter{6}{8}
...
\beginsong{Camino Rojo}[tags={path}, ph={IV}, key={Am}, sks={Am, Gm--D\shrp{}m}]
...
\beginsong{Wirikuta}[ititle={Pachamama}, tags={Mother Earth, Sun}, ph={IV}, key={Am}, sks={Bm, Am--C\shrp{}m}]
  \beginverse
    |\[\mnc{E}Am]Pacha|\[\mn{G}]ma\[\mn{E}]ma |\[\mnc{D}G]pa\[\mn{C}]cha|\[\mnc{B}Am]ma\[\mn{A}]ma \altchords{\id[1]{(Bm)}|Bm | - |A |Bm}
    |\[Am]Pacha|mama |\[G]madre |\[Am]tierra \altchords{|Bm | - |A |Bm}
  \endverse
  \beginchorus\memorize % memorize chords here instead of the non-chorus verse above
    |\[\mnc{E}Am]Wiri\[^\mn{C}]ku\[^\mn{A}]ta |\[\mnc{D}G]Wiri\[^\mn{G}]ku\[\mnc{E}Am]ta |\[\mnc{C}C]Wiriku\[\mnc{D}Dm]ta |\[\mnc{G}E7]Gran E\[^\mn{C}]spí\[^\mn{B}]ri\[\mnc{A}Am]tu
      \altchords{|Bm |A Bm |D Em |F\shrp{}7 Bm}
  \endchorus
  \notesoff
