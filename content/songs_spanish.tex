...
\beginsong{A li kuni}[ex={shipibo, español}]
  \meter{4}{4}
  \beginchorus
  ...
  \end{translation}  
  \begin{center}
    \includegraphics[width=0.3\textwidth]{moon_bw_transparent_bg_1600px.png}
  \end{center}
\endsong
...
\begin{intersong}
  \vfill
  \begin{center}
    \includegraphics[width=0.9\textwidth]{snake_sa_bw_transparent_bg_960x720.png}
  \end{center}
\end{intersong}
