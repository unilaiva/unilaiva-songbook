...
\beginsong{Luz del Bosque}[by={Adrian Freedman},tags={light 1},ph={III, IV}]
  ...
  \beginchorus\replay[chords_luzdelbosque_a]
    Transfor|^mamos el dol|^or traye|^ndo todo a la l|^uz
  \endchorus\glueverses
  \beginverse\replay[chords_luzdelbosque_b]
    Con el e|^spíritu \textsuperscript{*}de la abue|^lita can|^tando toda la |^noche \replay
    Con la a|^yuda \textsuperscript{¤}de la madre|^cita can|^tando toda la |^noche | |
  \endverse
  \vspace{1em}\hfill{\small \textsuperscript{*}del abuelito, \textsuperscript{¤}del padrecito}
  \textnote{suomeksi:}
  \beginchorus\replay[chords_luzdelbosque_a]
  ...
  \endchorus\glueverses
  \beginverse\replay[chords_luzdelbosque_b]
    \textsuperscript{*}Iso|^äidin |^kanssa |^laulamme läpi |^yön \replay
    \textsuperscript{¤}Äi|^din avul|^la |^laulamme koko |^yön | |
  \endverse
  \vspace{1em}\hfill{\small \textsuperscript{*}isoisän, \textsuperscript{¤}isän}
