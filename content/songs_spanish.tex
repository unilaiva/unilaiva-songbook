...
\beginsong{En el cielo y en la tierra}[tags={Mother Earth 1, fire 1}]
  \beginverse
...
\beginsong{Vuela con el Viento}[by={Ayla Schafer}]
  \meter{6}{8}
  \beginchorus\memorize
  ...
  \endchorus
  \beginchorus
    |\[Em]Cura, cura, cúrame, |\[D]sana todo lo que yo llevo |
...
\beginsong{Tlazocamati}[ah={150},ex={nahuatl, español},tags={Ayahuasca 1}]
  \beginchorus\memorize % memorize chords even though in ``chorus''
  ...
  \endchorus
  \begin{explanation}
    \textbf{Tlazocamati} means 'thank you' in Nahuatl (also known as Aztec) language, spoken nowadays in what is currently central Mexico.
  \end{explanation}
\endsong
