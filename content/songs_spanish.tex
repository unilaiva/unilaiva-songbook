...
\beginsong{Luz del Bosque}[by={Adrian Freedman},ph={III, IV}]
  % This song is apparently originally in English and by Adrian Freedman.
  \beginchorus
    |\[C\noteUL{C}]Somos \[\noteU{D}]la \[\noteU{E}]luz \[\noteU{C}]del |\[G\noteUL{G}]bosque, e|\[Dm]spíritu de todas e|\[Am]dades |
  \endchorus
  \beginchorus
    \chorusindent |\[Dm]Somos la luz di|\[C]vina, sabidu|\[G]ría de los |\[Am]mares |\textsuperscript{2}( - )
  \endchorus
  \beginchorus
    Transfor|\[C]mamos el dol|\[G]or traye|\[Dm]ndo todo a la l|\[Am]uz
  \endchorus
  \beginverse
    \chorusindent Con el e|\[Dm]spíritu \textsuperscript{*}de la abue|\[C]lita can|\[G]tando toda la |\[Am]noche
    \chorusindent Con la a|\[Dm]yuda \textsuperscript{¤}de la madre|\[C]cita can|\[G]tando toda la |\[Am]noche
  \endverse
  ...
  \begin{translation}
    ...
    \nextverse
    We transform the pain bringing everything to light
    \nextverse
