...
\beginsong{Cuatro Vientos}[id={cuatro-vientos-whb4vc},by={Danit Treubig},tags={wind},ph={I, II},key={Dm},gk={C\shrp{}m, Bm--Em}]
  ...
  \beginverse[1]
    \beginrep\noteson
      |\[\mnc{A}Am]Vuela vuela vuela vuela |\[\mn{E}]vuela vuela vue\[\mn{D}]la \altchords{|Am | \e}
...
\beginsong{Ani Qu Ne'}[id={ani-qu-ne-nqp2vs},ex={tsalagi gawonihisdi, español},tags={Moon, fire},ph={I, II},key={Am},gk={Am, Am--Dm}]
  ...
  \beginverse[1]
    \beginrep
      |\[\mnc{A}Am]Ani \[\mnc{D}Dm]qu ne' |\[\mnc{E}E7]cha\[\mn{C}]wu'\[\mn{B}]na\[\mnc{A}Am]ni \rep{2}
      |\[Dm]{A wa} \[\bm]wa bika |\[Am]na' kaye\[\bm]na \rep{2}
...
\beginsong{Lunita}[id={lunita-r00txq},by={Danit Treubig},tags={moon},ph={II},key={Am},gk={Gm, Gm--Bm}]
  ...
  \endverse
  \beginverse[1]
    \[\mn{C}]Tu |\[Fmaj7]luz, \[\mn{E}]tu clari|\[C]dad, \[\mn{C}]tu vibra|\[Fmaj7]ción, \[\mn{E}]tu armo|\[C]nía
    Tu si|\[Fmaj7]lencio, tu a|\[C]mor, pode|\[Em]rosa lu|\[Am]nita
  \endverse
  \beginverse[2]
    |\[\mncii{D}{F}Dm]Rei\[\mn{E}]na \[\mn{F}]del |\[\mnc{G}G]cie\[\mn{D}]lo, \[\mn{E}\mn{D}]te |\[\mnc{E}C]doy \[\mn{D}]mi \[\mnc{E}Em]co\[\mn{F}]ra|\[\mnc{E}Am]zón
    |\[Dm]Reina del |\[G]cielo, compa|\[C]ñera de mi \[Em]vida, de mi |\[Am]alma
  \endverse
  \beginverse[1]
    \[\mn{C}]En tu |\[\mncadj{4ex}{E}Fmaj7]{luz to}do el mundo |\[C]bril\[\mn{C}]la, en tu a|\[Fmaj7]brazo \[\mn{E}]la tierra |\[C]can\[\mn{C}]ta
    En tu |\[Fmaj7]{luz todo} el mundo |\[C]brilla, pode|\[Em]rosa lu|\[Am]nita,
    pode|\[Em]rosa abue|\[Am]lita
  \endverse
  \beginverse[3]
    \beginrep
      \[\mn{E}]Dan|\[\mnc{F}F]zar con el universo, can|\[\mnc{E}C]tar en tu sonrisa
...
\beginsong{Aguila Aguilé}[id={aguila-aguile-3egcww},ph={II},key={Am},gk={Am, Am--Dm}]
  ...
  \beginverse[1]\noteson
    \beginrep
      |\[\mncii{E}{D}C]Águi\[\mn{E}]la | |\[\mnc{D}G]águila a\[\mn{E}]gui\[\mn{D}]lé | \e
...
\beginsong{Abre tus Alas}[id={abre-tus-alas-fo4ow0},by={Nina Almar},tags={path, flying},ph={II, III},key={Em},gk={Em, Dm--Gm}]
  ...
  \beginverse[1]
    \beginrep
      \[\mn{B}]Abre tus |\[\mnc{A}Am]a\[\mn{E}]las libres y ha \[\mn{F#}]vo|\[\mncii{G}{E}Em]lar
...
\beginsong{Ayahuasca Ayní}[id={ayahuasca-ayni-n7e6pi},by={Diego Palma},tags={Aya},ph={II},key={Bm},gk={C\shrp{}m, Bm--Dm}]
  ...
  \beginverse[2]
    \beginrep
      |\[Am]{} \[\mn{E}]Nara\[\bm]naina |\[\mn{D}]Nai\[\mn{C}]ra \[\bmc\mn{B}]Nai\[\mn{A}]ra|\[\mnc{E}Em]nai Nara\[\bm]nai \[\mn{B}]Na|\[\mnc{A}Am]nai | \e
    \endrep
  \endverse
  \segno
  \beginverse
  ...
  \beginverse[1]
    \beginrep
      |\[Am]{} \[\mn{E}]Madrecita ay|\[\mnc{D}G]ní, | madrecita |\[\mnc{E}Am]cú\[\mn{D}]ra\[\mn{C}]nos
    \endrep
  \endverse
  \beginverse
    \beginrep
...
\beginsong{Abrete Corazón}[id={abrete-corazon-dhunqo},by={Rosa Giove},tags={opening},ph={II, III},key={F},gk={F, D\shrp{}--G}]
  ...
  \beginverse
    \beginrep
      |\[G]{} \ilsl{\[\mn{B}]Ábrete} \[\mn{A}]co\[\mn{G}]ra|zón, |\[Em]{} \[\mn{B}]ábrete \[\mn{A}]sen\[\mn{G}]ti|\[\mn{B}]mien\[\mn{G}]to
...
\beginsong{El Viejo Tambor}[id={el-viejo-tambor-ovxglq},by={Alonso del Río},tags={path, heart},ph={II, III},key={Am},gk={Bm, Am--Dm}]
  ...
  \notesoff
  \beginverse[1]\noteson
    |\[Dm]{} \[\mn{D}]Y voy can|tando por mi \[\mn{E}]ca|\[\mnc{C}F]mi\[\mn{A}]no
...
\beginsong{Mira como Cura}[id={mira-como-cura-0wf3iu},by={Alonso del Río},tags={water, air, fire, earth},ph={III},key={Am},gk={Gm, Gm--Am}]
 \audio[key=Em]{https://www.youtube.com/watch?v=rvfY9tUHTYA}
  ...
  \endverse
  \beginverse[1]
    |\[F]{} \[\mn{A}]Que Willka|mayu traiga \[\mn{G}]las |\[\mnc{E}C]notas
...
\beginsong{Amor y Unidad}[id={amor-y-unidad-zoleig},by={Bóveda Celeste},ph={III},key={Am},gk={Am, Em--Am}]
  ...
  \mnbeginverse
    \beginrep
      |\[\mauiic{G}{E}Em]Corren dos \[\bm]liebres a|\[\mauii{A}{G}]tra\[\mauii{G}{F}]ve\[\bmc{\renewcommand\mntagtext{1,2}\mn{E}}]san\[\mn{D}]{do\jw el}
      |\[\mauiic{A}{E}Am]bosque \[\mauii{G}{D}]don\[\bmc\mauiic{A}{E}]de \[\mauiic{G}{D}]na|\[{\renewcommand\mntagtext{1,2}\mn{E}}\mn{D}]cie\[\mn{E}]ron \[\bm]
      \[\mn{D}]de|\[\mnc{E}Em]scansan a un \[\bm]lado de un |\[\mn{G}]la\[\mnc{F}]go \[\bmc\mn{E}]don\[\mn{D}]de
      pla|\[\mnc{E}Am]tican \[\mn{D}]con \[\bmc\mn{E}]un \[\mnc{D}]jil|\[\mncii{E}{D}]gue\[\mn{E}]ro
    \endrep
  \mnendverse
  \mnbeginverse[1]
    \beginrep
      \[\bmc\mn{C}]Que \[\mn{B}]co|\[\mnc{A}F]me\[\mn{F}]nta \[\bm]que el a|mor es
      \[\bmc\mn{C}]com\[\mn{B}]par|\[\mncii{A}{E}C]tir lo \[\bm]que hay \[\mn{D}]en |\[\mn{E}\mn{D}\mn{C}]ti \[\bm]
      \[\mn{D}]es |\[\mnc{E}Em]nuestra na\[\bm]tura\[\mnc{G}]le|\[\mncii{F}{E}]{-za,} \[\bm]nues\[\mn{D}]tra\jw
      e|\[\mnc{E}Am]sencia \[\bm]más \[\mn{D}]su|\[\mn{E}]til
    \endrep
  \mnendverse
  \beginverse
    \beginrep
      |\[Em]Águila y \[\bm]condor se\jw en|cuentran \[\bm]en la
      |\[Am]cima de u\[\bm]na cordi|llera \[\bm]
      sem|\[Em]brando un men\[\bm]saje que |llega\jw al
      \[\bm]inte|\[Am]rior de la \[\bm]madre |tierra
    \endrep
  \endverse
  \beginverse[1]
    \beginrep
      \[\bm]Que nos |\[F]dice \[\bm]que ve|nimos de \[\bm]la misma
      |\[C]fuente y del \[\bm]mismo lu|gar \[\bm]
      to|\[Em]dos somos \[\bm]de la ti|erra,
      \usealtmnstyletrue{} del |\[\mnc{C}Am]agua, del \[\bm]fuego y \[\mn{G}]del |\[\mn{A}]aire
    \endrep
  \endverse
  \begin{translation}[EN]
...
\beginsong{Que Florezca la Luz}[id={que-florezca-la-luz-5gd3pa},tags={light, love},ph={III},key={Am},gk={Am, Gm--Dm}]
  ...
  \beginverse
    \beginrep
      \[\mn{A}]Que flo|\[Am]rez\[\mn{E}]ca \[\mn{D}]la |\[G]lu\[\mn{C}\mn{B}]z, \[\mn{D}]que flo|\[E7]rez\[\mn{F}]ca \[\mn{E}]la |\[Am]luz \[\ac<2>{A7}]
    \endrep
  \endverse\glueverses
  \notesoff
  \beginverse
...
\beginsong{Vuela con el Viento}[id={vuela-con-el-viento-hda9wb},by={Ayla Schafer},tags={flying},ph={III},key={Dm},gk={Dm, Cm--Em}]
  ...
  \beginverse\memorize
    \beginrep
      |\[\mnc{B}Em]Llé\[^\mn{E}]vame con tus |\[\mnc{D}D]alas \[^\mn{E}]de \[^\mn{D}]luz \altchords{\id[1]{(Em)}|Em |D}
  ...
  \beginverse[1]
    \beginrep
      |\[\mnc{G}Em]Cu\[\mn{F#}]ra, \[\mn{G}]cu\[\mn{F#}]ra, \[\mn{G}]cu\[\mn{F#}]ra, \[\mn{G}]cú\[\mn{B}]ra\[\mn{G}]me, |\[\mnc{F#}D]sa\[\mn{E}]na \[\mn{F#}]to\[\mn{E}]do \[\mn{F#}]lo \[\mn{E}]que \[\mn{F#}]yo \[\mn{D}]llevo
      |\[C]agradesco por mi vida Pa|\[D]chamama yo te amo
    \endrep
  \endverse
  \beginverse[2]
    \beginrep
      |\[Em]{} \[\mn{B}]Vue\[\mn{A}]la \[\mn{G}]con \[\mn{A}]el |\[D]vien\[\mn{D}]to, |\[C]{} \[\mn{B}]vue\[\mn{A}]la \[\mn{G}]con \[\mn{A}]el |\[D]vien\[\mn{D}]to
    \endrep
  \endverse
  \notesoff
  \beginverse
...
\beginsong{Pachamama Pachacamaq}[id={pachamama-pachacamaq-uelgay},by={Kike Pinto},tags={Mother Earth, thankfulness, you},ph={III},key={Am},gk={B\flt{}m, Am--Cm}]
  ...
  \beginverse[1]\memorize[chords_pachamamacamaq_b]
    \noteson
    \[^\mn{E}]Por \[^\mn{G}]mi |\[\mnc{A}F]tierra y |mi \[^\mn{G}]fa|\[C]mi\[^\mn{E}]lia, | por\[^\mn{G}]que |\[\mnc{A}F]son par|\[^\mn{C}]te \[^\mn{A}]de |\[\mnc{G}C]mi | \e
...
\beginsong{Machi}[id={machi-xdxaal},by={Peia},ph={III},key={Am},gk={Am, Gm--Bm}]
  ...
  \beginverse
    \beginrep
      |\[\mnc{A}F#m]Ma\[\mn{B}]chi |\[\mnc{C#}A]ma\[\mn{B}]chi |\[E]{} \[\mn{C#}]ma\[\mn{B}]chi|\[\mnc{F#}F#m]ma \up{2}(| \e)
    \endrep
  \endverse
  \vspace{2ex}
  \beginverse
...
\beginsong{La Semilla\\Be in the Now}[id={la-semilla-bxn3n3},by={Shimshai},tags={love, heart},ph={III},key={Dm},gk={Dm, Cm--Em}]
  ...
  \beginverse[1]\memorize[chords_lasemilla_d] % memorize chords into a named register
    \[^\mn{D}]Con a|\[\mnc{A}F]mor e\[\mnc{G}C]ter\[^\mn{F}]na\[^\mn{G}]men|\[\mnc{A}Dm]te \[^\mn{D}]crecerá,
...
\beginsong{Nadi Wewe}[id={nadi-wewe-vag0pp},by={Kuitzi Moezzi},tags={Aya},ph={III},key={Am},gk={Am, Gm--Am}]
  ...
  \beginverse[1]
    \beginrep
      \[\mn{A}]Na\[\mn{C}]di |\[\mnc{D}Dm]wewe | \[\mn{E}]na\[\mn{D}]di |\[\mnc{C}Am]we\[\mn{A}]we | \e
...
\beginsong{Agua de Estrellas}[id={agua-de-estrellas-6nw3fu},by={Miguel Molina},tags={water, stars, Mother Earth},ph={III, IV},key={Am},gk={Am, Am--Bm}]
  ...
  \beginverse[1]
    \beginrep
      \[\mn{D}]Agua \[\mn{E}]de |\[\mnc{F}F]luz \[\mn{G}\mn{A}]agua \[\mn{C}]de es|\[Am]tre\[\mn{A}]llas
      Pacha|\[G]mama vie\[C]nes del |\[Dm]cielo | \e
    \endrep
  \endverse
  \beginverse[2]\memorize
    \beginrep
      |\[\mncii{A}{F}Dm]Limpia |\[^\mn{A}\mn{F}]limpia \notesoff
...
\beginsong{Corazón es lo Único que Tengo}[id={corazon-es-lo-unico-que-tengo-8f2lmq},by={Nubia Rodriguez},tags={heart},ph={III, IV},key={Am},gk={Am, Gm--Bm}]
  ...
  \beginverse[1]
    \beginrep\noteson
      \[\mn{E}]Cora|\[Em]zón que es lo |único que |\[\mnc{G}G]tengo | \e
...
\beginsong{Cura Sana}[id={cura-sana-quar11},by={Andrés Córdoba},ex={cofan, quechua, español},ph={III, IV},key={Am},gk={Fm--Gm}]
  ...
  \beginverse[1]
    \[^\mn{E}]{O\ldots}|\[\mnc{A}Am]coremajaï jojo\[^\mn{B}]re |\[\mnc{C}F]jas\[^\mn{A}]paruñaï
  ...
  \endverse
  \beginverse[1]
    \[\mn{E}]I|^quisimanyairo u\[\mn{B}]ru|^ma\[\mn{A}]ña y gente
  ...
  \goto{Cura cura}
  \beginverse[2]
    \[\mn{E}]O|^coremajaï jojo\[\mn{B}]re |^ta\[\mn{D}]cro \[\mn{C}]yo\[\mn{B}]cro-
  ...
  \goto{Cura cura}
  \beginverse[3]
    \[\mn{E}]O|^coremajaï jojo\[\mn{B}]re |^jas\[\mn{A}]paruñaï
...
\beginsong{Pura Medicina}[id={pura-medicina-a2v9lq},by={Mallkikuna},ph={IV},key={Am},gk={Am (Em), Gm--Am}]
  ...
  \noteson
  \beginverse[1]
    \[\mn{E}]Si |\[\mnc{A}F]sientes que te \[\mn{G}]lev|\[\mn{A}]anta, la me\[\mn{B}]di|\[\mnc{C}G]ci\[\mn{B}]na \[\mn{A}]de tu \[\mn{G}]am|\[\mnc{E}C]or
    Si |\[F]sientes que te lev|anta, la medi|\[G]cina de coraz|\[C]on!
  \endverse
  \beginverse[2]
    \[\mn{E}]Toca\[\mn{D}]te |\[\mnc{E}C]lindo \[\mn{D}]el \[\mn{E}]tam\[\mn{D}]bor\[\mn{G}]ci|\[\mn{E}]to, y alegra |\[G]nos el \[\mn{D}]co\[\mn{C}]raz|\[\mnc{A}Am]on
...
\beginsong{Guacamayo}[id={guacamayo-o97ol2},by={Danit Treubig},ph={IV},key={Am},gk={C\shrp{}m, Bm--D\shrp{}m}]
  ...
  \mnbeginverse[1]
    \beginrep
      |\[\mnc{G}G]Pinta pinta pinta con el |\[Em]movimie\[\mn{E}]nto
      |\[\mnc{B}G]de tus plumas sale |\[\mnc{G}Em]una vibración
      |\[\mnc{B}G]que me abraza e|\[\mnc{G}Em]ternamente
      |\[\mnc{B}G]que me enseña e|\[\mauiic{A}{G}\ac<1>Em \ac<2>{Am}]ternamente
    \endrep
  ...
  \mnbeginverse
    \beginrep
      \beginrep\prep{4}
        |\[\mnc{A}Am]{ Guacamayo} |Gu'acama\[\mn{G}]yo
        |\[\mnc{C}C]heeheehee \[\mn{G}]poder|\[\mn{C}]oso Guacamayo |\[\mnc{A}Am]hee \[\mn{C}\mn{G}]hey|\[\mn{A}]hee
      \endrep
      \emptyline
  ...
  \beginverse
    \beginrep
      |\[\mnc{C}C]hee|y y\[\mn{A}]a |\[Am]hee | \e \rep{6}
    \endrep
...
\beginsong{Espíritu Eterno \\ Cayarírirí}[id={espiritu-eterno-w40q01},by={Darío Poletti},ph={III, IV},key={Em},gk={Gm, F\shrp{}m--Gm}]
  ...
  \mnbeginverse[1]
    \beginrep
      \[\mn{E}]Ca\[\mn{F#}]ya|\[\mnc{G}C]rí \[\mn{F#}]ri\[\mn{G}]rí \[\mn{F#}]ri|\[\mn{G}]rí \[\mn{A}]ri\[\mn{G}]rí \[\mn{F#}]rí|\[\mnc{E}G]rí \[\mn{D}]rirí \[\mn{B}]riri|\[\mn{D}]rí
      |\[\mnc{A}D]Es la presencia de |\[\mnc{B}Bm]tu espíritu e|\[Em]ter\[\mn{E}]no | \e
    \endrep
  \mnendverse
  \notesoff
  \beginverse
...
\beginsong{Como Te Quiero Yo}[id={como-te-quiero-yo-l171r4},by={Irina Florez},ph={III, IV},tags={love},key={Dm},gk={C\shrp{}m, Cm--Em}]
  ...
  \beginverse[1]\memorize[chords_comotequieroyo_a]
    |\[\mnc{A}Am]Yana he ya\[^\mn{E}]na |\[C]yo, yana he |\[E7]ya\[^\mn{D}]na yo \[^\mn{C}]hi\[^\mn{B}]a|\[\mnc{A}Am]na
...
\beginsong{Cuñaq}[id={cunaq-1cqutb},by={Miguel Molina},tags={water},ph={IV},key={Am},gk={Am, Gm--Bm}]
  ...
  \beginverse[1]
    \beginrep\noteson
      |\[\mnc{E}Am]De \[\mn{D}]can\[\mn{C}]tar \[\mn{A}]hua\[\mnc{C}C]li\[\mn{A}]nas |y a \[\mn{B}]la \[\mn{C}]vez \[\mn{D}]llo\[\mnc{E}Em]rando \altchords{|Gm B\flt{} | - Dm}
...
\beginsong{Plantas Sagradas}[id={plantas-sagradas-2k60jf},by={Danit Treubig},ph={IV},key={Am},gk={Am, Am--Bm}]
  ...
  \mnendverse
  \mnbeginverse[1]
    |\[F]{} \[\mn{C}]Sien\[\mn{A}]to |\[\mn{C}]vivo, |\[Am]sien\[\mn{A}]to la |paz,
    |\[\mnc{C}F]siento el po|der de \[\mn{D}]la |\[\mnc{C}Am]ma|\[\mn{A}]dre.
    |\[F]{} \[\mn{F}]Sien\[\mn{G}]to |\[\mn{A}]vi\[\mn{G}\mn{F}]vo, |\[\mnc{E}Am]siento la |pa\[\mn{A}]z,
    |\[\mnc{F}F]siento el \[\mn{G}]po|\[\mn{A}]der \[\mn{G}]de \[\mn{F}]la |\[\mnc{E}Am]ma|\[\mn{A}]dre.
  \mnendverse
  \beginverse[2]
    \beginrep
      |\[\mnc{B}Em]Siento las |\[\mnc{G}G]plan\[\mn{C}]tas \[\mn{B}]sa|\[Am]gra|\[\mn{A}]das.
    \endrep
  \endverse
  \notesoff
  \beginverse
...
\beginsong{Wirikuta}[id={wirikuta-h0akns},ititle={Pachamama},tags={Mother Earth, Sun},ph={IV},key={Am},gk={Am, Am--C\shrp{}m}]
  ...
  \beginverse\memorize
    \beginrep
      |\[\mnc{E}Am]Wiri\[^\mn{C}]ku\[^\mn{A}]ta |\[\mnc{D}G]Wiri\[^\mn{G}]ku\[\mnc{E}Am]ta |\[\mnc{C}C]Wiriku\[\mnc{D}Dm]ta |\[\mnc{G}Em7]Gran E\[^\mn{C}]spí\[^\mn{B}]ri\[\mnc{A}Am]tu
    \endrep
  \endverse
  \notesoff
...
\beginsong{Bienvenidos Hermanitos}[id={bienvenidos-hermanitos-23b8zl},by={Daniel Osorio},tags={morning, Mother Earth, Sun},ph={IV, V},key={Am},gk={Am, Gm--G\shrp{}m--(Am)}]
  ...
  \beginverse[1]
    \beginrep
      |\[\mnc{A}F]Lailaralai Lara|\[\mnc{C}C]lai \[\bm{G}]Laralai |\[G]Lai Lara\[\mn{A}]la|\[\mnc{E}C]lai
  ...
  \beginverse[1]
    \beginrep
      |\[\mnc{A}F]Bien\[\mn{G}]ve|\[\mn{A}]ni\[\mn{G}]dos \[\mn{A}]her\[\mn{G}]ma|\[\mnc{E}C]ni\[\mn{G}]tos |\[\mnc{A}F]bien\[\mn{G}]ve|\[\mn{A}]ni\[\mn{G}]dos \[\mn{E}]hoy
...
\audio[key=Am]{https://www.youtube.com/watch?v=1zU2Dq8itV8}
  ...
  \mnbeginverse
    \beginrep
      |\[\mnc{C}Am]{Que\jw el} \[\mn{B}]e\[\bmc\mn{C}]ter\[\mn{E}]no |\[C]sol \[\bm] |\[\mnc{A}F]te \[\bmc\mn{G}]ilu|\[\mnc{E}C]mi\[\bm]ne \altchords{\id[1]{(Gm)}|Gm |B\flt{} |E\flt{} |B\flt{}}
      |\[E]Y \[\bmc\mn{D}]{el a}|\[\mnc{E}Am]mor \[\bm] |\[E]{} \[\mnc{C}]te\[\bmc\mn{B}]{} ro|\[\mnc{A}Am]dee \[\bm] \altchords{|D |Gm |D |Gm}
    \endrep
  \mnendverse
  % verse 2
  \mnbeginverse
    \beginrep
      |\[\mnc{A}F]Y \[\bmc\mn{G}]la |\[\mnc{E}C]luz \[\bm] |\[\mnc{A}F]pura \[\bmc\mn{G}]inte|\[\mnc{E}C]rior \[\bm] \altchords{|E\flt{} |B\flt{} |E\flt{} |B\flt{}}
      |\[E]Guie \[\bmc\mn{D}]{tu ca}|\[\mnc{E}Am]mi\[\bm]no, |\[E]{} \[\mn{C}]guie \[\bm]tu \[\mn{B}]ca|\[\mnc{A}Am]mi\[\bm]no \altchords{|D |Gm |D |Gm}
    \endrep
  \mnendverse
  \dacapo
  % outro
  \mnbeginverse
    \beginrep
      |\[\mnc{A}F]Sat\[\bmc\mn{G}]{} |\[\mnc{E}C]Nam, \[\bm] |\[\mnc{A}F]Sat\[\bmc\mn{B}]{} |\[\mnc{E}C]Nam \[\bm] \altchords{|E\flt{} |B\flt{} |E\flt{} |B\flt{}}
      |\[E]Sat\[\bmc\mn{D}\mn{E}]{} |\[Am]Nam, \[\bm] |\[E]{} \[\mn{B}]Siri \[\bm]Wa\[\mn{C}]{he Gu}|\[\mnc{A}Am]ru \[\bm] \altchords{|D |Gm |D |Gm}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep
      |\[E]{} \[\mn{B}]Siri \[\bm]Wa\[\mn{C}]{he Gu}|\[\mnc{A}Am]ru \[\bm] \altchords{|D |Gm}
    \endrep
  \mnendverse
  \begin{translation}[EN]
