...
\beginsong{Lunita}[by={Danit Treubig},tags={moon},ph={II}]
  % Audio: https://www.youtube.com/watch?v=13xb_TVri0U
  \beginchorus
...
\beginsong{Estrella Azul}[by={Narayan Dass}, tags={stars}, ph={II}]
  % Audio: https://maureenji.bandcamp.com/track/estrella-azul (Cm in A=432Hz)
...
\beginsong{Medicina que Trae los Cielos}[by={Hamilton Dielu},ph={II, III}]
  % Audio: https://soundcloud.com/sacredvalleytribe/medicina\eque\etrae\elos\ecielos
  \meter{3}{4}
...
\beginsong{Machi}[by={Peia},ph={III}]
  % Audio: https://www.youtube.com/watch?v=D7os9V-n7rs (note: is in A=432Hz)
...
\beginsong{Tzen Tze Re Rei}[by={Nase Chiriap},ex={shuar, español},ph={III, IV}]
  ...
  % Audio: https://www.youtube.com/watch?v=PC26I9uFW_Q
  \beginverse
...
\beginsong{Sol de la Mañana}[by={Bóveda Celeste},ph={IV}]
  % Audio: https://www.youtube.com/watch?v=gTGygs833d0 (in Bm)
  % \capo{2}
  \beginchorus
...
\beginsong{Tierra, tan Sólo}[by={Marta Gómez, Fereríco García Lorca},ph={II},tags={earth}]
  % Audio: https://www.youtube.com/watch?v=6qVmZM9xSF4
  % Audio: https://soundcloud.com/sudhir-ibiza/tierra
  \capo{3}
  \beginverse
    \[^\mn{B}]Ti|\[Em]er\[^\mn{E}]ra \[^\mn{G}]tan \[^\mn{F#}]só\[^\mn{E}]lo |\[\mnc{B}G/B]tier\[^\mn{C}]ra
    |\[Am] para las heridas re|\[F#\textdegree]cien\[B7]tes
    Ti|\[Em]erra tan sólo |\[G/B]tierra
    |\[Am] para el humilde pensa|\[F#\textdegree]mient\[B7]o
  ...
  \beginverse
    ...
    de |\[B7]noches in|\[D]me\[B7]{'}|\[Em]nsas
  \endverse
  \beginverse
    |\[D] No es la ce\[Cmaj7]niza en v|\[B7]ilo
    de las |\[C]cosas quema|\[B7]{'das}
    |\[Am] Lo que yo vengo busca|\[Em]ndo
    es |\[C]tie\[B7]{'r}|\[Em]ra
  \endverse
  \brk
  \textnote{Instrumental}
  \goto{Tierra tan sólo (2nd)}
  \goto{No es la ceniza}
  \beginverse
