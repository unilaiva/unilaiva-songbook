...
\beginsong{En la Selva un Río}[by={Kike Pinto},ph={III, IV}]
  ...
  \beginverse
    ...
    |\[Am] va surcan|\[Bm]do una ca|\[Em]noa. | \nl \rrep
  ...
  \begin{center}%
    \vfill%
    % Downloaded from: https://openclipart.org/detail/120811/jaguar
    % License: in the public domain
    % 0.618^2 ~ 0.382 (Golden Ratio)
    \includegraphics[width=0.382\textwidth]{jaguar_drawing_bw_transparent_bg_PD__1081px.png}%
    \vfill%
  \end{center}
\endsong
...
\beginsong{Machi}[by={Peia},ph={III}]
  ...
  \beginverse
    ...
    |\[D] Machi |\[F#m]cántame |\[D]una |\[F#m]nana | |
  \endverse
...
\beginsong{Sólo Dios Sabe si Vuelvo}[by={Julian Herreros Riveira},ph={III, IV}]
  \beginverse
    |\[Am\noteULL{E}]A|a\[^\noteU{D}]bre\[^\noteU{E}]te \[^\noteU{D}]flor|\[F\noteUL{C}]ci\[^\noteU{A}]ta de los |\[^\noteU{C}]cua\[^\noteU{A}]tro vien\[^\noteU{G}]tos |\[C\noteUL{E}]yari | \nl
    Oloro|\[C]cita perfu|\[G]mera doctor|\[Am]cita | \nl
    Estrelli|\[Am]ta de siete |\[Em]flechas Tonan|\[Am]zina | \nl
    Ay danza|\[C]remos hasta |\[G]las claras del |\[Am]día | \nl
    para escu|\[Am]char la voz de |\[Em]los que ya se |\[Am]fueron | |
  \endverse
  \notesoff
  \beginverse
    \chorusindent |^Naa|a na na na |^naana na na |naina na na |^naana | \nl
    \chorusindent Na na na |^naana na na |^naina na na |^naana | \nl
    \chorusindent Na na na |^naana na na |^naina na na |^naana | |
  \endverse
  \beginverse
    |^So|on tus aguas |^que le dan la |vida a mi |^pueblo | \nl
    ...
    y rever|^decen en mi |^quebrada de a|^mor | |
  \endverse
  \gotochorus{Naa na na na}
  \beginverse
    |^Lle|eno de ale|^gría danza |la muerte a mi |^lado | \nl
    Chuma bo|^rracherita |^pinta gente |^yari | \nl
    Cuatro oto|^rongos magos |^llegan a la |^fiesta | \nl
...
\beginsong{Sol de la Mañana}[by={Bóveda Celeste},ph={IV}]
  ...
  \beginchorus
    ...
    |\hspace{0.5em} Brilla el |sol de la ma|ñana | |
    |\hspace{0.5em} Movi|miento de ésta |\[Dm]tie|'rra, |
    |\hspace{0.5em} palpi|tando en la flo|\[Am]re|'sta |
    |\hspace{0.5em} Donde un lla|mado nos re|úne | |
    |En el cora|zón de una fa|milia | | | \nl
    Her|mano, |Huitzillín y que |\[C]sue|ñas
    En |\[Dm]la nueva au|rora y la armo|\[Am]nía | \nl
    ...
    |Canta cantor|cito mari|ri-ri-ri-ri-|ri-ri-ri-ri-|riii | | | |
    |Canta cantor|cito mari|ri-ri-ri-ri-|ri-ri-ri-ri-|riii | | | \nl
  \endchorus
  \beginchorus
    ...
    Que el |tiempo que |pasa es u|\[G]na i\[E]lu|\[Am]sión | | | |
    |Canta cantor|cito mari|ri-ri-ri-ri-|ri-ri-ri-ri-|riii | | | |
    |Canta cantor|cito mari|ri-ri-ri-ri-|ri-ri-ri-ri-|riii | | | \nl
  \endchorus
  \begin{translation}
...
\beginsong{Amor y Unidad}[by={Bóveda Celeste},ph={III}]
  ...
  \begin{center}%
    \vfill%
    \includegraphics[width=0.236\textwidth]{eagle_feather_bw_transparent_bg_1280px.png}%
    \vfill%
  \end{center}
\endsong
...
\beginsong{Medicina que Trae los Cielos}[by={Hamilton Dielu},ph={II, III}]
  % See: https://soundcloud.com/sacredvalleytribe/medicina-que-trae-los-cielos
  \meter{3}{4}
...
\beginsong{Sirenita Bobinzana}[by={Artur Mena},ph={III, IV}]
  \meter{3}{4}
  \beginverse
    \lrep \[^\noteU{E}]Si\[^\noteU{D}]re|\[C\noteUL{E}]nita de los |\[G]ríos, danza |\[B7]danza con el |\[Em]viento | \nl \rrep
    \lrep Con  tus |\[G]flores y a|romas, per|fumas los \[B7]cora|\[Em]zones | \nl \rrep
  \endverse
  \notesoff
  \beginverse
    \lrep Cura |^cura cuerpe|^citos, limpia |^limpia espiri|^titos | \nl \rrep
...
\beginsong{Buscando el Camino}[by={Karin Micha},tags={path 1},ph={IV}]
  ...
  \beginverse
    ...
    % \chorusindent la |^lai la lai la |^laa la lai |^lai la la lai lai |^laa! | |
  \endverse
  \beginverse
...
\beginsong{Señora mi Señora}[by={Santiago Andrade, Irina Flores},ex={español, nahuatl},tags={Divine Mother 1},ph={II}]
  ...
  \beginverse
    ...
    Pacha|\[Em]mama Nunckui |\[G]Tierra sinchi |\[D]Tonāntzin coa|\[Em]tli yarí \brk| | \nl
  \endverse
  \beginchorus
  ...
  \beginverse
    ...
    va cu|\[Em]rando, va sa|\[G]nando sinchi |\[D]Tonāntzin coa|\[Em]tli yarí \brk| | \nl
  \endverse
  \beginchorus
  ...
  \beginverse
    va cu|\[Em]rando, va sa|\[G]nando sinchi |\[D]Tonāntzin coa|\[Em]tli yarí
    va cu|\[Em]rando va sem|\[G]brando sinchi |\[D]Tonāntzin coa|\[Em]tli yarí \brk| | \nl
  \endverse
  \beginchorus
  ...
  \beginverse
    va cu|\[Em]rando va sa|\[G]nando sinchi |\[D]Tonāntzin coa|\[Em]tli yarí
    va cu|\[Em]rando alimen|\[G]tando sinchi |\[D]Tonāntzin coa|\[Em]tli yarí \brk| | \nl
  \endverse
  \beginchorus
  ...
  \beginverse
    ...
    van cu|\[Em]rando hay endul|\[G]zando sinchi |\[D]Tonāntzin coa|\[Em]tli yarí \brk| | \nl
  \endverse
  \begin{explanation}
    \begin{description}
...
\beginsong{Cuando la Luna}[by={Keya Maria},tags={moon 1},ph={II}]
  ...
  \beginchorus
    ...
    \chorusindent |\[G]Quiro es\[D]tar pres|\[Em]ente |\[B7]en todo mo|\[Em]mento | \textsuperscript{2}( | \nl)
  \endchorus
  \notesoff
  \beginchorus
    Cuando la |\[Em]luna rendonda es|\[C]ta | | \nl
...
\beginsong{Aguila Aguilé}[ph={II}]
  ...
  \beginverse
    ...
    Es mi a|^buela \textsuperscript{1}que canta, | |^canta enamorada | \nl \hfill{\footnotesize\emph{\textsuperscript{2}Ayahuasca}}
  \endverse
  \beginverse
    Ese |^pájaro | es mi a|^buelo | \nl
    Es mi a|^buelo \textsuperscript{1}que canta, | |^canta enamorado | | \hfill{\footnotesize\emph{\textsuperscript{2}Peyote}}
  \endverse
  \beginverse
