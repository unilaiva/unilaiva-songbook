...
\beginsong{Bienvenidos Hermanitos}[by={Daniel Osorio},tags={morning 1, Mother Earth 1, Sun 1}]
...
\beginsong{Todo es mi Familia}[ititle={Familia}]
  \beginverse
...
\beginsong{Ábrete Corazón}[by={Rosa Giove}]
  \beginchorus
...
\beginsong{Pachamama Pachacamaq}[by={Kike Pinto},tags={Mother Earth 1, thankfulness 1}]
  \meter{3}{4}
...
\beginsong{Madre Selva}[by={Grupo Putumayo}]
  \beginverse
...
\beginsong{Gracias}[tags={thankfulness 1, love 1}]
  \meter{6}{8}
  \beginchorus
...
\beginsong{Wirikuta}[tags={Mother Earth 1, Sun 1}]
  \beginverse
...
\beginsong{Ayahuasca Ayní}[by={Diego Palma},tags={Aya 1}]
  \meter{6}{8}
  \beginchorus
...
\beginsong{Abuelita Ayahuasquita}[tags={Aya 1, flight 1}]
  \meter{6}{8}
  \beginchorus
...
\beginsong{Ayahuasca Takimuyki}[by={Shimshai, Don José Campos},ex={quechua, español},tags={Aya 1},ex={quechua, español}]
...
\beginsong{Tlazocamati}[tags={Aya 1}]
  \beginchorus\memorize % memorize chords even though in ``chorus''
...
\beginsong{Nadi Wewe}[by={Kuitzi Moezzi},tags={Aya 1}]
  \beginverse
