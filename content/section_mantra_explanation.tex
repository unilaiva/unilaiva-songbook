...
% (Note that this file is not supposed to be wrapped in 'songs' environment.)
  ...
  ‘bhajans’. Literally, the term means ‘sharing’.
  ...
  \end{description}
  % Comment the following line (\clearpage) out, when the 'Contents' has again swelled to take
  % an odd number of pages, to remove an extra empty page.
  \clearpage%
  \begin{center}%
    \vspace*{\fill}%
