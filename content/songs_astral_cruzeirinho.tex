...
\beginsong{Eu Peço}[id={eu-peco-9k8e8p},by={Mestre Irineu Serra},key={C},gk={D, C-E}]
  ...
  \mnbeginverse[1]
    \beginrep
      \[\mn{E}]Eu |\[\mnc{C}C]pe\[\bmc\mn{G}]ço, \[\mn{E}]eu |\[\mn{C}]pe\[\bmc\mn{G}]ço \altchords{\id[1]{(D)}|D | \e }
      \[\mn{E}]Eu |\[\mn{C}]pe\[\mn{G}]ço ao \[\bmc\mn{C}]Pai \[\mn{E}]Di|\[\mnc{D}Dm]vi\[\bm]no \altchords{| - |Em}
      Que me |dê a \[\bm]Santa |\[\mnc{G}G7]Luz \altchords{| |A7}
      Para i\[\bm]lu\[\mn{F}]mi|\[\mnc{E}(Em)]nar \[\mn{D}]o \[\mnc{C}G7]meu \[\mn{B}]ca|\[\mnc{C}C]mi\[\bm]nho \altchords{|(F\shrp{}m) A7 |D}
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep\memorize
...
\beginsong{Quem Procurar Esta Casa}[id={quem-procurar-esta-casa-qq560l},by={Mestre Irineu Serra},ph={I},key={Am},gk={Am, Gm--G\shrp{}m--(Am)}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep
        \[^\mn{E}]En|\[\mnc{A}Am]contra \[^\mn{B}]{com a} \[\mnc{C}(C)]Vir\[^\mn{B}]gem \[^\mn{A}]Ma|\[\mncii{D}{F}Dm]ri\[\mnc{A}(F)]a \altchords{|Em (G) |Am (C)}
        |\[\mnc{E}Am]Su\[^\mn{F}]a \[^\mn{E}]sa\[\mnc{D}E7]úde \[^\mn{C}]E\[^\mn{B}]la |\[\mnc{A}Am]dá \[\bm]{} \altchords{|Em B7 |Em}
      \endrep
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Eu Tomo Esta Bebida}[id={eu-tomo-esta-bebida-uo3htd},by={Mestre Irineu Serra},key={Gm},gk={F\shrp{}m, (Em)--(Gm)}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep
        \[^\mn{/}]Ela |\[\mnc{A}Am]mostra a \[\bmc\mn{C}]to\[^\mn{E}]dos |\[\mnc{G}Em]nós \altchords{|Am |Em}
        A\[\bmc\mn{B}]qui \[^\mn{E}]den|\[\mnc{F#}B7]tro \[^\mn{A}]des\[\bmc\mn{C}]ta \[^\mn{B}]ver|\[\mnc{E}\ac<1>{E7} \ac<2>{Em}]da\[\bm]de \altchords{|B7 |\ac<1>{E7} \ac<2>{Em}}
      \endrep
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Aqui Estou Dizendo}[id={aqui-estou-dizendo-jsp040},by={Mestre Irineu Serra},key={Am},gk={Am, Gm--Bm}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \beginrep
        \[^\mn{C}]Eu |\[\mnc{A}Am]digo \[\mnc{C}(C)]pa\[^\mn{E}]ra |\[\mnc{D}Dm]todos \altchords{|Bm (D) |Em}
        \[\bmc\mn{E}]E \[^\mn{F}]os |\[\mnc{E}E7]hinos \[^\mn{D}]estão \[\bmc\mn{C}]en\[^\mn{B}]si|\[\mnc{A}Am]nan\[\bm]do \altchords{|F\shrp{}7 |Bm}
      \endrep
    \endrep
  \mnendverse
  \notesoff
  ...
  \mnbeginverse
    \beginrep\noteson
      ...
      \beginrep
        \[\mn{C}]Que \[\mn{B}]nós |^somos ^Filhos \[\mn{E}]E|^ternos
        ^Fi\[\mn{F}]lhos |^de \[\mn{D}]Nos^sa \[\mn{B}]Se|^nho^ra
      \endrep
    \endrep
  \mnendverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
...
\beginsong{Flor das Águas}[id={flor-das-aguas-lq1q9t},by={Mestre Irineu Serra},tags={2x},key={Am},gk={Cm, G\shrp{}m--D\shrp{}m}]
  ...
  \mnbeginverse[1]
    \beginrep\memorize
      \[^\mn{A}]A \[^\mn{C}]mo|\[\mnc{E}Am]rada \[\mnc{D}G]do \[^\mn{E}]meu |\[\mncii{C}{B}Am]Pai \altchords{|Dm C |Dm}
      \[\bmc\mn{A}]É \[^\mn{C}]no |\[\mnc{E}C]cora\[\bmc\mn{D}]ção \[^\mn{E}]do |\[\mnc{D}Dm]mun\[\bm]do \altchords{|F |Gm}
      Aonde e|xiste \[\mnc{C}C]to\[^\mn{B}]do a|\[\mnc{E}E]mor \altchords{|Gm F |A}
      E \[\mnc{D}(E7/D)]{tem um} |\[\mnc{C}C]se\[^\mn{B}]gre\[\mnc{G#}E7]do \[^\mn{B}]pro|\[\mnc{A}Am]fun\[\bm]do \altchords{(A7/G) |F A7 |Dm}
    \endrep
  \mnendverse
  \notesoff
  \beginverse[1]
