...
\beginsong{Dou Viva a Deus nas Alturas}[by={Mestre Irineu Serra},tags={valsa},key={C},gk={C, C--D}]
...
\beginsong{Todos Querem Ser Irmão}[by={Mestre Irineu Serra},key={Am},gk={Am, Gm--G\shrp{}m--(Am)}]
...
\beginsong{Confia}[by={Mestre Irineu Serra},key={Dm},gk={Dm, Cm--Em}]
...
\beginsong{Eu Peço}[by={Mestre Irineu Serra},key={C},gk={D, C-E}]
...
\beginsong{Está Força}[by={Mestre Irineu Serra},tags={valsa, 2x},key={C},gk={D, C--D}]
...
\beginsong{Quem Procurar Esta Casa}[by={Mestre Irineu Serra}, ph={I}, key={Am}, gk={Am, Gm--G\shrp{}m--(Am)}]
  ...
  \mnbeginverse
    ...
    \beginrep \[^\mn{E}]En|\[\mnc{A}Am]contra \[^\mn{B}]{com a} \[\mnc{C}(C)]Vir\[^\mn{B}]gem \[^\mn{A}]Ma|\[\mncii{D}{F}Dm]ri\[\mnc{A}(F)]a \altchords{|Em (G) |Am (C)}
    |\[\mnc{E}Am]Su\[^\mn{F}]a \[^\mn{E}]sa\[\mnc{D}E7]úde \[^\mn{C}]E\[^\mn{B}]la |\[\mnc{A}Am]dá \[\bm]{} \altchords{|Em B7 |Em} \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    ...
    \beginrep |^Vós como ^Mãe sobe|^ra^na \altchords{|Am |Dm F}
    |^A Divi^na Mãe de |^Deus^ \altchords{|E E7 |Am} \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    ...
    \beginrep |^Peço a vós ^a Santa |^Lu^z \altchords{|Am C |Dm F}
    |^Para ilumi^nar o meu per|^dão ^ \altchords{|E Dm |Am} \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    ...
    \beginrep |^Seguindo ^o bom ca|^mi^nho \altchords{|Am |Dm}
    |^Fazer bem, ^não fazer |^mal ^ \altchords{|E |Am} \endrep
    \endrep
  \endverse
  \brk
...
\beginsong{Eu Tomo Esta Bebida}[by={Mestre Irineu Serra},key={Gm},gk={F\shrp{}m, (Em)--(Gm)}]
  ...
  \mnbeginverse
    ...
    \beginrep \[^\mn{/}]Ela |\[\mnc{A}Am]mostra a \[\bmc\mn{C}]to\[^\mn{E}]dos |\[\mnc{G}Em]nós \altchords{|Am |Em}
    A\[\bmc\mn{B}]qui \[^\mn{E}]den|\[\mnc{F#}B7]tro \[^\mn{A}]des\[\bmc\mn{C}]ta \[^\mn{B}]ver|\[\mnc{E}\ac(1){E7} \ac(2){Em}]da\[\bm]de \altchords{|B7 |\ac(1){E7} \ac(2){Em}} \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    ...
    \beginrep Quando eu |^chequei ^nas al|^turas
    En^contrei |^com a Vir^gem Ma|^ri^a \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    ...
    \beginrep Encon|^trei com o ^Pai E|^terno \altchords{|Bm |F\shrp{}m }
    E ^Jesus |^Cristo ^Reden|^tor ^ \altchords{|C\shrp{}7 |\ac(1){F\shrp{}7} \ac(2){F\shrp{}m}} \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    ...
    \beginrep |^Viva o ^Pai E|^terno
    E ^viva |^todo ^Ser Di|^vi^no \endrep
...
\beginsong{Aqui Estou Dizendo}[by={Mestre Irineu Serra},key={Am},gk={Am, Gm--Bm}]
  ...
  \mnbeginverse
    ...
    \beginrep \[^\mn{C}]Eu |\[\mnc{A}Am]digo \[\mnc{C}(C)]pa\[^\mn{E}]ra |\[\mnc{D}Dm]todos \altchords{|Bm (D) |Em}
    \[\bmc\mn{E}]E \[^\mn{F}]os |\[\mnc{E}E7]hinos \[^\mn{D}]estão \[\bmc\mn{C}]en\[^\mn{B}]si|\[\mnc{A}Am]nan\[\bm]do \altchords{|F\shrp{}7 |Bm} \endrep
    \endrep
  \mnendverse
  \notesoff
  \beginverse
    ...
    ^Não de|^vem enca^rar pe|^ri^go \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
    ...
    E ^nesta |^firme^za es|^tou^ \endrep
    \endrep
  \endverse
  \beginverse
    \beginrep
  ...
  \mnbeginverse
    ...
    \beginrep \[\mn{C}]Que \[\mn{B}]nós |^somos ^Filhos \[\mn{E}]E|^ternos
    ^Fi\[\mn{F}]lhos |^de \[\mn{D}]Nos^sa \[\mn{B}]Se|^nho^ra \endrep
    \endrep
  \mnendverse
  \begin{lilywrap}\begin{lilypond}[] \include "ulsbs-include-head.ly"
    % transcribed by larva, updated on 2023-01
...
\beginsong{Flor das Águas}[by={Mestre Irineu Serra}, tags={2x}, key={Am}, gk={Cm, G\shrp{}m--D\shrp{}m}]
...
\beginsong{Eu Pedi}[by={Mestre Irineu Serra},key={G},gk={G, (F\shrp{})--(G)}]
...
\beginsong{Pisei na Terra Fria}[by={Mestre Irineu Serra},key={Am},gk={Am, Gm--Bm}]
