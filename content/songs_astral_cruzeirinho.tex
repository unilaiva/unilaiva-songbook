...
\beginsong{Dou Viva a Deus nas Alturas}[id={dou-viva-a-deus-nas-alturas-r9uq8x},by={Mestre Irineu Serra},tags={valsa},key={C},gk={C, C--D}]
  ...
  \mnbeginverse
    ...
    \beginrep\memorize[chords_douvivaadeus_b]
      ...
      E Je|\[<G>G]sus Cris|\[<E>C/E]to \[^<C>]Reden|\[C]tor \altchords{|A |D/F# |D}
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Todos Querem Ser Irmão}[id={todos-querem-ser-irmao-fw6uy1},by={Mestre Irineu Serra},key={Am},gk={Am, Gm--G#m--(Am)}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_todosquerem_a]
      ...
      \[<E>E]Mas \[^<G>]não |\[G]têm a \[<D>Dm]leal|\[<C>C]da\[^<A>]de\[Am]{} \altchords{D |F Cm |B& Gm}
    \endrep
    \mnendverse\glueverses\mnbeginverse
...
\beginsong{Confia}[id={confia-906ihw},by={Mestre Irineu Serra},key={Dm},gk={Dm, Cm--Em}]
  ...
  \beginverse
    \beginrep
      |^ Es^tamos |todos reu^nidos \altchords{\id[4]{ED (Dm)}|Dm |D7/F# Gm}
      Com a nos|sa chave na ^mão \altchords{|C7 F}
      A lim|par mentali^dade \altchords{|B&maj7 A7sus4}
...
\beginsong{Eu Peço}[id={eu-peco-9k8e8p},by={Mestre Irineu Serra},key={C},gk={D, C-E}]
  ...
  \mnbeginverse[1]
    \beginrep
      ...
      Para i\[<*>]lu\[<F>]mi|\[<E>(Em)]nar \[<D>]o \[<C>G7]meu \[<B>]ca|\[<C>C]mi\[<*>]nho \altchords{|(F#m) A7 |D}
    \endrep
  \mnendverse
  \mnbeginverse
    \beginrep\memorize
...
\beginsong{Está Força}[id={esta-forca-ne3v1p},by={Mestre Irineu Serra},tags={valsa, 2x},key={C},gk={D, C--D}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_estaforca_a]
      ...
      |Eu de\[^<C>]vo a|\[<A>Am]mar \[^<C>]no |\[<B>G/B]meu \[^<C>]co\[^<D>]ra|\[<G>G]ção | \e \altchords{| |Bm |A/C# |A | \e}
    \endrep
    \mnendverse\glueverses\mnbeginverse
    \beginrep\memorize[chords_estaforca_b]
      \[^<E>]Tra\[^<A>]ba|\[<G F>C]lhar |\[<A>Am]no \[^<B>]mun\[^<C>]do |\[<G>G]Terra \altchords{|D |Bm |A}
      |A be\[^<C>]ne|\[<A>Am]fí\[^<C>]cio |\[<B>G7/B]dos \[^<C>]meus \[^<D>]ir|\[<C>C]maõs | \e \altchords{| |Bm |A7/C# |D | \e}
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Quem Procurar Esta Casa}[id={quem-procurar-esta-casa-qq560l},by={Mestre Irineu Serra},ph={I},key={Am},gk={Am, Gm--G#m--(Am)}]
...
\beginsong{Eu Andei na Casa Santa}[id={eu-andei-na-casa-santa-yeamg4},by={Mestre Irineu Serra},key={Dm},gk={Dm, Cm--Dm},tags={valsa}]
  ...
  \mnbeginverse
    \beginrep\memorize
      |\[<D>Dm]Eu \[^<F>]an\[^<E>]dei |\[^<D>]na \[^<F>]Ca\[^<D>]sa |\[<A>(A)]San|\[<F>F]ta \altchords{\id[1]{(Cm)}|Cm | - |(G) |E&}
...
\beginsong{Eu Tomo Esta Bebida}[id={eu-tomo-esta-bebida-uo3htd},by={Mestre Irineu Serra},key={Gm},gk={F#m, (Em)--(Gm)}]
  ...
  \beginverse
    \beginrep
      Su|^{bi, su}^bi, su|bi ^ \altchords{\id[2]{(F#m)}|F#m | \e}
      Su|bi foi ^com a|^mor ^ \altchords{| - F#7 |Bm}
      \beginrep
        Encon|^trei com o ^Pai E|^terno \altchords{|Bm |F#m }
        E ^Jesus |^Cristo ^Reden|^tor ^ \altchords{|C#7 |\ac{1}{F#7} \ac{2}{F#m}}
      \endrep
    \endrep
  \endverse
  \beginverse
...
\beginsong{Aqui Estou Dizendo}[id={aqui-estou-dizendo-jsp040},by={Mestre Irineu Serra},key={Am},gk={Am, Gm--Bm}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \[^<D>]A|\[<G>G]qui \[<*>]{} \[^<F>]es\[^<E>]tou \[^<D>]can|\[<F>F]tan\[^<E>]do\[E7]{} \altchords{|A |G F#7}
      \beginrep
        \[^<C>]Eu |\[<A>Am]digo \[<C>(C)]pa\[^<E>]ra |\[<D>Dm]todos \altchords{|Bm (D) |Em}
        \[<* E>]E \[^<F>]os |\[<E>E7]hinos \[^<D>]estão \[<* C>]en\[^<B>]si|\[<A>Am]nan\[<*>]do \altchords{|F#7 |Bm}
      \endrep
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Flor das Águas}[id={flor-das-aguas-lq1q9t},by={Mestre Irineu Serra},tags={2x},key={Am},gk={Cm, G#m--D#m}]
...
\beginsong{Eu Pedi}[id={eu-pedi-mlzsui},by={Mestre Irineu Serra},key={G},gk={G, (F#)--(G)}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \[^<A>]Para |\[Am]mim \[^<C>]a\[<B>(D)]pre\[^<A>]sen|\[<B G>G]tar \[(Em)]\altchords{|Bm (E) |A (F#m)}
  ...
  \ifchorded%
    ...
    \beginverse \noteson % first line of the next hino
      \hfill\tonextsongmark \hfill \[<B>]Eu |\[<D>G]cheguei \[<B>(Em/B)]nes\[<E>]ta |\[<D G>G]casa \ldots \altchords{|A (F#m/C#) |A}
    \endverse
  \fi
\endsong
...
\beginsong{Eu Cheguei Nesta Casa}[id={eu-cheguei-nesta-casa-el7qrf},by={Mestre Irineu Serra},key={G},gk={G, G--A}]
  ...
  \mnbeginverse
    \beginrep\memorize[chords_eucheguei_a]
      \[^<B>]Eu |\[<D>G]cheguei \[<B>(Em/B)]nes\[^<E>]ta |\[<D G>G]casa \altchords{\id[1]{(A)}|A (F#m/C#) |A}
    ...
    \beginrep\memorize[chords_eucheguei_b]
      ...
      \[^<G>]A \[<B>(Em/B)]quem \[^<E>]ro|\[<D>D7]gou \[^<C>]por \[<* A>]mi\[^<B>]nha |\[<G>G]volta \[<*>]{} \altchords{|(F#m/C#) |A}
    \endrep
  \mnendverse
  \notesoff
...
\beginsong{Pisei na Terra Fria}[id={pisei-na-terra-fria-l0waql},by={Mestre Irineu Serra},key={Am},gk={Am, Gm--Bm}]
  ...
  \mnbeginverse
    \beginrep\memorize
      ...
      \[^<C>]A \[<* A>]mi\[^<C>]nha |\[<E>E7]Mãe\[<*>]{} \[^<A>]que nos cri|\[Am]ou \[<*>]{} \altchords{|F#7 |Bm}
    \endrep
  \mnendverse
  \notesoff
  \beginverse
