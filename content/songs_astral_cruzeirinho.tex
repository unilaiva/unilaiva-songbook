...
\beginsong{Eu Tomo Esta Bebida}[by={Mestre Irineu Serra},key={Gm},gk={F\shrp{}m, (Em)--(Gm)}]
  ...
  \mnbeginchorus\memorize
    ...
    A\[\bmc\mn{B}]qui \[^\mn{E}]den|\[\mnc{F#}B7]tro \[^\mn{A}]des\[\bmc\mn{C}]ta \[^\mn{B}]ver|\[\mnc{E}\ac(1){E7} \ac(2){Em}]da\[\bm]de \rrep \altchords{|B7 |\ac(1){E7} \ac(2){Em}}
  \mnendchorus
  \notesoff
  \beginchorus
    Su|^{bi, su}^bi, su|bi ^
  ...
  \beginchorus
    ...
    E ^Jesus |^Cristo ^Reden|^tor ^ \rrep \altchords{|C\shrp{}7 |\ac(1){F\shrp{}7} \ac(2){F\shrp{}m}}
  \endchorus
  \beginchorus
    Su|^{bi, su}^bi, su|bi ^
...
\beginsong{Aqui Estou Dizendo}[by={Mestre Irineu Serra},key={Am},gk={Am, Gm--Bm}]
  ...
  \mnbeginchorus\noteson
    ...
    \lrep \[\mn{C}]Que \[\mn{B}]nós |^somos ^Filhos \[\mn{E}]E|^ternos
