...
\begin{document}
  ...
  % made smaller so that it fits on that same recto page, or the image can
  % be omitted completely, if there is no space for it, by commenting out the
  % whole \begin{center}...\end{center} block and also the \clearpage macro
  % before it.
