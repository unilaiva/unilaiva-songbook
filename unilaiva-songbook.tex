...
%         but now the Golden Ratio rules.
%       * For the "default" printer, minimum top margin is 16mm (to print the chapter name fully)
\usepackage[a5paper,inner=16.18mm,outer=10mm,tmargin=16.18mm,bmargin=10mm,headsep=6.18mm,headheight=3.5mm,nofoot]{geometry} % page size + margins
\usepackage{graphicx}
