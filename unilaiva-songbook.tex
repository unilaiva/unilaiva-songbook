...
\begin{document}
  ...
  \tableofcontents % TODO: consider making two-column TOC using multitoc (or some other) package
    ...
    \begin{otherlanguage}{finnish} % set language to finnish for hyphenation etc
      ...
      \section{Runoja, loitsuja}
        \begin{songs}{titleidx,authidx,tagidx}
          ...
          \renewcommand{\lyricfont}{\sffamily\small} % songs: use smaller font
          ...
          \renewcommand{\lyricfont}{\sffamily\large} % songs: back to the default font size
