...
% Content include: Unilaiva Songbook chapters, part 2.
...
%%
  ...
  % Edited by: larva
  \ulMainChapter{English}{chapenglishcolor}[ul-default-chapter-03_green_circles_ed_by_larva_CC0_1200px.jpg]
    \begin{songs}{titleidx,authidx,tagidx}
      \input{content/songs_english.tex}
    \end{songs}

  \ulMainChapter{Saṃskṛtam}{chapsanskritcolor}[ul-default-chapter-04_lotus_om_transbg_2000px.png]
  ...
  % License: Public Domain (CC0)
  % Edited by: larva
  \ulMainChapter{Other}{chapothercolor}[ul-default-chapter-05_Hopi_Navajo_Zuni_circle_ed_by_larva_transbg_CC0_1200px.png]
    \begin{songs}{titleidx,authidx,tagidx}
  ...
  \ulMainChapter{Suomi}{chapfinnishcolor}[ul-default-chapter-06_lintu_muinaissuomalaisilta_asuma-aloilta_perma_1426x1158px.png]
    \begin{finnish} % set language to finnish for hyphenation etc (polyglossia package)
      ...
      \section{Runoja, loitsuja}
        \begin{songs}{titleidx,authidx,tagidx}
          ...
          \renewcommand{\ulLyricFont}{\small} % use smaller font
