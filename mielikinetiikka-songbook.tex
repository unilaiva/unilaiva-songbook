...
\usepackage[bookmarks,unicode]{hyperref} % used by 'songs' package for index links in PDF
  \hypersetup{linkbordercolor=0.2 0.6 0.9,
              pdftitle=Mielikinetiikka songbook,
              unicode=true}
...
\input{mielikinetiikka-songbook-extra.tex}
...
\newindex{titleidx}{idx_mielikinetiikka-sb_title}
\newauthorindex{authidx}{idx_mielikinetiikka-sb_auth}
\newscripindex{tagidx}{idx_mielikinetiikka-sb_tag}
...
\begin{document}
  ...
  \begin{titlepage}
    ...
    \vspace*{\fill}
    \begin{center}
      \Huge Mieli\textit{k}in\textit{e}tiikka\\
      ...
      \\
      \vspace*{\fill}
      % Created by: qrencode -s 16 -l M -o content/img/QR_https_mielikinetiikka_aavalla_net.png "https://mielikinetiikka.aavalla.net/"
      \includegraphics[width=0.25\textwidth]{QR_https_mielikinetiikka_aavalla_net.png}
      \\
      {\small\url{https://mielikinetiikka.aavalla.net/}}
      \\
      \vspace*{\fill}
  ...
  \songchapter{Technical information}
    \section{Chords for Guitar}
      ...
      \gtab{B\textdegree7}{X20101:030102} \gtab{Bm11/D}{XX0200:000100} \\
      \vfill
    \section{Circles}
      %\vspace{4em}
      \begin{center}
