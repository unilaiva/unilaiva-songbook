 ...
 %% =====================================
 %%
 %% Collection of Santo Daime hymns: Suplementos para Cura
 %%
...
\newcommand{\subbooktitle}{Suplementos para Cura}
...
%         \vspace{\fill}
  ...
  \mainchapter{O Proximo Nivel}{chapsaomiguelcolor}{}
    \begin{songs}{}
      \input{content/songs_astral_proximo_nivel.tex}
  ...
  \mainchapter{Encerramento}{chapencerramentocolor}
    ...
    \setcounter{songnum}{1}
    \begin{songs}{}
      \beginsong{Transformação}[by={Lúcio Mortimer}, off={Apolo}, tags={valsa}, key={C}, gk={C, C--D}]
