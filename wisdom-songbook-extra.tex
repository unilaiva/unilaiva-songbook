...
\newcommand{\taglist}{}
\newsongkey{tags}{\def\SB@rawrefs{}\gdef\songrefs{}\def\taglist{}}
                 {\def\SB@rawrefs{#1}\SB@parsesrefs{#1}\def\taglist{AH: #1\par}}

% adds the new data from above to song prelude
