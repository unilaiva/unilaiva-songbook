%% unilaiva-astral-alfredo-novas
%% =============================
%%
%% Collection of Santo Daime hymns by Alfredo
%%
...
\renewcommand{\ulBookByText}{%
  Recebido por:\par\vspace{0.618034ex}\textbf{\Large Alfredo Gregório de Melo}%
}%
...
\begin{document}
  ...
  \ulCoverPage{unilaiva-astral-alfredo-novas_COVER.pdf}%
