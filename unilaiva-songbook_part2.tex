...
\newcommand{\fullbooktitle}{Unilaiva songbook: part 2}
...
\begin{document}
  ...
  % Cover page (recto):
  \includepdf[]{content/img/COVER_part2.pdf} % cover, by: larva (photo + edit)
  % The second page (verso):
  \secondpage{part 2:}{English, Other, Suomi} % the second (title) page here (verso)
