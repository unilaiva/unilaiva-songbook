...
\newcommand{\subsubbooktitle}{English, Other, Suomi}
...
\newindex{titleidx}{idx_unilaiva-songbook_part2_title}
\newauthorindex{authidx}{idx_unilaiva-songbook_part2_auth}
\newscripindex{tagidx}{idx_unilaiva-songbook_part2_tag}


\begin{document}

  % Cover page (recto), by larva (photo + edit):
  \includepdf[]{content/img/Unilaiva-songbook_part2_COVER.pdf}
