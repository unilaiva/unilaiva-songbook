...
% fancyhdr: setup header (by modifying the existing unilaiva style)
\fancypagestyle{unilaiva}{%
  \fancyhead[CE]{\headerbooktitle} % even center: book name
  \fancyhead[RE]{}
  \fancyhead[LO]{}
  \fancyhead[CO]{\headerchaptertitle} % odd center: chapter name
}
