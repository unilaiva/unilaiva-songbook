...
\providecommand{\secondpagefootnote}{%
  O material deste livro é coletado e transcrito, com a ajuda de uma multidão
  de pessoas, de várias fontes de áudio e texto --- e através do cantando,
  tocando, dançando, compartilhando, estudando e aprendendo. Este é um trabalho
  em andamento, feito com Gratidão e Amor.
}
