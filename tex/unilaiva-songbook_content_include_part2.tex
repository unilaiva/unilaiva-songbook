...
%%
  ...
  \definecolor{finnishcolor}{rgb}{.0078,.0039,.2549}
  ...
  % Edited by: larva
  \mainchapter{English}{englishcolor}[green_fractalish_circles_ed_by_larva_CC0_1200px.jpg]
    \begin{songs}{titleidx,authidx,tagidx}
      \input{content/songs_english.tex}
    \end{songs}

  \mainchapter{Saṃskṛtam}{sanskritcolor}[lotus_om_transparent_bg_2000px.png]
  ...
  % License: Public Domain (CC0)
  % Edited by: larva
  \mainchapter{Other}{brown}[Hopi_Navajo_Zuni_circle_ed_by_larva__transbg_CC0_1200px.png]
    \begin{songs}{titleidx,authidx,tagidx}
  ...
  \mainchapter{Suomi}{finnishcolor}[lintu_muinaissuomalaisilta_asuma-aloilta_perma__1426x1158px.png]
