...
%\renewcommand\mnsymbolstyle{\tiny} % make the melody note name text smaller
% Move melody note hints closer to the chords
\setlength{\mnhighheight}{1.75em} % upper media note height
\setlength{\mnnormalheight}{0.9em}
