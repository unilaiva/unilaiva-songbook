...
%%
  ...
  \mainchapter{Español}{spanishcolor}[Huichol_deer__transparent_bg_1042x1098px.png]
  ...
  % Edited by: larva
  % License: Free for non-commercial use
  \mainchapter{Português}{portuguesecolor}[caapi_heart_drawing_transparent_bg_1000x797px.png]
    \begin{songs}{titleidx,authidx,tagidx}
