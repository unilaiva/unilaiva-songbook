...
%%
  ...
  \definecolor{spanishcolor}{rgb}{.156,.698,.7921}
  \definecolor{portuguesecolor}{rgb}{.9411,.145,.7843}
  ...
  \mainchapter{Español}{spanishcolor}[ul-default-chapter-01_huichol_deer_transbg_1042x1098px.png]
  ...
  % Edited by: larva
  % License: Free for non-commercial use
  \mainchapter{Português}{portuguesecolor}[ul-default-chapter-02_caapi_heart_transbg_1000x797px.png]
    \begin{songs}{titleidx,authidx,tagidx}
